 ...
 */
public class GalaxyHttpClient extends TTransport {
  private static final Logger LOG = LoggerFactory.getLogger(GalaxyHttpClient.class);
  ...
  public static class Factory extends TTransportFactory {
    ...
    public TTransport getTransport(TTransport trans) {
      try {
        return new GalaxyHttpClient(url, client, credential, clock);
  ...
  public GalaxyHttpClient(String url, HttpClient client, Credential credential)
      throws TTransportException {
    this(url, client, credential, new AdjustableClock());
  }

  public GalaxyHttpClient(String url, HttpClient client, Credential credential, AdjustableClock clock)
      throws TTransportException {
    try {
      url_ = new URL(url);
      this.client = client;
  ...
  public GalaxyHttpClient setProtocol(ThriftProtocol protocol) {
    protocol_ = protocol;
    return this;
  }
  ...
  public GalaxyHttpClient setSocketTimeout(int timeout) {
  ...
  public GalaxyHttpClient setCustomHeaders(Map<String, String> headers) {
    customHeaders_ = headers;
    return this;
  }

  public GalaxyHttpClient setCustomHeader(String key, String value) {
  ...
  public GalaxyHttpClient setQueryString(String queryString) {
    this.queryString = queryString;
    return this;
  }

  public GalaxyHttpClient setSupportAccountKey(boolean supportAccountKey) {
  ...
  private GalaxyHttpClient setCustomHeaders(HttpPost post) {
