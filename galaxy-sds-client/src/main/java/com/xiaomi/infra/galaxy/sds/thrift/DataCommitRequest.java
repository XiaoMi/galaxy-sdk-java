...
public class DataCommitRequest implements libthrift091.TBase<DataCommitRequest, DataCommitRequest._Fields>, java.io.Serializable, Cloneable, Comparable<DataCommitRequest> {
  private static final libthrift091.protocol.TStruct STRUCT_DESC = new libthrift091.protocol.TStruct("DataCommitRequest");
  ...
  static {
    schemes.put(StandardScheme.class, new DataCommitRequestStandardSchemeFactory());
    schemes.put(TupleScheme.class, new DataCommitRequestTupleSchemeFactory());
  }
  ...
  private static final _Fields optionals[] = {_Fields.TABLE_NAME,_Fields.PARTITION_ID,_Fields.SUBSCRIBER_ID,_Fields.LAST_CONSUMED_OFFSET,_Fields.COMMIT_NUMBER};
  ...
  static {
    ...
    libthrift091.meta_data.FieldMetaData.addStructMetaDataMap(DataCommitRequest.class, metaDataMap);
  }
   ...
   */
  public DataCommitRequest(DataCommitRequest other) {
  ...
  public DataCommitRequest deepCopy() {
    return new DataCommitRequest(this);
  }
   ...
   * 表名
   */
  public DataCommitRequest setTableName(String tableName) {
   ...
   * 表分片ID
   */
  public DataCommitRequest setPartitionId(long partitionId) {
   ...
   * 订阅者ID
   */
  public DataCommitRequest setSubscriberId(String subscriberId) {
   ...
   * 当前消费存量数据的最后偏移
   */
  public DataCommitRequest setLastConsumedOffset(Map<String,Datum> lastConsumedOffset) {
   ...
   * 确认消费数量
   */
  public DataCommitRequest setCommitNumber(int commitNumber) {
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof DataCommitRequest)
      return this.equals((DataCommitRequest)that);
    return false;
  }

  public boolean equals(DataCommitRequest that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(DataCommitRequest other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("DataCommitRequest(");
    boolean first = true;
  ...
  private static class DataCommitRequestStandardSchemeFactory implements SchemeFactory {
    public DataCommitRequestStandardScheme getScheme() {
      return new DataCommitRequestStandardScheme();
    }
  }

  private static class DataCommitRequestStandardScheme extends StandardScheme<DataCommitRequest> {

    public void read(libthrift091.protocol.TProtocol iprot, DataCommitRequest struct) throws libthrift091.TException {
        ...
        switch (schemeField.id) {
          ...
          case 4: // LAST_CONSUMED_OFFSET
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                libthrift091.protocol.TMap _map396 = iprot.readMapBegin();
                struct.lastConsumedOffset = new HashMap<String,Datum>(2*_map396.size);
                String _key397;
                Datum _val398;
                for (int _i399 = 0; _i399 < _map396.size; ++_i399)
                {
                  ...
                  _val398 = new Datum();
                  _val398.read(iprot);
                  struct.lastConsumedOffset.put(_key397, _val398);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(libthrift091.protocol.TProtocol oprot, DataCommitRequest struct) throws libthrift091.TException {
      struct.validate();
      ...
      if (struct.lastConsumedOffset != null) {
        if (struct.isSetLastConsumedOffset()) {
          oprot.writeFieldBegin(LAST_CONSUMED_OFFSET_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Datum> _iter400 : struct.lastConsumedOffset.entrySet())
            {
  ...
  private static class DataCommitRequestTupleSchemeFactory implements SchemeFactory {
    public DataCommitRequestTupleScheme getScheme() {
      return new DataCommitRequestTupleScheme();
    }
  }

  private static class DataCommitRequestTupleScheme extends TupleScheme<DataCommitRequest> {

    @Override
    public void write(libthrift091.protocol.TProtocol prot, DataCommitRequest struct) throws libthrift091.TException {
      ...
      if (struct.isSetLastConsumedOffset()) {
        {
          ...
          for (Map.Entry<String, Datum> _iter401 : struct.lastConsumedOffset.entrySet())
          {
            oprot.writeString(_iter401.getKey());
            _iter401.getValue().write(oprot);
          }
        }
      }
      if (struct.isSetCommitNumber()) {
    ...
    @Override
    public void read(libthrift091.protocol.TProtocol prot, DataCommitRequest struct) throws libthrift091.TException {
      ...
      if (incoming.get(3)) {
        {
          libthrift091.protocol.TMap _map402 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.STRUCT, iprot.readI32());
          struct.lastConsumedOffset = new HashMap<String,Datum>(2*_map402.size);
          String _key403;
          Datum _val404;
          for (int _i405 = 0; _i405 < _map402.size; ++_i405)
          {
            ...
            _val404 = new Datum();
            _val404.read(iprot);
            struct.lastConsumedOffset.put(_key403, _val404);
          }
        }
        struct.setLastConsumedOffsetIsSet(true);
      }
