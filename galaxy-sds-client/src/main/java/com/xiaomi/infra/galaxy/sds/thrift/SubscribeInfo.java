...
public class SubscribeInfo implements libthrift091.TBase<SubscribeInfo, SubscribeInfo._Fields>, java.io.Serializable, Cloneable, Comparable<SubscribeInfo> {
  private static final libthrift091.protocol.TStruct STRUCT_DESC = new libthrift091.protocol.TStruct("SubscribeInfo");
  ...
  static {
    schemes.put(StandardScheme.class, new SubscribeInfoStandardSchemeFactory());
    schemes.put(TupleScheme.class, new SubscribeInfoTupleSchemeFactory());
  }
  ...
  static {
    ...
    libthrift091.meta_data.FieldMetaData.addStructMetaDataMap(SubscribeInfo.class, metaDataMap);
  }
   ...
   */
  public SubscribeInfo(SubscribeInfo other) {
  ...
  public SubscribeInfo setConsumedDataNumber(long consumedDataNumber) {
  ...
  public SubscribeInfo setCommittedDataNumber(long committedDataNumber) {
  ...
  public SubscribeInfo setConsumedEditNumber(long consumedEditNumber) {
  ...
  public SubscribeInfo setCommittedEditNumber(long committedEditNumber) {
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof SubscribeInfo)
      return this.equals((SubscribeInfo)that);
    return false;
  }

  public boolean equals(SubscribeInfo that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(SubscribeInfo other) {
  ...
  private static class SubscribeInfoStandardSchemeFactory implements SchemeFactory {
    public SubscribeInfoStandardScheme getScheme() {
      return new SubscribeInfoStandardScheme();
    }
  }

  private static class SubscribeInfoStandardScheme extends StandardScheme<SubscribeInfo> {

    public void read(libthrift091.protocol.TProtocol iprot, SubscribeInfo struct) throws libthrift091.TException {
    ...
    public void write(libthrift091.protocol.TProtocol oprot, SubscribeInfo struct) throws libthrift091.TException {
      struct.validate();
  ...
  private static class SubscribeInfoTupleSchemeFactory implements SchemeFactory {
    public SubscribeInfoTupleScheme getScheme() {
      return new SubscribeInfoTupleScheme();
    }
  }

  private static class SubscribeInfoTupleScheme extends TupleScheme<SubscribeInfo> {

    @Override
    public void write(libthrift091.protocol.TProtocol prot, SubscribeInfo struct) throws libthrift091.TException {
    ...
    @Override
    public void read(libthrift091.protocol.TProtocol prot, SubscribeInfo struct) throws libthrift091.TException {
