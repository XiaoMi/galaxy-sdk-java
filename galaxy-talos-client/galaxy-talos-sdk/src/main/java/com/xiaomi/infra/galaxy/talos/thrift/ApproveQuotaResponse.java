...
public class ApproveQuotaResponse implements libthrift091.TBase<ApproveQuotaResponse, ApproveQuotaResponse._Fields>, java.io.Serializable, Cloneable, Comparable<ApproveQuotaResponse> {
  private static final libthrift091.protocol.TStruct STRUCT_DESC = new libthrift091.protocol.TStruct("ApproveQuotaResponse");
  ...
  static {
    schemes.put(StandardScheme.class, new ApproveQuotaResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new ApproveQuotaResponseTupleSchemeFactory());
  }
  ...
  static {
    ...
    libthrift091.meta_data.FieldMetaData.addStructMetaDataMap(ApproveQuotaResponse.class, metaDataMap);
  }

  public ApproveQuotaResponse() {
  }
   ...
   */
  public ApproveQuotaResponse(ApproveQuotaResponse other) {
  ...
  public ApproveQuotaResponse deepCopy() {
    return new ApproveQuotaResponse(this);
  }
   ...
   * 
   */
  public ApproveQuotaResponse setPendingQuotaList(List<PartitionQuotaInfo> pendingQuotaList) {
    this.pendingQuotaList = pendingQuotaList;
    return this;
  }
   ...
   * 
   */
  public ApproveQuotaResponse setTalosAdmin(boolean talosAdmin) {
    this.talosAdmin = talosAdmin;
    setTalosAdminIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof ApproveQuotaResponse)
      return this.equals((ApproveQuotaResponse)that);
    return false;
  }

  public boolean equals(ApproveQuotaResponse that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(ApproveQuotaResponse other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("ApproveQuotaResponse(");
    boolean first = true;
  ...
  private static class ApproveQuotaResponseStandardSchemeFactory implements SchemeFactory {
    public ApproveQuotaResponseStandardScheme getScheme() {
      return new ApproveQuotaResponseStandardScheme();
    }
  }

  private static class ApproveQuotaResponseStandardScheme extends StandardScheme<ApproveQuotaResponse> {

    public void read(libthrift091.protocol.TProtocol iprot, ApproveQuotaResponse struct) throws libthrift091.TException {
            ...
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                ...
                struct.pendingQuotaList = new ArrayList<PartitionQuotaInfo>(_list26.size);
                PartitionQuotaInfo _elem27;
                for (int _i28 = 0; _i28 < _list26.size; ++_i28)
                {
                  _elem27 = new PartitionQuotaInfo();
                  _elem27.read(iprot);
                  struct.pendingQuotaList.add(_elem27);
                }
                iprot.readListEnd();
              }
    ...
    public void write(libthrift091.protocol.TProtocol oprot, ApproveQuotaResponse struct) throws libthrift091.TException {
      struct.validate();
      ...
      if (struct.pendingQuotaList != null) {
        oprot.writeFieldBegin(PENDING_QUOTA_LIST_FIELD_DESC);
        {
          ...
          for (PartitionQuotaInfo _iter29 : struct.pendingQuotaList)
          {
            _iter29.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class ApproveQuotaResponseTupleSchemeFactory implements SchemeFactory {
    public ApproveQuotaResponseTupleScheme getScheme() {
      return new ApproveQuotaResponseTupleScheme();
    }
  }

  private static class ApproveQuotaResponseTupleScheme extends TupleScheme<ApproveQuotaResponse> {

    @Override
    public void write(libthrift091.protocol.TProtocol prot, ApproveQuotaResponse struct) throws libthrift091.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      {
        oprot.writeI32(struct.pendingQuotaList.size());
        for (PartitionQuotaInfo _iter30 : struct.pendingQuotaList)
        {
          _iter30.write(oprot);
        }
      }
    ...
    @Override
    public void read(libthrift091.protocol.TProtocol prot, ApproveQuotaResponse struct) throws libthrift091.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      {
        ...
        struct.pendingQuotaList = new ArrayList<PartitionQuotaInfo>(_list31.size);
        PartitionQuotaInfo _elem32;
        for (int _i33 = 0; _i33 < _list31.size; ++_i33)
        {
          _elem32 = new PartitionQuotaInfo();
          _elem32.read(iprot);
          struct.pendingQuotaList.add(_elem32);
        }
      }
      struct.setPendingQuotaListIsSet(true);
      struct.talosAdmin = iprot.readBool();
