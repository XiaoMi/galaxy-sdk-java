...
public class ListPendingQuotaResponse implements libthrift091.TBase<ListPendingQuotaResponse, ListPendingQuotaResponse._Fields>, java.io.Serializable, Cloneable, Comparable<ListPendingQuotaResponse> {
  private static final libthrift091.protocol.TStruct STRUCT_DESC = new libthrift091.protocol.TStruct("ListPendingQuotaResponse");
  ...
  static {
    schemes.put(StandardScheme.class, new ListPendingQuotaResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new ListPendingQuotaResponseTupleSchemeFactory());
  }
  ...
  static {
    ...
    libthrift091.meta_data.FieldMetaData.addStructMetaDataMap(ListPendingQuotaResponse.class, metaDataMap);
  }

  public ListPendingQuotaResponse() {
  }
   ...
   */
  public ListPendingQuotaResponse(ListPendingQuotaResponse other) {
  ...
  public ListPendingQuotaResponse deepCopy() {
    return new ListPendingQuotaResponse(this);
  }
   ...
   * 
   */
  public ListPendingQuotaResponse setPendingQuotaList(List<PartitionQuotaInfo> pendingQuotaList) {
    this.pendingQuotaList = pendingQuotaList;
    return this;
  }
   ...
   * 
   */
  public ListPendingQuotaResponse setTalosAdmin(boolean talosAdmin) {
    this.talosAdmin = talosAdmin;
    setTalosAdminIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof ListPendingQuotaResponse)
      return this.equals((ListPendingQuotaResponse)that);
    return false;
  }

  public boolean equals(ListPendingQuotaResponse that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(ListPendingQuotaResponse other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("ListPendingQuotaResponse(");
    boolean first = true;
  ...
  private static class ListPendingQuotaResponseStandardSchemeFactory implements SchemeFactory {
    public ListPendingQuotaResponseStandardScheme getScheme() {
      return new ListPendingQuotaResponseStandardScheme();
    }
  }

  private static class ListPendingQuotaResponseStandardScheme extends StandardScheme<ListPendingQuotaResponse> {

    public void read(libthrift091.protocol.TProtocol iprot, ListPendingQuotaResponse struct) throws libthrift091.TException {
            ...
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                ...
                struct.pendingQuotaList = new ArrayList<PartitionQuotaInfo>(_list18.size);
                PartitionQuotaInfo _elem19;
                for (int _i20 = 0; _i20 < _list18.size; ++_i20)
                {
                  _elem19 = new PartitionQuotaInfo();
                  _elem19.read(iprot);
                  struct.pendingQuotaList.add(_elem19);
                }
                iprot.readListEnd();
              }
    ...
    public void write(libthrift091.protocol.TProtocol oprot, ListPendingQuotaResponse struct) throws libthrift091.TException {
      struct.validate();
      ...
      if (struct.pendingQuotaList != null) {
        oprot.writeFieldBegin(PENDING_QUOTA_LIST_FIELD_DESC);
        {
          ...
          for (PartitionQuotaInfo _iter21 : struct.pendingQuotaList)
          {
            _iter21.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class ListPendingQuotaResponseTupleSchemeFactory implements SchemeFactory {
    public ListPendingQuotaResponseTupleScheme getScheme() {
      return new ListPendingQuotaResponseTupleScheme();
    }
  }

  private static class ListPendingQuotaResponseTupleScheme extends TupleScheme<ListPendingQuotaResponse> {

    @Override
    public void write(libthrift091.protocol.TProtocol prot, ListPendingQuotaResponse struct) throws libthrift091.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      {
        oprot.writeI32(struct.pendingQuotaList.size());
        for (PartitionQuotaInfo _iter22 : struct.pendingQuotaList)
        {
          _iter22.write(oprot);
        }
      }
    ...
    @Override
    public void read(libthrift091.protocol.TProtocol prot, ListPendingQuotaResponse struct) throws libthrift091.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      {
        ...
        struct.pendingQuotaList = new ArrayList<PartitionQuotaInfo>(_list23.size);
        PartitionQuotaInfo _elem24;
        for (int _i25 = 0; _i25 < _list23.size; ++_i25)
        {
          _elem24 = new PartitionQuotaInfo();
          _elem24.read(iprot);
          struct.pendingQuotaList.add(_elem24);
        }
      }
      struct.setPendingQuotaListIsSet(true);
      struct.talosAdmin = iprot.readBool();
