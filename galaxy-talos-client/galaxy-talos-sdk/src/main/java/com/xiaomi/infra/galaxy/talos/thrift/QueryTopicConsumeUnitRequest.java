...
public class QueryTopicConsumeUnitRequest implements libthrift091.TBase<QueryTopicConsumeUnitRequest, QueryTopicConsumeUnitRequest._Fields>, java.io.Serializable, Cloneable, Comparable<QueryTopicConsumeUnitRequest> {
  private static final libthrift091.protocol.TStruct STRUCT_DESC = new libthrift091.protocol.TStruct("QueryTopicConsumeUnitRequest");
  ...
  static {
    schemes.put(StandardScheme.class, new QueryTopicConsumeUnitRequestStandardSchemeFactory());
    schemes.put(TupleScheme.class, new QueryTopicConsumeUnitRequestTupleSchemeFactory());
  }
  ...
  static {
    ...
    libthrift091.meta_data.FieldMetaData.addStructMetaDataMap(QueryTopicConsumeUnitRequest.class, metaDataMap);
  }

  public QueryTopicConsumeUnitRequest() {
  }
   ...
   */
  public QueryTopicConsumeUnitRequest(QueryTopicConsumeUnitRequest other) {
  ...
  public QueryTopicConsumeUnitRequest deepCopy() {
    return new QueryTopicConsumeUnitRequest(this);
  }
   ...
   * 
   */
  public QueryTopicConsumeUnitRequest setTopicTalosResourceName(com.xiaomi.infra.galaxy.talos.thrift.TopicTalosResourceName topicTalosResourceName) {
    this.topicTalosResourceName = topicTalosResourceName;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof QueryTopicConsumeUnitRequest)
      return this.equals((QueryTopicConsumeUnitRequest)that);
    return false;
  }

  public boolean equals(QueryTopicConsumeUnitRequest that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(QueryTopicConsumeUnitRequest other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("QueryTopicConsumeUnitRequest(");
    boolean first = true;
  ...
  private static class QueryTopicConsumeUnitRequestStandardSchemeFactory implements SchemeFactory {
    public QueryTopicConsumeUnitRequestStandardScheme getScheme() {
      return new QueryTopicConsumeUnitRequestStandardScheme();
    }
  }

  private static class QueryTopicConsumeUnitRequestStandardScheme extends StandardScheme<QueryTopicConsumeUnitRequest> {

    public void read(libthrift091.protocol.TProtocol iprot, QueryTopicConsumeUnitRequest struct) throws libthrift091.TException {
    ...
    public void write(libthrift091.protocol.TProtocol oprot, QueryTopicConsumeUnitRequest struct) throws libthrift091.TException {
      struct.validate();
  ...
  private static class QueryTopicConsumeUnitRequestTupleSchemeFactory implements SchemeFactory {
    public QueryTopicConsumeUnitRequestTupleScheme getScheme() {
      return new QueryTopicConsumeUnitRequestTupleScheme();
    }
  }

  private static class QueryTopicConsumeUnitRequestTupleScheme extends TupleScheme<QueryTopicConsumeUnitRequest> {

    @Override
    public void write(libthrift091.protocol.TProtocol prot, QueryTopicConsumeUnitRequest struct) throws libthrift091.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      struct.topicTalosResourceName.write(oprot);
    }

    @Override
    public void read(libthrift091.protocol.TProtocol prot, QueryTopicConsumeUnitRequest struct) throws libthrift091.TException {
