...
public class TopicState implements libthrift091.TBase<TopicState, TopicState._Fields>, java.io.Serializable, Cloneable, Comparable<TopicState> {
  ...
  private static final libthrift091.protocol.TField TOTAL_MESSAGE_NUMBER_FIELD_DESC = new libthrift091.protocol.TField("totalMessageNumber", libthrift091.protocol.TType.I64, (short)5);
  private static final libthrift091.protocol.TField TOTAL_MESSAGE_BYTES_FIELD_DESC = new libthrift091.protocol.TField("totalMessageBytes", libthrift091.protocol.TType.I64, (short)6);
  private static final libthrift091.protocol.TField PARTITION_STATES_FIELD_DESC = new libthrift091.protocol.TField("partitionStates", libthrift091.protocol.TType.LIST, (short)7);
   ...
   * 
   */
  public long totalMessageNumber; // required
  /**
   * The total message bytes of this topic
   * 
   */
  public long totalMessageBytes; // required
  /**
  ...
  public enum _Fields implements libthrift091.TFieldIdEnum {
     ...
     * 
     */
    TOTAL_MESSAGE_NUMBER((short)5, "totalMessageNumber"),
    /**
     * The total message bytes of this topic
     * 
     */
    TOTAL_MESSAGE_BYTES((short)6, "totalMessageBytes"),
    /**
     * All partition state for this partition;
     * 
     */
    PARTITION_STATES((short)7, "partitionStates");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 5: // TOTAL_MESSAGE_NUMBER
          return TOTAL_MESSAGE_NUMBER;
        case 6: // TOTAL_MESSAGE_BYTES
          return TOTAL_MESSAGE_BYTES;
        case 7: // PARTITION_STATES
  ...
  static {
    ...
    tmpMap.put(_Fields.MESSAGE_BYTES, new libthrift091.meta_data.FieldMetaData("messageBytes", libthrift091.TFieldRequirementType.REQUIRED, 
        new libthrift091.meta_data.FieldValueMetaData(libthrift091.protocol.TType.I64)));
    tmpMap.put(_Fields.TOTAL_MESSAGE_NUMBER, new libthrift091.meta_data.FieldMetaData("totalMessageNumber", libthrift091.TFieldRequirementType.REQUIRED, 
        new libthrift091.meta_data.FieldValueMetaData(libthrift091.protocol.TType.I64)));
    tmpMap.put(_Fields.TOTAL_MESSAGE_BYTES, new libthrift091.meta_data.FieldMetaData("totalMessageBytes", libthrift091.TFieldRequirementType.REQUIRED, 
        new libthrift091.meta_data.FieldValueMetaData(libthrift091.protocol.TType.I64)));
  ...
  public boolean equals(TopicState that) {
    ...
    boolean this_present_totalMessageNumber = true;
    boolean that_present_totalMessageNumber = true;
    ...
    boolean this_present_totalMessageBytes = true;
    boolean that_present_totalMessageBytes = true;
  ...
  public void validate() throws libthrift091.TException {
    ...
    // alas, we cannot check 'totalMessageNumber' because it's a primitive and you chose the non-beans generator.
    // alas, we cannot check 'totalMessageBytes' because it's a primitive and you chose the non-beans generator.
  ...
  private static class TopicStateStandardScheme extends StandardScheme<TopicState> {
    ...
    public void read(libthrift091.protocol.TProtocol iprot, TopicState struct) throws libthrift091.TException {
      ...
      if (!struct.isSetTotalMessageNumber()) {
        throw new libthrift091.protocol.TProtocolException("Required field 'totalMessageNumber' was not found in serialized data! Struct: " + toString());
      }
      if (!struct.isSetTotalMessageBytes()) {
        throw new libthrift091.protocol.TProtocolException("Required field 'totalMessageBytes' was not found in serialized data! Struct: " + toString());
      }
      struct.validate();
    }
