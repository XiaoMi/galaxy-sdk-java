...
public class QuotaService {
  ...
  public interface Iface extends com.xiaomi.infra.galaxy.talos.thrift.TalosBaseService.Iface {
    ...
    public void autoApplyQuota(AutoApplyQuotaRequest request) throws com.xiaomi.infra.galaxy.talos.thrift.GalaxyTalosException, libthrift091.TException;
  ...
  public interface AsyncIface extends com.xiaomi.infra.galaxy.talos.thrift.TalosBaseService .AsyncIface {
    ...
    public void autoApplyQuota(AutoApplyQuotaRequest request, libthrift091.async.AsyncMethodCallback resultHandler) throws libthrift091.TException;
  ...
  public static class Client extends com.xiaomi.infra.galaxy.talos.thrift.TalosBaseService.Client implements Iface {
    ...
    public void autoApplyQuota(AutoApplyQuotaRequest request) throws com.xiaomi.infra.galaxy.talos.thrift.GalaxyTalosException, libthrift091.TException
    {
      send_autoApplyQuota(request);
      recv_autoApplyQuota();
    }

    public void send_autoApplyQuota(AutoApplyQuotaRequest request) throws libthrift091.TException
    {
      autoApplyQuota_args args = new autoApplyQuota_args();
      args.setRequest(request);
      sendBase("autoApplyQuota", args);
    }

    public void recv_autoApplyQuota() throws com.xiaomi.infra.galaxy.talos.thrift.GalaxyTalosException, libthrift091.TException
    {
      autoApplyQuota_result result = new autoApplyQuota_result();
      receiveBase(result, "autoApplyQuota");
      if (result.e != null) {
        throw result.e;
      }
      return;
  ...
  public static class AsyncClient extends com.xiaomi.infra.galaxy.talos.thrift.TalosBaseService.AsyncClient implements AsyncIface {
    ...
    public void autoApplyQuota(AutoApplyQuotaRequest request, libthrift091.async.AsyncMethodCallback resultHandler) throws libthrift091.TException {
      checkReady();
      autoApplyQuota_call method_call = new autoApplyQuota_call(request, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }

    public static class autoApplyQuota_call extends libthrift091.async.TAsyncMethodCall {
      private AutoApplyQuotaRequest request;
      public autoApplyQuota_call(AutoApplyQuotaRequest request, libthrift091.async.AsyncMethodCallback resultHandler, libthrift091.async.TAsyncClient client, libthrift091.protocol.TProtocolFactory protocolFactory, libthrift091.transport.TNonblockingTransport transport) throws libthrift091.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.request = request;
      }

      public void write_args(libthrift091.protocol.TProtocol prot) throws libthrift091.TException {
        prot.writeMessageBegin(new libthrift091.protocol.TMessage("autoApplyQuota", libthrift091.protocol.TMessageType.CALL, 0));
        autoApplyQuota_args args = new autoApplyQuota_args();
        args.setRequest(request);
        args.write(prot);
        prot.writeMessageEnd();
      ...
      public void getResult() throws com.xiaomi.infra.galaxy.talos.thrift.GalaxyTalosException, libthrift091.TException {
        ...
        libthrift091.transport.TMemoryInputTransport memoryTransport = new libthrift091.transport.TMemoryInputTransport(getFrameBuffer().array());
        libthrift091.protocol.TProtocol prot = client.getProtocolFactory().getProtocol(memoryTransport);
        (new Client(prot)).recv_autoApplyQuota();
      }
    }
  ...
  public static class Processor<I extends Iface> extends com.xiaomi.infra.galaxy.talos.thrift.TalosBaseService.Processor<I> implements libthrift091.TProcessor {
    ...
    private static <I extends Iface> Map<String,  libthrift091.ProcessFunction<I, ? extends  libthrift091.TBase>> getProcessMap(Map<String,  libthrift091.ProcessFunction<I, ? extends  libthrift091.TBase>> processMap) {
      ...
      processMap.put("autoApplyQuota", new autoApplyQuota());
    ...
    public static class autoApplyQuota<I extends Iface> extends libthrift091.ProcessFunction<I, autoApplyQuota_args> {
      public autoApplyQuota() {
        super("autoApplyQuota");
      }

      public autoApplyQuota_args getEmptyArgsInstance() {
        return new autoApplyQuota_args();
      }
      ...
      public autoApplyQuota_result getResult(I iface, autoApplyQuota_args args) throws libthrift091.TException {
        autoApplyQuota_result result = new autoApplyQuota_result();
        try {
          iface.autoApplyQuota(args.request);
        } catch (com.xiaomi.infra.galaxy.talos.thrift.GalaxyTalosException e) {
          result.e = e;
        }
        return result;
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends com.xiaomi.infra.galaxy.talos.thrift.TalosBaseService.AsyncProcessor<I> {
    ...
    public static class autoApplyQuota<I extends AsyncIface> extends libthrift091.AsyncProcessFunction<I, autoApplyQuota_args, Void> {
      public autoApplyQuota() {
        super("autoApplyQuota");
      }
      ...
      public void start(I iface, autoApplyQuota_args args, libthrift091.async.AsyncMethodCallback<Void> resultHandler) throws TException {
        iface.autoApplyQuota(args.request,resultHandler);
      }
    }
...
;
  ...
  public static class autoApplyQuota_args implements libthrift091.TBase<autoApplyQuota_args, autoApplyQuota_args._Fields>, java.io.Serializable, Cloneable, Comparable<autoApplyQuota_args>   {
    private static final libthrift091.protocol.TStruct STRUCT_DESC = new libthrift091.protocol.TStruct("autoApplyQuota_args");

    private static final libthrift091.protocol.TField REQUEST_FIELD_DESC = new libthrift091.protocol.TField("request", libthrift091.protocol.TType.STRUCT, (short)1);

    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new autoApplyQuota_argsStandardSchemeFactory());
      schemes.put(TupleScheme.class, new autoApplyQuota_argsTupleSchemeFactory());
    }

    public AutoApplyQuotaRequest request; // required
    ...
    static {
      Map<_Fields, libthrift091.meta_data.FieldMetaData> tmpMap = new EnumMap<_Fields, libthrift091.meta_data.FieldMetaData>(_Fields.class);
      tmpMap.put(_Fields.REQUEST, new libthrift091.meta_data.FieldMetaData("request", libthrift091.TFieldRequirementType.DEFAULT, 
          new libthrift091.meta_data.StructMetaData(libthrift091.protocol.TType.STRUCT, AutoApplyQuotaRequest.class)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      libthrift091.meta_data.FieldMetaData.addStructMetaDataMap(autoApplyQuota_args.class, metaDataMap);
    }

    public autoApplyQuota_args() {
    }

    public autoApplyQuota_args(
      AutoApplyQuotaRequest request)
    {
      this();
      this.request = request;
    }
     ...
     * Performs a deep copy on <i>other</i>.
     */
    public autoApplyQuota_args(autoApplyQuota_args other) {
      if (other.isSetRequest()) {
        this.request = new AutoApplyQuotaRequest(other.request);
      }
    }

    public autoApplyQuota_args deepCopy() {
      return new autoApplyQuota_args(this);
    }
    ...
    public AutoApplyQuotaRequest getRequest() {
      return this.request;
    }

    public autoApplyQuota_args setRequest(AutoApplyQuotaRequest request) {
      this.request = request;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case REQUEST:
        if (value == null) {
          ...
          setRequest((AutoApplyQuotaRequest)value);
        }
        break;
    ...
    public boolean equals(Object that) {
      if (that == null)
        return false;
      if (that instanceof autoApplyQuota_args)
        return this.equals((autoApplyQuota_args)that);
      return false;
    }

    public boolean equals(autoApplyQuota_args that) {
      if (that == null)
        return false;
    ...
    @Override
    public int compareTo(autoApplyQuota_args other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("autoApplyQuota_args(");
      boolean first = true;
    ...
    private static class autoApplyQuota_argsStandardSchemeFactory implements SchemeFactory {
      public autoApplyQuota_argsStandardScheme getScheme() {
        return new autoApplyQuota_argsStandardScheme();
      }
    }

    private static class autoApplyQuota_argsStandardScheme extends StandardScheme<autoApplyQuota_args> {

      public void read(libthrift091.protocol.TProtocol iprot, autoApplyQuota_args struct) throws libthrift091.TException {
        libthrift091.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
          ...
          switch (schemeField.id) {
            case 1: // REQUEST
              if (schemeField.type == libthrift091.protocol.TType.STRUCT) {
                struct.request = new AutoApplyQuotaRequest();
                struct.request.read(iprot);
                struct.setRequestIsSet(true);
              } else { 
                libthrift091.protocol.TProtocolUtil.skip(iprot, schemeField.type);
      ...
      public void write(libthrift091.protocol.TProtocol oprot, autoApplyQuota_args struct) throws libthrift091.TException {
        struct.validate();
    ...
    private static class autoApplyQuota_argsTupleSchemeFactory implements SchemeFactory {
      public autoApplyQuota_argsTupleScheme getScheme() {
        return new autoApplyQuota_argsTupleScheme();
      }
    }

    private static class autoApplyQuota_argsTupleScheme extends TupleScheme<autoApplyQuota_args> {

      @Override
      public void write(libthrift091.protocol.TProtocol prot, autoApplyQuota_args struct) throws libthrift091.TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetRequest()) {
          optionals.set(0);
      ...
      @Override
      public void read(libthrift091.protocol.TProtocol prot, autoApplyQuota_args struct) throws libthrift091.TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(1);
        if (incoming.get(0)) {
          struct.request = new AutoApplyQuotaRequest();
  ...
  public static class autoApplyQuota_result implements libthrift091.TBase<autoApplyQuota_result, autoApplyQuota_result._Fields>, java.io.Serializable, Cloneable, Comparable<autoApplyQuota_result>   {
    private static final libthrift091.protocol.TStruct STRUCT_DESC = new libthrift091.protocol.TStruct("autoApplyQuota_result");

    private static final libthrift091.protocol.TField E_FIELD_DESC = new libthrift091.protocol.TField("e", libthrift091.protocol.TType.STRUCT, (short)1);

    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new autoApplyQuota_resultStandardSchemeFactory());
      schemes.put(TupleScheme.class, new autoApplyQuota_resultTupleSchemeFactory());
    }
    ...
    static {
      ...
      tmpMap.put(_Fields.E, new libthrift091.meta_data.FieldMetaData("e", libthrift091.TFieldRequirementType.DEFAULT, 
          new libthrift091.meta_data.FieldValueMetaData(libthrift091.protocol.TType.STRUCT)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      libthrift091.meta_data.FieldMetaData.addStructMetaDataMap(autoApplyQuota_result.class, metaDataMap);
    }

    public autoApplyQuota_result() {
    }
     ...
     * Performs a deep copy on <i>other</i>.
     */
    public autoApplyQuota_result(autoApplyQuota_result other) {
      if (other.isSetE()) {
        this.e = new com.xiaomi.infra.galaxy.talos.thrift.GalaxyTalosException(other.e);
      }
    }

    public autoApplyQuota_result deepCopy() {
      return new autoApplyQuota_result(this);
    }
    ...
    public autoApplyQuota_result setE(com.xiaomi.infra.galaxy.talos.thrift.GalaxyTalosException e) {
      this.e = e;
      return this;
    }
    ...
    public boolean equals(Object that) {
      if (that == null)
        return false;
      if (that instanceof autoApplyQuota_result)
        return this.equals((autoApplyQuota_result)that);
      return false;
    }

    public boolean equals(autoApplyQuota_result that) {
      if (that == null)
        return false;
    ...
    @Override
    public int compareTo(autoApplyQuota_result other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("autoApplyQuota_result(");
      boolean first = true;
    ...
    private static class autoApplyQuota_resultStandardSchemeFactory implements SchemeFactory {
      public autoApplyQuota_resultStandardScheme getScheme() {
        return new autoApplyQuota_resultStandardScheme();
      }
    }

    private static class autoApplyQuota_resultStandardScheme extends StandardScheme<autoApplyQuota_result> {

      public void read(libthrift091.protocol.TProtocol iprot, autoApplyQuota_result struct) throws libthrift091.TException {
        libthrift091.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(libthrift091.protocol.TProtocol oprot, autoApplyQuota_result struct) throws libthrift091.TException {
        struct.validate();
    ...
    private static class autoApplyQuota_resultTupleSchemeFactory implements SchemeFactory {
      public autoApplyQuota_resultTupleScheme getScheme() {
        return new autoApplyQuota_resultTupleScheme();
      }
    }

    private static class autoApplyQuota_resultTupleScheme extends TupleScheme<autoApplyQuota_result> {

      @Override
      public void write(libthrift091.protocol.TProtocol prot, autoApplyQuota_result struct) throws libthrift091.TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetE()) {
          optionals.set(0);
      ...
      @Override
      public void read(libthrift091.protocol.TProtocol prot, autoApplyQuota_result struct) throws libthrift091.TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(1);
        if (incoming.get(0)) {
          struct.e = new com.xiaomi.infra.galaxy.talos.thrift.GalaxyTalosException();
