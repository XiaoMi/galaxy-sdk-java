...
public class GetMessageResponse implements libthrift091.TBase<GetMessageResponse, GetMessageResponse._Fields>, java.io.Serializable, Cloneable, Comparable<GetMessageResponse> {
  ...
  private static final libthrift091.protocol.TField IS_TRANSFER_FIELD_DESC = new libthrift091.protocol.TField("isTransfer", libthrift091.protocol.TType.BOOL, (short)5);
  ...
  public enum _Fields implements libthrift091.TFieldIdEnum {
     ...
     * 
     */
    IS_TRANSFER((short)5, "isTransfer");
  ...
  private static final int __ISTRANSFER_ISSET_ID = 2;
  private byte __isset_bitfield = 0;
  private static final _Fields optionals[] = {_Fields.UN_HANDLED_MESSAGE_NUMBER,_Fields.IS_TRANSFER};
   ...
   * 
   */
  public GetMessageResponse setIsTransfer(boolean isTransfer) {
            ...
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                ...
                struct.messageBlocks = new ArrayList<MessageBlock>(_list16.size);
                MessageBlock _elem17;
                for (int _i18 = 0; _i18 < _list16.size; ++_i18)
                {
                  _elem17 = new MessageBlock();
                  _elem17.read(iprot);
                  struct.messageBlocks.add(_elem17);
                }
                iprot.readListEnd();
              }
    ...
    public void write(libthrift091.protocol.TProtocol oprot, GetMessageResponse struct) throws libthrift091.TException {
      ...
      if (struct.messageBlocks != null) {
        oprot.writeFieldBegin(MESSAGE_BLOCKS_FIELD_DESC);
        {
          ...
          for (MessageBlock _iter19 : struct.messageBlocks)
          {
            _iter19.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class GetMessageResponseTupleScheme extends TupleScheme<GetMessageResponse> {
    ...
    public void write(libthrift091.protocol.TProtocol prot, GetMessageResponse struct) throws libthrift091.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      {
        ...
        for (MessageBlock _iter20 : struct.messageBlocks)
        {
          _iter20.write(oprot);
        }
      }
    ...
    public void read(libthrift091.protocol.TProtocol prot, GetMessageResponse struct) throws libthrift091.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      {
        ...
        struct.messageBlocks = new ArrayList<MessageBlock>(_list21.size);
        MessageBlock _elem22;
        for (int _i23 = 0; _i23 < _list21.size; ++_i23)
        {
          _elem22 = new MessageBlock();
          _elem22.read(iprot);
          struct.messageBlocks.add(_elem22);
        }
      }
      struct.setMessageBlocksIsSet(true);
      struct.messageNumber = iprot.readI32();
