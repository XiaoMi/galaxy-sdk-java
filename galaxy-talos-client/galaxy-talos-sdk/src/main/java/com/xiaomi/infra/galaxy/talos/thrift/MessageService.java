...
public class MessageService {
  ...
  public interface Iface extends com.xiaomi.infra.galaxy.talos.thrift.TalosBaseService.Iface {
     ...
     * @param request
     */
    public GetScheduleInfoResponse getScheduleInfo(GetScheduleInfoRequest request) throws com.xiaomi.infra.galaxy.talos.thrift.GalaxyTalosException, libthrift091.TException;
  ...
  public interface AsyncIface extends com.xiaomi.infra.galaxy.talos.thrift.TalosBaseService .AsyncIface {
    ...
    public void getScheduleInfo(GetScheduleInfoRequest request, libthrift091.async.AsyncMethodCallback resultHandler) throws libthrift091.TException;
  ...
  public static class Client extends com.xiaomi.infra.galaxy.talos.thrift.TalosBaseService.Client implements Iface {
    ...
    public GetScheduleInfoResponse getScheduleInfo(GetScheduleInfoRequest request) throws com.xiaomi.infra.galaxy.talos.thrift.GalaxyTalosException, libthrift091.TException
    {
      send_getScheduleInfo(request);
      return recv_getScheduleInfo();
    }

    public void send_getScheduleInfo(GetScheduleInfoRequest request) throws libthrift091.TException
    {
      getScheduleInfo_args args = new getScheduleInfo_args();
      args.setRequest(request);
      sendBase("getScheduleInfo", args);
    }

    public GetScheduleInfoResponse recv_getScheduleInfo() throws com.xiaomi.infra.galaxy.talos.thrift.GalaxyTalosException, libthrift091.TException
    {
      getScheduleInfo_result result = new getScheduleInfo_result();
      receiveBase(result, "getScheduleInfo");
      if (result.isSetSuccess()) {
        return result.success;
      }
      if (result.e != null) {
      ...
      throw new libthrift091.TApplicationException(libthrift091.TApplicationException.MISSING_RESULT, "getScheduleInfo failed: unknown result");
    }
  ...
  public static class AsyncClient extends com.xiaomi.infra.galaxy.talos.thrift.TalosBaseService.AsyncClient implements AsyncIface {
    ...
    public void getScheduleInfo(GetScheduleInfoRequest request, libthrift091.async.AsyncMethodCallback resultHandler) throws libthrift091.TException {
      checkReady();
      getScheduleInfo_call method_call = new getScheduleInfo_call(request, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }

    public static class getScheduleInfo_call extends libthrift091.async.TAsyncMethodCall {
      private GetScheduleInfoRequest request;
      public getScheduleInfo_call(GetScheduleInfoRequest request, libthrift091.async.AsyncMethodCallback resultHandler, libthrift091.async.TAsyncClient client, libthrift091.protocol.TProtocolFactory protocolFactory, libthrift091.transport.TNonblockingTransport transport) throws libthrift091.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.request = request;
      }

      public void write_args(libthrift091.protocol.TProtocol prot) throws libthrift091.TException {
        prot.writeMessageBegin(new libthrift091.protocol.TMessage("getScheduleInfo", libthrift091.protocol.TMessageType.CALL, 0));
        getScheduleInfo_args args = new getScheduleInfo_args();
        args.setRequest(request);
        args.write(prot);
        prot.writeMessageEnd();
      ...
      public GetScheduleInfoResponse getResult() throws com.xiaomi.infra.galaxy.talos.thrift.GalaxyTalosException, libthrift091.TException {
        if (getState() != libthrift091.async.TAsyncMethodCall.State.RESPONSE_READ) {
          throw new IllegalStateException("Method call not finished!");
        }
        libthrift091.transport.TMemoryInputTransport memoryTransport = new libthrift091.transport.TMemoryInputTransport(getFrameBuffer().array());
        libthrift091.protocol.TProtocol prot = client.getProtocolFactory().getProtocol(memoryTransport);
        return (new Client(prot)).recv_getScheduleInfo();
      }
    }
  ...
  public static class Processor<I extends Iface> extends com.xiaomi.infra.galaxy.talos.thrift.TalosBaseService.Processor<I> implements libthrift091.TProcessor {
    ...
    private static <I extends Iface> Map<String,  libthrift091.ProcessFunction<I, ? extends  libthrift091.TBase>> getProcessMap(Map<String,  libthrift091.ProcessFunction<I, ? extends  libthrift091.TBase>> processMap) {
      ...
      processMap.put("getScheduleInfo", new getScheduleInfo());
      return processMap;
    }
    ...
    public static class getScheduleInfo<I extends Iface> extends libthrift091.ProcessFunction<I, getScheduleInfo_args> {
      public getScheduleInfo() {
        super("getScheduleInfo");
      }

      public getScheduleInfo_args getEmptyArgsInstance() {
        return new getScheduleInfo_args();
      }
      ...
      public getScheduleInfo_result getResult(I iface, getScheduleInfo_args args) throws libthrift091.TException {
        getScheduleInfo_result result = new getScheduleInfo_result();
        try {
          result.success = iface.getScheduleInfo(args.request);
        } catch (com.xiaomi.infra.galaxy.talos.thrift.GalaxyTalosException e) {
          result.e = e;
        }
        return result;
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends com.xiaomi.infra.galaxy.talos.thrift.TalosBaseService.AsyncProcessor<I> {
    ...
    public static class getScheduleInfo<I extends AsyncIface> extends libthrift091.AsyncProcessFunction<I, getScheduleInfo_args, GetScheduleInfoResponse> {
      public getScheduleInfo() {
        super("getScheduleInfo");
      }
      ...
      public AsyncMethodCallback<GetScheduleInfoResponse> getResultHandler(final AsyncFrameBuffer fb, final int seqid) {
        final libthrift091.AsyncProcessFunction fcall = this;
        return new AsyncMethodCallback<GetScheduleInfoResponse>() { 
          public void onComplete(GetScheduleInfoResponse o) {
            getScheduleInfo_result result = new getScheduleInfo_result();
            result.success = o;
            try {
              fcall.sendResponse(fb,result, libthrift091.protocol.TMessageType.REPLY,seqid);
      ...
      public void start(I iface, getScheduleInfo_args args, libthrift091.async.AsyncMethodCallback<GetScheduleInfoResponse> resultHandler) throws TException {
        iface.getScheduleInfo(args.request,resultHandler);
      }
    }
  ...
  public static class getScheduleInfo_args implements libthrift091.TBase<getScheduleInfo_args, getScheduleInfo_args._Fields>, java.io.Serializable, Cloneable, Comparable<getScheduleInfo_args>   {
    private static final libthrift091.protocol.TStruct STRUCT_DESC = new libthrift091.protocol.TStruct("getScheduleInfo_args");

    private static final libthrift091.protocol.TField REQUEST_FIELD_DESC = new libthrift091.protocol.TField("request", libthrift091.protocol.TType.STRUCT, (short)1);

    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new getScheduleInfo_argsStandardSchemeFactory());
      schemes.put(TupleScheme.class, new getScheduleInfo_argsTupleSchemeFactory());
    }

    public GetScheduleInfoRequest request; // required
    ...
    static {
      Map<_Fields, libthrift091.meta_data.FieldMetaData> tmpMap = new EnumMap<_Fields, libthrift091.meta_data.FieldMetaData>(_Fields.class);
      tmpMap.put(_Fields.REQUEST, new libthrift091.meta_data.FieldMetaData("request", libthrift091.TFieldRequirementType.DEFAULT, 
          new libthrift091.meta_data.StructMetaData(libthrift091.protocol.TType.STRUCT, GetScheduleInfoRequest.class)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      libthrift091.meta_data.FieldMetaData.addStructMetaDataMap(getScheduleInfo_args.class, metaDataMap);
    }

    public getScheduleInfo_args() {
    }

    public getScheduleInfo_args(
      GetScheduleInfoRequest request)
    {
      this();
      this.request = request;
    }
     ...
     * Performs a deep copy on <i>other</i>.
     */
    public getScheduleInfo_args(getScheduleInfo_args other) {
      if (other.isSetRequest()) {
        this.request = new GetScheduleInfoRequest(other.request);
      }
    }

    public getScheduleInfo_args deepCopy() {
      return new getScheduleInfo_args(this);
    }
    ...
    public GetScheduleInfoRequest getRequest() {
      return this.request;
    }

    public getScheduleInfo_args setRequest(GetScheduleInfoRequest request) {
      this.request = request;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case REQUEST:
        if (value == null) {
          ...
          setRequest((GetScheduleInfoRequest)value);
        }
        break;
    ...
    public boolean equals(Object that) {
      if (that == null)
        return false;
      if (that instanceof getScheduleInfo_args)
        return this.equals((getScheduleInfo_args)that);
      return false;
    }

    public boolean equals(getScheduleInfo_args that) {
      if (that == null)
        return false;
    ...
    @Override
    public int compareTo(getScheduleInfo_args other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("getScheduleInfo_args(");
      boolean first = true;
    ...
    private static class getScheduleInfo_argsStandardSchemeFactory implements SchemeFactory {
      public getScheduleInfo_argsStandardScheme getScheme() {
        return new getScheduleInfo_argsStandardScheme();
      }
    }

    private static class getScheduleInfo_argsStandardScheme extends StandardScheme<getScheduleInfo_args> {

      public void read(libthrift091.protocol.TProtocol iprot, getScheduleInfo_args struct) throws libthrift091.TException {
        libthrift091.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
          ...
          switch (schemeField.id) {
            case 1: // REQUEST
              if (schemeField.type == libthrift091.protocol.TType.STRUCT) {
                struct.request = new GetScheduleInfoRequest();
                struct.request.read(iprot);
                struct.setRequestIsSet(true);
              } else { 
                libthrift091.protocol.TProtocolUtil.skip(iprot, schemeField.type);
      ...
      public void write(libthrift091.protocol.TProtocol oprot, getScheduleInfo_args struct) throws libthrift091.TException {
        struct.validate();
    ...
    private static class getScheduleInfo_argsTupleSchemeFactory implements SchemeFactory {
      public getScheduleInfo_argsTupleScheme getScheme() {
        return new getScheduleInfo_argsTupleScheme();
      }
    }

    private static class getScheduleInfo_argsTupleScheme extends TupleScheme<getScheduleInfo_args> {

      @Override
      public void write(libthrift091.protocol.TProtocol prot, getScheduleInfo_args struct) throws libthrift091.TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetRequest()) {
          optionals.set(0);
      ...
      @Override
      public void read(libthrift091.protocol.TProtocol prot, getScheduleInfo_args struct) throws libthrift091.TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(1);
        if (incoming.get(0)) {
          struct.request = new GetScheduleInfoRequest();
  ...
  public static class getScheduleInfo_result implements libthrift091.TBase<getScheduleInfo_result, getScheduleInfo_result._Fields>, java.io.Serializable, Cloneable, Comparable<getScheduleInfo_result>   {
    private static final libthrift091.protocol.TStruct STRUCT_DESC = new libthrift091.protocol.TStruct("getScheduleInfo_result");
    ...
    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new getScheduleInfo_resultStandardSchemeFactory());
      schemes.put(TupleScheme.class, new getScheduleInfo_resultTupleSchemeFactory());
    }

    public GetScheduleInfoResponse success; // required
    public com.xiaomi.infra.galaxy.talos.thrift.GalaxyTalosException e; // required
    ...
    static {
      Map<_Fields, libthrift091.meta_data.FieldMetaData> tmpMap = new EnumMap<_Fields, libthrift091.meta_data.FieldMetaData>(_Fields.class);
      tmpMap.put(_Fields.SUCCESS, new libthrift091.meta_data.FieldMetaData("success", libthrift091.TFieldRequirementType.DEFAULT, 
          new libthrift091.meta_data.StructMetaData(libthrift091.protocol.TType.STRUCT, GetScheduleInfoResponse.class)));
      tmpMap.put(_Fields.E, new libthrift091.meta_data.FieldMetaData("e", libthrift091.TFieldRequirementType.DEFAULT, 
          new libthrift091.meta_data.FieldValueMetaData(libthrift091.protocol.TType.STRUCT)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      libthrift091.meta_data.FieldMetaData.addStructMetaDataMap(getScheduleInfo_result.class, metaDataMap);
    }

    public getScheduleInfo_result() {
    }

    public getScheduleInfo_result(
      GetScheduleInfoResponse success,
      com.xiaomi.infra.galaxy.talos.thrift.GalaxyTalosException e)
    {
      this();
      this.success = success;
     ...
     * Performs a deep copy on <i>other</i>.
     */
    public getScheduleInfo_result(getScheduleInfo_result other) {
      if (other.isSetSuccess()) {
        this.success = new GetScheduleInfoResponse(other.success);
      }
      if (other.isSetE()) {
        this.e = new com.xiaomi.infra.galaxy.talos.thrift.GalaxyTalosException(other.e);
      }
    ...
    public getScheduleInfo_result deepCopy() {
      return new getScheduleInfo_result(this);
    }
    ...
    public GetScheduleInfoResponse getSuccess() {
      return this.success;
    }

    public getScheduleInfo_result setSuccess(GetScheduleInfoResponse success) {
      this.success = success;
      return this;
    }
    ...
    public getScheduleInfo_result setE(com.xiaomi.infra.galaxy.talos.thrift.GalaxyTalosException e) {
      this.e = e;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case SUCCESS:
        if (value == null) {
          ...
          setSuccess((GetScheduleInfoResponse)value);
        }
        break;
    ...
    public boolean equals(Object that) {
      if (that == null)
        return false;
      if (that instanceof getScheduleInfo_result)
        return this.equals((getScheduleInfo_result)that);
      return false;
    }

    public boolean equals(getScheduleInfo_result that) {
      if (that == null)
        return false;
    ...
    @Override
    public int compareTo(getScheduleInfo_result other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("getScheduleInfo_result(");
      boolean first = true;
    ...
    private static class getScheduleInfo_resultStandardSchemeFactory implements SchemeFactory {
      public getScheduleInfo_resultStandardScheme getScheme() {
        return new getScheduleInfo_resultStandardScheme();
      }
    }

    private static class getScheduleInfo_resultStandardScheme extends StandardScheme<getScheduleInfo_result> {

      public void read(libthrift091.protocol.TProtocol iprot, getScheduleInfo_result struct) throws libthrift091.TException {
        libthrift091.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
          ...
          switch (schemeField.id) {
            case 0: // SUCCESS
              if (schemeField.type == libthrift091.protocol.TType.STRUCT) {
                struct.success = new GetScheduleInfoResponse();
                struct.success.read(iprot);
                struct.setSuccessIsSet(true);
              } else { 
                libthrift091.protocol.TProtocolUtil.skip(iprot, schemeField.type);
      ...
      public void write(libthrift091.protocol.TProtocol oprot, getScheduleInfo_result struct) throws libthrift091.TException {
        struct.validate();
    ...
    private static class getScheduleInfo_resultTupleSchemeFactory implements SchemeFactory {
      public getScheduleInfo_resultTupleScheme getScheme() {
        return new getScheduleInfo_resultTupleScheme();
      }
    }

    private static class getScheduleInfo_resultTupleScheme extends TupleScheme<getScheduleInfo_result> {

      @Override
      public void write(libthrift091.protocol.TProtocol prot, getScheduleInfo_result struct) throws libthrift091.TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetSuccess()) {
          optionals.set(0);
      ...
      @Override
      public void read(libthrift091.protocol.TProtocol prot, getScheduleInfo_result struct) throws libthrift091.TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(2);
        if (incoming.get(0)) {
          struct.success = new GetScheduleInfoResponse();
