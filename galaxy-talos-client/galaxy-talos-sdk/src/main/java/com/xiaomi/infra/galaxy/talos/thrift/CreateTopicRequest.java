...
public class CreateTopicRequest implements libthrift091.TBase<CreateTopicRequest, CreateTopicRequest._Fields>, java.io.Serializable, Cloneable, Comparable<CreateTopicRequest> {
  ...
  private _Fields optionals[] = {_Fields.TOPIC_QUOTA,_Fields.ACL_MAP};
            ...
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                ...
                {
                  com.xiaomi.infra.galaxy.rpc.thrift.Grantee _key30;
                  Permission _val31;
                  _key30 = new com.xiaomi.infra.galaxy.rpc.thrift.Grantee();
                  _key30.read(iprot);
                  _val31 = Permission.findByValue(iprot.readI32());
                  struct.aclMap.put(_key30, _val31);
                }
                iprot.readMapEnd();
              }
      ...
      if (incoming.get(1)) {
        {
          ...
          {
            com.xiaomi.infra.galaxy.rpc.thrift.Grantee _key36;
            Permission _val37;
            _key36 = new com.xiaomi.infra.galaxy.rpc.thrift.Grantee();
            _key36.read(iprot);
            _val37 = Permission.findByValue(iprot.readI32());
            struct.aclMap.put(_key36, _val37);
          }
        }
        struct.setAclMapIsSet(true);
      }
