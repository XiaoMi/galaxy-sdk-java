...
public class TopicAttribute implements libthrift091.TBase<TopicAttribute, TopicAttribute._Fields>, java.io.Serializable, Cloneable, Comparable<TopicAttribute> {
  ...
  /**
   * The retention time(in secs) for message in the topic, talos will make sure
  ...
  private static final _Fields optionals[] = {_Fields.PARTITION_NUMBER,_Fields.MESSAGE_RETENTION_SECS,_Fields.ATTRIBUTES};
