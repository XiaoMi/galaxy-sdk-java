...
@Generated(value = "Autogenerated by Thrift Compiler (0.9.2)", date = "2019-5-9")
public class GetTopicResourceNameResponse implements libthrift091.TBase<GetTopicResourceNameResponse, GetTopicResourceNameResponse._Fields>, java.io.Serializable, Cloneable, Comparable<GetTopicResourceNameResponse> {
  private static final libthrift091.protocol.TStruct STRUCT_DESC = new libthrift091.protocol.TStruct("GetTopicResourceNameResponse");
  ...
  static {
    schemes.put(StandardScheme.class, new GetTopicResourceNameResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new GetTopicResourceNameResponseTupleSchemeFactory());
  }
  ...
  static {
    ...
    libthrift091.meta_data.FieldMetaData.addStructMetaDataMap(GetTopicResourceNameResponse.class, metaDataMap);
  }

  public GetTopicResourceNameResponse() {
  }
   ...
   */
  public GetTopicResourceNameResponse(GetTopicResourceNameResponse other) {
    if (other.isSetTopicTalosResourceName()) {
      this.topicTalosResourceName = new TopicTalosResourceName(other.topicTalosResourceName);
    }
  }

  public GetTopicResourceNameResponse deepCopy() {
    return new GetTopicResourceNameResponse(this);
  }
   ...
   * 
   */
  public GetTopicResourceNameResponse setTopicTalosResourceName(TopicTalosResourceName topicTalosResourceName) {
    this.topicTalosResourceName = topicTalosResourceName;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof GetTopicResourceNameResponse)
      return this.equals((GetTopicResourceNameResponse)that);
    return false;
  }

  public boolean equals(GetTopicResourceNameResponse that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(GetTopicResourceNameResponse other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("GetTopicResourceNameResponse(");
    boolean first = true;
  ...
  private static class GetTopicResourceNameResponseStandardSchemeFactory implements SchemeFactory {
    public GetTopicResourceNameResponseStandardScheme getScheme() {
      return new GetTopicResourceNameResponseStandardScheme();
    }
  }

  private static class GetTopicResourceNameResponseStandardScheme extends StandardScheme<GetTopicResourceNameResponse> {

    public void read(libthrift091.protocol.TProtocol iprot, GetTopicResourceNameResponse struct) throws libthrift091.TException {
    ...
    public void write(libthrift091.protocol.TProtocol oprot, GetTopicResourceNameResponse struct) throws libthrift091.TException {
      struct.validate();
  ...
  private static class GetTopicResourceNameResponseTupleSchemeFactory implements SchemeFactory {
    public GetTopicResourceNameResponseTupleScheme getScheme() {
      return new GetTopicResourceNameResponseTupleScheme();
    }
  }

  private static class GetTopicResourceNameResponseTupleScheme extends TupleScheme<GetTopicResourceNameResponse> {

    @Override
    public void write(libthrift091.protocol.TProtocol prot, GetTopicResourceNameResponse struct) throws libthrift091.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      struct.topicTalosResourceName.write(oprot);
    }

    @Override
    public void read(libthrift091.protocol.TProtocol prot, GetTopicResourceNameResponse struct) throws libthrift091.TException {
