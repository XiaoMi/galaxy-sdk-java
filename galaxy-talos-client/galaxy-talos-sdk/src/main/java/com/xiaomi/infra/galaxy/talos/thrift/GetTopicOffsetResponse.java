            ...
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                ...
                struct.offsetInfoList = new ArrayList<OffsetInfo>(_list24.size);
                OffsetInfo _elem25;
                for (int _i26 = 0; _i26 < _list24.size; ++_i26)
                {
                  _elem25 = new OffsetInfo();
                  _elem25.read(iprot);
                  struct.offsetInfoList.add(_elem25);
                }
                iprot.readListEnd();
              }
    ...
    public void write(libthrift091.protocol.TProtocol oprot, GetTopicOffsetResponse struct) throws libthrift091.TException {
      ...
      if (struct.offsetInfoList != null) {
        oprot.writeFieldBegin(OFFSET_INFO_LIST_FIELD_DESC);
        {
          ...
          for (OffsetInfo _iter27 : struct.offsetInfoList)
          {
            _iter27.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class GetTopicOffsetResponseTupleScheme extends TupleScheme<GetTopicOffsetResponse> {
    ...
    public void write(libthrift091.protocol.TProtocol prot, GetTopicOffsetResponse struct) throws libthrift091.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      {
        ...
        for (OffsetInfo _iter28 : struct.offsetInfoList)
        {
          _iter28.write(oprot);
        }
      }
    ...
    public void read(libthrift091.protocol.TProtocol prot, GetTopicOffsetResponse struct) throws libthrift091.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      {
        ...
        struct.offsetInfoList = new ArrayList<OffsetInfo>(_list29.size);
        OffsetInfo _elem30;
        for (int _i31 = 0; _i31 < _list29.size; ++_i31)
        {
          _elem30 = new OffsetInfo();
          _elem30.read(iprot);
          struct.offsetInfoList.add(_elem30);
        }
      }
      struct.setOffsetInfoListIsSet(true);
    }
