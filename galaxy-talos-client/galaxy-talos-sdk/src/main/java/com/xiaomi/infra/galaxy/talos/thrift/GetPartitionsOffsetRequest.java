            ...
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                ...
                struct.topicAndPartitionList = new ArrayList<com.xiaomi.infra.galaxy.talos.thrift.TopicAndPartition>(_list32.size);
                com.xiaomi.infra.galaxy.talos.thrift.TopicAndPartition _elem33;
                for (int _i34 = 0; _i34 < _list32.size; ++_i34)
                {
                  _elem33 = new com.xiaomi.infra.galaxy.talos.thrift.TopicAndPartition();
                  _elem33.read(iprot);
                  struct.topicAndPartitionList.add(_elem33);
                }
                iprot.readListEnd();
              }
    ...
    public void write(libthrift091.protocol.TProtocol oprot, GetPartitionsOffsetRequest struct) throws libthrift091.TException {
      ...
      if (struct.topicAndPartitionList != null) {
        oprot.writeFieldBegin(TOPIC_AND_PARTITION_LIST_FIELD_DESC);
        {
          ...
          for (com.xiaomi.infra.galaxy.talos.thrift.TopicAndPartition _iter35 : struct.topicAndPartitionList)
          {
            _iter35.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class GetPartitionsOffsetRequestTupleScheme extends TupleScheme<GetPartitionsOffsetRequest> {
    ...
    public void write(libthrift091.protocol.TProtocol prot, GetPartitionsOffsetRequest struct) throws libthrift091.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      {
        ...
        for (com.xiaomi.infra.galaxy.talos.thrift.TopicAndPartition _iter36 : struct.topicAndPartitionList)
        {
          _iter36.write(oprot);
        }
      }
    ...
    public void read(libthrift091.protocol.TProtocol prot, GetPartitionsOffsetRequest struct) throws libthrift091.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      {
        ...
        struct.topicAndPartitionList = new ArrayList<com.xiaomi.infra.galaxy.talos.thrift.TopicAndPartition>(_list37.size);
        com.xiaomi.infra.galaxy.talos.thrift.TopicAndPartition _elem38;
        for (int _i39 = 0; _i39 < _list37.size; ++_i39)
        {
          _elem38 = new com.xiaomi.infra.galaxy.talos.thrift.TopicAndPartition();
          _elem38.read(iprot);
          struct.topicAndPartitionList.add(_elem38);
        }
      }
      struct.setTopicAndPartitionListIsSet(true);
    }
