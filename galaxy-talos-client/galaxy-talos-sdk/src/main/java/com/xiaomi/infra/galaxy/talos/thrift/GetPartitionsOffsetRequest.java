            ...
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                ...
                {
                  com.xiaomi.infra.galaxy.talos.thrift.TopicAndPartition _elem26;
                  _elem26 = new com.xiaomi.infra.galaxy.talos.thrift.TopicAndPartition();
                  _elem26.read(iprot);
                  struct.topicAndPartitionList.add(_elem26);
                }
                iprot.readListEnd();
              }
  ...
  private static class GetPartitionsOffsetRequestTupleScheme extends TupleScheme<GetPartitionsOffsetRequest> {
    ...
    public void read(libthrift091.protocol.TProtocol prot, GetPartitionsOffsetRequest struct) throws libthrift091.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      {
        ...
        {
          com.xiaomi.infra.galaxy.talos.thrift.TopicAndPartition _elem31;
          _elem31 = new com.xiaomi.infra.galaxy.talos.thrift.TopicAndPartition();
          _elem31.read(iprot);
          struct.topicAndPartitionList.add(_elem31);
        }
      }
      struct.setTopicAndPartitionListIsSet(true);
    }
