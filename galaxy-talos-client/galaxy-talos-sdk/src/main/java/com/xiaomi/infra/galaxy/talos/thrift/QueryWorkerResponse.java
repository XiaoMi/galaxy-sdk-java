            ...
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                ...
                for (int _i33 = 0; _i33 < _map32.size; ++_i33)
                {
                  ...
                  _key34 = iprot.readString();
                  {
                    ...
                    _val35 = new ArrayList<Integer>(_list36.size);
                  ...
                  struct.workerMap.put(_key34, _val35);
                }
                iprot.readMapEnd();
              }
      ...
      TTupleProtocol iprot = (TTupleProtocol) prot;
      {
        ...
        for (int _i44 = 0; _i44 < _map43.size; ++_i44)
        {
          ...
          _key45 = iprot.readString();
          {
            ...
            _val46 = new ArrayList<Integer>(_list47.size);
          ...
          struct.workerMap.put(_key45, _val46);
        }
      }
      struct.setWorkerMapIsSet(true);
    }
