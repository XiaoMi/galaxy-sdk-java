...
public class GetScheduleInfoRequest implements libthrift091.TBase<GetScheduleInfoRequest, GetScheduleInfoRequest._Fields>, java.io.Serializable, Cloneable, Comparable<GetScheduleInfoRequest> {
  private static final libthrift091.protocol.TStruct STRUCT_DESC = new libthrift091.protocol.TStruct("GetScheduleInfoRequest");
  ...
  static {
    schemes.put(StandardScheme.class, new GetScheduleInfoRequestStandardSchemeFactory());
    schemes.put(TupleScheme.class, new GetScheduleInfoRequestTupleSchemeFactory());
  }
  ...
  static {
    ...
    libthrift091.meta_data.FieldMetaData.addStructMetaDataMap(GetScheduleInfoRequest.class, metaDataMap);
  }
   ...
   */
  public GetScheduleInfoRequest(GetScheduleInfoRequest other) {
  ...
  public GetScheduleInfoRequest deepCopy() {
    return new GetScheduleInfoRequest(this);
  }
   ...
   * 
   */
  public GetScheduleInfoRequest setTopicTalosResourceName(com.xiaomi.infra.galaxy.talos.thrift.TopicTalosResourceName topicTalosResourceName) {
    this.topicTalosResourceName = topicTalosResourceName;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof GetScheduleInfoRequest)
      return this.equals((GetScheduleInfoRequest)that);
    return false;
  }

  public boolean equals(GetScheduleInfoRequest that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(GetScheduleInfoRequest other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("GetScheduleInfoRequest(");
    boolean first = true;
  ...
  private static class GetScheduleInfoRequestStandardSchemeFactory implements SchemeFactory {
    public GetScheduleInfoRequestStandardScheme getScheme() {
      return new GetScheduleInfoRequestStandardScheme();
    }
  }

  private static class GetScheduleInfoRequestStandardScheme extends StandardScheme<GetScheduleInfoRequest> {

    public void read(libthrift091.protocol.TProtocol iprot, GetScheduleInfoRequest struct) throws libthrift091.TException {
    ...
    public void write(libthrift091.protocol.TProtocol oprot, GetScheduleInfoRequest struct) throws libthrift091.TException {
      struct.validate();
  ...
  private static class GetScheduleInfoRequestTupleSchemeFactory implements SchemeFactory {
    public GetScheduleInfoRequestTupleScheme getScheme() {
      return new GetScheduleInfoRequestTupleScheme();
    }
  }

  private static class GetScheduleInfoRequestTupleScheme extends TupleScheme<GetScheduleInfoRequest> {

    @Override
    public void write(libthrift091.protocol.TProtocol prot, GetScheduleInfoRequest struct) throws libthrift091.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      struct.topicTalosResourceName.write(oprot);
    }

    @Override
    public void read(libthrift091.protocol.TProtocol prot, GetScheduleInfoRequest struct) throws libthrift091.TException {
