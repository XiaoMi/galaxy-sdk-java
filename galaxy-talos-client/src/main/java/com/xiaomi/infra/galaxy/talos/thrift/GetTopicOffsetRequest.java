...
public class GetTopicOffsetRequest implements libthrift091.TBase<GetTopicOffsetRequest, GetTopicOffsetRequest._Fields>, java.io.Serializable, Cloneable, Comparable<GetTopicOffsetRequest> {
  private static final libthrift091.protocol.TStruct STRUCT_DESC = new libthrift091.protocol.TStruct("GetTopicOffsetRequest");
  ...
  static {
    schemes.put(StandardScheme.class, new GetTopicOffsetRequestStandardSchemeFactory());
    schemes.put(TupleScheme.class, new GetTopicOffsetRequestTupleSchemeFactory());
  }

  /**
   * The topicTalos resource name
   * 
   */
  ...
  static {
    ...
    libthrift091.meta_data.FieldMetaData.addStructMetaDataMap(GetTopicOffsetRequest.class, metaDataMap);
  }

  public GetTopicOffsetRequest() {
  }
   ...
   */
  public GetTopicOffsetRequest(GetTopicOffsetRequest other) {
  ...
  public GetTopicOffsetRequest deepCopy() {
    return new GetTopicOffsetRequest(this);
  }
   ...
   * 
   */
  public GetTopicOffsetRequest setTopicTalosResourceName(com.xiaomi.infra.galaxy.talos.thrift.TopicTalosResourceName topicTalosResourceName) {
    this.topicTalosResourceName = topicTalosResourceName;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof GetTopicOffsetRequest)
      return this.equals((GetTopicOffsetRequest)that);
    return false;
  }

  public boolean equals(GetTopicOffsetRequest that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(GetTopicOffsetRequest other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("GetTopicOffsetRequest(");
    boolean first = true;
  ...
  private static class GetTopicOffsetRequestStandardSchemeFactory implements SchemeFactory {
    public GetTopicOffsetRequestStandardScheme getScheme() {
      return new GetTopicOffsetRequestStandardScheme();
    }
  }

  private static class GetTopicOffsetRequestStandardScheme extends StandardScheme<GetTopicOffsetRequest> {

    public void read(libthrift091.protocol.TProtocol iprot, GetTopicOffsetRequest struct) throws libthrift091.TException {
    ...
    public void write(libthrift091.protocol.TProtocol oprot, GetTopicOffsetRequest struct) throws libthrift091.TException {
      struct.validate();
  ...
  private static class GetTopicOffsetRequestTupleSchemeFactory implements SchemeFactory {
    public GetTopicOffsetRequestTupleScheme getScheme() {
      return new GetTopicOffsetRequestTupleScheme();
    }
  }

  private static class GetTopicOffsetRequestTupleScheme extends TupleScheme<GetTopicOffsetRequest> {

    @Override
    public void write(libthrift091.protocol.TProtocol prot, GetTopicOffsetRequest struct) throws libthrift091.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      struct.topicTalosResourceName.write(oprot);
    }

    @Override
    public void read(libthrift091.protocol.TProtocol prot, GetTopicOffsetRequest struct) throws libthrift091.TException {
