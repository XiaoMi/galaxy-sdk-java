...
public class CreateTopicRequest implements libthrift091.TBase<CreateTopicRequest, CreateTopicRequest._Fields>, java.io.Serializable, Cloneable, Comparable<CreateTopicRequest> {
   ...
   * the 'identifier' must be the 'appId'/'developerId' in openplatform of Xiaomi
   * 
   */
            ...
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                ...
                struct.aclMap = new HashMap<com.xiaomi.infra.galaxy.rpc.thrift.Grantee,Permission>(2*_map18.size);
                com.xiaomi.infra.galaxy.rpc.thrift.Grantee _key19;
                Permission _val20;
                for (int _i21 = 0; _i21 < _map18.size; ++_i21)
                {
                  _key19 = new com.xiaomi.infra.galaxy.rpc.thrift.Grantee();
                  _key19.read(iprot);
                  _val20 = com.xiaomi.infra.galaxy.talos.thrift.Permission.findByValue(iprot.readI32());
                  struct.aclMap.put(_key19, _val20);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.aclMap != null) {
        if (struct.isSetAclMap()) {
          oprot.writeFieldBegin(ACL_MAP_FIELD_DESC);
          {
            ...
            for (Map.Entry<com.xiaomi.infra.galaxy.rpc.thrift.Grantee, Permission> _iter22 : struct.aclMap.entrySet())
            {
              _iter22.getKey().write(oprot);
              oprot.writeI32(_iter22.getValue().getValue());
            }
            oprot.writeMapEnd();
          }
          oprot.writeFieldEnd();
  ...
  private static class CreateTopicRequestTupleScheme extends TupleScheme<CreateTopicRequest> {
      ...
      if (struct.isSetAclMap()) {
        {
          ...
          for (Map.Entry<com.xiaomi.infra.galaxy.rpc.thrift.Grantee, Permission> _iter23 : struct.aclMap.entrySet())
          {
            _iter23.getKey().write(oprot);
            oprot.writeI32(_iter23.getValue().getValue());
          }
        }
      }
    }
    ...
    public void read(libthrift091.protocol.TProtocol prot, CreateTopicRequest struct) throws libthrift091.TException {
      ...
      if (incoming.get(1)) {
        {
          libthrift091.protocol.TMap _map24 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRUCT, libthrift091.protocol.TType.I32, iprot.readI32());
          struct.aclMap = new HashMap<com.xiaomi.infra.galaxy.rpc.thrift.Grantee,Permission>(2*_map24.size);
          com.xiaomi.infra.galaxy.rpc.thrift.Grantee _key25;
          Permission _val26;
          for (int _i27 = 0; _i27 < _map24.size; ++_i27)
          {
            _key25 = new com.xiaomi.infra.galaxy.rpc.thrift.Grantee();
            _key25.read(iprot);
            _val26 = com.xiaomi.infra.galaxy.talos.thrift.Permission.findByValue(iprot.readI32());
            struct.aclMap.put(_key25, _val26);
          }
        }
        struct.setAclMapIsSet(true);
      }
