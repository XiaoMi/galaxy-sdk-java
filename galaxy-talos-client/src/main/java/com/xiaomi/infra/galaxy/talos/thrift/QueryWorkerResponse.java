...
public class QueryWorkerResponse implements libthrift091.TBase<QueryWorkerResponse, QueryWorkerResponse._Fields>, java.io.Serializable, Cloneable, Comparable<QueryWorkerResponse> {
   ...
   * 
   */
  public QueryWorkerResponse setWorkerMap(Map<String,List<com.xiaomi.infra.galaxy.talos.thrift.TopicAndPartition>> workerMap) {
    this.workerMap = workerMap;
    return this;
  }
            ...
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                ...
                struct.workerMap = new HashMap<String,List<com.xiaomi.infra.galaxy.talos.thrift.TopicAndPartition>>(2*_map18.size);
                String _key19;
                List<com.xiaomi.infra.galaxy.talos.thrift.TopicAndPartition> _val20;
                for (int _i21 = 0; _i21 < _map18.size; ++_i21)
                {
                  _key19 = iprot.readString();
                  {
                    libthrift091.protocol.TList _list22 = iprot.readListBegin();
                    _val20 = new ArrayList<com.xiaomi.infra.galaxy.talos.thrift.TopicAndPartition>(_list22.size);
                    com.xiaomi.infra.galaxy.talos.thrift.TopicAndPartition _elem23;
                    for (int _i24 = 0; _i24 < _list22.size; ++_i24)
                    {
                      _elem23 = new com.xiaomi.infra.galaxy.talos.thrift.TopicAndPartition();
                      _elem23.read(iprot);
                      _val20.add(_elem23);
                    }
                    iprot.readListEnd();
                  }
                  struct.workerMap.put(_key19, _val20);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(libthrift091.protocol.TProtocol oprot, QueryWorkerResponse struct) throws libthrift091.TException {
      ...
      if (struct.workerMap != null) {
        oprot.writeFieldBegin(WORKER_MAP_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, List<com.xiaomi.infra.galaxy.talos.thrift.TopicAndPartition>> _iter25 : struct.workerMap.entrySet())
          {
            oprot.writeString(_iter25.getKey());
            {
              oprot.writeListBegin(new libthrift091.protocol.TList(libthrift091.protocol.TType.STRUCT, _iter25.getValue().size()));
              for (com.xiaomi.infra.galaxy.talos.thrift.TopicAndPartition _iter26 : _iter25.getValue())
              {
                _iter26.write(oprot);
              }
              oprot.writeListEnd();
  ...
  private static class QueryWorkerResponseTupleScheme extends TupleScheme<QueryWorkerResponse> {
    ...
    public void write(libthrift091.protocol.TProtocol prot, QueryWorkerResponse struct) throws libthrift091.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      {
        ...
        for (Map.Entry<String, List<com.xiaomi.infra.galaxy.talos.thrift.TopicAndPartition>> _iter27 : struct.workerMap.entrySet())
        {
          oprot.writeString(_iter27.getKey());
          {
            oprot.writeI32(_iter27.getValue().size());
            for (com.xiaomi.infra.galaxy.talos.thrift.TopicAndPartition _iter28 : _iter27.getValue())
            {
              _iter28.write(oprot);
            }
          }
    ...
    public void read(libthrift091.protocol.TProtocol prot, QueryWorkerResponse struct) throws libthrift091.TException {
      ...
      {
        libthrift091.protocol.TMap _map29 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.LIST, iprot.readI32());
        struct.workerMap = new HashMap<String,List<com.xiaomi.infra.galaxy.talos.thrift.TopicAndPartition>>(2*_map29.size);
        String _key30;
        List<com.xiaomi.infra.galaxy.talos.thrift.TopicAndPartition> _val31;
        for (int _i32 = 0; _i32 < _map29.size; ++_i32)
        {
          _key30 = iprot.readString();
          {
            ...
            _val31 = new ArrayList<com.xiaomi.infra.galaxy.talos.thrift.TopicAndPartition>(_list33.size);
            com.xiaomi.infra.galaxy.talos.thrift.TopicAndPartition _elem34;
            for (int _i35 = 0; _i35 < _list33.size; ++_i35)
            {
              _elem34 = new com.xiaomi.infra.galaxy.talos.thrift.TopicAndPartition();
              _elem34.read(iprot);
              _val31.add(_elem34);
            }
          }
          struct.workerMap.put(_key30, _val31);
        }
      }
      struct.setWorkerMapIsSet(true);
    }
