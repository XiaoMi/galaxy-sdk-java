...
public class LockResponse implements libthrift091.TBase<LockResponse, LockResponse._Fields>, java.io.Serializable, Cloneable, Comparable<LockResponse> {
  private static final libthrift091.protocol.TStruct STRUCT_DESC = new libthrift091.protocol.TStruct("LockResponse");
  ...
  static {
    ...
    libthrift091.meta_data.FieldMetaData.addStructMetaDataMap(LockResponse.class, metaDataMap);
  }
   ...
   * 
   */
  public LockResponse setSuccessPartitions(List<Integer> successPartitions) {
    this.successPartitions = successPartitions;
    return this;
  }
   ...
   * 
   */
  public LockResponse setFailedPartitions(List<Integer> failedPartitions) {
    this.failedPartitions = failedPartitions;
    return this;
  }
  ...
  private static class LockResponseStandardScheme extends StandardScheme<LockResponse> {
    ...
    public void read(libthrift091.protocol.TProtocol iprot, LockResponse struct) throws libthrift091.TException {
    ...
    public void write(libthrift091.protocol.TProtocol oprot, LockResponse struct) throws libthrift091.TException {
      struct.validate();
  ...
  private static class LockResponseTupleScheme extends TupleScheme<LockResponse> {
    ...
    @Override
    public void write(libthrift091.protocol.TProtocol prot, LockResponse struct) throws libthrift091.TException {
    ...
    @Override
    public void read(libthrift091.protocol.TProtocol prot, LockResponse struct) throws libthrift091.TException {
