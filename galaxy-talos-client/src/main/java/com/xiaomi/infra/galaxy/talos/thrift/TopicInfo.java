...
public class TopicInfo implements libthrift091.TBase<TopicInfo, TopicInfo._Fields>, java.io.Serializable, Cloneable, Comparable<TopicInfo> {
  ...
  private static final libthrift091.protocol.TField TOPIC_TALOS_RESOURCE_NAME_FIELD_DESC = new libthrift091.protocol.TField("topicTalosResourceName", libthrift091.protocol.TType.STRING, (short)2);
   ...
   * 
   */
  public TopicInfo setTopicTalosResourceName(String topicTalosResourceName) {
    this.topicTalosResourceName = topicTalosResourceName;
    return this;
  }
   ...
   * 
   */
  public TopicInfo setDeveloperId(String developerId) {
    this.developerId = developerId;
    return this;
  }
