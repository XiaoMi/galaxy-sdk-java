...
public class QueryTopicQuotaRequest implements libthrift091.TBase<QueryTopicQuotaRequest, QueryTopicQuotaRequest._Fields>, java.io.Serializable, Cloneable, Comparable<QueryTopicQuotaRequest> {
  private static final libthrift091.protocol.TStruct STRUCT_DESC = new libthrift091.protocol.TStruct("QueryTopicQuotaRequest");
  ...
  static {
    schemes.put(StandardScheme.class, new QueryTopicQuotaRequestStandardSchemeFactory());
    schemes.put(TupleScheme.class, new QueryTopicQuotaRequestTupleSchemeFactory());
  }
  ...
  static {
    ...
    libthrift091.meta_data.FieldMetaData.addStructMetaDataMap(QueryTopicQuotaRequest.class, metaDataMap);
  }
   ...
   */
  public QueryTopicQuotaRequest(QueryTopicQuotaRequest other) {
    if (other.isSetTopicResourceName()) {
      this.topicResourceName = new TopicTalosResourceName(other.topicResourceName);
    }
  }

  public QueryTopicQuotaRequest deepCopy() {
    return new QueryTopicQuotaRequest(this);
  }
   ...
   * 
   */
  public QueryTopicQuotaRequest setTopicResourceName(TopicTalosResourceName topicResourceName) {
    this.topicResourceName = topicResourceName;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof QueryTopicQuotaRequest)
      return this.equals((QueryTopicQuotaRequest)that);
    return false;
  }

  public boolean equals(QueryTopicQuotaRequest that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(QueryTopicQuotaRequest other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("QueryTopicQuotaRequest(");
    boolean first = true;
  ...
  private static class QueryTopicQuotaRequestStandardSchemeFactory implements SchemeFactory {
    public QueryTopicQuotaRequestStandardScheme getScheme() {
      return new QueryTopicQuotaRequestStandardScheme();
    }
  }

  private static class QueryTopicQuotaRequestStandardScheme extends StandardScheme<QueryTopicQuotaRequest> {

    public void read(libthrift091.protocol.TProtocol iprot, QueryTopicQuotaRequest struct) throws libthrift091.TException {
    ...
    public void write(libthrift091.protocol.TProtocol oprot, QueryTopicQuotaRequest struct) throws libthrift091.TException {
      struct.validate();
  ...
  private static class QueryTopicQuotaRequestTupleSchemeFactory implements SchemeFactory {
    public QueryTopicQuotaRequestTupleScheme getScheme() {
      return new QueryTopicQuotaRequestTupleScheme();
    }
  }

  private static class QueryTopicQuotaRequestTupleScheme extends TupleScheme<QueryTopicQuotaRequest> {

    @Override
    public void write(libthrift091.protocol.TProtocol prot, QueryTopicQuotaRequest struct) throws libthrift091.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      struct.topicResourceName.write(oprot);
    }

    @Override
    public void read(libthrift091.protocol.TProtocol prot, QueryTopicQuotaRequest struct) throws libthrift091.TException {
