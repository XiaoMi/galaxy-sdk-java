...
public class PartitionState implements libthrift091.TBase<PartitionState, PartitionState._Fields>, java.io.Serializable, Cloneable, Comparable<PartitionState> {
  ...
  private static final libthrift091.protocol.TField PARTITION_ID_FIELD_DESC = new libthrift091.protocol.TField("partitionId", libthrift091.protocol.TType.STRING, (short)1);
   ...
   * 
   */
  public String partitionId; // required
  /**
  ...
  private static final int __LASTESTOFFSET_ISSET_ID = 1;
  private static final int __MESSAGENUMBER_ISSET_ID = 2;
  private static final int __MESSAGEBYTES_ISSET_ID = 3;
   ...
   * 
   */
  public PartitionState setPartitionId(String partitionId) {
    this.partitionId = partitionId;
    return this;
  }
  ...
  public void validate() throws libthrift091.TException {
    ...
    if (partitionId == null) {
      throw new libthrift091.protocol.TProtocolException("Required field 'partitionId' was not present! Struct: " + toString());
    }
  ...
  private static class PartitionStateStandardScheme extends StandardScheme<PartitionState> {
        ...
        switch (schemeField.id) {
          case 1: // PARTITION_ID
            if (schemeField.type == libthrift091.protocol.TType.STRING) {
              struct.partitionId = iprot.readString();
    ...
    public void write(libthrift091.protocol.TProtocol oprot, PartitionState struct) throws libthrift091.TException {
      ...
      if (struct.partitionId != null) {
        ...
        oprot.writeString(struct.partitionId);
        oprot.writeFieldEnd();
      }
