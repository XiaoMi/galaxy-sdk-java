...
public class RevokePermissionRequest implements libthrift091.TBase<RevokePermissionRequest, RevokePermissionRequest._Fields>, java.io.Serializable, Cloneable, Comparable<RevokePermissionRequest> {
  ...
  /**
   * Topic info for which to revoke permission;
   * 
   */
  public TopicInfo topicInfo; // required
  /**
   * The developerId to revoke permission;
   * 
   */
   ...
   * 
   */
  public RevokePermissionRequest setTopicInfo(TopicInfo topicInfo) {
    this.topicInfo = topicInfo;
    return this;
  }
   ...
   * 
   */
  public RevokePermissionRequest setDeveloperId(String developerId) {
    this.developerId = developerId;
    return this;
  }
