...
public class RevokePermissionRequest implements libthrift091.TBase<RevokePermissionRequest, RevokePermissionRequest._Fields>, java.io.Serializable, Cloneable, Comparable<RevokePermissionRequest> {
  private static final libthrift091.protocol.TStruct STRUCT_DESC = new libthrift091.protocol.TStruct("RevokePermissionRequest");
  ...
  private static final libthrift091.protocol.TField PRINCIPAL_FIELD_DESC = new libthrift091.protocol.TField("principal", libthrift091.protocol.TType.STRING, (short)2);

  private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
  static {
    schemes.put(StandardScheme.class, new RevokePermissionRequestStandardSchemeFactory());
    schemes.put(TupleScheme.class, new RevokePermissionRequestTupleSchemeFactory());
  }

  /**
   * Topic resource name for which to revoke permission;
   * 
   */
  public TopicTalosResourceName topicResourceName; // required
  /**
   * The principal to revoke permission;
   * the principal can be a developerId or appKey/userId etc.
   * 
   */
  ...
  static {
    ...
    tmpMap.put(_Fields.PRINCIPAL, new libthrift091.meta_data.FieldMetaData("principal", libthrift091.TFieldRequirementType.REQUIRED, 
        new libthrift091.meta_data.FieldValueMetaData(libthrift091.protocol.TType.STRING)));
    metaDataMap = Collections.unmodifiableMap(tmpMap);
    libthrift091.meta_data.FieldMetaData.addStructMetaDataMap(RevokePermissionRequest.class, metaDataMap);
  }
   ...
   */
  public RevokePermissionRequest(RevokePermissionRequest other) {
  ...
  public RevokePermissionRequest deepCopy() {
   ...
   * 
   */
  public RevokePermissionRequest setTopicResourceName(TopicTalosResourceName topicResourceName) {
    this.topicResourceName = topicResourceName;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof RevokePermissionRequest)
      return this.equals((RevokePermissionRequest)that);
    return false;
  }

  public boolean equals(RevokePermissionRequest that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(RevokePermissionRequest other) {
    ...
    if (isSetPrincipal()) {
      lastComparison = libthrift091.TBaseHelper.compareTo(this.principal, other.principal);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("RevokePermissionRequest(");
    boolean first = true;
  ...
  public void validate() throws libthrift091.TException {
    ...
    if (principal == null) {
      throw new libthrift091.protocol.TProtocolException("Required field 'principal' was not present! Struct: " + toString());
    }
  ...
  private static class RevokePermissionRequestStandardSchemeFactory implements SchemeFactory {
    public RevokePermissionRequestStandardScheme getScheme() {
      return new RevokePermissionRequestStandardScheme();
    }
  }

  private static class RevokePermissionRequestStandardScheme extends StandardScheme<RevokePermissionRequest> {

    public void read(libthrift091.protocol.TProtocol iprot, RevokePermissionRequest struct) throws libthrift091.TException {
    ...
    public void write(libthrift091.protocol.TProtocol oprot, RevokePermissionRequest struct) throws libthrift091.TException {
      struct.validate();
  ...
  private static class RevokePermissionRequestTupleSchemeFactory implements SchemeFactory {
    public RevokePermissionRequestTupleScheme getScheme() {
      return new RevokePermissionRequestTupleScheme();
    }
  }

  private static class RevokePermissionRequestTupleScheme extends TupleScheme<RevokePermissionRequest> {

    @Override
    public void write(libthrift091.protocol.TProtocol prot, RevokePermissionRequest struct) throws libthrift091.TException {
    ...
    @Override
    public void read(libthrift091.protocol.TProtocol prot, RevokePermissionRequest struct) throws libthrift091.TException {
