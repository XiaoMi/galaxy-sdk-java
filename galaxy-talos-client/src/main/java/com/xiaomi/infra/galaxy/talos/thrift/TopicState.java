        ...
        switch (schemeField.id) {
          ...
          case 2: // TOPIC_STATUS
            if (schemeField.type == libthrift091.protocol.TType.I32) {
              struct.topicStatus = TopicStatus.findByValue(iprot.readI32());
            ...
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                ...
                {
                  PartitionState _elem2;
                  _elem2 = new PartitionState();
                  _elem2.read(iprot);
                  struct.partitionStates.add(_elem2);
                }
                iprot.readListEnd();
              }
  ...
  private static class TopicStateTupleScheme extends TupleScheme<TopicState> {
    ...
    public void read(libthrift091.protocol.TProtocol prot, TopicState struct) throws libthrift091.TException {
      ...
      struct.setMessageBytesIsSet(true);
      {
        ...
        {
          PartitionState _elem7;
          _elem7 = new PartitionState();
          _elem7.read(iprot);
          struct.partitionStates.add(_elem7);
        }
      }
      struct.setPartitionStatesIsSet(true);
    }
