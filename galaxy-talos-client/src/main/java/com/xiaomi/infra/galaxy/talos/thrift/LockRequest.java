...
public class LockRequest implements libthrift091.TBase<LockRequest, LockRequest._Fields>, java.io.Serializable, Cloneable, Comparable<LockRequest> {
  private static final libthrift091.protocol.TStruct STRUCT_DESC = new libthrift091.protocol.TStruct("LockRequest");
  ...
  static {
    ...
    libthrift091.meta_data.FieldMetaData.addStructMetaDataMap(LockRequest.class, metaDataMap);
  }
   ...
   * 
   */
  public LockRequest setConsumeUnit(ConsumeUnit consumeUnit) {
    this.consumeUnit = consumeUnit;
    return this;
  }
  ...
  private static class LockRequestStandardScheme extends StandardScheme<LockRequest> {
    ...
    public void read(libthrift091.protocol.TProtocol iprot, LockRequest struct) throws libthrift091.TException {
    ...
    public void write(libthrift091.protocol.TProtocol oprot, LockRequest struct) throws libthrift091.TException {
      struct.validate();
  ...
  private static class LockRequestTupleScheme extends TupleScheme<LockRequest> {
    ...
    @Override
    public void write(libthrift091.protocol.TProtocol prot, LockRequest struct) throws libthrift091.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      struct.consumeUnit.write(oprot);
    }

    @Override
    public void read(libthrift091.protocol.TProtocol prot, LockRequest struct) throws libthrift091.TException {
