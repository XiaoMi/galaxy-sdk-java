...
public class CommonConstants {
  ...
  static {
    ...
    ERROR_BACKOFF.put(com.xiaomi.infra.galaxy.talos.thrift.ErrorCode.MESSAGE_INDEX_OUT_OF_RANGE, 1000L);
  ...
  static {
    ...
    ERROR_RETRY_TYPE.put(com.xiaomi.infra.galaxy.talos.thrift.ErrorCode.MESSAGE_INDEX_OUT_OF_RANGE, com.xiaomi.infra.galaxy.talos.thrift.RetryType.UNSAFE);
