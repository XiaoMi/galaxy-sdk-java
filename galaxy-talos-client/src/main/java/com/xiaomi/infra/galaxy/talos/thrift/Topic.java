...
public class Topic implements libthrift091.TBase<Topic, Topic._Fields>, java.io.Serializable, Cloneable, Comparable<Topic> {
   ...
   * 
   */
  public Map<String,Long> topicAcl; // optional
  ...
  public Topic(Topic other) {
    ...
    if (other.isSetTopicAcl()) {
      Map<String,Long> __this__topicAcl = new HashMap<String,Long>(other.topicAcl);
  ...
  public void putToTopicAcl(String key, long val) {
    if (this.topicAcl == null) {
      this.topicAcl = new HashMap<String,Long>();
    }
   ...
   * 
   */
  public Map<String,Long> getTopicAcl() {
   ...
   * 
   */
  public Topic setTopicAcl(Map<String,Long> topicAcl) {
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case TOPIC_ACL:
      if (value == null) {
        ...
        setTopicAcl((Map<String,Long>)value);
      }
      break;
            ...
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                ...
                struct.topicAcl = new HashMap<String,Long>(2*_map8.size);
                String _key9;
                long _val10;
                for (int _i11 = 0; _i11 < _map8.size; ++_i11)
                {
                  ...
                  struct.topicAcl.put(_key9, _val10);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(libthrift091.protocol.TProtocol oprot, Topic struct) throws libthrift091.TException {
      ...
      if (struct.topicAcl != null) {
        if (struct.isSetTopicAcl()) {
          ...
          {
            oprot.writeMapBegin(new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.I64, struct.topicAcl.size()));
            for (Map.Entry<String, Long> _iter12 : struct.topicAcl.entrySet())
            {
  ...
  private static class TopicTupleScheme extends TupleScheme<Topic> {
      ...
      if (struct.isSetTopicAcl()) {
        {
          ...
          for (Map.Entry<String, Long> _iter13 : struct.topicAcl.entrySet())
          {
    ...
    public void read(libthrift091.protocol.TProtocol prot, Topic struct) throws libthrift091.TException {
      ...
      if (incoming.get(1)) {
        {
          libthrift091.protocol.TMap _map14 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.I64, iprot.readI32());
          struct.topicAcl = new HashMap<String,Long>(2*_map14.size);
          String _key15;
          long _val16;
          for (int _i17 = 0; _i17 < _map14.size; ++_i17)
          {
            ...
            struct.topicAcl.put(_key15, _val16);
          }
        }
        struct.setTopicAclIsSet(true);
      }
