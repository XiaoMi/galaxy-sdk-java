            ...
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                ...
                struct.topicAcl = new HashMap<String,Integer>(2*_map8.size);
                String _key9;
                int _val10;
      ...
      if (struct.topicAcl != null) {
        if (struct.isSetTopicAcl()) {
          oprot.writeFieldBegin(TOPIC_ACL_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Integer> _iter12 : struct.topicAcl.entrySet())
            {
      ...
      if (struct.isSetTopicAcl()) {
        {
          ...
          for (Map.Entry<String, Integer> _iter13 : struct.topicAcl.entrySet())
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.topicAcl = new HashMap<String,Integer>(2*_map14.size);
          String _key15;
          int _val16;
