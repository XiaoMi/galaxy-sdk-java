...
public class RenewRequest implements libthrift091.TBase<RenewRequest, RenewRequest._Fields>, java.io.Serializable, Cloneable, Comparable<RenewRequest> {
  private static final libthrift091.protocol.TStruct STRUCT_DESC = new libthrift091.protocol.TStruct("RenewRequest");
  ...
  static {
    schemes.put(StandardScheme.class, new RenewRequestStandardSchemeFactory());
    schemes.put(TupleScheme.class, new RenewRequestTupleSchemeFactory());
  }
  ...
  static {
    ...
    libthrift091.meta_data.FieldMetaData.addStructMetaDataMap(RenewRequest.class, metaDataMap);
  }
   ...
   * 
   */
  public RenewRequest setConsumeUnit(ConsumeUnit consumeUnit) {
    this.consumeUnit = consumeUnit;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof RenewRequest)
      return this.equals((RenewRequest)that);
    return false;
  }

  public boolean equals(RenewRequest that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(RenewRequest other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("RenewRequest(");
    boolean first = true;
  ...
  private static class RenewRequestStandardSchemeFactory implements SchemeFactory {
    public RenewRequestStandardScheme getScheme() {
      return new RenewRequestStandardScheme();
    }
  }

  private static class RenewRequestStandardScheme extends StandardScheme<RenewRequest> {

    public void read(libthrift091.protocol.TProtocol iprot, RenewRequest struct) throws libthrift091.TException {
    ...
    public void write(libthrift091.protocol.TProtocol oprot, RenewRequest struct) throws libthrift091.TException {
      struct.validate();
  ...
  private static class RenewRequestTupleSchemeFactory implements SchemeFactory {
    public RenewRequestTupleScheme getScheme() {
      return new RenewRequestTupleScheme();
    }
  }

  private static class RenewRequestTupleScheme extends TupleScheme<RenewRequest> {

    @Override
    public void write(libthrift091.protocol.TProtocol prot, RenewRequest struct) throws libthrift091.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      struct.consumeUnit.write(oprot);
    }

    @Override
    public void read(libthrift091.protocol.TProtocol prot, RenewRequest struct) throws libthrift091.TException {
