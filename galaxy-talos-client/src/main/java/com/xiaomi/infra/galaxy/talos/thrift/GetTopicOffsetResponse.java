...
public class GetTopicOffsetResponse implements libthrift091.TBase<GetTopicOffsetResponse, GetTopicOffsetResponse._Fields>, java.io.Serializable, Cloneable, Comparable<GetTopicOffsetResponse> {
  private static final libthrift091.protocol.TStruct STRUCT_DESC = new libthrift091.protocol.TStruct("GetTopicOffsetResponse");
  ...
  static {
    schemes.put(StandardScheme.class, new GetTopicOffsetResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new GetTopicOffsetResponseTupleSchemeFactory());
  }
  ...
  static {
    ...
    libthrift091.meta_data.FieldMetaData.addStructMetaDataMap(GetTopicOffsetResponse.class, metaDataMap);
  }

  public GetTopicOffsetResponse() {
  }
   ...
   */
  public GetTopicOffsetResponse(GetTopicOffsetResponse other) {
  ...
  public GetTopicOffsetResponse deepCopy() {
    return new GetTopicOffsetResponse(this);
  }
   ...
   * 
   */
  public GetTopicOffsetResponse setOffsetInfoList(List<OffsetInfo> offsetInfoList) {
    this.offsetInfoList = offsetInfoList;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof GetTopicOffsetResponse)
      return this.equals((GetTopicOffsetResponse)that);
    return false;
  }

  public boolean equals(GetTopicOffsetResponse that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(GetTopicOffsetResponse other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("GetTopicOffsetResponse(");
    boolean first = true;
  ...
  private static class GetTopicOffsetResponseStandardSchemeFactory implements SchemeFactory {
    public GetTopicOffsetResponseStandardScheme getScheme() {
      return new GetTopicOffsetResponseStandardScheme();
    }
  }

  private static class GetTopicOffsetResponseStandardScheme extends StandardScheme<GetTopicOffsetResponse> {

    public void read(libthrift091.protocol.TProtocol iprot, GetTopicOffsetResponse struct) throws libthrift091.TException {
            ...
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                ...
                struct.offsetInfoList = new ArrayList<OffsetInfo>(_list16.size);
                OffsetInfo _elem17;
                for (int _i18 = 0; _i18 < _list16.size; ++_i18)
                {
                  _elem17 = new OffsetInfo();
                  _elem17.read(iprot);
                  struct.offsetInfoList.add(_elem17);
                }
                iprot.readListEnd();
              }
    ...
    public void write(libthrift091.protocol.TProtocol oprot, GetTopicOffsetResponse struct) throws libthrift091.TException {
      struct.validate();
      ...
      if (struct.offsetInfoList != null) {
        oprot.writeFieldBegin(OFFSET_INFO_LIST_FIELD_DESC);
        {
          ...
          for (OffsetInfo _iter19 : struct.offsetInfoList)
          {
            _iter19.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class GetTopicOffsetResponseTupleSchemeFactory implements SchemeFactory {
    public GetTopicOffsetResponseTupleScheme getScheme() {
      return new GetTopicOffsetResponseTupleScheme();
    }
  }

  private static class GetTopicOffsetResponseTupleScheme extends TupleScheme<GetTopicOffsetResponse> {

    @Override
    public void write(libthrift091.protocol.TProtocol prot, GetTopicOffsetResponse struct) throws libthrift091.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      {
        oprot.writeI32(struct.offsetInfoList.size());
        for (OffsetInfo _iter20 : struct.offsetInfoList)
        {
          _iter20.write(oprot);
        }
      }
    ...
    @Override
    public void read(libthrift091.protocol.TProtocol prot, GetTopicOffsetResponse struct) throws libthrift091.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      {
        ...
        struct.offsetInfoList = new ArrayList<OffsetInfo>(_list21.size);
        OffsetInfo _elem22;
        for (int _i23 = 0; _i23 < _list21.size; ++_i23)
        {
          _elem22 = new OffsetInfo();
          _elem22.read(iprot);
          struct.offsetInfoList.add(_elem22);
        }
      }
      struct.setOffsetInfoListIsSet(true);
    }
