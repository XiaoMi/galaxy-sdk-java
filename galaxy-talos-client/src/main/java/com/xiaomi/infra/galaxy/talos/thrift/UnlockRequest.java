...
public class UnlockRequest implements libthrift091.TBase<UnlockRequest, UnlockRequest._Fields>, java.io.Serializable, Cloneable, Comparable<UnlockRequest> {
  private static final libthrift091.protocol.TStruct STRUCT_DESC = new libthrift091.protocol.TStruct("UnlockRequest");
  ...
  static {
    ...
    libthrift091.meta_data.FieldMetaData.addStructMetaDataMap(UnlockRequest.class, metaDataMap);
  }
   ...
   * 
   */
  public UnlockRequest setConsumeUnit(ConsumeUnit consumeUnit) {
    this.consumeUnit = consumeUnit;
    return this;
  }
  ...
  private static class UnlockRequestStandardScheme extends StandardScheme<UnlockRequest> {
    ...
    public void read(libthrift091.protocol.TProtocol iprot, UnlockRequest struct) throws libthrift091.TException {
    ...
    public void write(libthrift091.protocol.TProtocol oprot, UnlockRequest struct) throws libthrift091.TException {
      struct.validate();
  ...
  private static class UnlockRequestTupleScheme extends TupleScheme<UnlockRequest> {
    ...
    @Override
    public void write(libthrift091.protocol.TProtocol prot, UnlockRequest struct) throws libthrift091.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      struct.consumeUnit.write(oprot);
    }

    @Override
    public void read(libthrift091.protocol.TProtocol prot, UnlockRequest struct) throws libthrift091.TException {
