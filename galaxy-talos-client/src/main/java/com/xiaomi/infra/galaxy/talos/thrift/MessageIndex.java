...
public class MessageIndex implements libthrift091.TBase<MessageIndex, MessageIndex._Fields>, java.io.Serializable, Cloneable, Comparable<MessageIndex> {
  ...
  private static final libthrift091.protocol.TField HDFS_LOG_FILE_NAME_FIELD_DESC = new libthrift091.protocol.TField("hdfsLogFileName", libthrift091.protocol.TType.STRING, (short)3);
  private static final libthrift091.protocol.TField HDFS_LOG_FILE_OFFSET_FIELD_DESC = new libthrift091.protocol.TField("hdfsLogFileOffset", libthrift091.protocol.TType.I32, (short)4);
  ...
  /**
   * The hdfs log file that store this message;
   * 
   */
  public String hdfsLogFileName; // required
  /**
   * The hdfs log file offset that to store this message;
   * 
   */
  public int hdfsLogFileOffset; // required
  ...
  public enum _Fields implements libthrift091.TFieldIdEnum {
     ...
     * 
     */
    HDFS_LOG_FILE_NAME((short)3, "hdfsLogFileName"),
    /**
     * The hdfs log file offset that to store this message;
     * 
     */
    HDFS_LOG_FILE_OFFSET((short)4, "hdfsLogFileOffset");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 3: // HDFS_LOG_FILE_NAME
          return HDFS_LOG_FILE_NAME;
        case 4: // HDFS_LOG_FILE_OFFSET
  ...
  static {
    ...
    tmpMap.put(_Fields.HDFS_LOG_FILE_NAME, new libthrift091.meta_data.FieldMetaData("hdfsLogFileName", libthrift091.TFieldRequirementType.REQUIRED, 
  ...
  public MessageIndex(
    ...
    long messageOffset,
    String hdfsLogFileName,
    int hdfsLogFileOffset)
  {
    this();
    this.topicAndPartition = topicAndPartition;
    this.messageOffset = messageOffset;
    setMessageOffsetIsSet(true);
    this.hdfsLogFileName = hdfsLogFileName;
  ...
  public MessageIndex(MessageIndex other) {
    ...
    if (other.isSetHdfsLogFileName()) {
      this.hdfsLogFileName = other.hdfsLogFileName;
    }
   ...
   * 
   */
  public String getHdfsLogFileName() {
    return this.hdfsLogFileName;
  }
   ...
   * 
   */
  public MessageIndex setHdfsLogFileName(String hdfsLogFileName) {
    this.hdfsLogFileName = hdfsLogFileName;
    return this;
  }

  public void unsetHdfsLogFileName() {
    this.hdfsLogFileName = null;
  }

  /** Returns true if field hdfsLogFileName is set (has been assigned a value) and false otherwise */
  public boolean isSetHdfsLogFileName() {
    return this.hdfsLogFileName != null;
  }

  public void setHdfsLogFileNameIsSet(boolean value) {
    if (!value) {
      this.hdfsLogFileName = null;
    }
  }
   ...
   * 
   */
  public int getHdfsLogFileOffset() {
   ...
   * 
   */
  public MessageIndex setHdfsLogFileOffset(int hdfsLogFileOffset) {
    this.hdfsLogFileOffset = hdfsLogFileOffset;
    setHdfsLogFileOffsetIsSet(true);
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case HDFS_LOG_FILE_NAME:
      if (value == null) {
        unsetHdfsLogFileName();
      } else {
        setHdfsLogFileName((String)value);
      }
      break;
    ...
    case HDFS_LOG_FILE_OFFSET:
      if (value == null) {
        ...
        setHdfsLogFileOffset((Integer)value);
      }
      break;
  ...
  public Object getFieldValue(_Fields field) {
    ...
    case HDFS_LOG_FILE_NAME:
      return getHdfsLogFileName();

    case HDFS_LOG_FILE_OFFSET:
      return Integer.valueOf(getHdfsLogFileOffset());
  ...
  public boolean equals(MessageIndex that) {
    ...
    boolean this_present_hdfsLogFileName = true && this.isSetHdfsLogFileName();
    boolean that_present_hdfsLogFileName = true && that.isSetHdfsLogFileName();
    if (this_present_hdfsLogFileName || that_present_hdfsLogFileName) {
      if (!(this_present_hdfsLogFileName && that_present_hdfsLogFileName))
        return false;
      if (!this.hdfsLogFileName.equals(that.hdfsLogFileName))
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_hdfsLogFileName = true && (isSetHdfsLogFileName());
    list.add(present_hdfsLogFileName);
    if (present_hdfsLogFileName)
      list.add(hdfsLogFileName);
  ...
  public int compareTo(MessageIndex other) {
    ...
    lastComparison = Boolean.valueOf(isSetHdfsLogFileName()).compareTo(other.isSetHdfsLogFileName());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetHdfsLogFileName()) {
      lastComparison = libthrift091.TBaseHelper.compareTo(this.hdfsLogFileName, other.hdfsLogFileName);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    ...
    first = false;
    if (!first) sb.append(", ");
    sb.append("hdfsLogFileName:");
    if (this.hdfsLogFileName == null) {
      sb.append("null");
    } else {
      sb.append(this.hdfsLogFileName);
    }
    first = false;
    if (!first) sb.append(", ");
  ...
  public void validate() throws libthrift091.TException {
    ...
    if (hdfsLogFileName == null) {
      throw new libthrift091.protocol.TProtocolException("Required field 'hdfsLogFileName' was not present! Struct: " + toString());
    }
  ...
  private static class MessageIndexStandardScheme extends StandardScheme<MessageIndex> {
        ...
        switch (schemeField.id) {
          ...
          case 3: // HDFS_LOG_FILE_NAME
            if (schemeField.type == libthrift091.protocol.TType.STRING) {
              struct.hdfsLogFileName = iprot.readString();
              struct.setHdfsLogFileNameIsSet(true);
            } else { 
              libthrift091.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
          case 4: // HDFS_LOG_FILE_OFFSET
            if (schemeField.type == libthrift091.protocol.TType.I32) {
              struct.hdfsLogFileOffset = iprot.readI32();
    ...
    public void write(libthrift091.protocol.TProtocol oprot, MessageIndex struct) throws libthrift091.TException {
      ...
      oprot.writeFieldEnd();
      if (struct.hdfsLogFileName != null) {
        oprot.writeFieldBegin(HDFS_LOG_FILE_NAME_FIELD_DESC);
        oprot.writeString(struct.hdfsLogFileName);
        oprot.writeFieldEnd();
      }
      oprot.writeFieldBegin(HDFS_LOG_FILE_OFFSET_FIELD_DESC);
      oprot.writeI32(struct.hdfsLogFileOffset);
      oprot.writeFieldEnd();
