...
public class MessageIndex implements libthrift091.TBase<MessageIndex, MessageIndex._Fields>, java.io.Serializable, Cloneable, Comparable<MessageIndex> {
  ...
  private static final libthrift091.protocol.TField HDFS_LOG_FILE_OFFSET_FIELD_DESC = new libthrift091.protocol.TField("hdfsLogFileOffset", libthrift091.protocol.TType.I64, (short)4);
