...
public class AddPermissionRequest implements libthrift091.TBase<AddPermissionRequest, AddPermissionRequest._Fields>, java.io.Serializable, Cloneable, Comparable<AddPermissionRequest> {
  private static final libthrift091.protocol.TStruct STRUCT_DESC = new libthrift091.protocol.TStruct("AddPermissionRequest");
  ...
  static {
    schemes.put(StandardScheme.class, new AddPermissionRequestStandardSchemeFactory());
    schemes.put(TupleScheme.class, new AddPermissionRequestTupleSchemeFactory());
  }

  /**
   * Topic info for which to add permission;
   * 
   */
  public TopicInfo topicInfo; // required
  /**
   * The developer to add permission;
   * 
   */
  public String developerId; // required
  /**
   * The permission to add, you should "|" with Permission to get this permission;
   * 
   */
  ...
  static {
    ...
    libthrift091.meta_data.FieldMetaData.addStructMetaDataMap(AddPermissionRequest.class, metaDataMap);
  }
   ...
   */
  public AddPermissionRequest(AddPermissionRequest other) {
  ...
  public AddPermissionRequest deepCopy() {
   ...
   * 
   */
  public AddPermissionRequest setTopicInfo(TopicInfo topicInfo) {
    this.topicInfo = topicInfo;
    return this;
  }
   ...
   * 
   */
  public AddPermissionRequest setDeveloperId(String developerId) {
    this.developerId = developerId;
    return this;
  }
   ...
   * 
   */
  public AddPermissionRequest setPermission(long permission) {
    this.permission = permission;
    setPermissionIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof AddPermissionRequest)
      return this.equals((AddPermissionRequest)that);
    return false;
  }

  public boolean equals(AddPermissionRequest that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(AddPermissionRequest other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("AddPermissionRequest(");
    boolean first = true;
  ...
  private static class AddPermissionRequestStandardSchemeFactory implements SchemeFactory {
    public AddPermissionRequestStandardScheme getScheme() {
      return new AddPermissionRequestStandardScheme();
    }
  }

  private static class AddPermissionRequestStandardScheme extends StandardScheme<AddPermissionRequest> {

    public void read(libthrift091.protocol.TProtocol iprot, AddPermissionRequest struct) throws libthrift091.TException {
    ...
    public void write(libthrift091.protocol.TProtocol oprot, AddPermissionRequest struct) throws libthrift091.TException {
      struct.validate();
  ...
  private static class AddPermissionRequestTupleSchemeFactory implements SchemeFactory {
    public AddPermissionRequestTupleScheme getScheme() {
      return new AddPermissionRequestTupleScheme();
    }
  }

  private static class AddPermissionRequestTupleScheme extends TupleScheme<AddPermissionRequest> {

    @Override
    public void write(libthrift091.protocol.TProtocol prot, AddPermissionRequest struct) throws libthrift091.TException {
    ...
    @Override
    public void read(libthrift091.protocol.TProtocol prot, AddPermissionRequest struct) throws libthrift091.TException {
