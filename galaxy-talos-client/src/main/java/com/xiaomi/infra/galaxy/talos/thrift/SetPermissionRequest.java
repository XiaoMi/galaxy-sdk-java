...
public class SetPermissionRequest implements libthrift091.TBase<SetPermissionRequest, SetPermissionRequest._Fields>, java.io.Serializable, Cloneable, Comparable<SetPermissionRequest> {
  ...
  /**
   * Topic info for which to set permission;
   * 
   */
  public TopicInfo topicInfo; // required
  /**
   * The developerId to set permission;
   * 
   */
  public String developerId; // required
  /**
   * The permission to set, you should "|" with Permission to get this permission;
   * 
   */
   ...
   * 
   */
  public SetPermissionRequest setTopicInfo(TopicInfo topicInfo) {
    this.topicInfo = topicInfo;
    return this;
  }
   ...
   * 
   */
  public SetPermissionRequest setPermission(long permission) {
    this.permission = permission;
    setPermissionIsSet(true);
    return this;
  }
