...
import com.xiaomi.infra.galaxy.metrics.thrift.AuthenticationConstants;
 ...
 */
public class MetricsHttpClient extends TTransport {
  ...
  public static class Factory extends TTransportFactory {
    ...
    public TTransport getTransport(TTransport trans) {
      try {
        return new MetricsHttpClient(url, client, credential, clock);
  ...
  public MetricsHttpClient(String url, HttpClient client, Credential credential)
      throws TTransportException {
    this(url, client, credential, new AdjustableClock());
  }

  public MetricsHttpClient(String url, HttpClient client, Credential credential, AdjustableClock clock)
      throws TTransportException {
    try {
      url_ = new URL(url);
      this.client = client;
  ...
  public MetricsHttpClient setProtocol(ThriftProtocol protocol) {
    protocol_ = protocol;
    return this;
  }
  ...
  public MetricsHttpClient setConnectTimeout(int timeout) {
  ...
  public MetricsHttpClient setCustomHeaders(Map<String, String> headers) {
    customHeaders_ = headers;
    return this;
  }

  public MetricsHttpClient setCustomHeader(String key, String value) {
  ...
  public MetricsHttpClient setQueryString(String queryString) {
  ...
  private MetricsHttpClient setCustomHeaders(HttpPost post) {
