...
public class ResizeInstanceGroupResponse implements libthrift091.TBase<ResizeInstanceGroupResponse, ResizeInstanceGroupResponse._Fields>, java.io.Serializable, Cloneable, Comparable<ResizeInstanceGroupResponse> {
  private static final libthrift091.protocol.TStruct STRUCT_DESC = new libthrift091.protocol.TStruct("ResizeInstanceGroupResponse");
  ...
  private static final libthrift091.protocol.TField SUCCEED_FIELD_DESC = new libthrift091.protocol.TField("succeed", libthrift091.protocol.TType.BOOL, (short)4);
  ...
  static {
    ...
    libthrift091.meta_data.FieldMetaData.addStructMetaDataMap(ResizeInstanceGroupResponse.class, metaDataMap);
  }
   ...
   */
  public ResizeInstanceGroupResponse(ResizeInstanceGroupResponse other) {
  ...
  public ResizeInstanceGroupResponse deepCopy() {
  ...
  public ResizeInstanceGroupResponse setClusterId(String clusterId) {
    this.clusterId = clusterId;
    return this;
  }
  ...
  public ResizeInstanceGroupResponse setInstanceGroupId(String instanceGroupId) {
    this.instanceGroupId = instanceGroupId;
    return this;
  }
  ...
  public ResizeInstanceGroupResponse setRequestCount(int requestCount) {
    this.requestCount = requestCount;
    setRequestCountIsSet(true);
    return this;
  }
  ...
  public ResizeInstanceGroupResponse setSucceed(boolean succeed) {
    this.succeed = succeed;
    setSucceedIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof ResizeInstanceGroupResponse)
      return this.equals((ResizeInstanceGroupResponse)that);
    return false;
  }

  public boolean equals(ResizeInstanceGroupResponse that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(ResizeInstanceGroupResponse other) {
  ...
  private static class ResizeInstanceGroupResponseStandardScheme extends StandardScheme<ResizeInstanceGroupResponse> {

    public void read(libthrift091.protocol.TProtocol iprot, ResizeInstanceGroupResponse struct) throws libthrift091.TException {
    ...
    public void write(libthrift091.protocol.TProtocol oprot, ResizeInstanceGroupResponse struct) throws libthrift091.TException {
      struct.validate();
  ...
  private static class ResizeInstanceGroupResponseTupleScheme extends TupleScheme<ResizeInstanceGroupResponse> {

    @Override
    public void write(libthrift091.protocol.TProtocol prot, ResizeInstanceGroupResponse struct) throws libthrift091.TException {
    ...
    @Override
    public void read(libthrift091.protocol.TProtocol prot, ResizeInstanceGroupResponse struct) throws libthrift091.TException {
