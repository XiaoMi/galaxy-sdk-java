...
public class GetTagsResponse implements libthrift091.TBase<GetTagsResponse, GetTagsResponse._Fields>, java.io.Serializable, Cloneable, Comparable<GetTagsResponse> {
  private static final libthrift091.protocol.TStruct STRUCT_DESC = new libthrift091.protocol.TStruct("GetTagsResponse");
  ...
  static {
    schemes.put(StandardScheme.class, new GetTagsResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new GetTagsResponseTupleSchemeFactory());
  }
  ...
  static {
    ...
    libthrift091.meta_data.FieldMetaData.addStructMetaDataMap(GetTagsResponse.class, metaDataMap);
  }
   ...
   */
  public GetTagsResponse(GetTagsResponse other) {
  ...
  public GetTagsResponse deepCopy() {
  ...
  public GetTagsResponse setClusterId(String clusterId) {
    this.clusterId = clusterId;
    return this;
  }
  ...
  public GetTagsResponse setTags(Map<String,String> tags) {
    this.tags = tags;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof GetTagsResponse)
      return this.equals((GetTagsResponse)that);
    return false;
  }

  public boolean equals(GetTagsResponse that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(GetTagsResponse other) {
  ...
  private static class GetTagsResponseStandardSchemeFactory implements SchemeFactory {
    public GetTagsResponseStandardScheme getScheme() {
      return new GetTagsResponseStandardScheme();
    }
  }

  private static class GetTagsResponseStandardScheme extends StandardScheme<GetTagsResponse> {

    public void read(libthrift091.protocol.TProtocol iprot, GetTagsResponse struct) throws libthrift091.TException {
            ...
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                ...
                struct.tags = new HashMap<String,String>(2*_map160.size);
                String _key161;
                String _val162;
                for (int _i163 = 0; _i163 < _map160.size; ++_i163)
                {
                  ...
                  struct.tags.put(_key161, _val162);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(libthrift091.protocol.TProtocol oprot, GetTagsResponse struct) throws libthrift091.TException {
      struct.validate();
      ...
      if (struct.tags != null) {
        if (struct.isSetTags()) {
          oprot.writeFieldBegin(TAGS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, String> _iter164 : struct.tags.entrySet())
            {
  ...
  private static class GetTagsResponseTupleSchemeFactory implements SchemeFactory {
    public GetTagsResponseTupleScheme getScheme() {
      return new GetTagsResponseTupleScheme();
    }
  }

  private static class GetTagsResponseTupleScheme extends TupleScheme<GetTagsResponse> {

    @Override
    public void write(libthrift091.protocol.TProtocol prot, GetTagsResponse struct) throws libthrift091.TException {
      ...
      if (struct.isSetTags()) {
        {
          ...
          for (Map.Entry<String, String> _iter165 : struct.tags.entrySet())
          {
    ...
    @Override
    public void read(libthrift091.protocol.TProtocol prot, GetTagsResponse struct) throws libthrift091.TException {
      ...
      if (incoming.get(0)) {
        {
          libthrift091.protocol.TMap _map166 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.STRING, iprot.readI32());
          struct.tags = new HashMap<String,String>(2*_map166.size);
          String _key167;
          String _val168;
          for (int _i169 = 0; _i169 < _map166.size; ++_i169)
          {
            ...
            struct.tags.put(_key167, _val168);
          }
        }
        struct.setTagsIsSet(true);
      }
