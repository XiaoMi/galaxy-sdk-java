...
public class EMRMasterService {
  ...
  public interface Iface {
    ...
    public boolean ping() throws libthrift091.TException;

    public SetConfigResponse setConfig(SetConfigRequest request) throws libthrift091.TException;

    public StartServiceResponse startService(StartServiceRequest request) throws libthrift091.TException;

    public StopServiceResponse stopService(StopServiceRequest request) throws libthrift091.TException;

    public ClusterState queryClusterState(String cluster) throws libthrift091.TException;
  ...
  public static class Client extends libthrift091.TServiceClient implements Iface {
    ...
    public boolean recv_ping() throws libthrift091.TException
    {
    ...
    public SetConfigResponse recv_setConfig() throws libthrift091.TException
    {
    ...
    public StartServiceResponse recv_startService() throws libthrift091.TException
    {
    ...
    public StopServiceResponse recv_stopService() throws libthrift091.TException
    {
    ...
    public ClusterState recv_queryClusterState() throws libthrift091.TException
    {
  ...
  public static class AsyncClient extends libthrift091.async.TAsyncClient implements AsyncIface {
    ...
    public static class ping_call extends libthrift091.async.TAsyncMethodCall {
      ...
      public boolean getResult() throws libthrift091.TException {
    ...
    public static class setConfig_call extends libthrift091.async.TAsyncMethodCall {
      ...
      public SetConfigResponse getResult() throws libthrift091.TException {
        if (getState() != libthrift091.async.TAsyncMethodCall.State.RESPONSE_READ) {
          throw new IllegalStateException("Method call not finished!");
        }
        libthrift091.transport.TMemoryInputTransport memoryTransport = new libthrift091.transport.TMemoryInputTransport(getFrameBuffer().array());
    ...
    public static class startService_call extends libthrift091.async.TAsyncMethodCall {
      ...
      public StartServiceResponse getResult() throws libthrift091.TException {
        if (getState() != libthrift091.async.TAsyncMethodCall.State.RESPONSE_READ) {
          throw new IllegalStateException("Method call not finished!");
        }
        libthrift091.transport.TMemoryInputTransport memoryTransport = new libthrift091.transport.TMemoryInputTransport(getFrameBuffer().array());
    ...
    public static class stopService_call extends libthrift091.async.TAsyncMethodCall {
      ...
      public StopServiceResponse getResult() throws libthrift091.TException {
        if (getState() != libthrift091.async.TAsyncMethodCall.State.RESPONSE_READ) {
          throw new IllegalStateException("Method call not finished!");
        }
        libthrift091.transport.TMemoryInputTransport memoryTransport = new libthrift091.transport.TMemoryInputTransport(getFrameBuffer().array());
    ...
    public static class queryClusterState_call extends libthrift091.async.TAsyncMethodCall {
      ...
      public ClusterState getResult() throws libthrift091.TException {
        if (getState() != libthrift091.async.TAsyncMethodCall.State.RESPONSE_READ) {
          throw new IllegalStateException("Method call not finished!");
        }
        libthrift091.transport.TMemoryInputTransport memoryTransport = new libthrift091.transport.TMemoryInputTransport(getFrameBuffer().array());
