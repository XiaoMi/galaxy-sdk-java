...
public class BatchRequestItem implements libthrift091.TBase<BatchRequestItem, BatchRequestItem._Fields>, java.io.Serializable, Cloneable, Comparable<BatchRequestItem> {
   ...
   * @see BatchOp
   */
  public BatchOp action; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.ACTION, new libthrift091.meta_data.FieldMetaData("action", libthrift091.TFieldRequirementType.REQUIRED, 
        new libthrift091.meta_data.EnumMetaData(libthrift091.protocol.TType.ENUM, BatchOp.class)));
    tmpMap.put(_Fields.REQUEST, new libthrift091.meta_data.FieldMetaData("request", libthrift091.TFieldRequirementType.REQUIRED, 
  ...
  public void validate() throws libthrift091.TException {
    ...
    if (action == null) {
      throw new libthrift091.protocol.TProtocolException("Required field 'action' was not present! Struct: " + toString());
    }
    if (request == null) {
      throw new libthrift091.protocol.TProtocolException("Required field 'request' was not present! Struct: " + toString());
    }
