...
public class CommonConstants {
  ...
  static {
    THRIFT_HEADER_MAP.put(com.xiaomi.infra.galaxy.rpc.thrift.ThriftProtocol.TCOMPACT, "application/x-thrift-compact");
    THRIFT_HEADER_MAP.put(com.xiaomi.infra.galaxy.rpc.thrift.ThriftProtocol.TJSON, "application/x-thrift-json");
    THRIFT_HEADER_MAP.put(com.xiaomi.infra.galaxy.rpc.thrift.ThriftProtocol.TBINARY, "application/x-thrift-binary");
  }

  public static final Map<String,ThriftProtocol> HEADER_THRIFT_MAP = new HashMap<String,ThriftProtocol>();
  static {
    HEADER_THRIFT_MAP.put("application/x-thrift-compact", com.xiaomi.infra.galaxy.rpc.thrift.ThriftProtocol.TCOMPACT);
    HEADER_THRIFT_MAP.put("application/x-thrift-json", com.xiaomi.infra.galaxy.rpc.thrift.ThriftProtocol.TJSON);
    HEADER_THRIFT_MAP.put("application/x-thrift-binary", com.xiaomi.infra.galaxy.rpc.thrift.ThriftProtocol.TBINARY);
    HEADER_THRIFT_MAP.put("application/x-thrift", com.xiaomi.infra.galaxy.rpc.thrift.ThriftProtocol.TJSON);
  }
