...
public class QueueAttribute implements libthrift091.TBase<QueueAttribute, QueueAttribute._Fields>, java.io.Serializable, Cloneable, Comparable<QueueAttribute> {
   ...
   * message will receive again, default 30s (0s ~ 12hour)
   * 
   */
  public int invisibilitySeconds; // optional
  /**
   * The seconds when receiveMessage called, default 0s (0s ~ 20s)
   * 
   */
  ...
  /**
   * Partition number for this queue default 8 (1 ~ 255)
   * 
   */
  ...
  private static final _Fields optionals[] = {_Fields.DELAY_SECONDS,_Fields.INVISIBILITY_SECONDS,_Fields.RECEIVE_MESSAGE_WAIT_SECONDS,_Fields.RECEIVE_MESSAGE_MAXIMUM_NUMBER,_Fields.MESSAGE_RETENTION_SECONDS,_Fields.MESSAGE_MAXIMUM_BYTES,_Fields.PARTITION_NUMBER};
