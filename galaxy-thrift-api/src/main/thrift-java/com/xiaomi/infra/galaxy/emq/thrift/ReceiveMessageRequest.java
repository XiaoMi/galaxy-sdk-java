...
public class ReceiveMessageRequest implements libthrift091.TBase<ReceiveMessageRequest, ReceiveMessageRequest._Fields>, java.io.Serializable, Cloneable, Comparable<ReceiveMessageRequest> {
  ...
  private static final libthrift091.protocol.TField MAX_RECEIVE_MESSAGE_NUMBER_FIELD_DESC = new libthrift091.protocol.TField("maxReceiveMessageNumber", libthrift091.protocol.TType.I32, (short)1);
  private static final libthrift091.protocol.TField MAX_RECEIVE_MESSAGE_WAIT_SECONDS_FIELD_DESC = new libthrift091.protocol.TField("maxReceiveMessageWaitSeconds", libthrift091.protocol.TType.I32, (short)2);
  ...
  public enum _Fields implements libthrift091.TFieldIdEnum {
     ...
     * 
     */
    MAX_RECEIVE_MESSAGE_NUMBER((short)1, "maxReceiveMessageNumber"),
    /**
     *   * Max receive message wait seconds, default 20s (0 ~ 20), 0s means no wait;
     * *
     */
    MAX_RECEIVE_MESSAGE_WAIT_SECONDS((short)2, "maxReceiveMessageWaitSeconds");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        case 1: // MAX_RECEIVE_MESSAGE_NUMBER
          return MAX_RECEIVE_MESSAGE_NUMBER;
        case 2: // MAX_RECEIVE_MESSAGE_WAIT_SECONDS
