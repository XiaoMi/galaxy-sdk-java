...
public class StopServiceRequest implements libthrift091.TBase<StopServiceRequest, StopServiceRequest._Fields>, java.io.Serializable, Cloneable, Comparable<StopServiceRequest> {
            ...
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                ...
                struct.services = new ArrayList<String>(_list212.size);
                String _elem213;
                for (int _i214 = 0; _i214 < _list212.size; ++_i214)
                {
                  _elem213 = iprot.readString();
                  struct.services.add(_elem213);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.services != null) {
        if (struct.isSetServices()) {
          oprot.writeFieldBegin(SERVICES_FIELD_DESC);
          {
            ...
            for (String _iter215 : struct.services)
            {
  ...
  private static class StopServiceRequestTupleScheme extends TupleScheme<StopServiceRequest> {
      ...
      if (struct.isSetServices()) {
        {
          ...
          for (String _iter216 : struct.services)
          {
    ...
    public void read(libthrift091.protocol.TProtocol prot, StopServiceRequest struct) throws libthrift091.TException {
      ...
      if (incoming.get(1)) {
        {
          libthrift091.protocol.TList _list217 = new libthrift091.protocol.TList(libthrift091.protocol.TType.STRING, iprot.readI32());
          struct.services = new ArrayList<String>(_list217.size);
          String _elem218;
          for (int _i219 = 0; _i219 < _list217.size; ++_i219)
          {
            _elem218 = iprot.readString();
            struct.services.add(_elem218);
          }
        }
        struct.setServicesIsSet(true);
      }
