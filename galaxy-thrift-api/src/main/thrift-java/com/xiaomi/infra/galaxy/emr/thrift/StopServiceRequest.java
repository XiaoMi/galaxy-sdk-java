...
public class StopServiceRequest implements libthrift091.TBase<StopServiceRequest, StopServiceRequest._Fields>, java.io.Serializable, Cloneable, Comparable<StopServiceRequest> {
            ...
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                ...
                struct.services = new ArrayList<String>(_list174.size);
                String _elem175;
                for (int _i176 = 0; _i176 < _list174.size; ++_i176)
                {
                  _elem175 = iprot.readString();
                  struct.services.add(_elem175);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.services != null) {
        if (struct.isSetServices()) {
          oprot.writeFieldBegin(SERVICES_FIELD_DESC);
          {
            ...
            for (String _iter177 : struct.services)
            {
  ...
  private static class StopServiceRequestTupleScheme extends TupleScheme<StopServiceRequest> {
      ...
      if (struct.isSetServices()) {
        {
          ...
          for (String _iter178 : struct.services)
          {
    ...
    public void read(libthrift091.protocol.TProtocol prot, StopServiceRequest struct) throws libthrift091.TException {
      ...
      if (incoming.get(1)) {
        {
          libthrift091.protocol.TList _list179 = new libthrift091.protocol.TList(libthrift091.protocol.TType.STRING, iprot.readI32());
          struct.services = new ArrayList<String>(_list179.size);
          String _elem180;
          for (int _i181 = 0; _i181 < _list179.size; ++_i181)
          {
            _elem180 = iprot.readString();
            struct.services.add(_elem180);
          }
        }
        struct.setServicesIsSet(true);
      }
