...
public class StopServiceRequest implements libthrift091.TBase<StopServiceRequest, StopServiceRequest._Fields>, java.io.Serializable, Cloneable, Comparable<StopServiceRequest> {
        ...
        switch (schemeField.id) {
          ...
          case 2: // SERVICES
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                libthrift091.protocol.TList _list204 = iprot.readListBegin();
                struct.services = new ArrayList<String>(_list204.size);
                String _elem205;
                for (int _i206 = 0; _i206 < _list204.size; ++_i206)
                {
                  _elem205 = iprot.readString();
                  struct.services.add(_elem205);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.services != null) {
        if (struct.isSetServices()) {
          oprot.writeFieldBegin(SERVICES_FIELD_DESC);
          {
            ...
            for (String _iter207 : struct.services)
            {
  ...
  private static class StopServiceRequestTupleScheme extends TupleScheme<StopServiceRequest> {
      ...
      if (struct.isSetServices()) {
        {
          ...
          for (String _iter208 : struct.services)
          {
    ...
    public void read(libthrift091.protocol.TProtocol prot, StopServiceRequest struct) throws libthrift091.TException {
      ...
      if (incoming.get(1)) {
        {
          libthrift091.protocol.TList _list209 = new libthrift091.protocol.TList(libthrift091.protocol.TType.STRING, iprot.readI32());
          struct.services = new ArrayList<String>(_list209.size);
          String _elem210;
          for (int _i211 = 0; _i211 < _list209.size; ++_i211)
          {
            _elem210 = iprot.readString();
            struct.services.add(_elem210);
          }
        }
        struct.setServicesIsSet(true);
      }
