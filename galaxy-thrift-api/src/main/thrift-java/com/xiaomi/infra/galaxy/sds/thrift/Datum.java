...
public class Datum implements libthrift091.TBase<Datum, Datum._Fields>, java.io.Serializable, Cloneable, Comparable<Datum> {
  ...
  static {
    ...
    tmpMap.put(_Fields.VALUE, new libthrift091.meta_data.FieldMetaData("value", libthrift091.TFieldRequirementType.REQUIRED, 
  ...
  public void validate() throws libthrift091.TException {
    ...
    if (value == null) {
      throw new libthrift091.protocol.TProtocolException("Required field 'value' was not present! Struct: " + toString());
    }
