            ...
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                ...
                {
                  String _key66;
                  com.xiaomi.infra.galaxy.sds.thrift.Datum _val67;
                  _key66 = iprot.readString();
                  _val67 = new com.xiaomi.infra.galaxy.sds.thrift.Datum();
                  _val67.read(iprot);
                  struct.data.put(_key66, _val67);
                }
                iprot.readMapEnd();
              }
      ...
      if (incoming.get(0)) {
        {
          ...
          {
            String _key72;
            com.xiaomi.infra.galaxy.sds.thrift.Datum _val73;
            _key72 = iprot.readString();
            _val73 = new com.xiaomi.infra.galaxy.sds.thrift.Datum();
            _val73.read(iprot);
            struct.data.put(_key72, _val73);
          }
        }
        struct.setDataIsSet(true);
      }
