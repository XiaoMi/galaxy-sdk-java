...
public class LocalSecondaryIndexSpec implements libthrift091.TBase<LocalSecondaryIndexSpec, LocalSecondaryIndexSpec._Fields>, java.io.Serializable, Cloneable, Comparable<LocalSecondaryIndexSpec> {
   ...
   * 索引定义
   */
  public List<KeySpec> indexSchema; // required
  /**
  ...
  private _Fields optionals[] = {_Fields.PROJECTIONS,_Fields.CONSISTENCY_MODE,_Fields.UNIQUE};
  public static final Map<_Fields, libthrift091.meta_data.FieldMetaData> metaDataMap;
  static {
    Map<_Fields, libthrift091.meta_data.FieldMetaData> tmpMap = new EnumMap<_Fields, libthrift091.meta_data.FieldMetaData>(_Fields.class);
    tmpMap.put(_Fields.INDEX_SCHEMA, new libthrift091.meta_data.FieldMetaData("indexSchema", libthrift091.TFieldRequirementType.REQUIRED, 
  ...
  public void validate() throws libthrift091.TException {
    ...
    if (indexSchema == null) {
      throw new libthrift091.protocol.TProtocolException("Required field 'indexSchema' was not present! Struct: " + toString());
    }
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                ...
                for (int _i65 = 0; _i65 < _list64.size; ++_i65)
                {
                  ...
                  _elem66 = new KeySpec();
                  _elem66.read(iprot);
                  struct.indexSchema.add(_elem66);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                ...
                for (int _i68 = 0; _i68 < _list67.size; ++_i68)
                {
                  ...
                  struct.projections.add(_elem69);
                }
                iprot.readListEnd();
              }
          ...
          case 3: // CONSISTENCY_MODE
            if (schemeField.type == libthrift091.protocol.TType.I32) {
              struct.consistencyMode = SecondaryIndexConsistencyMode.findByValue(iprot.readI32());
    ...
    public void read(libthrift091.protocol.TProtocol prot, LocalSecondaryIndexSpec struct) throws libthrift091.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      {
        ...
        for (int _i75 = 0; _i75 < _list74.size; ++_i75)
        {
          ...
          _elem76 = new KeySpec();
          _elem76.read(iprot);
          struct.indexSchema.add(_elem76);
        }
      }
      struct.setIndexSchemaIsSet(true);
      ...
      if (incoming.get(0)) {
        {
          ...
          for (int _i78 = 0; _i78 < _list77.size; ++_i78)
          {
            ...
            struct.projections.add(_elem79);
          }
        }
        struct.setProjectionsIsSet(true);
      }
