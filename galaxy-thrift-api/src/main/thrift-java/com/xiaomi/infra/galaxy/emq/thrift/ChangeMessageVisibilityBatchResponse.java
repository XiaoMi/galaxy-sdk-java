...
public class ChangeMessageVisibilityBatchResponse implements libthrift091.TBase<ChangeMessageVisibilityBatchResponse, ChangeMessageVisibilityBatchResponse._Fields>, java.io.Serializable, Cloneable, Comparable<ChangeMessageVisibilityBatchResponse> {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                ...
                struct.successful = new ArrayList<String>(_list16.size);
                String _elem17;
                for (int _i18 = 0; _i18 < _list16.size; ++_i18)
                {
                  _elem17 = iprot.readString();
                  struct.successful.add(_elem17);
                }
                iprot.readListEnd();
              }
          ...
          case 2: // FAILED
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                libthrift091.protocol.TList _list19 = iprot.readListBegin();
                struct.failed = new ArrayList<MessageBatchErrorEntry>(_list19.size);
                MessageBatchErrorEntry _elem20;
                for (int _i21 = 0; _i21 < _list19.size; ++_i21)
                {
                  _elem20 = new MessageBatchErrorEntry();
                  _elem20.read(iprot);
                  struct.failed.add(_elem20);
                }
                iprot.readListEnd();
              }
    ...
    public void write(libthrift091.protocol.TProtocol oprot, ChangeMessageVisibilityBatchResponse struct) throws libthrift091.TException {
      ...
      if (struct.successful != null) {
        oprot.writeFieldBegin(SUCCESSFUL_FIELD_DESC);
        {
          ...
          for (String _iter22 : struct.successful)
          {
      ...
      if (struct.failed != null) {
        oprot.writeFieldBegin(FAILED_FIELD_DESC);
        {
          ...
          for (MessageBatchErrorEntry _iter23 : struct.failed)
          {
            _iter23.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class ChangeMessageVisibilityBatchResponseTupleScheme extends TupleScheme<ChangeMessageVisibilityBatchResponse> {
      ...
      if (struct.isSetSuccessful()) {
        {
          ...
          for (String _iter24 : struct.successful)
          {
      ...
      if (struct.isSetFailed()) {
        {
          ...
          for (MessageBatchErrorEntry _iter25 : struct.failed)
          {
            _iter25.write(oprot);
          }
        }
    ...
    public void read(libthrift091.protocol.TProtocol prot, ChangeMessageVisibilityBatchResponse struct) throws libthrift091.TException {
      ...
      if (incoming.get(0)) {
        {
          libthrift091.protocol.TList _list26 = new libthrift091.protocol.TList(libthrift091.protocol.TType.STRING, iprot.readI32());
          struct.successful = new ArrayList<String>(_list26.size);
          String _elem27;
          for (int _i28 = 0; _i28 < _list26.size; ++_i28)
          {
            _elem27 = iprot.readString();
            struct.successful.add(_elem27);
          }
        }
        struct.setSuccessfulIsSet(true);
      }
      if (incoming.get(1)) {
        {
          ...
          struct.failed = new ArrayList<MessageBatchErrorEntry>(_list29.size);
          MessageBatchErrorEntry _elem30;
          for (int _i31 = 0; _i31 < _list29.size; ++_i31)
          {
            _elem30 = new MessageBatchErrorEntry();
            _elem30.read(iprot);
            struct.failed.add(_elem30);
          }
        }
        struct.setFailedIsSet(true);
      }
