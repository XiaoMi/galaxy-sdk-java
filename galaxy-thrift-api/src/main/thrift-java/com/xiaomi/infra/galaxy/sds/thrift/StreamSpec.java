...
public class StreamSpec implements libthrift091.TBase<StreamSpec, StreamSpec._Fields>, java.io.Serializable, Cloneable, Comparable<StreamSpec> {
            ...
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                ...
                struct.attributes = new ArrayList<String>(_list88.size);
                String _elem89;
                for (int _i90 = 0; _i90 < _list88.size; ++_i90)
                {
                  _elem89 = iprot.readString();
                  struct.attributes.add(_elem89);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.attributes != null) {
        if (struct.isSetAttributes()) {
          oprot.writeFieldBegin(ATTRIBUTES_FIELD_DESC);
          {
            ...
            for (String _iter91 : struct.attributes)
            {
  ...
  private static class StreamSpecTupleScheme extends TupleScheme<StreamSpec> {
      ...
      if (struct.isSetAttributes()) {
        {
          ...
          for (String _iter92 : struct.attributes)
          {
    ...
    public void read(libthrift091.protocol.TProtocol prot, StreamSpec struct) throws libthrift091.TException {
      ...
      if (incoming.get(2)) {
        {
          libthrift091.protocol.TList _list93 = new libthrift091.protocol.TList(libthrift091.protocol.TType.STRING, iprot.readI32());
          struct.attributes = new ArrayList<String>(_list93.size);
          String _elem94;
          for (int _i95 = 0; _i95 < _list93.size; ++_i95)
          {
            _elem94 = iprot.readString();
            struct.attributes.add(_elem94);
          }
        }
        struct.setAttributesIsSet(true);
      }
