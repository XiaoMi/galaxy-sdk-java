...
public class RCBasicMeta implements libthrift091.TBase<RCBasicMeta, RCBasicMeta._Fields>, java.io.Serializable, Cloneable, Comparable<RCBasicMeta> {
  ...
  private _Fields optionals[] = {_Fields.KEYS,_Fields.TYPES};
            ...
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                ...
                {
                  String _key15;
                  com.xiaomi.infra.galaxy.sds.thrift.DataType _val16;
                  _key15 = iprot.readString();
                  _val16 = com.xiaomi.infra.galaxy.sds.thrift.DataType.findByValue(iprot.readI32());
                  struct.types.put(_key15, _val16);
                }
                iprot.readMapEnd();
              }
      ...
      if (incoming.get(1)) {
        {
          ...
          {
            String _key26;
            com.xiaomi.infra.galaxy.sds.thrift.DataType _val27;
            _key26 = iprot.readString();
            _val27 = com.xiaomi.infra.galaxy.sds.thrift.DataType.findByValue(iprot.readI32());
            struct.types.put(_key26, _val27);
          }
        }
        struct.setTypesIsSet(true);
      }
