...
public class QueueState implements libthrift091.TBase<QueueState, QueueState._Fields>, java.io.Serializable, Cloneable, Comparable<QueueState> {
  ...
  private static final libthrift091.protocol.TField APPROXIMATE_DELAYED_MESSAGE_NUMBER_FIELD_DESC = new libthrift091.protocol.TField("approximateDelayedMessageNumber", libthrift091.protocol.TType.I64, (short)5);
  ...
  /**
   * The delayed message number in this queue, this is for message that send to
   * this queue that in delaySeconds;
   * 
   */
  public long approximateDelayedMessageNumber; // required
  ...
  public enum _Fields implements libthrift091.TFieldIdEnum {
     ...
     * 
     */
    APPROXIMATE_DELAYED_MESSAGE_NUMBER((short)5, "approximateDelayedMessageNumber");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 5: // APPROXIMATE_DELAYED_MESSAGE_NUMBER
          return APPROXIMATE_DELAYED_MESSAGE_NUMBER;
        default:
          return null;
      }
    }
  ...
  private static final int __APPROXIMATEINVISIBILITYMESSAGENUMBER_ISSET_ID = 3;
  private static final int __APPROXIMATEDELAYEDMESSAGENUMBER_ISSET_ID = 4;
  ...
  static {
    ...
    tmpMap.put(_Fields.APPROXIMATE_INVISIBILITY_MESSAGE_NUMBER, new libthrift091.meta_data.FieldMetaData("approximateInvisibilityMessageNumber", libthrift091.TFieldRequirementType.REQUIRED, 
        new libthrift091.meta_data.FieldValueMetaData(libthrift091.protocol.TType.I64)));
    tmpMap.put(_Fields.APPROXIMATE_DELAYED_MESSAGE_NUMBER, new libthrift091.meta_data.FieldMetaData("approximateDelayedMessageNumber", libthrift091.TFieldRequirementType.REQUIRED, 
        new libthrift091.meta_data.FieldValueMetaData(libthrift091.protocol.TType.I64)));
  ...
  public QueueState(
    ...
    long approximateDelayedMessageNumber)
  {
    this();
    ...
    this.approximateDelayedMessageNumber = approximateDelayedMessageNumber;
    setApproximateDelayedMessageNumberIsSet(true);
  }
  ...
  public QueueState(QueueState other) {
    ...
    this.approximateDelayedMessageNumber = other.approximateDelayedMessageNumber;
  }
  ...
  public void clear() {
    ...
    setApproximateDelayedMessageNumberIsSet(false);
    this.approximateDelayedMessageNumber = 0;
  }
   ...
   * 
   */
  public long getApproximateDelayedMessageNumber() {
    return this.approximateDelayedMessageNumber;
  }
   ...
   * 
   */
  public QueueState setApproximateDelayedMessageNumber(long approximateDelayedMessageNumber) {
    this.approximateDelayedMessageNumber = approximateDelayedMessageNumber;
    setApproximateDelayedMessageNumberIsSet(true);
    return this;
  }

  public void unsetApproximateDelayedMessageNumber() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __APPROXIMATEDELAYEDMESSAGENUMBER_ISSET_ID);
  }

  /** Returns true if field approximateDelayedMessageNumber is set (has been assigned a value) and false otherwise */
  public boolean isSetApproximateDelayedMessageNumber() {
    return EncodingUtils.testBit(__isset_bitfield, __APPROXIMATEDELAYEDMESSAGENUMBER_ISSET_ID);
  }

  public void setApproximateDelayedMessageNumberIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __APPROXIMATEDELAYEDMESSAGENUMBER_ISSET_ID, value);
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case APPROXIMATE_DELAYED_MESSAGE_NUMBER:
      if (value == null) {
        unsetApproximateDelayedMessageNumber();
      } else {
        setApproximateDelayedMessageNumber((Long)value);
      }
      break;
  ...
  public Object getFieldValue(_Fields field) {
    ...
    case APPROXIMATE_DELAYED_MESSAGE_NUMBER:
      return Long.valueOf(getApproximateDelayedMessageNumber());
  ...
  public boolean isSet(_Fields field) {
    ...
    case APPROXIMATE_DELAYED_MESSAGE_NUMBER:
      return isSetApproximateDelayedMessageNumber();
    }
    throw new IllegalStateException();
  }
  ...
  public boolean equals(QueueState that) {
    ...
    boolean this_present_approximateDelayedMessageNumber = true;
    boolean that_present_approximateDelayedMessageNumber = true;
    if (this_present_approximateDelayedMessageNumber || that_present_approximateDelayedMessageNumber) {
      if (!(this_present_approximateDelayedMessageNumber && that_present_approximateDelayedMessageNumber))
        return false;
      if (this.approximateDelayedMessageNumber != that.approximateDelayedMessageNumber)
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_approximateDelayedMessageNumber = true;
    list.add(present_approximateDelayedMessageNumber);
    if (present_approximateDelayedMessageNumber)
      list.add(approximateDelayedMessageNumber);
  ...
  public int compareTo(QueueState other) {
    ...
    lastComparison = Boolean.valueOf(isSetApproximateDelayedMessageNumber()).compareTo(other.isSetApproximateDelayedMessageNumber());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetApproximateDelayedMessageNumber()) {
      lastComparison = libthrift091.TBaseHelper.compareTo(this.approximateDelayedMessageNumber, other.approximateDelayedMessageNumber);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    ...
    first = false;
    if (!first) sb.append(", ");
    sb.append("approximateDelayedMessageNumber:");
    sb.append(this.approximateDelayedMessageNumber);
    first = false;
    sb.append(")");
    return sb.toString();
  }
  ...
  public void validate() throws libthrift091.TException {
    ...
    // alas, we cannot check 'approximateDelayedMessageNumber' because it's a primitive and you chose the non-beans generator.
  ...
  private static class QueueStateStandardScheme extends StandardScheme<QueueState> {
    ...
    public void read(libthrift091.protocol.TProtocol iprot, QueueState struct) throws libthrift091.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 5: // APPROXIMATE_DELAYED_MESSAGE_NUMBER
            if (schemeField.type == libthrift091.protocol.TType.I64) {
              struct.approximateDelayedMessageNumber = iprot.readI64();
              struct.setApproximateDelayedMessageNumberIsSet(true);
            } else { 
              libthrift091.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
      ...
      if (!struct.isSetApproximateDelayedMessageNumber()) {
        throw new libthrift091.protocol.TProtocolException("Required field 'approximateDelayedMessageNumber' was not found in serialized data! Struct: " + toString());
      }
      struct.validate();
    }
    ...
    public void write(libthrift091.protocol.TProtocol oprot, QueueState struct) throws libthrift091.TException {
      ...
      oprot.writeFieldEnd();
      oprot.writeFieldBegin(APPROXIMATE_DELAYED_MESSAGE_NUMBER_FIELD_DESC);
      oprot.writeI64(struct.approximateDelayedMessageNumber);
      oprot.writeFieldEnd();
