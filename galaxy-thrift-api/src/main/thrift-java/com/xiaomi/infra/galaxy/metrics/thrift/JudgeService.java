              ...
              if (schemeField.type == libthrift091.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<AlertRule>(_list16.size);
                  AlertRule _elem17;
      ...
      public void write(libthrift091.protocol.TProtocol oprot, listAlertRules_result struct) throws libthrift091.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (AlertRule _iter19 : struct.success)
            {
              _iter19.write(oprot);
            }
            oprot.writeListEnd();
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (AlertRule _iter20 : struct.success)
            {
              _iter20.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<AlertRule>(_list21.size);
            AlertRule _elem22;
