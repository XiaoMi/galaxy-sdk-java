...
public class KeysOnlyEntry implements libthrift091.TBase<KeysOnlyEntry, KeysOnlyEntry._Fields>, java.io.Serializable, Cloneable, Comparable<KeysOnlyEntry> {
        ...
        switch (schemeField.id) {
          case 1: // RECORD
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                libthrift091.protocol.TMap _map440 = iprot.readMapBegin();
                struct.record = new HashMap<String,Datum>(2*_map440.size);
                String _key441;
                Datum _val442;
                for (int _i443 = 0; _i443 < _map440.size; ++_i443)
                {
                  ...
                  _val442 = new Datum();
                  _val442.read(iprot);
                  struct.record.put(_key441, _val442);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.record != null) {
        if (struct.isSetRecord()) {
          oprot.writeFieldBegin(RECORD_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Datum> _iter444 : struct.record.entrySet())
            {
              oprot.writeString(_iter444.getKey());
              _iter444.getValue().write(oprot);
            }
            oprot.writeMapEnd();
          }
          oprot.writeFieldEnd();
  ...
  private static class KeysOnlyEntryTupleScheme extends TupleScheme<KeysOnlyEntry> {
      ...
      if (struct.isSetRecord()) {
        {
          ...
          for (Map.Entry<String, Datum> _iter445 : struct.record.entrySet())
          {
    ...
    public void read(libthrift091.protocol.TProtocol prot, KeysOnlyEntry struct) throws libthrift091.TException {
      ...
      if (incoming.get(0)) {
        {
          libthrift091.protocol.TMap _map446 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.STRUCT, iprot.readI32());
          struct.record = new HashMap<String,Datum>(2*_map446.size);
          String _key447;
          Datum _val448;
          for (int _i449 = 0; _i449 < _map446.size; ++_i449)
          {
            ...
            _val448 = new Datum();
            _val448.read(iprot);
            struct.record.put(_key447, _val448);
          }
        }
        struct.setRecordIsSet(true);
      }
