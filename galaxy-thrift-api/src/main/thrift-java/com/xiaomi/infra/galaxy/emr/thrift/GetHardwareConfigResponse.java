            ...
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                ...
                struct.hardware = new ArrayList<InstanceTypeInfo>(_list132.size);
                InstanceTypeInfo _elem133;
                for (int _i134 = 0; _i134 < _list132.size; ++_i134)
                {
                  _elem133 = new InstanceTypeInfo();
                  _elem133.read(iprot);
                  struct.hardware.add(_elem133);
                }
                iprot.readListEnd();
              }
    ...
    public void write(libthrift091.protocol.TProtocol oprot, GetHardwareConfigResponse struct) throws libthrift091.TException {
      ...
      if (struct.hardware != null) {
        oprot.writeFieldBegin(HARDWARE_FIELD_DESC);
        {
          ...
          for (InstanceTypeInfo _iter135 : struct.hardware)
          {
      ...
      if (struct.isSetHardware()) {
        {
          ...
          for (InstanceTypeInfo _iter136 : struct.hardware)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.hardware = new ArrayList<InstanceTypeInfo>(_list137.size);
          InstanceTypeInfo _elem138;
          for (int _i139 = 0; _i139 < _list137.size; ++_i139)
          {
            _elem138 = new InstanceTypeInfo();
            _elem138.read(iprot);
            struct.hardware.add(_elem138);
          }
        }
        struct.setHardwareIsSet(true);
      }
