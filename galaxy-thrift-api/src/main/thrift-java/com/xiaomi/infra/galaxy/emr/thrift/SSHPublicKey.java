...
public class SSHPublicKey implements libthrift091.TBase<SSHPublicKey, SSHPublicKey._Fields>, java.io.Serializable, Cloneable, Comparable<SSHPublicKey> {
  ...
  private static final libthrift091.protocol.TField FIGUREPRINT_FIELD_DESC = new libthrift091.protocol.TField("figureprint", libthrift091.protocol.TType.STRING, (short)3);
  ...
  public String figureprint; // optional
  ...
  public enum _Fields implements libthrift091.TFieldIdEnum {
    ...
    FIGUREPRINT((short)3, "figureprint"),
  ...
  private static final _Fields optionals[] = {_Fields.TITLE,_Fields.CONTENT,_Fields.FIGUREPRINT,_Fields.ADD_TIME};
  ...
  static {
    ...
    tmpMap.put(_Fields.CONTENT, new libthrift091.meta_data.FieldMetaData("content", libthrift091.TFieldRequirementType.OPTIONAL, 
        new libthrift091.meta_data.FieldValueMetaData(libthrift091.protocol.TType.STRING)));
    tmpMap.put(_Fields.FIGUREPRINT, new libthrift091.meta_data.FieldMetaData("figureprint", libthrift091.TFieldRequirementType.OPTIONAL, 
        new libthrift091.meta_data.FieldValueMetaData(libthrift091.protocol.TType.STRING)));
  ...
  public SSHPublicKey(SSHPublicKey other) {
    ...
    if (other.isSetFigureprint()) {
      this.figureprint = other.figureprint;
    }
  ...
  public SSHPublicKey setFigureprint(String figureprint) {
    this.figureprint = figureprint;
    return this;
  }

  public void unsetFigureprint() {
    this.figureprint = null;
  }

  /** Returns true if field figureprint is set (has been assigned a value) and false otherwise */
  public boolean isSetFigureprint() {
    return this.figureprint != null;
  }

  public void setFigureprintIsSet(boolean value) {
    if (!value) {
      this.figureprint = null;
    }
  }
  ...
  public boolean equals(SSHPublicKey that) {
    ...
    boolean this_present_figureprint = true && this.isSetFigureprint();
    boolean that_present_figureprint = true && that.isSetFigureprint();
    if (this_present_figureprint || that_present_figureprint) {
      if (!(this_present_figureprint && that_present_figureprint))
        return false;
      if (!this.figureprint.equals(that.figureprint))
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_figureprint = true && (isSetFigureprint());
    list.add(present_figureprint);
    if (present_figureprint)
      list.add(figureprint);
  ...
  public int compareTo(SSHPublicKey other) {
    ...
    lastComparison = Boolean.valueOf(isSetFigureprint()).compareTo(other.isSetFigureprint());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetFigureprint()) {
      lastComparison = libthrift091.TBaseHelper.compareTo(this.figureprint, other.figureprint);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    ...
    if (isSetFigureprint()) {
      if (!first) sb.append(", ");
      sb.append("figureprint:");
      if (this.figureprint == null) {
        sb.append("null");
      } else {
        sb.append(this.figureprint);
      }
      first = false;
    }
    if (isSetAddTime()) {
  ...
  private static class SSHPublicKeyStandardScheme extends StandardScheme<SSHPublicKey> {
    ...
    public void read(libthrift091.protocol.TProtocol iprot, SSHPublicKey struct) throws libthrift091.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 3: // FIGUREPRINT
            if (schemeField.type == libthrift091.protocol.TType.STRING) {
              struct.figureprint = iprot.readString();
              struct.setFigureprintIsSet(true);
            } else { 
              libthrift091.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(libthrift091.protocol.TProtocol oprot, SSHPublicKey struct) throws libthrift091.TException {
      ...
      if (struct.figureprint != null) {
        if (struct.isSetFigureprint()) {
          oprot.writeFieldBegin(FIGUREPRINT_FIELD_DESC);
          oprot.writeString(struct.figureprint);
          oprot.writeFieldEnd();
        }
      }
