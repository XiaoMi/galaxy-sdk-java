...
public class HttpAuthorizationHeader implements libthrift091.TBase<HttpAuthorizationHeader, HttpAuthorizationHeader._Fields>, java.io.Serializable, Cloneable, Comparable<HttpAuthorizationHeader> {
  ...
  public int hashCode() {
    ...
    boolean present_supportAccountKey = true && (isSetSupportAccountKey());
    list.add(present_supportAccountKey);
    if (present_supportAccountKey)
      list.add(supportAccountKey);
  ...
  public int compareTo(HttpAuthorizationHeader other) {
    ...
    lastComparison = Boolean.valueOf(isSetSupportAccountKey()).compareTo(other.isSetSupportAccountKey());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSupportAccountKey()) {
      lastComparison = libthrift091.TBaseHelper.compareTo(this.supportAccountKey, other.supportAccountKey);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class HttpAuthorizationHeaderStandardScheme extends StandardScheme<HttpAuthorizationHeader> {
        ...
        switch (schemeField.id) {
          ...
          case 2: // USER_TYPE
            if (schemeField.type == libthrift091.protocol.TType.I32) {
              struct.userType = com.xiaomi.infra.galaxy.rpc.thrift.UserType.findByValue(iprot.readI32());
          ...
          case 6: // ALGORITHM
            if (schemeField.type == libthrift091.protocol.TType.I32) {
              struct.algorithm = com.xiaomi.infra.galaxy.rpc.thrift.MacAlgorithm.findByValue(iprot.readI32());
          ...
          case 8: // SUPPORT_ACCOUNT_KEY
            if (schemeField.type == libthrift091.protocol.TType.BOOL) {
              struct.supportAccountKey = iprot.readBool();
              struct.setSupportAccountKeyIsSet(true);
            } else { 
              libthrift091.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(libthrift091.protocol.TProtocol oprot, HttpAuthorizationHeader struct) throws libthrift091.TException {
      ...
      if (struct.isSetSupportAccountKey()) {
        oprot.writeFieldBegin(SUPPORT_ACCOUNT_KEY_FIELD_DESC);
        oprot.writeBool(struct.supportAccountKey);
        oprot.writeFieldEnd();
      }
