            ...
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                ...
                struct.software = new ArrayList<ApplicationSuite>(_list124.size);
                ApplicationSuite _elem125;
                for (int _i126 = 0; _i126 < _list124.size; ++_i126)
                {
                  _elem125 = new ApplicationSuite();
                  _elem125.read(iprot);
                  struct.software.add(_elem125);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.isSetSoftware()) {
        {
          ...
          for (ApplicationSuite _iter128 : struct.software)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.software = new ArrayList<ApplicationSuite>(_list129.size);
          ApplicationSuite _elem130;
          for (int _i131 = 0; _i131 < _list129.size; ++_i131)
          {
            _elem130 = new ApplicationSuite();
            _elem130.read(iprot);
            struct.software.add(_elem130);
          }
        }
        struct.setSoftwareIsSet(true);
      }
