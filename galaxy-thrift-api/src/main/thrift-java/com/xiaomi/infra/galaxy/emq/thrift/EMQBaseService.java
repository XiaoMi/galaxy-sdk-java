...
public class EMQBaseService {
  ...
  public interface Iface {
     ...
     * 
     */
    public void validClientVersion() throws GalaxyEmqServiceException, libthrift091.TException;
  ...
  public interface AsyncIface {
    ...
    public void validClientVersion(libthrift091.async.AsyncMethodCallback resultHandler) throws libthrift091.TException;
  ...
  public static class Client extends libthrift091.TServiceClient implements Iface {
    ...
    public void validClientVersion() throws GalaxyEmqServiceException, libthrift091.TException
    {
      send_validClientVersion();
      recv_validClientVersion();
    }

    public void send_validClientVersion() throws libthrift091.TException
    {
  ...
  public static class AsyncClient extends libthrift091.async.TAsyncClient implements AsyncIface {
    ...
    public void validClientVersion(libthrift091.async.AsyncMethodCallback resultHandler) throws libthrift091.TException {
      checkReady();
      validClientVersion_call method_call = new validClientVersion_call(resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }

    public static class validClientVersion_call extends libthrift091.async.TAsyncMethodCall {
      public validClientVersion_call(libthrift091.async.AsyncMethodCallback resultHandler, libthrift091.async.TAsyncClient client, libthrift091.protocol.TProtocolFactory protocolFactory, libthrift091.transport.TNonblockingTransport transport) throws libthrift091.TException {
        super(client, protocolFactory, transport, resultHandler, false);
      }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends libthrift091.TBaseAsyncProcessor<I> {
    ...
    public static class validClientVersion<I extends AsyncIface> extends libthrift091.AsyncProcessFunction<I, validClientVersion_args, Void> {
      ...
      public void start(I iface, validClientVersion_args args, libthrift091.async.AsyncMethodCallback<Void> resultHandler) throws TException {
        iface.validClientVersion(resultHandler);
      }
    }
