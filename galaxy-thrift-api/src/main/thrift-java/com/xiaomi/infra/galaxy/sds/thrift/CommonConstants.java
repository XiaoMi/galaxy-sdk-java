...
public class CommonConstants {
   ...
   * client端读写超时时间（s）
   */
  public static final double DEFAULT_CLIENT_TIMEOUT = (double)10;

  /**
   * client端DDL操作超时时间（s）
   */
  public static final double DEFAULT_ADMIN_CLIENT_TIMEOUT = (double)30;

  /**
   * client端连接超时时间（s）
   */
  public static final double DEFAULT_CLIENT_CONN_TIMEOUT = (double)3;
