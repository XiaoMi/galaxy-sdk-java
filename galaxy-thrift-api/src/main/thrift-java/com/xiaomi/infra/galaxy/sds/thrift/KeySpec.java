...
public class KeySpec implements libthrift091.TBase<KeySpec, KeySpec._Fields>, java.io.Serializable, Cloneable, Comparable<KeySpec> {
  ...
  private static final _Fields optionals[] = {_Fields.ASC};
  public static final Map<_Fields, libthrift091.meta_data.FieldMetaData> metaDataMap;
  static {
    Map<_Fields, libthrift091.meta_data.FieldMetaData> tmpMap = new EnumMap<_Fields, libthrift091.meta_data.FieldMetaData>(_Fields.class);
    tmpMap.put(_Fields.ATTRIBUTE, new libthrift091.meta_data.FieldMetaData("attribute", libthrift091.TFieldRequirementType.REQUIRED, 
  ...
  public void validate() throws libthrift091.TException {
    ...
    if (attribute == null) {
      throw new libthrift091.protocol.TProtocolException("Required field 'attribute' was not present! Struct: " + toString());
    }
