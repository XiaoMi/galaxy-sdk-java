            ...
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                ...
                struct.clusterIds = new ArrayList<String>(_list0.size);
                String _elem1;
                for (int _i2 = 0; _i2 < _list0.size; ++_i2)
                {
                  _elem1 = iprot.readString();
                  struct.clusterIds.add(_elem1);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.clusterIds != null) {
        if (struct.isSetClusterIds()) {
          oprot.writeFieldBegin(CLUSTER_IDS_FIELD_DESC);
          {
            ...
            for (String _iter3 : struct.clusterIds)
            {
      ...
      if (struct.isSetClusterIds()) {
        {
          ...
          for (String _iter4 : struct.clusterIds)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.clusterIds = new ArrayList<String>(_list5.size);
          String _elem6;
          for (int _i7 = 0; _i7 < _list5.size; ++_i7)
          {
            _elem6 = iprot.readString();
            struct.clusterIds.add(_elem6);
          }
        }
        struct.setClusterIdsIsSet(true);
      }
