...
public class TableService {
  ...
  public interface Iface extends com.xiaomi.infra.galaxy.sds.thrift.BaseService.Iface {
     ...
     * @param request
     */
    public GetNewImageResult getNewImage(GetNewImageRequest request) throws com.xiaomi.infra.galaxy.sds.thrift.ServiceException, libthrift091.TException;
  ...
  public interface AsyncIface extends com.xiaomi.infra.galaxy.sds.thrift.BaseService .AsyncIface {
    ...
    public void getNewImage(GetNewImageRequest request, libthrift091.async.AsyncMethodCallback resultHandler) throws libthrift091.TException;
  ...
  public static class Client extends com.xiaomi.infra.galaxy.sds.thrift.BaseService.Client implements Iface {
    ...
    public GetNewImageResult getNewImage(GetNewImageRequest request) throws com.xiaomi.infra.galaxy.sds.thrift.ServiceException, libthrift091.TException
    {
      send_getNewImage(request);
      return recv_getNewImage();
    }

    public void send_getNewImage(GetNewImageRequest request) throws libthrift091.TException
    {
      getNewImage_args args = new getNewImage_args();
      args.setRequest(request);
      sendBase("getNewImage", args);
    }

    public GetNewImageResult recv_getNewImage() throws com.xiaomi.infra.galaxy.sds.thrift.ServiceException, libthrift091.TException
    {
      getNewImage_result result = new getNewImage_result();
      receiveBase(result, "getNewImage");
      if (result.isSetSuccess()) {
        return result.success;
      }
      if (result.se != null) {
      ...
      throw new libthrift091.TApplicationException(libthrift091.TApplicationException.MISSING_RESULT, "getNewImage failed: unknown result");
    }
  ...
  public static class AsyncClient extends com.xiaomi.infra.galaxy.sds.thrift.BaseService.AsyncClient implements AsyncIface {
    ...
    public void getNewImage(GetNewImageRequest request, libthrift091.async.AsyncMethodCallback resultHandler) throws libthrift091.TException {
      checkReady();
      getNewImage_call method_call = new getNewImage_call(request, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }

    public static class getNewImage_call extends libthrift091.async.TAsyncMethodCall {
      private GetNewImageRequest request;
      public getNewImage_call(GetNewImageRequest request, libthrift091.async.AsyncMethodCallback resultHandler, libthrift091.async.TAsyncClient client, libthrift091.protocol.TProtocolFactory protocolFactory, libthrift091.transport.TNonblockingTransport transport) throws libthrift091.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.request = request;
      }

      public void write_args(libthrift091.protocol.TProtocol prot) throws libthrift091.TException {
        prot.writeMessageBegin(new libthrift091.protocol.TMessage("getNewImage", libthrift091.protocol.TMessageType.CALL, 0));
        getNewImage_args args = new getNewImage_args();
        args.setRequest(request);
        args.write(prot);
        prot.writeMessageEnd();
      ...
      public GetNewImageResult getResult() throws com.xiaomi.infra.galaxy.sds.thrift.ServiceException, libthrift091.TException {
        if (getState() != libthrift091.async.TAsyncMethodCall.State.RESPONSE_READ) {
          throw new IllegalStateException("Method call not finished!");
        }
        libthrift091.transport.TMemoryInputTransport memoryTransport = new libthrift091.transport.TMemoryInputTransport(getFrameBuffer().array());
        libthrift091.protocol.TProtocol prot = client.getProtocolFactory().getProtocol(memoryTransport);
        return (new Client(prot)).recv_getNewImage();
      }
    }
  ...
  public static class Processor<I extends Iface> extends com.xiaomi.infra.galaxy.sds.thrift.BaseService.Processor<I> implements libthrift091.TProcessor {
    ...
    private static <I extends Iface> Map<String,  libthrift091.ProcessFunction<I, ? extends  libthrift091.TBase>> getProcessMap(Map<String,  libthrift091.ProcessFunction<I, ? extends  libthrift091.TBase>> processMap) {
      ...
      processMap.put("getNewImage", new getNewImage());
      return processMap;
    }
    ...
    public static class getNewImage<I extends Iface> extends libthrift091.ProcessFunction<I, getNewImage_args> {
      public getNewImage() {
        super("getNewImage");
      }

      public getNewImage_args getEmptyArgsInstance() {
        return new getNewImage_args();
      }
      ...
      public getNewImage_result getResult(I iface, getNewImage_args args) throws libthrift091.TException {
        getNewImage_result result = new getNewImage_result();
        try {
          result.success = iface.getNewImage(args.request);
        } catch (com.xiaomi.infra.galaxy.sds.thrift.ServiceException se) {
          result.se = se;
        }
        return result;
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends com.xiaomi.infra.galaxy.sds.thrift.BaseService.AsyncProcessor<I> {
    ...
    public static class getNewImage<I extends AsyncIface> extends libthrift091.AsyncProcessFunction<I, getNewImage_args, GetNewImageResult> {
      public getNewImage() {
        super("getNewImage");
      }
      ...
      public AsyncMethodCallback<GetNewImageResult> getResultHandler(final AsyncFrameBuffer fb, final int seqid) {
        final libthrift091.AsyncProcessFunction fcall = this;
        return new AsyncMethodCallback<GetNewImageResult>() { 
          public void onComplete(GetNewImageResult o) {
            getNewImage_result result = new getNewImage_result();
            result.success = o;
            try {
              fcall.sendResponse(fb,result, libthrift091.protocol.TMessageType.REPLY,seqid);
      ...
      public void start(I iface, getNewImage_args args, libthrift091.async.AsyncMethodCallback<GetNewImageResult> resultHandler) throws TException {
        iface.getNewImage(args.request,resultHandler);
      }
    }
  ...
  public static class getNewImage_args implements libthrift091.TBase<getNewImage_args, getNewImage_args._Fields>, java.io.Serializable, Cloneable, Comparable<getNewImage_args>   {
    private static final libthrift091.protocol.TStruct STRUCT_DESC = new libthrift091.protocol.TStruct("getNewImage_args");

    private static final libthrift091.protocol.TField REQUEST_FIELD_DESC = new libthrift091.protocol.TField("request", libthrift091.protocol.TType.STRUCT, (short)1);

    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new getNewImage_argsStandardSchemeFactory());
      schemes.put(TupleScheme.class, new getNewImage_argsTupleSchemeFactory());
    }

    public GetNewImageRequest request; // required
    ...
    static {
      Map<_Fields, libthrift091.meta_data.FieldMetaData> tmpMap = new EnumMap<_Fields, libthrift091.meta_data.FieldMetaData>(_Fields.class);
      tmpMap.put(_Fields.REQUEST, new libthrift091.meta_data.FieldMetaData("request", libthrift091.TFieldRequirementType.DEFAULT, 
          new libthrift091.meta_data.StructMetaData(libthrift091.protocol.TType.STRUCT, GetNewImageRequest.class)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      libthrift091.meta_data.FieldMetaData.addStructMetaDataMap(getNewImage_args.class, metaDataMap);
    }

    public getNewImage_args() {
    }

    public getNewImage_args(
      GetNewImageRequest request)
    {
      this();
      this.request = request;
    }
     ...
     * Performs a deep copy on <i>other</i>.
     */
    public getNewImage_args(getNewImage_args other) {
      if (other.isSetRequest()) {
        this.request = new GetNewImageRequest(other.request);
      }
    }

    public getNewImage_args deepCopy() {
      return new getNewImage_args(this);
    }
    ...
    public GetNewImageRequest getRequest() {
      return this.request;
    }

    public getNewImage_args setRequest(GetNewImageRequest request) {
      this.request = request;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case REQUEST:
        if (value == null) {
          ...
          setRequest((GetNewImageRequest)value);
        }
        break;
    ...
    public boolean equals(Object that) {
      if (that == null)
        return false;
      if (that instanceof getNewImage_args)
        return this.equals((getNewImage_args)that);
      return false;
    }

    public boolean equals(getNewImage_args that) {
      if (that == null)
        return false;
    ...
    @Override
    public int compareTo(getNewImage_args other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("getNewImage_args(");
      boolean first = true;
    ...
    private static class getNewImage_argsStandardSchemeFactory implements SchemeFactory {
      public getNewImage_argsStandardScheme getScheme() {
        return new getNewImage_argsStandardScheme();
      }
    }

    private static class getNewImage_argsStandardScheme extends StandardScheme<getNewImage_args> {

      public void read(libthrift091.protocol.TProtocol iprot, getNewImage_args struct) throws libthrift091.TException {
        libthrift091.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
          ...
          switch (schemeField.id) {
            case 1: // REQUEST
              if (schemeField.type == libthrift091.protocol.TType.STRUCT) {
                struct.request = new GetNewImageRequest();
                struct.request.read(iprot);
                struct.setRequestIsSet(true);
              } else { 
                libthrift091.protocol.TProtocolUtil.skip(iprot, schemeField.type);
      ...
      public void write(libthrift091.protocol.TProtocol oprot, getNewImage_args struct) throws libthrift091.TException {
        struct.validate();
    ...
    private static class getNewImage_argsTupleSchemeFactory implements SchemeFactory {
      public getNewImage_argsTupleScheme getScheme() {
        return new getNewImage_argsTupleScheme();
      }
    }

    private static class getNewImage_argsTupleScheme extends TupleScheme<getNewImage_args> {

      @Override
      public void write(libthrift091.protocol.TProtocol prot, getNewImage_args struct) throws libthrift091.TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetRequest()) {
          optionals.set(0);
      ...
      @Override
      public void read(libthrift091.protocol.TProtocol prot, getNewImage_args struct) throws libthrift091.TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(1);
        if (incoming.get(0)) {
          struct.request = new GetNewImageRequest();
  ...
  public static class getNewImage_result implements libthrift091.TBase<getNewImage_result, getNewImage_result._Fields>, java.io.Serializable, Cloneable, Comparable<getNewImage_result>   {
    private static final libthrift091.protocol.TStruct STRUCT_DESC = new libthrift091.protocol.TStruct("getNewImage_result");
    ...
    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new getNewImage_resultStandardSchemeFactory());
      schemes.put(TupleScheme.class, new getNewImage_resultTupleSchemeFactory());
    }

    public GetNewImageResult success; // required
    public com.xiaomi.infra.galaxy.sds.thrift.ServiceException se; // required
    ...
    static {
      Map<_Fields, libthrift091.meta_data.FieldMetaData> tmpMap = new EnumMap<_Fields, libthrift091.meta_data.FieldMetaData>(_Fields.class);
      tmpMap.put(_Fields.SUCCESS, new libthrift091.meta_data.FieldMetaData("success", libthrift091.TFieldRequirementType.DEFAULT, 
          new libthrift091.meta_data.StructMetaData(libthrift091.protocol.TType.STRUCT, GetNewImageResult.class)));
      tmpMap.put(_Fields.SE, new libthrift091.meta_data.FieldMetaData("se", libthrift091.TFieldRequirementType.DEFAULT, 
          new libthrift091.meta_data.FieldValueMetaData(libthrift091.protocol.TType.STRUCT)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      libthrift091.meta_data.FieldMetaData.addStructMetaDataMap(getNewImage_result.class, metaDataMap);
    }

    public getNewImage_result() {
    }

    public getNewImage_result(
      GetNewImageResult success,
      com.xiaomi.infra.galaxy.sds.thrift.ServiceException se)
    {
      this();
      this.success = success;
     ...
     * Performs a deep copy on <i>other</i>.
     */
    public getNewImage_result(getNewImage_result other) {
      if (other.isSetSuccess()) {
        this.success = new GetNewImageResult(other.success);
      }
      if (other.isSetSe()) {
        this.se = new com.xiaomi.infra.galaxy.sds.thrift.ServiceException(other.se);
      }
    ...
    public getNewImage_result deepCopy() {
      return new getNewImage_result(this);
    }
    ...
    public GetNewImageResult getSuccess() {
      return this.success;
    }

    public getNewImage_result setSuccess(GetNewImageResult success) {
      this.success = success;
      return this;
    }
    ...
    public getNewImage_result setSe(com.xiaomi.infra.galaxy.sds.thrift.ServiceException se) {
      this.se = se;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case SUCCESS:
        if (value == null) {
          ...
          setSuccess((GetNewImageResult)value);
        }
        break;
    ...
    public boolean equals(Object that) {
      if (that == null)
        return false;
      if (that instanceof getNewImage_result)
        return this.equals((getNewImage_result)that);
      return false;
    }

    public boolean equals(getNewImage_result that) {
      if (that == null)
        return false;
    ...
    @Override
    public int compareTo(getNewImage_result other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("getNewImage_result(");
      boolean first = true;
    ...
    private static class getNewImage_resultStandardSchemeFactory implements SchemeFactory {
      public getNewImage_resultStandardScheme getScheme() {
        return new getNewImage_resultStandardScheme();
      }
    }

    private static class getNewImage_resultStandardScheme extends StandardScheme<getNewImage_result> {

      public void read(libthrift091.protocol.TProtocol iprot, getNewImage_result struct) throws libthrift091.TException {
        libthrift091.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
          ...
          switch (schemeField.id) {
            case 0: // SUCCESS
              if (schemeField.type == libthrift091.protocol.TType.STRUCT) {
                struct.success = new GetNewImageResult();
                struct.success.read(iprot);
                struct.setSuccessIsSet(true);
              } else { 
                libthrift091.protocol.TProtocolUtil.skip(iprot, schemeField.type);
      ...
      public void write(libthrift091.protocol.TProtocol oprot, getNewImage_result struct) throws libthrift091.TException {
        struct.validate();
    ...
    private static class getNewImage_resultTupleSchemeFactory implements SchemeFactory {
      public getNewImage_resultTupleScheme getScheme() {
        return new getNewImage_resultTupleScheme();
      }
    }

    private static class getNewImage_resultTupleScheme extends TupleScheme<getNewImage_result> {

      @Override
      public void write(libthrift091.protocol.TProtocol prot, getNewImage_result struct) throws libthrift091.TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetSuccess()) {
          optionals.set(0);
      ...
      @Override
      public void read(libthrift091.protocol.TProtocol prot, getNewImage_result struct) throws libthrift091.TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(2);
        if (incoming.get(0)) {
          struct.success = new GetNewImageResult();
