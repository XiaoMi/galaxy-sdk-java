...
public class KillJobRequest implements libthrift091.TBase<KillJobRequest, KillJobRequest._Fields>, java.io.Serializable, Cloneable, Comparable<KillJobRequest> {
  private static final libthrift091.protocol.TStruct STRUCT_DESC = new libthrift091.protocol.TStruct("KillJobRequest");
  ...
  static {
    schemes.put(StandardScheme.class, new KillJobRequestStandardSchemeFactory());
    schemes.put(TupleScheme.class, new KillJobRequestTupleSchemeFactory());
  }
  ...
  static {
    ...
    libthrift091.meta_data.FieldMetaData.addStructMetaDataMap(KillJobRequest.class, metaDataMap);
  }
   ...
   */
  public KillJobRequest(KillJobRequest other) {
    if (other.isSetJobId()) {
  ...
  public KillJobRequest deepCopy() {
    return new KillJobRequest(this);
  }
  ...
  public KillJobRequest setJobId(String jobId) {
    this.jobId = jobId;
    return this;
  }
  ...
  public KillJobRequest setClusterId(String clusterId) {
    this.clusterId = clusterId;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof KillJobRequest)
      return this.equals((KillJobRequest)that);
    return false;
  }

  public boolean equals(KillJobRequest that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(KillJobRequest other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("KillJobRequest(");
    boolean first = true;
  ...
  private static class KillJobRequestStandardSchemeFactory implements SchemeFactory {
    public KillJobRequestStandardScheme getScheme() {
      return new KillJobRequestStandardScheme();
    }
  }

  private static class KillJobRequestStandardScheme extends StandardScheme<KillJobRequest> {

    public void read(libthrift091.protocol.TProtocol iprot, KillJobRequest struct) throws libthrift091.TException {
    ...
    public void write(libthrift091.protocol.TProtocol oprot, KillJobRequest struct) throws libthrift091.TException {
      struct.validate();
  ...
  private static class KillJobRequestTupleSchemeFactory implements SchemeFactory {
    public KillJobRequestTupleScheme getScheme() {
      return new KillJobRequestTupleScheme();
    }
  }

  private static class KillJobRequestTupleScheme extends TupleScheme<KillJobRequest> {

    @Override
    public void write(libthrift091.protocol.TProtocol prot, KillJobRequest struct) throws libthrift091.TException {
    ...
    @Override
    public void read(libthrift091.protocol.TProtocol prot, KillJobRequest struct) throws libthrift091.TException {
