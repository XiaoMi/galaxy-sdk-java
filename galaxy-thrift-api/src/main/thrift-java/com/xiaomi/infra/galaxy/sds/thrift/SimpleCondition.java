...
public class SimpleCondition implements libthrift091.TBase<SimpleCondition, SimpleCondition._Fields>, java.io.Serializable, Cloneable, Comparable<SimpleCondition> {
   ...
   * @see OperatorType
   */
  public OperatorType operator; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.OPERATOR, new libthrift091.meta_data.FieldMetaData("operator", libthrift091.TFieldRequirementType.REQUIRED, 
        new libthrift091.meta_data.EnumMetaData(libthrift091.protocol.TType.ENUM, OperatorType.class)));
    tmpMap.put(_Fields.FIELD, new libthrift091.meta_data.FieldMetaData("field", libthrift091.TFieldRequirementType.REQUIRED, 
  ...
  public void validate() throws libthrift091.TException {
    ...
    if (operator == null) {
      throw new libthrift091.protocol.TProtocolException("Required field 'operator' was not present! Struct: " + toString());
    }
    if (field == null) {
      throw new libthrift091.protocol.TProtocolException("Required field 'field' was not present! Struct: " + toString());
    }
