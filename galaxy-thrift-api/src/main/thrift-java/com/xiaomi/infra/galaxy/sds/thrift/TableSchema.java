...
public class TableSchema implements libthrift091.TBase<TableSchema, TableSchema._Fields>, java.io.Serializable, Cloneable, Comparable<TableSchema> {
   ...
   * 属性定义
   */
  public Map<String,DataType> attributes; // required
  /**
  ...
  private _Fields optionals[] = {_Fields.VERSION,_Fields.ENTITY_GROUP,_Fields.SECONDARY_INDEXES,_Fields.TTL,_Fields.PRE_SPLITS};
            ...
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                ...
                for (int _i89 = 0; _i89 < _list88.size; ++_i89)
                {
                  ...
                  _elem90 = new KeySpec();
                  _elem90.read(iprot);
                  struct.primaryIndex.add(_elem90);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                ...
                {
                  String _key93;
                  LocalSecondaryIndexSpec _val94;
                  _key93 = iprot.readString();
                  _val94 = new LocalSecondaryIndexSpec();
                  _val94.read(iprot);
                  struct.secondaryIndexes.put(_key93, _val94);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                ...
                for (int _i96 = 0; _i96 < _map95.size; ++_i96)
                {
                  ...
                  _val98 = DataType.findByValue(iprot.readI32());
                  struct.attributes.put(_key97, _val98);
                }
                iprot.readMapEnd();
              }
  ...
  private static class TableSchemaTupleScheme extends TupleScheme<TableSchema> {
    ...
    public void write(libthrift091.protocol.TProtocol prot, TableSchema struct) throws libthrift091.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      {
        ...
        for (Map.Entry<String, DataType> _iter102 : struct.attributes.entrySet())
        {
      ...
      if (struct.isSetPrimaryIndex()) {
        {
          ...
          for (KeySpec _iter103 : struct.primaryIndex)
          {
      ...
      if (struct.isSetSecondaryIndexes()) {
        {
          ...
          for (Map.Entry<String, LocalSecondaryIndexSpec> _iter104 : struct.secondaryIndexes.entrySet())
          {
    ...
    public void read(libthrift091.protocol.TProtocol prot, TableSchema struct) throws libthrift091.TException {
      ...
      {
        libthrift091.protocol.TMap _map105 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.I32, iprot.readI32());
        struct.attributes = new HashMap<String,DataType>(2*_map105.size);
        for (int _i106 = 0; _i106 < _map105.size; ++_i106)
        {
          String _key107;
          DataType _val108;
          _key107 = iprot.readString();
          _val108 = DataType.findByValue(iprot.readI32());
          struct.attributes.put(_key107, _val108);
        }
      }
      struct.setAttributesIsSet(true);
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.primaryIndex = new ArrayList<KeySpec>(_list109.size);
          for (int _i110 = 0; _i110 < _list109.size; ++_i110)
          {
            KeySpec _elem111;
            _elem111 = new KeySpec();
            _elem111.read(iprot);
            struct.primaryIndex.add(_elem111);
          }
        }
        struct.setPrimaryIndexIsSet(true);
      }
      if (incoming.get(3)) {
        {
          libthrift091.protocol.TMap _map112 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.STRUCT, iprot.readI32());
          struct.secondaryIndexes = new HashMap<String,LocalSecondaryIndexSpec>(2*_map112.size);
          for (int _i113 = 0; _i113 < _map112.size; ++_i113)
          {
            String _key114;
            LocalSecondaryIndexSpec _val115;
            _key114 = iprot.readString();
            _val115 = new LocalSecondaryIndexSpec();
            _val115.read(iprot);
            struct.secondaryIndexes.put(_key114, _val115);
          }
        }
        struct.setSecondaryIndexesIsSet(true);
      }
