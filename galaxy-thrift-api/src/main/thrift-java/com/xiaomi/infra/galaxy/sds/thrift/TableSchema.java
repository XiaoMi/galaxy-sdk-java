...
public class TableSchema implements libthrift091.TBase<TableSchema, TableSchema._Fields>, java.io.Serializable, Cloneable, Comparable<TableSchema> {
  ...
  private static final _Fields optionals[] = {_Fields.VERSION,_Fields.ENTITY_GROUP,_Fields.SECONDARY_INDEXES,_Fields.TTL,_Fields.PRE_SPLITS};
    ...
    public void read(libthrift091.protocol.TProtocol prot, TableSchema struct) throws libthrift091.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      {
        ...
        for (int _i108 = 0; _i108 < _map105.size; ++_i108)
        {
          ...
          _val107 = com.xiaomi.infra.galaxy.sds.thrift.DataType.findByValue(iprot.readI32());
      ...
      if (incoming.get(2)) {
        {
          ...
          {
            _elem110 = new KeySpec();
            _elem110.read(iprot);
            struct.primaryIndex.add(_elem110);
          }
        }
        struct.setPrimaryIndexIsSet(true);
      }
      if (incoming.get(3)) {
        {
          ...
          String _key113;
          LocalSecondaryIndexSpec _val114;
          for (int _i115 = 0; _i115 < _map112.size; ++_i115)
          {
            _key113 = iprot.readString();
            _val114 = new LocalSecondaryIndexSpec();
            _val114.read(iprot);
            struct.secondaryIndexes.put(_key113, _val114);
          }
        }
        struct.setSecondaryIndexesIsSet(true);
      }
