...
public class TableSchema implements libthrift091.TBase<TableSchema, TableSchema._Fields>, java.io.Serializable, Cloneable, Comparable<TableSchema> {
  ...
  private static final libthrift091.protocol.TField ENABLE_TRANSACTION_FIELD_DESC = new libthrift091.protocol.TField("enableTransaction", libthrift091.protocol.TType.BOOL, (short)10);
   ...
   * 支持事务
   */
  public boolean enableTransaction; // optional
  ...
  public enum _Fields implements libthrift091.TFieldIdEnum {
     ...
     * 支持事务
     */
    ENABLE_TRANSACTION((short)10, "enableTransaction");
  ...
  private static final int __ENABLETRANSACTION_ISSET_ID = 3;
  private byte __isset_bitfield = 0;
  private static final _Fields optionals[] = {_Fields.VERSION,_Fields.ENTITY_GROUP,_Fields.SECONDARY_INDEXES,_Fields.ATTRIBUTES,_Fields.TTL,_Fields.PRE_SPLITS,_Fields.STREAMS,_Fields.GLOBAL_SECONDARY_INDEXES,_Fields.ENABLE_TRANSACTION};
  ...
  static {
    ...
    tmpMap.put(_Fields.ENABLE_TRANSACTION, new libthrift091.meta_data.FieldMetaData("enableTransaction", libthrift091.TFieldRequirementType.OPTIONAL, 
  ...
  public TableSchema(TableSchema other) {
    ...
    this.enableTransaction = other.enableTransaction;
  }
  ...
  public void clear() {
    ...
    setEnableTransactionIsSet(false);
   ...
   * 支持事务
   */
  public TableSchema setEnableTransaction(boolean enableTransaction) {
    this.enableTransaction = enableTransaction;
    setEnableTransactionIsSet(true);
    return this;
  }

  public void unsetEnableTransaction() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __ENABLETRANSACTION_ISSET_ID);
  }

  /** Returns true if field enableTransaction is set (has been assigned a value) and false otherwise */
  public boolean isSetEnableTransaction() {
    return EncodingUtils.testBit(__isset_bitfield, __ENABLETRANSACTION_ISSET_ID);
  }

  public void setEnableTransactionIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __ENABLETRANSACTION_ISSET_ID, value);
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case ENABLE_TRANSACTION:
      if (value == null) {
        unsetEnableTransaction();
      } else {
        setEnableTransaction((Boolean)value);
      }
      break;
  ...
  public Object getFieldValue(_Fields field) {
    ...
    case ENABLE_TRANSACTION:
      return Boolean.valueOf(isEnableTransaction());
  ...
  public boolean equals(TableSchema that) {
    ...
    boolean this_present_enableTransaction = true && this.isSetEnableTransaction();
    boolean that_present_enableTransaction = true && that.isSetEnableTransaction();
    if (this_present_enableTransaction || that_present_enableTransaction) {
      if (!(this_present_enableTransaction && that_present_enableTransaction))
        return false;
      if (this.enableTransaction != that.enableTransaction)
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_enableTransaction = true && (isSetEnableTransaction());
    list.add(present_enableTransaction);
    if (present_enableTransaction)
      list.add(enableTransaction);
  ...
  public int compareTo(TableSchema other) {
    ...
    lastComparison = Boolean.valueOf(isSetEnableTransaction()).compareTo(other.isSetEnableTransaction());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetEnableTransaction()) {
      lastComparison = libthrift091.TBaseHelper.compareTo(this.enableTransaction, other.enableTransaction);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    ...
    if (isSetEnableTransaction()) {
      if (!first) sb.append(", ");
      sb.append("enableTransaction:");
      sb.append(this.enableTransaction);
      first = false;
    }
    sb.append(")");
    return sb.toString();
  ...
  private static class TableSchemaStandardScheme extends StandardScheme<TableSchema> {
        ...
        switch (schemeField.id) {
          ...
          case 10: // ENABLE_TRANSACTION
            if (schemeField.type == libthrift091.protocol.TType.BOOL) {
              struct.enableTransaction = iprot.readBool();
              struct.setEnableTransactionIsSet(true);
            } else { 
              libthrift091.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(libthrift091.protocol.TProtocol oprot, TableSchema struct) throws libthrift091.TException {
      ...
      if (struct.isSetEnableTransaction()) {
        oprot.writeFieldBegin(ENABLE_TRANSACTION_FIELD_DESC);
        oprot.writeBool(struct.enableTransaction);
        oprot.writeFieldEnd();
      }
