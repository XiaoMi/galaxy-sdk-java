...
public class RecordImage implements libthrift091.TBase<RecordImage, RecordImage._Fields>, java.io.Serializable, Cloneable, Comparable<RecordImage> {
      ...
      if (struct.record != null) {
        if (struct.isSetRecord()) {
          oprot.writeFieldBegin(RECORD_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Datum> _iter398 : struct.record.entrySet())
            {
  ...
  private static class RecordImageTupleScheme extends TupleScheme<RecordImage> {
      ...
      if (struct.isSetRecord()) {
        {
          ...
          for (Map.Entry<String, Datum> _iter399 : struct.record.entrySet())
          {
    ...
    public void read(libthrift091.protocol.TProtocol prot, RecordImage struct) throws libthrift091.TException {
      ...
      if (incoming.get(0)) {
        {
          libthrift091.protocol.TMap _map400 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.STRUCT, iprot.readI32());
          struct.record = new HashMap<String,Datum>(2*_map400.size);
          String _key401;
          Datum _val402;
          for (int _i403 = 0; _i403 < _map400.size; ++_i403)
          {
            ...
            _val402 = new Datum();
            _val402.read(iprot);
            struct.record.put(_key401, _val402);
          }
        }
        struct.setRecordIsSet(true);
      }
