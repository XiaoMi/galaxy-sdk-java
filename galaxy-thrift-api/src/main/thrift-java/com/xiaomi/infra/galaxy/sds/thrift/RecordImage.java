...
public class RecordImage implements libthrift091.TBase<RecordImage, RecordImage._Fields>, java.io.Serializable, Cloneable, Comparable<RecordImage> {
  ...
  private static class RecordImageTupleScheme extends TupleScheme<RecordImage> {
      ...
      if (struct.isSetRecord()) {
        {
          ...
          for (Map.Entry<String, Datum> _iter419 : struct.record.entrySet())
          {
    ...
    public void read(libthrift091.protocol.TProtocol prot, RecordImage struct) throws libthrift091.TException {
      ...
      if (incoming.get(0)) {
        {
          libthrift091.protocol.TMap _map420 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.STRUCT, iprot.readI32());
          struct.record = new HashMap<String,Datum>(2*_map420.size);
          String _key421;
          Datum _val422;
          for (int _i423 = 0; _i423 < _map420.size; ++_i423)
          {
            ...
            _val422 = new Datum();
            _val422.read(iprot);
            struct.record.put(_key421, _val422);
          }
        }
        struct.setRecordIsSet(true);
      }
