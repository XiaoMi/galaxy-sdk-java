...
public class RecordImage implements libthrift091.TBase<RecordImage, RecordImage._Fields>, java.io.Serializable, Cloneable, Comparable<RecordImage> {
        ...
        switch (schemeField.id) {
          case 1: // RECORD
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                libthrift091.protocol.TMap _map430 = iprot.readMapBegin();
                struct.record = new HashMap<String,Datum>(2*_map430.size);
                String _key431;
                Datum _val432;
                for (int _i433 = 0; _i433 < _map430.size; ++_i433)
                {
                  ...
                  _val432 = new Datum();
                  _val432.read(iprot);
                  struct.record.put(_key431, _val432);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.record != null) {
        if (struct.isSetRecord()) {
          oprot.writeFieldBegin(RECORD_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Datum> _iter434 : struct.record.entrySet())
            {
  ...
  private static class RecordImageTupleScheme extends TupleScheme<RecordImage> {
      ...
      if (struct.isSetRecord()) {
        {
          ...
          for (Map.Entry<String, Datum> _iter435 : struct.record.entrySet())
          {
    ...
    public void read(libthrift091.protocol.TProtocol prot, RecordImage struct) throws libthrift091.TException {
      ...
      if (incoming.get(0)) {
        {
          libthrift091.protocol.TMap _map436 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.STRUCT, iprot.readI32());
          struct.record = new HashMap<String,Datum>(2*_map436.size);
          String _key437;
          Datum _val438;
          for (int _i439 = 0; _i439 < _map436.size; ++_i439)
          {
            ...
            _val438 = new Datum();
            _val438.read(iprot);
            struct.record.put(_key437, _val438);
          }
        }
        struct.setRecordIsSet(true);
      }
