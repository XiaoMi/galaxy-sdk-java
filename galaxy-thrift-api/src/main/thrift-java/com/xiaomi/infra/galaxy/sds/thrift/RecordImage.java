...
public class RecordImage implements libthrift091.TBase<RecordImage, RecordImage._Fields>, java.io.Serializable, Cloneable, Comparable<RecordImage> {
  ...
  private static final libthrift091.protocol.TField TABLE_NAME_FIELD_DESC = new libthrift091.protocol.TField("tableName", libthrift091.protocol.TType.STRING, (short)4);
  ...
  private static final _Fields optionals[] = {_Fields.RECORD,_Fields.ROW_DELETED,_Fields.TIMESTAMP,_Fields.TABLE_NAME};
   ...
   * sds tableName
   */
  public RecordImage setTableName(String tableName) {
        ...
        switch (schemeField.id) {
          case 1: // RECORD
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                libthrift091.protocol.TMap _map422 = iprot.readMapBegin();
      ...
      if (struct.record != null) {
        if (struct.isSetRecord()) {
          oprot.writeFieldBegin(RECORD_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Datum> _iter426 : struct.record.entrySet())
            {
  ...
  private static class RecordImageTupleScheme extends TupleScheme<RecordImage> {
      ...
      if (struct.isSetRecord()) {
        {
          ...
          for (Map.Entry<String, Datum> _iter427 : struct.record.entrySet())
          {
    ...
    public void read(libthrift091.protocol.TProtocol prot, RecordImage struct) throws libthrift091.TException {
      ...
      if (incoming.get(0)) {
        {
          libthrift091.protocol.TMap _map428 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.STRUCT, iprot.readI32());
          struct.record = new HashMap<String,Datum>(2*_map428.size);
          String _key429;
          Datum _val430;
          for (int _i431 = 0; _i431 < _map428.size; ++_i431)
          {
            ...
            _val430 = new Datum();
            _val430.read(iprot);
            struct.record.put(_key429, _val430);
          }
        }
        struct.setRecordIsSet(true);
      }
