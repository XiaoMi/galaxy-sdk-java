        ...
        switch (schemeField.id) {
          case 1: // RECORD
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                libthrift091.protocol.TMap _map368 = iprot.readMapBegin();
                struct.record = new HashMap<String,Datum>(2*_map368.size);
                String _key369;
                Datum _val370;
                for (int _i371 = 0; _i371 < _map368.size; ++_i371)
                {
                  ...
                  _val370 = new Datum();
                  _val370.read(iprot);
                  struct.record.put(_key369, _val370);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.record != null) {
        if (struct.isSetRecord()) {
          oprot.writeFieldBegin(RECORD_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Datum> _iter372 : struct.record.entrySet())
            {
      ...
      if (struct.isSetRecord()) {
        {
          ...
          for (Map.Entry<String, Datum> _iter373 : struct.record.entrySet())
          {
