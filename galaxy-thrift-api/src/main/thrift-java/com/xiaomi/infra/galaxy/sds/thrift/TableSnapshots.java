...
public class TableSnapshots implements libthrift091.TBase<TableSnapshots, TableSnapshots._Fields>, java.io.Serializable, Cloneable, Comparable<TableSnapshots> {
  ...
  private static final libthrift091.protocol.TField COLD_STAND_BY_SNAPSHOTS_FIELD_DESC = new libthrift091.protocol.TField("coldStandBySnapshots", libthrift091.protocol.TType.LIST, (short)5);
   ...
   * 冷备生成的快照
   */
  public List<Snapshot> coldStandBySnapshots; // optional
  ...
  public enum _Fields implements libthrift091.TFieldIdEnum {
     ...
     * 冷备生成的快照
     */
    COLD_STAND_BY_SNAPSHOTS((short)5, "coldStandBySnapshots");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 5: // COLD_STAND_BY_SNAPSHOTS
  ...
  private static final _Fields optionals[] = {_Fields.TABLE_NAME,_Fields.SYS_SNAPSHOTS,_Fields.USER_SNAPSHOTS,_Fields.PITR_SNAPSHOTS,_Fields.COLD_STAND_BY_SNAPSHOTS};
  ...
  static {
    ...
    tmpMap.put(_Fields.PITR_SNAPSHOTS, new libthrift091.meta_data.FieldMetaData("pitrSnapshots", libthrift091.TFieldRequirementType.OPTIONAL, 
        new libthrift091.meta_data.ListMetaData(libthrift091.protocol.TType.LIST, 
            new libthrift091.meta_data.StructMetaData(libthrift091.protocol.TType.STRUCT, Snapshot.class))));
    tmpMap.put(_Fields.COLD_STAND_BY_SNAPSHOTS, new libthrift091.meta_data.FieldMetaData("coldStandBySnapshots", libthrift091.TFieldRequirementType.OPTIONAL, 
        new libthrift091.meta_data.ListMetaData(libthrift091.protocol.TType.LIST, 
            new libthrift091.meta_data.StructMetaData(libthrift091.protocol.TType.STRUCT, Snapshot.class))));
  ...
  public TableSnapshots(TableSnapshots other) {
    ...
    if (other.isSetColdStandBySnapshots()) {
      List<Snapshot> __this__coldStandBySnapshots = new ArrayList<Snapshot>(other.coldStandBySnapshots.size());
      for (Snapshot other_element : other.coldStandBySnapshots) {
        __this__coldStandBySnapshots.add(new Snapshot(other_element));
      }
      this.coldStandBySnapshots = __this__coldStandBySnapshots;
    }
  }
  ...
  public int getColdStandBySnapshotsSize() {
    return (this.coldStandBySnapshots == null) ? 0 : this.coldStandBySnapshots.size();
  }

  public java.util.Iterator<Snapshot> getColdStandBySnapshotsIterator() {
    return (this.coldStandBySnapshots == null) ? null : this.coldStandBySnapshots.iterator();
  }

  public void addToColdStandBySnapshots(Snapshot elem) {
    if (this.coldStandBySnapshots == null) {
      this.coldStandBySnapshots = new ArrayList<Snapshot>();
    }
    this.coldStandBySnapshots.add(elem);
  }
   ...
   * 冷备生成的快照
   */
  public TableSnapshots setColdStandBySnapshots(List<Snapshot> coldStandBySnapshots) {
    this.coldStandBySnapshots = coldStandBySnapshots;
    return this;
  }
  ...
  /** Returns true if field coldStandBySnapshots is set (has been assigned a value) and false otherwise */
  public boolean isSetColdStandBySnapshots() {
    return this.coldStandBySnapshots != null;
  }

  public void setColdStandBySnapshotsIsSet(boolean value) {
    if (!value) {
      this.coldStandBySnapshots = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case COLD_STAND_BY_SNAPSHOTS:
      if (value == null) {
        ...
        setColdStandBySnapshots((List<Snapshot>)value);
      }
      break;
  ...
  public boolean equals(TableSnapshots that) {
    ...
    boolean this_present_coldStandBySnapshots = true && this.isSetColdStandBySnapshots();
    boolean that_present_coldStandBySnapshots = true && that.isSetColdStandBySnapshots();
    if (this_present_coldStandBySnapshots || that_present_coldStandBySnapshots) {
      if (!(this_present_coldStandBySnapshots && that_present_coldStandBySnapshots))
        return false;
      if (!this.coldStandBySnapshots.equals(that.coldStandBySnapshots))
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_coldStandBySnapshots = true && (isSetColdStandBySnapshots());
    list.add(present_coldStandBySnapshots);
    if (present_coldStandBySnapshots)
      list.add(coldStandBySnapshots);
  ...
  public int compareTo(TableSnapshots other) {
    ...
    lastComparison = Boolean.valueOf(isSetColdStandBySnapshots()).compareTo(other.isSetColdStandBySnapshots());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetColdStandBySnapshots()) {
      lastComparison = libthrift091.TBaseHelper.compareTo(this.coldStandBySnapshots, other.coldStandBySnapshots);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class TableSnapshotsStandardScheme extends StandardScheme<TableSnapshots> {
            ...
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                ...
                struct.coldStandBySnapshots = new ArrayList<Snapshot>(_list47.size);
                Snapshot _elem48;
                for (int _i49 = 0; _i49 < _list47.size; ++_i49)
                {
                  _elem48 = new Snapshot();
                  _elem48.read(iprot);
                  struct.coldStandBySnapshots.add(_elem48);
                }
                iprot.readListEnd();
              }
              struct.setColdStandBySnapshotsIsSet(true);
            } else { 
              libthrift091.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(libthrift091.protocol.TProtocol oprot, TableSnapshots struct) throws libthrift091.TException {
      ...
      if (struct.coldStandBySnapshots != null) {
        if (struct.isSetColdStandBySnapshots()) {
          oprot.writeFieldBegin(COLD_STAND_BY_SNAPSHOTS_FIELD_DESC);
          {
            oprot.writeListBegin(new libthrift091.protocol.TList(libthrift091.protocol.TType.STRUCT, struct.coldStandBySnapshots.size()));
            for (Snapshot _iter53 : struct.coldStandBySnapshots)
            {
              _iter53.write(oprot);
            }
            oprot.writeListEnd();
  ...
  private static class TableSnapshotsTupleScheme extends TupleScheme<TableSnapshots> {
    ...
    public void write(libthrift091.protocol.TProtocol prot, TableSnapshots struct) throws libthrift091.TException {
      ...
      if (struct.isSetSysSnapshots()) {
        {
          ...
          for (Snapshot _iter54 : struct.sysSnapshots)
          {
            _iter54.write(oprot);
          }
        }
      ...
      if (struct.isSetUserSnapshots()) {
        {
          ...
          for (Snapshot _iter55 : struct.userSnapshots)
          {
            _iter55.write(oprot);
          }
        }
      ...
      if (struct.isSetPitrSnapshots()) {
        {
          ...
          for (Snapshot _iter56 : struct.pitrSnapshots)
          {
            _iter56.write(oprot);
          }
        }
      ...
      if (struct.isSetColdStandBySnapshots()) {
        {
          oprot.writeI32(struct.coldStandBySnapshots.size());
          for (Snapshot _iter57 : struct.coldStandBySnapshots)
          {
            _iter57.write(oprot);
          }
        }
    ...
    public void read(libthrift091.protocol.TProtocol prot, TableSnapshots struct) throws libthrift091.TException {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.sysSnapshots = new ArrayList<Snapshot>(_list58.size);
          Snapshot _elem59;
          for (int _i60 = 0; _i60 < _list58.size; ++_i60)
          {
            _elem59 = new Snapshot();
            _elem59.read(iprot);
            struct.sysSnapshots.add(_elem59);
          }
        }
        struct.setSysSnapshotsIsSet(true);
      }
      if (incoming.get(2)) {
        {
          ...
          struct.userSnapshots = new ArrayList<Snapshot>(_list61.size);
          Snapshot _elem62;
          for (int _i63 = 0; _i63 < _list61.size; ++_i63)
          {
            _elem62 = new Snapshot();
            _elem62.read(iprot);
            struct.userSnapshots.add(_elem62);
          }
        }
        struct.setUserSnapshotsIsSet(true);
      }
      if (incoming.get(3)) {
        {
          libthrift091.protocol.TList _list64 = new libthrift091.protocol.TList(libthrift091.protocol.TType.STRUCT, iprot.readI32());
          struct.pitrSnapshots = new ArrayList<Snapshot>(_list64.size);
          Snapshot _elem65;
          for (int _i66 = 0; _i66 < _list64.size; ++_i66)
          {
            _elem65 = new Snapshot();
            _elem65.read(iprot);
            struct.pitrSnapshots.add(_elem65);
          }
        }
        struct.setPitrSnapshotsIsSet(true);
      }
      if (incoming.get(4)) {
        {
          ...
          struct.coldStandBySnapshots = new ArrayList<Snapshot>(_list67.size);
          Snapshot _elem68;
          for (int _i69 = 0; _i69 < _list67.size; ++_i69)
          {
            _elem68 = new Snapshot();
            _elem68.read(iprot);
            struct.coldStandBySnapshots.add(_elem68);
          }
        }
        struct.setColdStandBySnapshotsIsSet(true);
      }
