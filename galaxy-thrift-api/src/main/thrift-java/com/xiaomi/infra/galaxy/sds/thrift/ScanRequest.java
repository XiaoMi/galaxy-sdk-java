...
public class ScanRequest implements libthrift091.TBase<ScanRequest, ScanRequest._Fields>, java.io.Serializable, Cloneable, Comparable<ScanRequest> {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 14: // INITIAL_START_KEY
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                libthrift091.protocol.TMap _map251 = iprot.readMapBegin();
                struct.initialStartKey = new HashMap<String,Datum>(2*_map251.size);
                String _key252;
                Datum _val253;
                for (int _i254 = 0; _i254 < _map251.size; ++_i254)
                {
                  ...
                  _val253 = new Datum();
                  _val253.read(iprot);
                  struct.initialStartKey.put(_key252, _val253);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.startKey != null) {
        if (struct.isSetStartKey()) {
          oprot.writeFieldBegin(START_KEY_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Datum> _iter255 : struct.startKey.entrySet())
            {
      ...
      if (struct.stopKey != null) {
        if (struct.isSetStopKey()) {
          oprot.writeFieldBegin(STOP_KEY_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Datum> _iter256 : struct.stopKey.entrySet())
            {
      ...
      if (struct.attributes != null) {
        if (struct.isSetAttributes()) {
          oprot.writeFieldBegin(ATTRIBUTES_FIELD_DESC);
          {
            ...
            for (String _iter257 : struct.attributes)
            {
      ...
      if (struct.initialStartKey != null) {
        if (struct.isSetInitialStartKey()) {
          oprot.writeFieldBegin(INITIAL_START_KEY_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Datum> _iter258 : struct.initialStartKey.entrySet())
            {
  ...
  private static class ScanRequestTupleScheme extends TupleScheme<ScanRequest> {
      ...
      if (struct.isSetStartKey()) {
        {
          ...
          for (Map.Entry<String, Datum> _iter259 : struct.startKey.entrySet())
          {
      ...
      if (struct.isSetStopKey()) {
        {
          ...
          for (Map.Entry<String, Datum> _iter260 : struct.stopKey.entrySet())
          {
      ...
      if (struct.isSetAttributes()) {
        {
          ...
          for (String _iter261 : struct.attributes)
          {
      ...
      if (struct.isSetInitialStartKey()) {
        {
          ...
          for (Map.Entry<String, Datum> _iter262 : struct.initialStartKey.entrySet())
          {
    ...
    public void read(libthrift091.protocol.TProtocol prot, ScanRequest struct) throws libthrift091.TException {
      ...
      if (incoming.get(2)) {
        {
          libthrift091.protocol.TMap _map263 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.STRUCT, iprot.readI32());
          struct.startKey = new HashMap<String,Datum>(2*_map263.size);
          String _key264;
          Datum _val265;
          for (int _i266 = 0; _i266 < _map263.size; ++_i266)
          {
            ...
            _val265 = new Datum();
            _val265.read(iprot);
            struct.startKey.put(_key264, _val265);
          }
        }
        struct.setStartKeyIsSet(true);
      }
      if (incoming.get(3)) {
        {
          libthrift091.protocol.TMap _map267 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.STRUCT, iprot.readI32());
          struct.stopKey = new HashMap<String,Datum>(2*_map267.size);
          String _key268;
          Datum _val269;
          for (int _i270 = 0; _i270 < _map267.size; ++_i270)
          {
            ...
            _val269 = new Datum();
            _val269.read(iprot);
            struct.stopKey.put(_key268, _val269);
          }
        }
        struct.setStopKeyIsSet(true);
      }
      if (incoming.get(4)) {
        {
          libthrift091.protocol.TList _list271 = new libthrift091.protocol.TList(libthrift091.protocol.TType.STRING, iprot.readI32());
          struct.attributes = new ArrayList<String>(_list271.size);
          String _elem272;
          for (int _i273 = 0; _i273 < _list271.size; ++_i273)
          {
            _elem272 = iprot.readString();
            struct.attributes.add(_elem272);
          }
        }
        struct.setAttributesIsSet(true);
      }
      ...
      if (incoming.get(13)) {
        {
          libthrift091.protocol.TMap _map274 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.STRUCT, iprot.readI32());
          struct.initialStartKey = new HashMap<String,Datum>(2*_map274.size);
          String _key275;
          Datum _val276;
          for (int _i277 = 0; _i277 < _map274.size; ++_i277)
          {
            ...
            _val276 = new Datum();
            _val276.read(iprot);
            struct.initialStartKey.put(_key275, _val276);
          }
        }
        struct.setInitialStartKeyIsSet(true);
      }
