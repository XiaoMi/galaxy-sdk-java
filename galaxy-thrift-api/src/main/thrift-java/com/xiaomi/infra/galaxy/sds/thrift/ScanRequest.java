...
public class ScanRequest implements libthrift091.TBase<ScanRequest, ScanRequest._Fields>, java.io.Serializable, Cloneable, Comparable<ScanRequest> {
        ...
        switch (schemeField.id) {
          ...
          case 3: // START_KEY
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                libthrift091.protocol.TMap _map302 = iprot.readMapBegin();
                struct.startKey = new HashMap<String,Datum>(2*_map302.size);
                String _key303;
                Datum _val304;
                for (int _i305 = 0; _i305 < _map302.size; ++_i305)
                {
                  ...
                  _val304 = new Datum();
                  _val304.read(iprot);
                  struct.startKey.put(_key303, _val304);
                }
                iprot.readMapEnd();
              }
          ...
          case 4: // STOP_KEY
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                libthrift091.protocol.TMap _map306 = iprot.readMapBegin();
                struct.stopKey = new HashMap<String,Datum>(2*_map306.size);
                String _key307;
                Datum _val308;
                for (int _i309 = 0; _i309 < _map306.size; ++_i309)
                {
                  ...
                  _val308 = new Datum();
                  _val308.read(iprot);
                  struct.stopKey.put(_key307, _val308);
                }
                iprot.readMapEnd();
              }
          ...
          case 5: // ATTRIBUTES
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                libthrift091.protocol.TList _list310 = iprot.readListBegin();
                struct.attributes = new ArrayList<String>(_list310.size);
                String _elem311;
                for (int _i312 = 0; _i312 < _list310.size; ++_i312)
                {
                  _elem311 = iprot.readString();
                  struct.attributes.add(_elem311);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.startKey != null) {
        if (struct.isSetStartKey()) {
          oprot.writeFieldBegin(START_KEY_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Datum> _iter313 : struct.startKey.entrySet())
            {
      ...
      if (struct.stopKey != null) {
        if (struct.isSetStopKey()) {
          oprot.writeFieldBegin(STOP_KEY_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Datum> _iter314 : struct.stopKey.entrySet())
            {
      ...
      if (struct.attributes != null) {
        if (struct.isSetAttributes()) {
          oprot.writeFieldBegin(ATTRIBUTES_FIELD_DESC);
          {
            ...
            for (String _iter315 : struct.attributes)
            {
  ...
  private static class ScanRequestTupleScheme extends TupleScheme<ScanRequest> {
      ...
      if (struct.isSetStartKey()) {
        {
          ...
          for (Map.Entry<String, Datum> _iter316 : struct.startKey.entrySet())
          {
      ...
      if (struct.isSetStopKey()) {
        {
          ...
          for (Map.Entry<String, Datum> _iter317 : struct.stopKey.entrySet())
          {
      ...
      if (struct.isSetAttributes()) {
        {
          ...
          for (String _iter318 : struct.attributes)
          {
    ...
    public void read(libthrift091.protocol.TProtocol prot, ScanRequest struct) throws libthrift091.TException {
      ...
      if (incoming.get(2)) {
        {
          libthrift091.protocol.TMap _map319 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.STRUCT, iprot.readI32());
          struct.startKey = new HashMap<String,Datum>(2*_map319.size);
          String _key320;
          Datum _val321;
          for (int _i322 = 0; _i322 < _map319.size; ++_i322)
          {
            ...
            _val321 = new Datum();
            _val321.read(iprot);
            struct.startKey.put(_key320, _val321);
          }
        }
        struct.setStartKeyIsSet(true);
      }
      if (incoming.get(3)) {
        {
          libthrift091.protocol.TMap _map323 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.STRUCT, iprot.readI32());
          struct.stopKey = new HashMap<String,Datum>(2*_map323.size);
          String _key324;
          Datum _val325;
          for (int _i326 = 0; _i326 < _map323.size; ++_i326)
          {
            ...
            _val325 = new Datum();
            _val325.read(iprot);
            struct.stopKey.put(_key324, _val325);
          }
        }
        struct.setStopKeyIsSet(true);
      }
      if (incoming.get(4)) {
        {
          libthrift091.protocol.TList _list327 = new libthrift091.protocol.TList(libthrift091.protocol.TType.STRING, iprot.readI32());
          struct.attributes = new ArrayList<String>(_list327.size);
          String _elem328;
          for (int _i329 = 0; _i329 < _list327.size; ++_i329)
          {
            _elem328 = iprot.readString();
            struct.attributes.add(_elem328);
          }
        }
        struct.setAttributesIsSet(true);
      }
