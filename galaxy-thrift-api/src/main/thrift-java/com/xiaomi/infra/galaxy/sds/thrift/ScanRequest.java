...
public class ScanRequest implements libthrift091.TBase<ScanRequest, ScanRequest._Fields>, java.io.Serializable, Cloneable, Comparable<ScanRequest> {
  ...
  private _Fields optionals[] = {_Fields.INDEX_NAME,_Fields.START_KEY,_Fields.STOP_KEY,_Fields.ATTRIBUTES,_Fields.CONDITION,_Fields.LIMIT,_Fields.REVERSE,_Fields.IN_GLOBAL_ORDER,_Fields.CACHE_RESULT};
            ...
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                ...
                for (int _i241 = 0; _i241 < _map240.size; ++_i241)
                {
                  ...
                  _val243 = new Datum();
                  _val243.read(iprot);
                  struct.startKey.put(_key242, _val243);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                ...
                for (int _i245 = 0; _i245 < _map244.size; ++_i245)
                {
                  ...
                  _val247 = new Datum();
                  _val247.read(iprot);
                  struct.stopKey.put(_key246, _val247);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                ...
                for (int _i249 = 0; _i249 < _list248.size; ++_i249)
                {
                  ...
                  struct.attributes.add(_elem250);
                }
                iprot.readListEnd();
              }
