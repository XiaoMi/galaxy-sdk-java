...
public class ScanRequest implements libthrift091.TBase<ScanRequest, ScanRequest._Fields>, java.io.Serializable, Cloneable, Comparable<ScanRequest> {
  ...
  public enum _Fields implements libthrift091.TFieldIdEnum {
     ...
     * 扫描表分片的索引，对salted table全局无序扫描时设置
     */
    SPLIT_INDEX((short)13, "splitIndex"),
    /**
     * 查询范围开始的初始值，对salted table全局无序扫描时设置
     */
  ...
  static {
    ...
    tmpMap.put(_Fields.SPLIT_INDEX, new libthrift091.meta_data.FieldMetaData("splitIndex", libthrift091.TFieldRequirementType.OPTIONAL, 
        new libthrift091.meta_data.FieldValueMetaData(libthrift091.protocol.TType.I32)));
   ...
   * 扫描表分片的索引，对salted table全局无序扫描时设置
   */
  public ScanRequest setSplitIndex(int splitIndex) {
  ...
  public int getInitialStartKeySize() {
    return (this.initialStartKey == null) ? 0 : this.initialStartKey.size();
  }

  public void putToInitialStartKey(String key, Datum val) {
    if (this.initialStartKey == null) {
      this.initialStartKey = new HashMap<String,Datum>();
    }
    this.initialStartKey.put(key, val);
  }

  /**
   * 查询范围开始的初始值，对salted table全局无序扫描时设置
   */
  public Map<String,Datum> getInitialStartKey() {
    return this.initialStartKey;
  }

  /**
   * 查询范围开始的初始值，对salted table全局无序扫描时设置
   */
  public ScanRequest setInitialStartKey(Map<String,Datum> initialStartKey) {
    this.initialStartKey = initialStartKey;
    return this;
  }

  public void unsetInitialStartKey() {
    this.initialStartKey = null;
  }

  /** Returns true if field initialStartKey is set (has been assigned a value) and false otherwise */
  public boolean isSetInitialStartKey() {
    return this.initialStartKey != null;
  }

  public void setInitialStartKeyIsSet(boolean value) {
    if (!value) {
      this.initialStartKey = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case INITIAL_START_KEY:
      if (value == null) {
        unsetInitialStartKey();
      } else {
        setInitialStartKey((Map<String,Datum>)value);
      }
      break;
  ...
  public boolean equals(ScanRequest that) {
    ...
    boolean this_present_initialStartKey = true && this.isSetInitialStartKey();
    boolean that_present_initialStartKey = true && that.isSetInitialStartKey();
    if (this_present_initialStartKey || that_present_initialStartKey) {
      if (!(this_present_initialStartKey && that_present_initialStartKey))
        return false;
      if (!this.initialStartKey.equals(that.initialStartKey))
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_initialStartKey = true && (isSetInitialStartKey());
  ...
  public int compareTo(ScanRequest other) {
    ...
    if (isSetSplitIndex()) {
      lastComparison = libthrift091.TBaseHelper.compareTo(this.splitIndex, other.splitIndex);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetInitialStartKey()).compareTo(other.isSetInitialStartKey());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetInitialStartKey()) {
      lastComparison = libthrift091.TBaseHelper.compareTo(this.initialStartKey, other.initialStartKey);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class ScanRequestStandardScheme extends StandardScheme<ScanRequest> {
        ...
        switch (schemeField.id) {
          ...
          case 3: // START_KEY
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                libthrift091.protocol.TMap _map260 = iprot.readMapBegin();
                struct.startKey = new HashMap<String,Datum>(2*_map260.size);
                String _key261;
                Datum _val262;
                for (int _i263 = 0; _i263 < _map260.size; ++_i263)
                {
                  ...
                  _val262 = new Datum();
                  _val262.read(iprot);
                  struct.startKey.put(_key261, _val262);
                }
                iprot.readMapEnd();
              }
          ...
          case 4: // STOP_KEY
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                libthrift091.protocol.TMap _map264 = iprot.readMapBegin();
                struct.stopKey = new HashMap<String,Datum>(2*_map264.size);
                String _key265;
                Datum _val266;
                for (int _i267 = 0; _i267 < _map264.size; ++_i267)
                {
                  ...
                  _val266 = new Datum();
                  _val266.read(iprot);
                  struct.stopKey.put(_key265, _val266);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                ...
                struct.attributes = new ArrayList<String>(_list268.size);
                String _elem269;
                for (int _i270 = 0; _i270 < _list268.size; ++_i270)
                {
                  _elem269 = iprot.readString();
                  struct.attributes.add(_elem269);
                }
                iprot.readListEnd();
              }
          ...
          case 14: // INITIAL_START_KEY
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                libthrift091.protocol.TMap _map271 = iprot.readMapBegin();
                struct.initialStartKey = new HashMap<String,Datum>(2*_map271.size);
                String _key272;
                Datum _val273;
                for (int _i274 = 0; _i274 < _map271.size; ++_i274)
                {
                  ...
                  _val273 = new Datum();
                  _val273.read(iprot);
                  struct.initialStartKey.put(_key272, _val273);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(libthrift091.protocol.TProtocol oprot, ScanRequest struct) throws libthrift091.TException {
      ...
      if (struct.startKey != null) {
        if (struct.isSetStartKey()) {
          oprot.writeFieldBegin(START_KEY_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Datum> _iter275 : struct.startKey.entrySet())
            {
      ...
      if (struct.stopKey != null) {
        if (struct.isSetStopKey()) {
          oprot.writeFieldBegin(STOP_KEY_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Datum> _iter276 : struct.stopKey.entrySet())
            {
      ...
      if (struct.attributes != null) {
        if (struct.isSetAttributes()) {
          oprot.writeFieldBegin(ATTRIBUTES_FIELD_DESC);
          {
            ...
            for (String _iter277 : struct.attributes)
            {
      ...
      if (struct.initialStartKey != null) {
        if (struct.isSetInitialStartKey()) {
          oprot.writeFieldBegin(INITIAL_START_KEY_FIELD_DESC);
          {
            oprot.writeMapBegin(new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.STRUCT, struct.initialStartKey.size()));
            for (Map.Entry<String, Datum> _iter278 : struct.initialStartKey.entrySet())
            {
  ...
  private static class ScanRequestTupleScheme extends TupleScheme<ScanRequest> {
    ...
    public void write(libthrift091.protocol.TProtocol prot, ScanRequest struct) throws libthrift091.TException {
      ...
      if (struct.isSetStartKey()) {
        {
          ...
          for (Map.Entry<String, Datum> _iter279 : struct.startKey.entrySet())
          {
      ...
      if (struct.isSetStopKey()) {
        {
          ...
          for (Map.Entry<String, Datum> _iter280 : struct.stopKey.entrySet())
          {
      ...
      if (struct.isSetAttributes()) {
        {
          ...
          for (String _iter281 : struct.attributes)
          {
      ...
      if (struct.isSetInitialStartKey()) {
        {
          oprot.writeI32(struct.initialStartKey.size());
          for (Map.Entry<String, Datum> _iter282 : struct.initialStartKey.entrySet())
          {
    ...
    public void read(libthrift091.protocol.TProtocol prot, ScanRequest struct) throws libthrift091.TException {
      ...
      if (incoming.get(2)) {
        {
          libthrift091.protocol.TMap _map283 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.STRUCT, iprot.readI32());
          struct.startKey = new HashMap<String,Datum>(2*_map283.size);
          String _key284;
          Datum _val285;
          for (int _i286 = 0; _i286 < _map283.size; ++_i286)
          {
            ...
            _val285 = new Datum();
            _val285.read(iprot);
            struct.startKey.put(_key284, _val285);
          }
        }
        struct.setStartKeyIsSet(true);
      }
      if (incoming.get(3)) {
        {
          libthrift091.protocol.TMap _map287 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.STRUCT, iprot.readI32());
          struct.stopKey = new HashMap<String,Datum>(2*_map287.size);
          String _key288;
          Datum _val289;
          for (int _i290 = 0; _i290 < _map287.size; ++_i290)
          {
            ...
            _val289 = new Datum();
            _val289.read(iprot);
            struct.stopKey.put(_key288, _val289);
          }
        }
        struct.setStopKeyIsSet(true);
      }
      if (incoming.get(4)) {
        {
          libthrift091.protocol.TList _list291 = new libthrift091.protocol.TList(libthrift091.protocol.TType.STRING, iprot.readI32());
          struct.attributes = new ArrayList<String>(_list291.size);
          String _elem292;
          for (int _i293 = 0; _i293 < _list291.size; ++_i293)
          {
            _elem292 = iprot.readString();
            struct.attributes.add(_elem292);
          }
        }
        struct.setAttributesIsSet(true);
      }
      ...
      if (incoming.get(13)) {
        {
          libthrift091.protocol.TMap _map294 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.STRUCT, iprot.readI32());
          struct.initialStartKey = new HashMap<String,Datum>(2*_map294.size);
          String _key295;
          Datum _val296;
          for (int _i297 = 0; _i297 < _map294.size; ++_i297)
          {
            ...
            _val296 = new Datum();
            _val296.read(iprot);
            struct.initialStartKey.put(_key295, _val296);
          }
        }
        struct.setInitialStartKeyIsSet(true);
      }
