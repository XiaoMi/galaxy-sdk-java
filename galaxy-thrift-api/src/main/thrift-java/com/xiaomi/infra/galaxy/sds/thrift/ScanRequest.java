...
public class ScanRequest implements libthrift091.TBase<ScanRequest, ScanRequest._Fields>, java.io.Serializable, Cloneable, Comparable<ScanRequest> {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                ...
                struct.startKey = new HashMap<String,Datum>(2*_map258.size);
                String _key259;
                Datum _val260;
                for (int _i261 = 0; _i261 < _map258.size; ++_i261)
                {
                  ...
                  _val260 = new Datum();
                  _val260.read(iprot);
                  struct.startKey.put(_key259, _val260);
                }
                iprot.readMapEnd();
              }
          ...
          case 4: // STOP_KEY
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                libthrift091.protocol.TMap _map262 = iprot.readMapBegin();
                struct.stopKey = new HashMap<String,Datum>(2*_map262.size);
                String _key263;
                Datum _val264;
                for (int _i265 = 0; _i265 < _map262.size; ++_i265)
                {
                  ...
                  _val264 = new Datum();
                  _val264.read(iprot);
                  struct.stopKey.put(_key263, _val264);
                }
                iprot.readMapEnd();
              }
          ...
          case 5: // ATTRIBUTES
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                libthrift091.protocol.TList _list266 = iprot.readListBegin();
                struct.attributes = new ArrayList<String>(_list266.size);
                String _elem267;
                for (int _i268 = 0; _i268 < _list266.size; ++_i268)
                {
                  _elem267 = iprot.readString();
                  struct.attributes.add(_elem267);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.startKey != null) {
        if (struct.isSetStartKey()) {
          oprot.writeFieldBegin(START_KEY_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Datum> _iter269 : struct.startKey.entrySet())
            {
      ...
      if (struct.stopKey != null) {
        if (struct.isSetStopKey()) {
          oprot.writeFieldBegin(STOP_KEY_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Datum> _iter270 : struct.stopKey.entrySet())
            {
      ...
      if (struct.attributes != null) {
        if (struct.isSetAttributes()) {
          oprot.writeFieldBegin(ATTRIBUTES_FIELD_DESC);
          {
            ...
            for (String _iter271 : struct.attributes)
            {
  ...
  private static class ScanRequestTupleScheme extends TupleScheme<ScanRequest> {
      ...
      if (struct.isSetStartKey()) {
        {
          ...
          for (Map.Entry<String, Datum> _iter272 : struct.startKey.entrySet())
          {
      ...
      if (struct.isSetStopKey()) {
        {
          ...
          for (Map.Entry<String, Datum> _iter273 : struct.stopKey.entrySet())
          {
      ...
      if (struct.isSetAttributes()) {
        {
          ...
          for (String _iter274 : struct.attributes)
          {
    ...
    public void read(libthrift091.protocol.TProtocol prot, ScanRequest struct) throws libthrift091.TException {
      ...
      if (incoming.get(2)) {
        {
          libthrift091.protocol.TMap _map275 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.STRUCT, iprot.readI32());
          struct.startKey = new HashMap<String,Datum>(2*_map275.size);
          String _key276;
          Datum _val277;
          for (int _i278 = 0; _i278 < _map275.size; ++_i278)
          {
            ...
            _val277 = new Datum();
            _val277.read(iprot);
            struct.startKey.put(_key276, _val277);
          }
        }
        struct.setStartKeyIsSet(true);
      }
      if (incoming.get(3)) {
        {
          libthrift091.protocol.TMap _map279 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.STRUCT, iprot.readI32());
          struct.stopKey = new HashMap<String,Datum>(2*_map279.size);
          String _key280;
          Datum _val281;
          for (int _i282 = 0; _i282 < _map279.size; ++_i282)
          {
            ...
            _val281 = new Datum();
            _val281.read(iprot);
            struct.stopKey.put(_key280, _val281);
          }
        }
        struct.setStopKeyIsSet(true);
      }
      if (incoming.get(4)) {
        {
          libthrift091.protocol.TList _list283 = new libthrift091.protocol.TList(libthrift091.protocol.TType.STRING, iprot.readI32());
          struct.attributes = new ArrayList<String>(_list283.size);
          String _elem284;
          for (int _i285 = 0; _i285 < _list283.size; ++_i285)
          {
            _elem284 = iprot.readString();
            struct.attributes.add(_elem284);
          }
        }
        struct.setAttributesIsSet(true);
      }
