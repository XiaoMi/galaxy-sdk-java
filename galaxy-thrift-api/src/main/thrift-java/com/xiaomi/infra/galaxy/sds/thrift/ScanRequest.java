...
public class ScanRequest implements libthrift091.TBase<ScanRequest, ScanRequest._Fields>, java.io.Serializable, Cloneable, Comparable<ScanRequest> {
        ...
        switch (schemeField.id) {
          ...
          case 3: // START_KEY
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                libthrift091.protocol.TMap _map276 = iprot.readMapBegin();
                struct.startKey = new HashMap<String,Datum>(2*_map276.size);
                String _key277;
                Datum _val278;
                for (int _i279 = 0; _i279 < _map276.size; ++_i279)
                {
                  ...
                  _val278 = new Datum();
                  _val278.read(iprot);
                  struct.startKey.put(_key277, _val278);
                }
                iprot.readMapEnd();
              }
          ...
          case 4: // STOP_KEY
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                libthrift091.protocol.TMap _map280 = iprot.readMapBegin();
                struct.stopKey = new HashMap<String,Datum>(2*_map280.size);
                String _key281;
                Datum _val282;
                for (int _i283 = 0; _i283 < _map280.size; ++_i283)
                {
                  ...
                  _val282 = new Datum();
                  _val282.read(iprot);
                  struct.stopKey.put(_key281, _val282);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                ...
                struct.attributes = new ArrayList<String>(_list284.size);
                String _elem285;
                for (int _i286 = 0; _i286 < _list284.size; ++_i286)
                {
                  _elem285 = iprot.readString();
                  struct.attributes.add(_elem285);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.startKey != null) {
        if (struct.isSetStartKey()) {
          oprot.writeFieldBegin(START_KEY_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Datum> _iter287 : struct.startKey.entrySet())
            {
      ...
      if (struct.stopKey != null) {
        if (struct.isSetStopKey()) {
          oprot.writeFieldBegin(STOP_KEY_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Datum> _iter288 : struct.stopKey.entrySet())
            {
      ...
      if (struct.attributes != null) {
        if (struct.isSetAttributes()) {
          oprot.writeFieldBegin(ATTRIBUTES_FIELD_DESC);
          {
            ...
            for (String _iter289 : struct.attributes)
            {
  ...
  private static class ScanRequestTupleScheme extends TupleScheme<ScanRequest> {
      ...
      if (struct.isSetStartKey()) {
        {
          ...
          for (Map.Entry<String, Datum> _iter290 : struct.startKey.entrySet())
          {
      ...
      if (struct.isSetStopKey()) {
        {
          ...
          for (Map.Entry<String, Datum> _iter291 : struct.stopKey.entrySet())
          {
      ...
      if (struct.isSetAttributes()) {
        {
          ...
          for (String _iter292 : struct.attributes)
          {
    ...
    public void read(libthrift091.protocol.TProtocol prot, ScanRequest struct) throws libthrift091.TException {
      ...
      if (incoming.get(2)) {
        {
          libthrift091.protocol.TMap _map293 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.STRUCT, iprot.readI32());
          struct.startKey = new HashMap<String,Datum>(2*_map293.size);
          String _key294;
          Datum _val295;
          for (int _i296 = 0; _i296 < _map293.size; ++_i296)
          {
            ...
            _val295 = new Datum();
            _val295.read(iprot);
            struct.startKey.put(_key294, _val295);
          }
        }
        struct.setStartKeyIsSet(true);
      }
      if (incoming.get(3)) {
        {
          libthrift091.protocol.TMap _map297 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.STRUCT, iprot.readI32());
          struct.stopKey = new HashMap<String,Datum>(2*_map297.size);
          String _key298;
          Datum _val299;
          for (int _i300 = 0; _i300 < _map297.size; ++_i300)
          {
            ...
            _val299 = new Datum();
            _val299.read(iprot);
            struct.stopKey.put(_key298, _val299);
          }
        }
        struct.setStopKeyIsSet(true);
      }
      if (incoming.get(4)) {
        {
          libthrift091.protocol.TList _list301 = new libthrift091.protocol.TList(libthrift091.protocol.TType.STRING, iprot.readI32());
          struct.attributes = new ArrayList<String>(_list301.size);
          String _elem302;
