            ...
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                ...
                struct.successful = new ArrayList<SendMessageBatchResponseEntry>(_list0.size);
                SendMessageBatchResponseEntry _elem1;
                for (int _i2 = 0; _i2 < _list0.size; ++_i2)
                {
                  _elem1 = new SendMessageBatchResponseEntry();
                  _elem1.read(iprot);
                  struct.successful.add(_elem1);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                ...
                struct.failed = new ArrayList<MessageBatchErrorEntry>(_list3.size);
                MessageBatchErrorEntry _elem4;
                for (int _i5 = 0; _i5 < _list3.size; ++_i5)
                {
                  _elem4 = new MessageBatchErrorEntry();
                  _elem4.read(iprot);
                  struct.failed.add(_elem4);
                }
                iprot.readListEnd();
              }
    ...
    public void write(libthrift091.protocol.TProtocol oprot, SendMessageBatchResponse struct) throws libthrift091.TException {
      ...
      if (struct.successful != null) {
        oprot.writeFieldBegin(SUCCESSFUL_FIELD_DESC);
        {
          ...
          for (SendMessageBatchResponseEntry _iter6 : struct.successful)
          {
            _iter6.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.failed != null) {
        oprot.writeFieldBegin(FAILED_FIELD_DESC);
        {
          ...
          for (MessageBatchErrorEntry _iter7 : struct.failed)
          {
            _iter7.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetSuccessful()) {
        {
          ...
          for (SendMessageBatchResponseEntry _iter8 : struct.successful)
          {
            _iter8.write(oprot);
          }
        }
      ...
      if (struct.isSetFailed()) {
        {
          ...
          for (MessageBatchErrorEntry _iter9 : struct.failed)
          {
            _iter9.write(oprot);
          }
        }
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.successful = new ArrayList<SendMessageBatchResponseEntry>(_list10.size);
          SendMessageBatchResponseEntry _elem11;
          for (int _i12 = 0; _i12 < _list10.size; ++_i12)
          {
            _elem11 = new SendMessageBatchResponseEntry();
            _elem11.read(iprot);
            struct.successful.add(_elem11);
          }
        }
        struct.setSuccessfulIsSet(true);
      }
      if (incoming.get(1)) {
        {
          ...
          struct.failed = new ArrayList<MessageBatchErrorEntry>(_list13.size);
          MessageBatchErrorEntry _elem14;
          for (int _i15 = 0; _i15 < _list13.size; ++_i15)
          {
            _elem14 = new MessageBatchErrorEntry();
            _elem14.read(iprot);
            struct.failed.add(_elem14);
          }
        }
        struct.setFailedIsSet(true);
      }
