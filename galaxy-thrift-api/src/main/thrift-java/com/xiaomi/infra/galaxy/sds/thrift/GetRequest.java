...
public class GetRequest implements libthrift091.TBase<GetRequest, GetRequest._Fields>, java.io.Serializable, Cloneable, Comparable<GetRequest> {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                ...
                struct.keys = new HashMap<String,Datum>(2*_map174.size);
                String _key175;
                Datum _val176;
                for (int _i177 = 0; _i177 < _map174.size; ++_i177)
                {
                  ...
                  _val176 = new Datum();
                  _val176.read(iprot);
                  struct.keys.put(_key175, _val176);
                }
                iprot.readMapEnd();
              }
          ...
          case 3: // ATTRIBUTES
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                libthrift091.protocol.TList _list178 = iprot.readListBegin();
                struct.attributes = new ArrayList<String>(_list178.size);
                String _elem179;
                for (int _i180 = 0; _i180 < _list178.size; ++_i180)
                {
                  _elem179 = iprot.readString();
                  struct.attributes.add(_elem179);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.keys != null) {
        if (struct.isSetKeys()) {
          oprot.writeFieldBegin(KEYS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Datum> _iter181 : struct.keys.entrySet())
            {
      ...
      if (struct.attributes != null) {
        if (struct.isSetAttributes()) {
          oprot.writeFieldBegin(ATTRIBUTES_FIELD_DESC);
          {
            ...
            for (String _iter182 : struct.attributes)
            {
  ...
  private static class GetRequestTupleScheme extends TupleScheme<GetRequest> {
      ...
      if (struct.isSetKeys()) {
        {
          ...
          for (Map.Entry<String, Datum> _iter183 : struct.keys.entrySet())
          {
      ...
      if (struct.isSetAttributes()) {
        {
          ...
          for (String _iter184 : struct.attributes)
          {
    ...
    public void read(libthrift091.protocol.TProtocol prot, GetRequest struct) throws libthrift091.TException {
      ...
      if (incoming.get(1)) {
        {
          libthrift091.protocol.TMap _map185 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.STRUCT, iprot.readI32());
          struct.keys = new HashMap<String,Datum>(2*_map185.size);
          String _key186;
          Datum _val187;
          for (int _i188 = 0; _i188 < _map185.size; ++_i188)
          {
            ...
            _val187 = new Datum();
            _val187.read(iprot);
            struct.keys.put(_key186, _val187);
          }
        }
        struct.setKeysIsSet(true);
      }
      if (incoming.get(2)) {
        {
          libthrift091.protocol.TList _list189 = new libthrift091.protocol.TList(libthrift091.protocol.TType.STRING, iprot.readI32());
          struct.attributes = new ArrayList<String>(_list189.size);
          String _elem190;
          for (int _i191 = 0; _i191 < _list189.size; ++_i191)
          {
            _elem190 = iprot.readString();
            struct.attributes.add(_elem190);
          }
        }
        struct.setAttributesIsSet(true);
      }
