...
public class GetRequest implements libthrift091.TBase<GetRequest, GetRequest._Fields>, java.io.Serializable, Cloneable, Comparable<GetRequest> {
        ...
        switch (schemeField.id) {
          ...
          case 2: // KEYS
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                libthrift091.protocol.TMap _map190 = iprot.readMapBegin();
                struct.keys = new HashMap<String,Datum>(2*_map190.size);
                String _key191;
                Datum _val192;
                for (int _i193 = 0; _i193 < _map190.size; ++_i193)
                {
                  ...
                  _val192 = new Datum();
                  _val192.read(iprot);
                  struct.keys.put(_key191, _val192);
                }
                iprot.readMapEnd();
              }
          ...
          case 3: // ATTRIBUTES
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                libthrift091.protocol.TList _list194 = iprot.readListBegin();
                struct.attributes = new ArrayList<String>(_list194.size);
                String _elem195;
      ...
      if (struct.keys != null) {
        if (struct.isSetKeys()) {
          oprot.writeFieldBegin(KEYS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Datum> _iter197 : struct.keys.entrySet())
            {
      ...
      if (struct.attributes != null) {
        if (struct.isSetAttributes()) {
          oprot.writeFieldBegin(ATTRIBUTES_FIELD_DESC);
          {
            ...
            for (String _iter198 : struct.attributes)
            {
  ...
  private static class GetRequestTupleScheme extends TupleScheme<GetRequest> {
      ...
      if (struct.isSetKeys()) {
        {
          ...
          for (Map.Entry<String, Datum> _iter199 : struct.keys.entrySet())
          {
      ...
      if (struct.isSetAttributes()) {
        {
          ...
          for (String _iter200 : struct.attributes)
          {
    ...
    public void read(libthrift091.protocol.TProtocol prot, GetRequest struct) throws libthrift091.TException {
      ...
      if (incoming.get(1)) {
        {
          libthrift091.protocol.TMap _map201 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.STRUCT, iprot.readI32());
          struct.keys = new HashMap<String,Datum>(2*_map201.size);
          String _key202;
          Datum _val203;
          for (int _i204 = 0; _i204 < _map201.size; ++_i204)
          {
            ...
            _val203 = new Datum();
            _val203.read(iprot);
            struct.keys.put(_key202, _val203);
          }
        }
        struct.setKeysIsSet(true);
      }
      if (incoming.get(2)) {
        {
          libthrift091.protocol.TList _list205 = new libthrift091.protocol.TList(libthrift091.protocol.TType.STRING, iprot.readI32());
          struct.attributes = new ArrayList<String>(_list205.size);
          String _elem206;
