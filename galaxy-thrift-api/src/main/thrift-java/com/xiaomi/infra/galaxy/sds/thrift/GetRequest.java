...
public class GetRequest implements libthrift091.TBase<GetRequest, GetRequest._Fields>, java.io.Serializable, Cloneable, Comparable<GetRequest> {
        ...
        switch (schemeField.id) {
          ...
          case 2: // KEYS
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                libthrift091.protocol.TMap _map172 = iprot.readMapBegin();
                struct.keys = new HashMap<String,Datum>(2*_map172.size);
                String _key173;
                Datum _val174;
                for (int _i175 = 0; _i175 < _map172.size; ++_i175)
                {
                  ...
                  _val174 = new Datum();
                  _val174.read(iprot);
                  struct.keys.put(_key173, _val174);
                }
                iprot.readMapEnd();
              }
          ...
          case 3: // ATTRIBUTES
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                libthrift091.protocol.TList _list176 = iprot.readListBegin();
                struct.attributes = new ArrayList<String>(_list176.size);
                String _elem177;
      ...
      if (struct.keys != null) {
        if (struct.isSetKeys()) {
          oprot.writeFieldBegin(KEYS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Datum> _iter179 : struct.keys.entrySet())
            {
      ...
      if (struct.attributes != null) {
        if (struct.isSetAttributes()) {
          oprot.writeFieldBegin(ATTRIBUTES_FIELD_DESC);
          {
            ...
            for (String _iter180 : struct.attributes)
            {
  ...
  private static class GetRequestTupleScheme extends TupleScheme<GetRequest> {
    ...
    public void read(libthrift091.protocol.TProtocol prot, GetRequest struct) throws libthrift091.TException {
      ...
      if (incoming.get(1)) {
        {
          libthrift091.protocol.TMap _map183 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.STRUCT, iprot.readI32());
          struct.keys = new HashMap<String,Datum>(2*_map183.size);
          String _key184;
          Datum _val185;
          for (int _i186 = 0; _i186 < _map183.size; ++_i186)
          {
            ...
            _val185 = new Datum();
            _val185.read(iprot);
            struct.keys.put(_key184, _val185);
          }
        }
        struct.setKeysIsSet(true);
      }
      if (incoming.get(2)) {
        {
          libthrift091.protocol.TList _list187 = new libthrift091.protocol.TList(libthrift091.protocol.TType.STRING, iprot.readI32());
          struct.attributes = new ArrayList<String>(_list187.size);
          String _elem188;
          for (int _i189 = 0; _i189 < _list187.size; ++_i189)
          {
            _elem188 = iprot.readString();
            struct.attributes.add(_elem188);
          }
        }
        struct.setAttributesIsSet(true);
      }
