...
public class DataConsumeRequest implements libthrift091.TBase<DataConsumeRequest, DataConsumeRequest._Fields>, java.io.Serializable, Cloneable, Comparable<DataConsumeRequest> {
   ...
   * 表分片ID
   */
  public DataConsumeRequest setPartitionId(long partitionId) {
   ...
   * 订阅者ID
   */
  public DataConsumeRequest setSubscriberId(String subscriberId) {
            ...
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                ...
                struct.consumeOffset = new HashMap<String,Datum>(2*_map342.size);
                String _key343;
                Datum _val344;
                for (int _i345 = 0; _i345 < _map342.size; ++_i345)
                {
                  ...
                  _val344 = new Datum();
                  _val344.read(iprot);
                  struct.consumeOffset.put(_key343, _val344);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.consumeOffset != null) {
        if (struct.isSetConsumeOffset()) {
          oprot.writeFieldBegin(CONSUME_OFFSET_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Datum> _iter346 : struct.consumeOffset.entrySet())
            {
      ...
      if (struct.isSetConsumeOffset()) {
        {
          ...
          for (Map.Entry<String, Datum> _iter347 : struct.consumeOffset.entrySet())
          {
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.consumeOffset = new HashMap<String,Datum>(2*_map348.size);
          String _key349;
          Datum _val350;
          for (int _i351 = 0; _i351 < _map348.size; ++_i351)
          {
            ...
            _val350 = new Datum();
            _val350.read(iprot);
            struct.consumeOffset.put(_key349, _val350);
          }
        }
        struct.setConsumeOffsetIsSet(true);
      }
