...
public class DataConsumeRequest implements libthrift091.TBase<DataConsumeRequest, DataConsumeRequest._Fields>, java.io.Serializable, Cloneable, Comparable<DataConsumeRequest> {
  private static final libthrift091.protocol.TStruct STRUCT_DESC = new libthrift091.protocol.TStruct("DataConsumeRequest");
  ...
  private static final libthrift091.protocol.TField CONSUME_OFFSET_FIELD_DESC = new libthrift091.protocol.TField("consumeOffset", libthrift091.protocol.TType.MAP, (short)5);

  private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
  static {
    schemes.put(StandardScheme.class, new DataConsumeRequestStandardSchemeFactory());
    schemes.put(TupleScheme.class, new DataConsumeRequestTupleSchemeFactory());
  }
   ...
   * 消费偏移
   */
  public Map<String,Datum> consumeOffset; // optional
  ...
  private static final _Fields optionals[] = {_Fields.TABLE_NAME,_Fields.PARTITION_ID,_Fields.SUBSCRIBER_NAME,_Fields.CONSUME_NUMBER,_Fields.CONSUME_OFFSET};
  ...
  static {
    ...
    libthrift091.meta_data.FieldMetaData.addStructMetaDataMap(DataConsumeRequest.class, metaDataMap);
  }

  public DataConsumeRequest() {
  }

  /**
   * Performs a deep copy on <i>other</i>.
   */
  public DataConsumeRequest(DataConsumeRequest other) {
    ...
    if (other.isSetConsumeOffset()) {
      this.consumeOffset = other.consumeOffset;
    }
  }

  public DataConsumeRequest deepCopy() {
    return new DataConsumeRequest(this);
  }
   ...
   * 表名
   */
  public DataConsumeRequest setTableName(String tableName) {
   ...
   * 表分区ID
   */
  public DataConsumeRequest setPartitionId(int partitionId) {
   ...
   * 订阅者名字
   */
  public DataConsumeRequest setSubscriberName(String subscriberName) {
   ...
   * 消费数量
   */
  public DataConsumeRequest setConsumeNumber(int consumeNumber) {
  ...
  public int getConsumeOffsetSize() {
    return (this.consumeOffset == null) ? 0 : this.consumeOffset.size();
  }

  public void putToConsumeOffset(String key, Datum val) {
    if (this.consumeOffset == null) {
      this.consumeOffset = new HashMap<String,Datum>();
    }
    this.consumeOffset.put(key, val);
  }

  /**
   * 消费偏移
   */
  public Map<String,Datum> getConsumeOffset() {
   ...
   * 消费偏移
   */
  public DataConsumeRequest setConsumeOffset(Map<String,Datum> consumeOffset) {
  ...
  public boolean isSetConsumeOffset() {
    return this.consumeOffset != null;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case CONSUME_OFFSET:
      if (value == null) {
        ...
        setConsumeOffset((Map<String,Datum>)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof DataConsumeRequest)
      return this.equals((DataConsumeRequest)that);
    return false;
  }

  public boolean equals(DataConsumeRequest that) {
    if (that == null)
      return false;
    ...
    if (this_present_consumeOffset || that_present_consumeOffset) {
      if (!(this_present_consumeOffset && that_present_consumeOffset))
        return false;
      if (!this.consumeOffset.equals(that.consumeOffset))
        return false;
    }
  ...
  @Override
  public int compareTo(DataConsumeRequest other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("DataConsumeRequest(");
    boolean first = true;
  ...
  private static class DataConsumeRequestStandardSchemeFactory implements SchemeFactory {
    public DataConsumeRequestStandardScheme getScheme() {
      return new DataConsumeRequestStandardScheme();
    }
  }

  private static class DataConsumeRequestStandardScheme extends StandardScheme<DataConsumeRequest> {

    public void read(libthrift091.protocol.TProtocol iprot, DataConsumeRequest struct) throws libthrift091.TException {
        ...
        switch (schemeField.id) {
          ...
          case 5: // CONSUME_OFFSET
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                libthrift091.protocol.TMap _map362 = iprot.readMapBegin();
                struct.consumeOffset = new HashMap<String,Datum>(2*_map362.size);
                String _key363;
                Datum _val364;
                for (int _i365 = 0; _i365 < _map362.size; ++_i365)
                {
                  ...
                  _val364 = new Datum();
                  _val364.read(iprot);
                  struct.consumeOffset.put(_key363, _val364);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(libthrift091.protocol.TProtocol oprot, DataConsumeRequest struct) throws libthrift091.TException {
      struct.validate();
      ...
      if (struct.consumeOffset != null) {
        if (struct.isSetConsumeOffset()) {
          oprot.writeFieldBegin(CONSUME_OFFSET_FIELD_DESC);
          {
            oprot.writeMapBegin(new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.STRUCT, struct.consumeOffset.size()));
            for (Map.Entry<String, Datum> _iter366 : struct.consumeOffset.entrySet())
            {
  ...
  private static class DataConsumeRequestTupleSchemeFactory implements SchemeFactory {
    public DataConsumeRequestTupleScheme getScheme() {
      return new DataConsumeRequestTupleScheme();
    }
  }

  private static class DataConsumeRequestTupleScheme extends TupleScheme<DataConsumeRequest> {

    @Override
    public void write(libthrift091.protocol.TProtocol prot, DataConsumeRequest struct) throws libthrift091.TException {
      ...
      if (struct.isSetConsumeOffset()) {
        {
          oprot.writeI32(struct.consumeOffset.size());
          for (Map.Entry<String, Datum> _iter367 : struct.consumeOffset.entrySet())
          {
            oprot.writeString(_iter367.getKey());
            _iter367.getValue().write(oprot);
          }
        }
      }
    }
    ...
    @Override
    public void read(libthrift091.protocol.TProtocol prot, DataConsumeRequest struct) throws libthrift091.TException {
      ...
      if (incoming.get(4)) {
        {
          libthrift091.protocol.TMap _map368 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.STRUCT, iprot.readI32());
          struct.consumeOffset = new HashMap<String,Datum>(2*_map368.size);
          String _key369;
          Datum _val370;
          for (int _i371 = 0; _i371 < _map368.size; ++_i371)
          {
            ...
            _val370 = new Datum();
            _val370.read(iprot);
            struct.consumeOffset.put(_key369, _val370);
          }
        }
        struct.setConsumeOffsetIsSet(true);
      }
