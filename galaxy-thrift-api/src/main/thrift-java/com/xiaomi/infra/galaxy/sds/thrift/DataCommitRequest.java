...
public class DataCommitRequest implements libthrift091.TBase<DataCommitRequest, DataCommitRequest._Fields>, java.io.Serializable, Cloneable, Comparable<DataCommitRequest> {
   ...
   * 表分区ID
   */
  public DataCommitRequest setPartitionId(int partitionId) {
   ...
   * 订阅者名字
   */
  public DataCommitRequest setSubscriberName(String subscriberName) {
        ...
        switch (schemeField.id) {
          ...
          case 4: // LAST_CONSUMED_OFFSET
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                libthrift091.protocol.TMap _map416 = iprot.readMapBegin();
                struct.lastConsumedOffset = new HashMap<String,Datum>(2*_map416.size);
                String _key417;
                Datum _val418;
                for (int _i419 = 0; _i419 < _map416.size; ++_i419)
                {
                  ...
                  _val418 = new Datum();
                  _val418.read(iprot);
                  struct.lastConsumedOffset.put(_key417, _val418);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.lastConsumedOffset != null) {
        if (struct.isSetLastConsumedOffset()) {
          oprot.writeFieldBegin(LAST_CONSUMED_OFFSET_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Datum> _iter420 : struct.lastConsumedOffset.entrySet())
            {
  ...
  private static class DataCommitRequestTupleScheme extends TupleScheme<DataCommitRequest> {
      ...
      if (struct.isSetLastConsumedOffset()) {
        {
          ...
          for (Map.Entry<String, Datum> _iter421 : struct.lastConsumedOffset.entrySet())
          {
    ...
    public void read(libthrift091.protocol.TProtocol prot, DataCommitRequest struct) throws libthrift091.TException {
      ...
      if (incoming.get(3)) {
        {
          libthrift091.protocol.TMap _map422 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.STRUCT, iprot.readI32());
          struct.lastConsumedOffset = new HashMap<String,Datum>(2*_map422.size);
          String _key423;
          Datum _val424;
          for (int _i425 = 0; _i425 < _map422.size; ++_i425)
          {
            ...
            _val424 = new Datum();
            _val424.read(iprot);
            struct.lastConsumedOffset.put(_key423, _val424);
          }
        }
        struct.setLastConsumedOffsetIsSet(true);
      }
