...
public class InternalMutationLogEntry implements libthrift091.TBase<InternalMutationLogEntry, InternalMutationLogEntry._Fields>, java.io.Serializable, Cloneable, Comparable<InternalMutationLogEntry> {
        ...
        switch (schemeField.id) {
          case 1: // RECORD
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                libthrift091.protocol.TMap _map348 = iprot.readMapBegin();
                struct.record = new HashMap<String,ByteBuffer>(2*_map348.size);
                String _key349;
                ByteBuffer _val350;
                for (int _i351 = 0; _i351 < _map348.size; ++_i351)
                {
                  ...
                  struct.record.put(_key349, _val350);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.record != null) {
        if (struct.isSetRecord()) {
          oprot.writeFieldBegin(RECORD_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, ByteBuffer> _iter352 : struct.record.entrySet())
            {
  ...
  private static class InternalMutationLogEntryTupleScheme extends TupleScheme<InternalMutationLogEntry> {
      ...
      if (struct.isSetRecord()) {
        {
          ...
          for (Map.Entry<String, ByteBuffer> _iter353 : struct.record.entrySet())
          {
            oprot.writeString(_iter353.getKey());
            oprot.writeBinary(_iter353.getValue());
          }
        }
      }
      if (struct.isSetType()) {
    ...
    public void read(libthrift091.protocol.TProtocol prot, InternalMutationLogEntry struct) throws libthrift091.TException {
      ...
      if (incoming.get(0)) {
        {
          libthrift091.protocol.TMap _map354 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.STRING, iprot.readI32());
          struct.record = new HashMap<String,ByteBuffer>(2*_map354.size);
          String _key355;
          ByteBuffer _val356;
          for (int _i357 = 0; _i357 < _map354.size; ++_i357)
          {
            _key355 = iprot.readString();
            _val356 = iprot.readBinary();
            struct.record.put(_key355, _val356);
          }
        }
        struct.setRecordIsSet(true);
      }
