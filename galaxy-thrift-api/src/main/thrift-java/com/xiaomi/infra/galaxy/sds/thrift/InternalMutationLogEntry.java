...
public class InternalMutationLogEntry implements libthrift091.TBase<InternalMutationLogEntry, InternalMutationLogEntry._Fields>, java.io.Serializable, Cloneable, Comparable<InternalMutationLogEntry> {
            ...
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                ...
                struct.record = new HashMap<String,ByteBuffer>(2*_map330.size);
                String _key331;
                ByteBuffer _val332;
                for (int _i333 = 0; _i333 < _map330.size; ++_i333)
                {
                  _key331 = iprot.readString();
                  _val332 = iprot.readBinary();
                  struct.record.put(_key331, _val332);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.record != null) {
        if (struct.isSetRecord()) {
          oprot.writeFieldBegin(RECORD_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, ByteBuffer> _iter334 : struct.record.entrySet())
            {
  ...
  private static class InternalMutationLogEntryTupleScheme extends TupleScheme<InternalMutationLogEntry> {
      ...
      if (struct.isSetRecord()) {
        {
          ...
          for (Map.Entry<String, ByteBuffer> _iter335 : struct.record.entrySet())
          {
            oprot.writeString(_iter335.getKey());
            oprot.writeBinary(_iter335.getValue());
          }
        }
      }
      if (struct.isSetType()) {
    ...
    public void read(libthrift091.protocol.TProtocol prot, InternalMutationLogEntry struct) throws libthrift091.TException {
      ...
      if (incoming.get(0)) {
        {
          libthrift091.protocol.TMap _map336 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.STRING, iprot.readI32());
          struct.record = new HashMap<String,ByteBuffer>(2*_map336.size);
          String _key337;
          ByteBuffer _val338;
          for (int _i339 = 0; _i339 < _map336.size; ++_i339)
          {
            _key337 = iprot.readString();
            _val338 = iprot.readBinary();
            struct.record.put(_key337, _val338);
          }
        }
        struct.setRecordIsSet(true);
      }
