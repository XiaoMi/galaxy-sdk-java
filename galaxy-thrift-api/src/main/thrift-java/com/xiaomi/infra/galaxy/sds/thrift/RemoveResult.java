...
public class RemoveResult implements libthrift091.TBase<RemoveResult, RemoveResult._Fields>, java.io.Serializable, Cloneable, Comparable<RemoveResult> {
  private static final libthrift091.protocol.TStruct STRUCT_DESC = new libthrift091.protocol.TStruct("RemoveResult");
  ...
  static {
    ...
    libthrift091.meta_data.FieldMetaData.addStructMetaDataMap(RemoveResult.class, metaDataMap);
  }
   ...
   * 删除操作是否被执行（是否满足设置的条件）
   */
  public RemoveResult setSuccess(boolean success) {
  ...
  private static class RemoveResultStandardScheme extends StandardScheme<RemoveResult> {
    ...
    public void read(libthrift091.protocol.TProtocol iprot, RemoveResult struct) throws libthrift091.TException {
    ...
    public void write(libthrift091.protocol.TProtocol oprot, RemoveResult struct) throws libthrift091.TException {
      struct.validate();
  ...
  private static class RemoveResultTupleScheme extends TupleScheme<RemoveResult> {
    ...
    @Override
    public void write(libthrift091.protocol.TProtocol prot, RemoveResult struct) throws libthrift091.TException {
    ...
    @Override
    public void read(libthrift091.protocol.TProtocol prot, RemoveResult struct) throws libthrift091.TException {
