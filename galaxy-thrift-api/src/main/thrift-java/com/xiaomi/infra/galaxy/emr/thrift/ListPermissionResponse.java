        ...
        switch (schemeField.id) {
          case 1: // PERMISSIONS
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                libthrift091.protocol.TMap _map84 = iprot.readMapBegin();
                struct.permissions = new HashMap<String,Permission>(2*_map84.size);
                String _key85;
                Permission _val86;
                for (int _i87 = 0; _i87 < _map84.size; ++_i87)
                {
                  _key85 = iprot.readString();
                  _val86 = com.xiaomi.infra.galaxy.emr.thrift.Permission.findByValue(iprot.readI32());
                  struct.permissions.put(_key85, _val86);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(libthrift091.protocol.TProtocol oprot, ListPermissionResponse struct) throws libthrift091.TException {
      ...
      if (struct.permissions != null) {
        oprot.writeFieldBegin(PERMISSIONS_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, Permission> _iter88 : struct.permissions.entrySet())
          {
  ...
  private static class ListPermissionResponseTupleScheme extends TupleScheme<ListPermissionResponse> {
    ...
    public void write(libthrift091.protocol.TProtocol prot, ListPermissionResponse struct) throws libthrift091.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      {
        ...
        for (Map.Entry<String, Permission> _iter89 : struct.permissions.entrySet())
        {
          oprot.writeString(_iter89.getKey());
          oprot.writeI32(_iter89.getValue().getValue());
        }
      }
    }
    ...
    public void read(libthrift091.protocol.TProtocol prot, ListPermissionResponse struct) throws libthrift091.TException {
      ...
      {
        libthrift091.protocol.TMap _map90 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.I32, iprot.readI32());
        struct.permissions = new HashMap<String,Permission>(2*_map90.size);
        String _key91;
        Permission _val92;
        for (int _i93 = 0; _i93 < _map90.size; ++_i93)
        {
          _key91 = iprot.readString();
          _val92 = com.xiaomi.infra.galaxy.emr.thrift.Permission.findByValue(iprot.readI32());
          struct.permissions.put(_key91, _val92);
        }
      }
      struct.setPermissionsIsSet(true);
    }
