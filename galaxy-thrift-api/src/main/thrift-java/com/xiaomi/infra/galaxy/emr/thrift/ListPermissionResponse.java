            ...
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                ...
                struct.permissions = new HashMap<String,Permission>(2*_map58.size);
                String _key59;
                Permission _val60;
                for (int _i61 = 0; _i61 < _map58.size; ++_i61)
                {
                  _key59 = iprot.readString();
                  _val60 = com.xiaomi.infra.galaxy.emr.thrift.Permission.findByValue(iprot.readI32());
                  struct.permissions.put(_key59, _val60);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(libthrift091.protocol.TProtocol oprot, ListPermissionResponse struct) throws libthrift091.TException {
      ...
      if (struct.permissions != null) {
        oprot.writeFieldBegin(PERMISSIONS_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, Permission> _iter62 : struct.permissions.entrySet())
          {
            oprot.writeString(_iter62.getKey());
            oprot.writeI32(_iter62.getValue().getValue());
          }
          oprot.writeMapEnd();
        }
        oprot.writeFieldEnd();
  ...
  private static class ListPermissionResponseTupleScheme extends TupleScheme<ListPermissionResponse> {
    ...
    public void write(libthrift091.protocol.TProtocol prot, ListPermissionResponse struct) throws libthrift091.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      {
        ...
        for (Map.Entry<String, Permission> _iter63 : struct.permissions.entrySet())
        {
    ...
    public void read(libthrift091.protocol.TProtocol prot, ListPermissionResponse struct) throws libthrift091.TException {
      ...
      {
        libthrift091.protocol.TMap _map64 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.I32, iprot.readI32());
        struct.permissions = new HashMap<String,Permission>(2*_map64.size);
        String _key65;
        Permission _val66;
        for (int _i67 = 0; _i67 < _map64.size; ++_i67)
        {
          _key65 = iprot.readString();
          _val66 = com.xiaomi.infra.galaxy.emr.thrift.Permission.findByValue(iprot.readI32());
