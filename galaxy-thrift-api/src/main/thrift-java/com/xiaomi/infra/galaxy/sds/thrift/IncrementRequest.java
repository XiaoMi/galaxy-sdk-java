...
public class IncrementRequest implements libthrift091.TBase<IncrementRequest, IncrementRequest._Fields>, java.io.Serializable, Cloneable, Comparable<IncrementRequest> {
        ...
        switch (schemeField.id) {
          ...
          case 2: // KEYS
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                libthrift091.protocol.TMap _map228 = iprot.readMapBegin();
                struct.keys = new HashMap<String,Datum>(2*_map228.size);
                String _key229;
                Datum _val230;
                for (int _i231 = 0; _i231 < _map228.size; ++_i231)
                {
                  ...
                  _val230 = new Datum();
                  _val230.read(iprot);
                  struct.keys.put(_key229, _val230);
                }
                iprot.readMapEnd();
              }
          ...
          case 3: // AMOUNTS
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                libthrift091.protocol.TMap _map232 = iprot.readMapBegin();
                struct.amounts = new HashMap<String,Datum>(2*_map232.size);
                String _key233;
                Datum _val234;
                for (int _i235 = 0; _i235 < _map232.size; ++_i235)
                {
                  ...
                  _val234 = new Datum();
                  _val234.read(iprot);
                  struct.amounts.put(_key233, _val234);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.keys != null) {
        if (struct.isSetKeys()) {
          oprot.writeFieldBegin(KEYS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Datum> _iter236 : struct.keys.entrySet())
            {
      ...
      if (struct.amounts != null) {
        if (struct.isSetAmounts()) {
          oprot.writeFieldBegin(AMOUNTS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Datum> _iter237 : struct.amounts.entrySet())
            {
  ...
  private static class IncrementRequestTupleScheme extends TupleScheme<IncrementRequest> {
      ...
      if (struct.isSetKeys()) {
        {
          ...
          for (Map.Entry<String, Datum> _iter238 : struct.keys.entrySet())
          {
      ...
      if (struct.isSetAmounts()) {
        {
          ...
          for (Map.Entry<String, Datum> _iter239 : struct.amounts.entrySet())
          {
    ...
    public void read(libthrift091.protocol.TProtocol prot, IncrementRequest struct) throws libthrift091.TException {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.keys = new HashMap<String,Datum>(2*_map240.size);
          String _key241;
          Datum _val242;
          for (int _i243 = 0; _i243 < _map240.size; ++_i243)
          {
            ...
            _val242 = new Datum();
            _val242.read(iprot);
            struct.keys.put(_key241, _val242);
          }
        }
        struct.setKeysIsSet(true);
      }
      if (incoming.get(2)) {
        {
          libthrift091.protocol.TMap _map244 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.STRUCT, iprot.readI32());
          struct.amounts = new HashMap<String,Datum>(2*_map244.size);
          String _key245;
          Datum _val246;
          for (int _i247 = 0; _i247 < _map244.size; ++_i247)
          {
            ...
            _val246 = new Datum();
            _val246.read(iprot);
            struct.amounts.put(_key245, _val246);
          }
        }
        struct.setAmountsIsSet(true);
      }
