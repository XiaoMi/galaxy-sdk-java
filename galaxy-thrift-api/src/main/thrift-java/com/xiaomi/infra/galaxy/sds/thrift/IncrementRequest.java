...
public class IncrementRequest implements libthrift091.TBase<IncrementRequest, IncrementRequest._Fields>, java.io.Serializable, Cloneable, Comparable<IncrementRequest> {
   ...
   * 待自增的记录主键
   */
  public Map<String,Datum> keys; // required
  /**
   * 需要进行自增操作的属性，必须为整形，且不能为索引属性
   */
  public Map<String,Datum> amounts; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.TABLE_NAME, new libthrift091.meta_data.FieldMetaData("tableName", libthrift091.TFieldRequirementType.REQUIRED, 
        new libthrift091.meta_data.FieldValueMetaData(libthrift091.protocol.TType.STRING)));
    tmpMap.put(_Fields.KEYS, new libthrift091.meta_data.FieldMetaData("keys", libthrift091.TFieldRequirementType.REQUIRED, 
        new libthrift091.meta_data.FieldValueMetaData(libthrift091.protocol.TType.MAP        , "Dictionary")));
    tmpMap.put(_Fields.AMOUNTS, new libthrift091.meta_data.FieldMetaData("amounts", libthrift091.TFieldRequirementType.REQUIRED, 
        new libthrift091.meta_data.FieldValueMetaData(libthrift091.protocol.TType.MAP        , "Dictionary")));
  ...
  public IncrementRequest(
    String tableName,
    Map<String,Datum> keys,
    Map<String,Datum> amounts)
  {
    this();
  ...
  public void validate() throws libthrift091.TException {
    ...
    if (tableName == null) {
      throw new libthrift091.protocol.TProtocolException("Required field 'tableName' was not present! Struct: " + toString());
    }
    if (keys == null) {
      throw new libthrift091.protocol.TProtocolException("Required field 'keys' was not present! Struct: " + toString());
    }
    if (amounts == null) {
      throw new libthrift091.protocol.TProtocolException("Required field 'amounts' was not present! Struct: " + toString());
    }
            ...
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                ...
                for (int _i193 = 0; _i193 < _map192.size; ++_i193)
                {
                  ...
                  _val195 = new Datum();
                  _val195.read(iprot);
                  struct.keys.put(_key194, _val195);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                ...
                for (int _i197 = 0; _i197 < _map196.size; ++_i197)
                {
                  ...
                  _val199 = new Datum();
                  _val199.read(iprot);
                  struct.amounts.put(_key198, _val199);
                }
                iprot.readMapEnd();
              }
    ...
    public void read(libthrift091.protocol.TProtocol prot, IncrementRequest struct) throws libthrift091.TException {
      ...
      struct.setTableNameIsSet(true);
      {
        ...
        for (int _i205 = 0; _i205 < _map204.size; ++_i205)
        {
          ...
          _val207 = new Datum();
          _val207.read(iprot);
          struct.keys.put(_key206, _val207);
        }
      }
      struct.setKeysIsSet(true);
      {
        ...
        for (int _i209 = 0; _i209 < _map208.size; ++_i209)
        {
          ...
          _val211 = new Datum();
          _val211.read(iprot);
          struct.amounts.put(_key210, _val211);
        }
      }
      struct.setAmountsIsSet(true);
    }
