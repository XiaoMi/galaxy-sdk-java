...
public class IncrementRequest implements libthrift091.TBase<IncrementRequest, IncrementRequest._Fields>, java.io.Serializable, Cloneable, Comparable<IncrementRequest> {
        ...
        switch (schemeField.id) {
          ...
          case 2: // KEYS
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                libthrift091.protocol.TMap _map210 = iprot.readMapBegin();
                struct.keys = new HashMap<String,Datum>(2*_map210.size);
                String _key211;
                Datum _val212;
                for (int _i213 = 0; _i213 < _map210.size; ++_i213)
                {
                  ...
                  _val212 = new Datum();
                  _val212.read(iprot);
                  struct.keys.put(_key211, _val212);
                }
                iprot.readMapEnd();
              }
          ...
          case 3: // AMOUNTS
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                libthrift091.protocol.TMap _map214 = iprot.readMapBegin();
                struct.amounts = new HashMap<String,Datum>(2*_map214.size);
                String _key215;
                Datum _val216;
                for (int _i217 = 0; _i217 < _map214.size; ++_i217)
                {
                  ...
                  _val216 = new Datum();
                  _val216.read(iprot);
                  struct.amounts.put(_key215, _val216);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.keys != null) {
        if (struct.isSetKeys()) {
          oprot.writeFieldBegin(KEYS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Datum> _iter218 : struct.keys.entrySet())
            {
      ...
      if (struct.amounts != null) {
        if (struct.isSetAmounts()) {
          oprot.writeFieldBegin(AMOUNTS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Datum> _iter219 : struct.amounts.entrySet())
            {
  ...
  private static class IncrementRequestTupleScheme extends TupleScheme<IncrementRequest> {
    ...
    public void read(libthrift091.protocol.TProtocol prot, IncrementRequest struct) throws libthrift091.TException {
      ...
      if (incoming.get(1)) {
        {
          libthrift091.protocol.TMap _map222 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.STRUCT, iprot.readI32());
      ...
      if (incoming.get(2)) {
        {
          libthrift091.protocol.TMap _map226 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.STRUCT, iprot.readI32());
          struct.amounts = new HashMap<String,Datum>(2*_map226.size);
          String _key227;
          Datum _val228;
          for (int _i229 = 0; _i229 < _map226.size; ++_i229)
          {
            ...
            _val228 = new Datum();
            _val228.read(iprot);
            struct.amounts.put(_key227, _val228);
          }
        }
        struct.setAmountsIsSet(true);
      }
