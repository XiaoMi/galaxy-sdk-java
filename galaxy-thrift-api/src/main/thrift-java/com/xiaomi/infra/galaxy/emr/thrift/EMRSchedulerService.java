  ...
  public static class addInstanceGroups_args implements libthrift091.TBase<addInstanceGroups_args, addInstanceGroups_args._Fields>, java.io.Serializable, Cloneable, Comparable<addInstanceGroups_args>   {
          ...
          switch (schemeField.id) {
            case 1: // INSTANCE_GROUPS
              if (schemeField.type == libthrift091.protocol.TType.LIST) {
                {
                  libthrift091.protocol.TList _list182 = iprot.readListBegin();
                  struct.instanceGroups = new ArrayList<AddInstanceGroupRequest>(_list182.size);
                  AddInstanceGroupRequest _elem183;
                  for (int _i184 = 0; _i184 < _list182.size; ++_i184)
                  {
                    _elem183 = new AddInstanceGroupRequest();
                    _elem183.read(iprot);
                    struct.instanceGroups.add(_elem183);
                  }
                  iprot.readListEnd();
                }
      ...
      public void write(libthrift091.protocol.TProtocol oprot, addInstanceGroups_args struct) throws libthrift091.TException {
        ...
        if (struct.instanceGroups != null) {
          oprot.writeFieldBegin(INSTANCE_GROUPS_FIELD_DESC);
          {
            ...
            for (AddInstanceGroupRequest _iter185 : struct.instanceGroups)
            {
    ...
    private static class addInstanceGroups_argsTupleScheme extends TupleScheme<addInstanceGroups_args> {
        ...
        if (struct.isSetInstanceGroups()) {
          {
            ...
            for (AddInstanceGroupRequest _iter186 : struct.instanceGroups)
            {
      ...
      public void read(libthrift091.protocol.TProtocol prot, addInstanceGroups_args struct) throws libthrift091.TException {
        ...
        if (incoming.get(0)) {
          {
            libthrift091.protocol.TList _list187 = new libthrift091.protocol.TList(libthrift091.protocol.TType.STRUCT, iprot.readI32());
            struct.instanceGroups = new ArrayList<AddInstanceGroupRequest>(_list187.size);
            AddInstanceGroupRequest _elem188;
            for (int _i189 = 0; _i189 < _list187.size; ++_i189)
            {
              _elem188 = new AddInstanceGroupRequest();
              _elem188.read(iprot);
              struct.instanceGroups.add(_elem188);
            }
          }
          struct.setInstanceGroupsIsSet(true);
        }
              ...
              if (schemeField.type == libthrift091.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<AddInstanceGroupResponse>(_list190.size);
                  AddInstanceGroupResponse _elem191;
                  for (int _i192 = 0; _i192 < _list190.size; ++_i192)
                  {
                    _elem191 = new AddInstanceGroupResponse();
                    _elem191.read(iprot);
      ...
      public void write(libthrift091.protocol.TProtocol oprot, addInstanceGroups_result struct) throws libthrift091.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (AddInstanceGroupResponse _iter193 : struct.success)
            {
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (AddInstanceGroupResponse _iter194 : struct.success)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<AddInstanceGroupResponse>(_list195.size);
            AddInstanceGroupResponse _elem196;
            for (int _i197 = 0; _i197 < _list195.size; ++_i197)
            {
              _elem196 = new AddInstanceGroupResponse();
              _elem196.read(iprot);
              ...
              if (schemeField.type == libthrift091.protocol.TType.LIST) {
                {
                  ...
                  struct.jobs = new ArrayList<SubmitJobRequest>(_list198.size);
                  SubmitJobRequest _elem199;
                  for (int _i200 = 0; _i200 < _list198.size; ++_i200)
                  {
                    _elem199 = new SubmitJobRequest();
                    _elem199.read(iprot);
                    struct.jobs.add(_elem199);
                  }
                  iprot.readListEnd();
                }
      ...
      public void write(libthrift091.protocol.TProtocol oprot, submitJobs_args struct) throws libthrift091.TException {
        ...
        if (struct.jobs != null) {
          oprot.writeFieldBegin(JOBS_FIELD_DESC);
          {
            ...
            for (SubmitJobRequest _iter201 : struct.jobs)
            {
        ...
        if (struct.isSetJobs()) {
          {
            ...
            for (SubmitJobRequest _iter202 : struct.jobs)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.jobs = new ArrayList<SubmitJobRequest>(_list203.size);
            SubmitJobRequest _elem204;
            for (int _i205 = 0; _i205 < _list203.size; ++_i205)
            {
              _elem204 = new SubmitJobRequest();
              _elem204.read(iprot);
              struct.jobs.add(_elem204);
            }
          }
          struct.setJobsIsSet(true);
        }
    ...
    private static class submitJobs_resultStandardScheme extends StandardScheme<submitJobs_result> {
              ...
              if (schemeField.type == libthrift091.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<SubmitJobResponse>(_list206.size);
                  SubmitJobResponse _elem207;
                  for (int _i208 = 0; _i208 < _list206.size; ++_i208)
                  {
                    _elem207 = new SubmitJobResponse();
                    _elem207.read(iprot);
      ...
      public void write(libthrift091.protocol.TProtocol oprot, submitJobs_result struct) throws libthrift091.TException {
        ...
        if (struct.success != null) {
          ...
          {
            oprot.writeListBegin(new libthrift091.protocol.TList(libthrift091.protocol.TType.STRUCT, struct.success.size()));
            for (SubmitJobResponse _iter209 : struct.success)
            {
    ...
    private static class submitJobs_resultTupleScheme extends TupleScheme<submitJobs_result> {
      ...
      public void write(libthrift091.protocol.TProtocol prot, submitJobs_result struct) throws libthrift091.TException {
        ...
        if (struct.isSetSuccess()) {
          {
            oprot.writeI32(struct.success.size());
            for (SubmitJobResponse _iter210 : struct.success)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<SubmitJobResponse>(_list211.size);
            SubmitJobResponse _elem212;
            for (int _i213 = 0; _i213 < _list211.size; ++_i213)
            {
              _elem212 = new SubmitJobResponse();
              _elem212.read(iprot);
    ...
    private static class listClusters_resultStandardScheme extends StandardScheme<listClusters_result> {
              ...
              if (schemeField.type == libthrift091.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<ClusterDetail>(_list214.size);
                  ClusterDetail _elem215;
                  for (int _i216 = 0; _i216 < _list214.size; ++_i216)
                  {
                    _elem215 = new ClusterDetail();
                    _elem215.read(iprot);
      ...
      public void write(libthrift091.protocol.TProtocol oprot, listClusters_result struct) throws libthrift091.TException {
        ...
        if (struct.success != null) {
          ...
          {
            oprot.writeListBegin(new libthrift091.protocol.TList(libthrift091.protocol.TType.STRUCT, struct.success.size()));
            for (ClusterDetail _iter217 : struct.success)
            {
    ...
    private static class listClusters_resultTupleScheme extends TupleScheme<listClusters_result> {
      ...
      public void write(libthrift091.protocol.TProtocol prot, listClusters_result struct) throws libthrift091.TException {
        ...
        if (struct.isSetSuccess()) {
          {
            oprot.writeI32(struct.success.size());
            for (ClusterDetail _iter218 : struct.success)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<ClusterDetail>(_list219.size);
            ClusterDetail _elem220;
            for (int _i221 = 0; _i221 < _list219.size; ++_i221)
            {
              _elem220 = new ClusterDetail();
              _elem220.read(iprot);
    ...
    private static class listInstanceGroups_resultStandardScheme extends StandardScheme<listInstanceGroups_result> {
              ...
              if (schemeField.type == libthrift091.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<InstanceGroupDetail>(_list230.size);
                  InstanceGroupDetail _elem231;
                  for (int _i232 = 0; _i232 < _list230.size; ++_i232)
                  {
                    _elem231 = new InstanceGroupDetail();
                    _elem231.read(iprot);
      ...
      public void write(libthrift091.protocol.TProtocol oprot, listInstanceGroups_result struct) throws libthrift091.TException {
        ...
        if (struct.success != null) {
          ...
          {
            oprot.writeListBegin(new libthrift091.protocol.TList(libthrift091.protocol.TType.STRUCT, struct.success.size()));
            for (InstanceGroupDetail _iter233 : struct.success)
            {
    ...
    private static class listInstanceGroups_resultTupleScheme extends TupleScheme<listInstanceGroups_result> {
      ...
      public void write(libthrift091.protocol.TProtocol prot, listInstanceGroups_result struct) throws libthrift091.TException {
        ...
        if (struct.isSetSuccess()) {
          {
            oprot.writeI32(struct.success.size());
            for (InstanceGroupDetail _iter234 : struct.success)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<InstanceGroupDetail>(_list235.size);
            InstanceGroupDetail _elem236;
            for (int _i237 = 0; _i237 < _list235.size; ++_i237)
            {
              _elem236 = new InstanceGroupDetail();
              _elem236.read(iprot);
    ...
    private static class listInstancesInCluster_resultStandardScheme extends StandardScheme<listInstancesInCluster_result> {
              ...
              if (schemeField.type == libthrift091.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<InstanceDetail>(_list238.size);
                  InstanceDetail _elem239;
                  for (int _i240 = 0; _i240 < _list238.size; ++_i240)
                  {
                    _elem239 = new InstanceDetail();
                    _elem239.read(iprot);
      ...
      public void write(libthrift091.protocol.TProtocol oprot, listInstancesInCluster_result struct) throws libthrift091.TException {
        ...
        if (struct.success != null) {
          ...
          {
            oprot.writeListBegin(new libthrift091.protocol.TList(libthrift091.protocol.TType.STRUCT, struct.success.size()));
            for (InstanceDetail _iter241 : struct.success)
            {
    ...
    private static class listInstancesInCluster_resultTupleScheme extends TupleScheme<listInstancesInCluster_result> {
      ...
      public void write(libthrift091.protocol.TProtocol prot, listInstancesInCluster_result struct) throws libthrift091.TException {
        ...
        if (struct.isSetSuccess()) {
          {
            oprot.writeI32(struct.success.size());
            for (InstanceDetail _iter242 : struct.success)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<InstanceDetail>(_list243.size);
            InstanceDetail _elem244;
            for (int _i245 = 0; _i245 < _list243.size; ++_i245)
            {
              _elem244 = new InstanceDetail();
              _elem244.read(iprot);
    ...
    private static class listJobs_resultStandardScheme extends StandardScheme<listJobs_result> {
              ...
              if (schemeField.type == libthrift091.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<JobDetail>(_list254.size);
                  JobDetail _elem255;
                  for (int _i256 = 0; _i256 < _list254.size; ++_i256)
                  {
                    _elem255 = new JobDetail();
                    _elem255.read(iprot);
      ...
      public void write(libthrift091.protocol.TProtocol oprot, listJobs_result struct) throws libthrift091.TException {
        ...
        if (struct.success != null) {
          ...
          {
            oprot.writeListBegin(new libthrift091.protocol.TList(libthrift091.protocol.TType.STRUCT, struct.success.size()));
            for (JobDetail _iter257 : struct.success)
            {
    ...
    private static class listJobs_resultTupleScheme extends TupleScheme<listJobs_result> {
      ...
      public void write(libthrift091.protocol.TProtocol prot, listJobs_result struct) throws libthrift091.TException {
        ...
        if (struct.isSetSuccess()) {
          {
            oprot.writeI32(struct.success.size());
            for (JobDetail _iter258 : struct.success)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<JobDetail>(_list259.size);
            JobDetail _elem260;
            for (int _i261 = 0; _i261 < _list259.size; ++_i261)
            {
              _elem260 = new JobDetail();
              _elem260.read(iprot);
