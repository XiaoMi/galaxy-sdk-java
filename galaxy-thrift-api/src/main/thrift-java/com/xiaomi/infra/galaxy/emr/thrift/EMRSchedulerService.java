  ...
  public static class addInstanceGroups_args implements libthrift091.TBase<addInstanceGroups_args, addInstanceGroups_args._Fields>, java.io.Serializable, Cloneable, Comparable<addInstanceGroups_args>   {
          ...
          switch (schemeField.id) {
            case 1: // INSTANCE_GROUPS
              if (schemeField.type == libthrift091.protocol.TType.LIST) {
                {
                  libthrift091.protocol.TList _list190 = iprot.readListBegin();
                  struct.instanceGroups = new ArrayList<AddInstanceGroupRequest>(_list190.size);
                  AddInstanceGroupRequest _elem191;
                  for (int _i192 = 0; _i192 < _list190.size; ++_i192)
                  {
                    _elem191 = new AddInstanceGroupRequest();
                    _elem191.read(iprot);
                    struct.instanceGroups.add(_elem191);
                  }
                  iprot.readListEnd();
                }
      ...
      public void write(libthrift091.protocol.TProtocol oprot, addInstanceGroups_args struct) throws libthrift091.TException {
        ...
        if (struct.instanceGroups != null) {
          oprot.writeFieldBegin(INSTANCE_GROUPS_FIELD_DESC);
          {
            ...
            for (AddInstanceGroupRequest _iter193 : struct.instanceGroups)
            {
    ...
    private static class addInstanceGroups_argsTupleScheme extends TupleScheme<addInstanceGroups_args> {
        ...
        if (struct.isSetInstanceGroups()) {
          {
            ...
            for (AddInstanceGroupRequest _iter194 : struct.instanceGroups)
            {
      ...
      public void read(libthrift091.protocol.TProtocol prot, addInstanceGroups_args struct) throws libthrift091.TException {
        ...
        if (incoming.get(0)) {
          {
            libthrift091.protocol.TList _list195 = new libthrift091.protocol.TList(libthrift091.protocol.TType.STRUCT, iprot.readI32());
            struct.instanceGroups = new ArrayList<AddInstanceGroupRequest>(_list195.size);
            AddInstanceGroupRequest _elem196;
            for (int _i197 = 0; _i197 < _list195.size; ++_i197)
            {
              _elem196 = new AddInstanceGroupRequest();
              _elem196.read(iprot);
              struct.instanceGroups.add(_elem196);
            }
          }
          struct.setInstanceGroupsIsSet(true);
        }
  ...
  public static class addInstanceGroups_result implements libthrift091.TBase<addInstanceGroups_result, addInstanceGroups_result._Fields>, java.io.Serializable, Cloneable, Comparable<addInstanceGroups_result>   {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
            case 0: // SUCCESS
              if (schemeField.type == libthrift091.protocol.TType.LIST) {
                {
                  libthrift091.protocol.TList _list198 = iprot.readListBegin();
                  struct.success = new ArrayList<AddInstanceGroupResponse>(_list198.size);
                  AddInstanceGroupResponse _elem199;
                  for (int _i200 = 0; _i200 < _list198.size; ++_i200)
                  {
                    _elem199 = new AddInstanceGroupResponse();
                    _elem199.read(iprot);
      ...
      public void write(libthrift091.protocol.TProtocol oprot, addInstanceGroups_result struct) throws libthrift091.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (AddInstanceGroupResponse _iter201 : struct.success)
            {
    ...
    private static class addInstanceGroups_resultTupleScheme extends TupleScheme<addInstanceGroups_result> {
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (AddInstanceGroupResponse _iter202 : struct.success)
            {
      ...
      public void read(libthrift091.protocol.TProtocol prot, addInstanceGroups_result struct) throws libthrift091.TException {
        ...
        if (incoming.get(0)) {
          {
            libthrift091.protocol.TList _list203 = new libthrift091.protocol.TList(libthrift091.protocol.TType.STRUCT, iprot.readI32());
            struct.success = new ArrayList<AddInstanceGroupResponse>(_list203.size);
            AddInstanceGroupResponse _elem204;
            for (int _i205 = 0; _i205 < _list203.size; ++_i205)
            {
              _elem204 = new AddInstanceGroupResponse();
              _elem204.read(iprot);
  ...
  public static class submitJobs_args implements libthrift091.TBase<submitJobs_args, submitJobs_args._Fields>, java.io.Serializable, Cloneable, Comparable<submitJobs_args>   {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
            case 1: // JOBS
              if (schemeField.type == libthrift091.protocol.TType.LIST) {
                {
                  libthrift091.protocol.TList _list206 = iprot.readListBegin();
                  struct.jobs = new ArrayList<SubmitJobRequest>(_list206.size);
                  SubmitJobRequest _elem207;
                  for (int _i208 = 0; _i208 < _list206.size; ++_i208)
                  {
                    _elem207 = new SubmitJobRequest();
                    _elem207.read(iprot);
                    struct.jobs.add(_elem207);
                  }
                  iprot.readListEnd();
                }
      ...
      public void write(libthrift091.protocol.TProtocol oprot, submitJobs_args struct) throws libthrift091.TException {
        ...
        if (struct.jobs != null) {
          oprot.writeFieldBegin(JOBS_FIELD_DESC);
          {
            ...
            for (SubmitJobRequest _iter209 : struct.jobs)
            {
    ...
    private static class submitJobs_argsTupleScheme extends TupleScheme<submitJobs_args> {
        ...
        if (struct.isSetJobs()) {
          {
            ...
            for (SubmitJobRequest _iter210 : struct.jobs)
            {
      ...
      public void read(libthrift091.protocol.TProtocol prot, submitJobs_args struct) throws libthrift091.TException {
        ...
        if (incoming.get(0)) {
          {
            libthrift091.protocol.TList _list211 = new libthrift091.protocol.TList(libthrift091.protocol.TType.STRUCT, iprot.readI32());
            struct.jobs = new ArrayList<SubmitJobRequest>(_list211.size);
            SubmitJobRequest _elem212;
            for (int _i213 = 0; _i213 < _list211.size; ++_i213)
            {
              _elem212 = new SubmitJobRequest();
              _elem212.read(iprot);
              struct.jobs.add(_elem212);
            }
          }
          struct.setJobsIsSet(true);
        }
    ...
    private static class submitJobs_resultStandardScheme extends StandardScheme<submitJobs_result> {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
            case 0: // SUCCESS
              if (schemeField.type == libthrift091.protocol.TType.LIST) {
                {
                  libthrift091.protocol.TList _list214 = iprot.readListBegin();
                  struct.success = new ArrayList<SubmitJobResponse>(_list214.size);
                  SubmitJobResponse _elem215;
                  for (int _i216 = 0; _i216 < _list214.size; ++_i216)
                  {
                    _elem215 = new SubmitJobResponse();
                    _elem215.read(iprot);
      ...
      public void write(libthrift091.protocol.TProtocol oprot, submitJobs_result struct) throws libthrift091.TException {
        ...
        if (struct.success != null) {
          ...
          {
            oprot.writeListBegin(new libthrift091.protocol.TList(libthrift091.protocol.TType.STRUCT, struct.success.size()));
            for (SubmitJobResponse _iter217 : struct.success)
            {
    ...
    private static class submitJobs_resultTupleScheme extends TupleScheme<submitJobs_result> {
      ...
      public void write(libthrift091.protocol.TProtocol prot, submitJobs_result struct) throws libthrift091.TException {
        ...
        if (struct.isSetSuccess()) {
          {
            oprot.writeI32(struct.success.size());
            for (SubmitJobResponse _iter218 : struct.success)
            {
      ...
      public void read(libthrift091.protocol.TProtocol prot, submitJobs_result struct) throws libthrift091.TException {
        ...
        if (incoming.get(0)) {
          {
            libthrift091.protocol.TList _list219 = new libthrift091.protocol.TList(libthrift091.protocol.TType.STRUCT, iprot.readI32());
            struct.success = new ArrayList<SubmitJobResponse>(_list219.size);
            SubmitJobResponse _elem220;
            for (int _i221 = 0; _i221 < _list219.size; ++_i221)
            {
              _elem220 = new SubmitJobResponse();
              _elem220.read(iprot);
    ...
    private static class listClusters_resultStandardScheme extends StandardScheme<listClusters_result> {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
            case 0: // SUCCESS
              if (schemeField.type == libthrift091.protocol.TType.LIST) {
                {
                  libthrift091.protocol.TList _list222 = iprot.readListBegin();
                  struct.success = new ArrayList<ClusterDetail>(_list222.size);
                  ClusterDetail _elem223;
                  for (int _i224 = 0; _i224 < _list222.size; ++_i224)
                  {
                    _elem223 = new ClusterDetail();
                    _elem223.read(iprot);
      ...
      public void write(libthrift091.protocol.TProtocol oprot, listClusters_result struct) throws libthrift091.TException {
        ...
        if (struct.success != null) {
          ...
          {
            oprot.writeListBegin(new libthrift091.protocol.TList(libthrift091.protocol.TType.STRUCT, struct.success.size()));
            for (ClusterDetail _iter225 : struct.success)
            {
    ...
    private static class listClusters_resultTupleScheme extends TupleScheme<listClusters_result> {
      ...
      public void write(libthrift091.protocol.TProtocol prot, listClusters_result struct) throws libthrift091.TException {
        ...
        if (struct.isSetSuccess()) {
          {
            oprot.writeI32(struct.success.size());
            for (ClusterDetail _iter226 : struct.success)
            {
      ...
      public void read(libthrift091.protocol.TProtocol prot, listClusters_result struct) throws libthrift091.TException {
        ...
        if (incoming.get(0)) {
          {
            libthrift091.protocol.TList _list227 = new libthrift091.protocol.TList(libthrift091.protocol.TType.STRUCT, iprot.readI32());
            struct.success = new ArrayList<ClusterDetail>(_list227.size);
            ClusterDetail _elem228;
            for (int _i229 = 0; _i229 < _list227.size; ++_i229)
            {
              _elem228 = new ClusterDetail();
              _elem228.read(iprot);
    ...
    private static class listClustersWithPrefix_resultStandardScheme extends StandardScheme<listClustersWithPrefix_result> {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
            case 0: // SUCCESS
              if (schemeField.type == libthrift091.protocol.TType.LIST) {
                {
                  libthrift091.protocol.TList _list230 = iprot.readListBegin();
                  struct.success = new ArrayList<ClusterDetail>(_list230.size);
                  ClusterDetail _elem231;
                  for (int _i232 = 0; _i232 < _list230.size; ++_i232)
                  {
                    _elem231 = new ClusterDetail();
                    _elem231.read(iprot);
      ...
      public void write(libthrift091.protocol.TProtocol oprot, listClustersWithPrefix_result struct) throws libthrift091.TException {
        ...
        if (struct.success != null) {
          ...
          {
            oprot.writeListBegin(new libthrift091.protocol.TList(libthrift091.protocol.TType.STRUCT, struct.success.size()));
            for (ClusterDetail _iter233 : struct.success)
            {
    ...
    private static class listClustersWithPrefix_resultTupleScheme extends TupleScheme<listClustersWithPrefix_result> {
      ...
      public void write(libthrift091.protocol.TProtocol prot, listClustersWithPrefix_result struct) throws libthrift091.TException {
        ...
        if (struct.isSetSuccess()) {
          {
            oprot.writeI32(struct.success.size());
            for (ClusterDetail _iter234 : struct.success)
            {
      ...
      public void read(libthrift091.protocol.TProtocol prot, listClustersWithPrefix_result struct) throws libthrift091.TException {
        ...
        if (incoming.get(0)) {
          {
            libthrift091.protocol.TList _list235 = new libthrift091.protocol.TList(libthrift091.protocol.TType.STRUCT, iprot.readI32());
            struct.success = new ArrayList<ClusterDetail>(_list235.size);
            ClusterDetail _elem236;
            for (int _i237 = 0; _i237 < _list235.size; ++_i237)
            {
              _elem236 = new ClusterDetail();
              _elem236.read(iprot);
    ...
    private static class listInstanceGroups_resultStandardScheme extends StandardScheme<listInstanceGroups_result> {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
            case 0: // SUCCESS
              if (schemeField.type == libthrift091.protocol.TType.LIST) {
                {
                  libthrift091.protocol.TList _list238 = iprot.readListBegin();
                  struct.success = new ArrayList<InstanceGroupDetail>(_list238.size);
                  InstanceGroupDetail _elem239;
                  for (int _i240 = 0; _i240 < _list238.size; ++_i240)
                  {
                    _elem239 = new InstanceGroupDetail();
                    _elem239.read(iprot);
      ...
      public void write(libthrift091.protocol.TProtocol oprot, listInstanceGroups_result struct) throws libthrift091.TException {
        ...
        if (struct.success != null) {
          ...
          {
            oprot.writeListBegin(new libthrift091.protocol.TList(libthrift091.protocol.TType.STRUCT, struct.success.size()));
            for (InstanceGroupDetail _iter241 : struct.success)
            {
    ...
    private static class listInstanceGroups_resultTupleScheme extends TupleScheme<listInstanceGroups_result> {
      ...
      public void write(libthrift091.protocol.TProtocol prot, listInstanceGroups_result struct) throws libthrift091.TException {
        ...
        if (struct.isSetSuccess()) {
          {
            oprot.writeI32(struct.success.size());
            for (InstanceGroupDetail _iter242 : struct.success)
            {
      ...
      public void read(libthrift091.protocol.TProtocol prot, listInstanceGroups_result struct) throws libthrift091.TException {
        ...
        if (incoming.get(0)) {
          {
            libthrift091.protocol.TList _list243 = new libthrift091.protocol.TList(libthrift091.protocol.TType.STRUCT, iprot.readI32());
            struct.success = new ArrayList<InstanceGroupDetail>(_list243.size);
            InstanceGroupDetail _elem244;
            for (int _i245 = 0; _i245 < _list243.size; ++_i245)
            {
              _elem244 = new InstanceGroupDetail();
              _elem244.read(iprot);
    ...
    private static class listInstancesInCluster_resultStandardScheme extends StandardScheme<listInstancesInCluster_result> {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
            case 0: // SUCCESS
              if (schemeField.type == libthrift091.protocol.TType.LIST) {
                {
                  libthrift091.protocol.TList _list246 = iprot.readListBegin();
                  struct.success = new ArrayList<InstanceDetail>(_list246.size);
                  InstanceDetail _elem247;
                  for (int _i248 = 0; _i248 < _list246.size; ++_i248)
                  {
                    _elem247 = new InstanceDetail();
                    _elem247.read(iprot);
      ...
      public void write(libthrift091.protocol.TProtocol oprot, listInstancesInCluster_result struct) throws libthrift091.TException {
        ...
        if (struct.success != null) {
          ...
          {
            oprot.writeListBegin(new libthrift091.protocol.TList(libthrift091.protocol.TType.STRUCT, struct.success.size()));
            for (InstanceDetail _iter249 : struct.success)
            {
    ...
    private static class listInstancesInCluster_resultTupleScheme extends TupleScheme<listInstancesInCluster_result> {
      ...
      public void write(libthrift091.protocol.TProtocol prot, listInstancesInCluster_result struct) throws libthrift091.TException {
        ...
        if (struct.isSetSuccess()) {
          {
            oprot.writeI32(struct.success.size());
            for (InstanceDetail _iter250 : struct.success)
            {
      ...
      public void read(libthrift091.protocol.TProtocol prot, listInstancesInCluster_result struct) throws libthrift091.TException {
        ...
        if (incoming.get(0)) {
          {
            libthrift091.protocol.TList _list251 = new libthrift091.protocol.TList(libthrift091.protocol.TType.STRUCT, iprot.readI32());
            struct.success = new ArrayList<InstanceDetail>(_list251.size);
            InstanceDetail _elem252;
            for (int _i253 = 0; _i253 < _list251.size; ++_i253)
            {
              _elem252 = new InstanceDetail();
              _elem252.read(iprot);
    ...
    private static class listInstancesInGroup_resultStandardScheme extends StandardScheme<listInstancesInGroup_result> {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
            case 0: // SUCCESS
              if (schemeField.type == libthrift091.protocol.TType.LIST) {
                {
                  libthrift091.protocol.TList _list254 = iprot.readListBegin();
                  struct.success = new ArrayList<InstanceDetail>(_list254.size);
                  InstanceDetail _elem255;
                  for (int _i256 = 0; _i256 < _list254.size; ++_i256)
                  {
                    _elem255 = new InstanceDetail();
                    _elem255.read(iprot);
      ...
      public void write(libthrift091.protocol.TProtocol oprot, listInstancesInGroup_result struct) throws libthrift091.TException {
        ...
        if (struct.success != null) {
          ...
          {
            oprot.writeListBegin(new libthrift091.protocol.TList(libthrift091.protocol.TType.STRUCT, struct.success.size()));
            for (InstanceDetail _iter257 : struct.success)
            {
    ...
    private static class listInstancesInGroup_resultTupleScheme extends TupleScheme<listInstancesInGroup_result> {
      ...
      public void write(libthrift091.protocol.TProtocol prot, listInstancesInGroup_result struct) throws libthrift091.TException {
        ...
        if (struct.isSetSuccess()) {
          {
            oprot.writeI32(struct.success.size());
            for (InstanceDetail _iter258 : struct.success)
            {
      ...
      public void read(libthrift091.protocol.TProtocol prot, listInstancesInGroup_result struct) throws libthrift091.TException {
        ...
        if (incoming.get(0)) {
          {
            libthrift091.protocol.TList _list259 = new libthrift091.protocol.TList(libthrift091.protocol.TType.STRUCT, iprot.readI32());
            struct.success = new ArrayList<InstanceDetail>(_list259.size);
            InstanceDetail _elem260;
            for (int _i261 = 0; _i261 < _list259.size; ++_i261)
            {
              _elem260 = new InstanceDetail();
              _elem260.read(iprot);
    ...
    private static class listJobs_resultStandardScheme extends StandardScheme<listJobs_result> {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
            case 0: // SUCCESS
              if (schemeField.type == libthrift091.protocol.TType.LIST) {
                {
                  libthrift091.protocol.TList _list262 = iprot.readListBegin();
                  struct.success = new ArrayList<JobDetail>(_list262.size);
                  JobDetail _elem263;
                  for (int _i264 = 0; _i264 < _list262.size; ++_i264)
                  {
                    _elem263 = new JobDetail();
                    _elem263.read(iprot);
      ...
      public void write(libthrift091.protocol.TProtocol oprot, listJobs_result struct) throws libthrift091.TException {
        ...
        if (struct.success != null) {
          ...
          {
            oprot.writeListBegin(new libthrift091.protocol.TList(libthrift091.protocol.TType.STRUCT, struct.success.size()));
            for (JobDetail _iter265 : struct.success)
            {
    ...
    private static class listJobs_resultTupleScheme extends TupleScheme<listJobs_result> {
      ...
      public void write(libthrift091.protocol.TProtocol prot, listJobs_result struct) throws libthrift091.TException {
        ...
        if (struct.isSetSuccess()) {
          {
            oprot.writeI32(struct.success.size());
            for (JobDetail _iter266 : struct.success)
            {
      ...
      public void read(libthrift091.protocol.TProtocol prot, listJobs_result struct) throws libthrift091.TException {
        ...
        if (incoming.get(0)) {
          {
            libthrift091.protocol.TList _list267 = new libthrift091.protocol.TList(libthrift091.protocol.TType.STRUCT, iprot.readI32());
            struct.success = new ArrayList<JobDetail>(_list267.size);
            JobDetail _elem268;
            for (int _i269 = 0; _i269 < _list267.size; ++_i269)
            {
              _elem268 = new JobDetail();
              _elem268.read(iprot);
