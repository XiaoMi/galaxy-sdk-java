...
public class TableStatus implements libthrift091.TBase<TableStatus, TableStatus._Fields>, java.io.Serializable, Cloneable, Comparable<TableStatus> {
  ...
  private _Fields optionals[] = {_Fields.STATE,_Fields.CREATE_TIME,_Fields.ALTER_TIME,_Fields.STAT_TIME,_Fields.SIZE,_Fields.ROW_COUNT};
        ...
        switch (schemeField.id) {
          case 1: // STATE
            if (schemeField.type == libthrift091.protocol.TType.I32) {
              struct.state = TableState.findByValue(iprot.readI32());
