...
public class TableSplit implements libthrift091.TBase<TableSplit, TableSplit._Fields>, java.io.Serializable, Cloneable, Comparable<TableSplit> {
        ...
        switch (schemeField.id) {
          case 1: // START_KEY
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                libthrift091.protocol.TMap _map152 = iprot.readMapBegin();
                struct.startKey = new HashMap<String,Datum>(2*_map152.size);
                String _key153;
                Datum _val154;
                for (int _i155 = 0; _i155 < _map152.size; ++_i155)
                {
                  ...
                  _val154 = new Datum();
                  _val154.read(iprot);
                  struct.startKey.put(_key153, _val154);
                }
                iprot.readMapEnd();
              }
          ...
          case 2: // STOP_KEY
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                libthrift091.protocol.TMap _map156 = iprot.readMapBegin();
                struct.stopKey = new HashMap<String,Datum>(2*_map156.size);
                String _key157;
                Datum _val158;
                for (int _i159 = 0; _i159 < _map156.size; ++_i159)
                {
                  ...
                  _val158 = new Datum();
                  _val158.read(iprot);
                  struct.stopKey.put(_key157, _val158);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.startKey != null) {
        if (struct.isSetStartKey()) {
          oprot.writeFieldBegin(START_KEY_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Datum> _iter160 : struct.startKey.entrySet())
            {
      ...
      if (struct.stopKey != null) {
        if (struct.isSetStopKey()) {
          oprot.writeFieldBegin(STOP_KEY_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Datum> _iter161 : struct.stopKey.entrySet())
            {
  ...
  private static class TableSplitTupleScheme extends TupleScheme<TableSplit> {
    ...
    public void read(libthrift091.protocol.TProtocol prot, TableSplit struct) throws libthrift091.TException {
      ...
      if (incoming.get(0)) {
        {
          libthrift091.protocol.TMap _map164 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.STRUCT, iprot.readI32());
          struct.startKey = new HashMap<String,Datum>(2*_map164.size);
          String _key165;
          Datum _val166;
          for (int _i167 = 0; _i167 < _map164.size; ++_i167)
          {
            ...
            _val166 = new Datum();
            _val166.read(iprot);
            struct.startKey.put(_key165, _val166);
          }
        }
        struct.setStartKeyIsSet(true);
      }
      if (incoming.get(1)) {
        {
          libthrift091.protocol.TMap _map168 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.STRUCT, iprot.readI32());
          struct.stopKey = new HashMap<String,Datum>(2*_map168.size);
          String _key169;
          Datum _val170;
          for (int _i171 = 0; _i171 < _map168.size; ++_i171)
          {
            ...
            _val170 = new Datum();
            _val170.read(iprot);
            struct.stopKey.put(_key169, _val170);
          }
        }
        struct.setStopKeyIsSet(true);
      }
