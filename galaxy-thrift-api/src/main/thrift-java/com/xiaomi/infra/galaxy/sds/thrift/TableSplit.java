...
public class TableSplit implements libthrift091.TBase<TableSplit, TableSplit._Fields>, java.io.Serializable, Cloneable, Comparable<TableSplit> {
  ...
  public TableSplit(TableSplit other) {
    if (other.isSetStartKey()) {
      Map<String,Datum> __this__startKey = new HashMap<String,Datum>(other.startKey.size());
      for (Map.Entry<String, Datum> other_element : other.startKey.entrySet()) {

        String other_element_key = other_element.getKey();
        Datum other_element_value = other_element.getValue();

        String __this__startKey_copy_key = other_element_key;

        Datum __this__startKey_copy_value = new Datum(other_element_value);

        __this__startKey.put(__this__startKey_copy_key, __this__startKey_copy_value);
      }
      this.startKey = __this__startKey;
    }
    if (other.isSetStopKey()) {
      Map<String,Datum> __this__stopKey = new HashMap<String,Datum>(other.stopKey.size());
      for (Map.Entry<String, Datum> other_element : other.stopKey.entrySet()) {

        String other_element_key = other_element.getKey();
        Datum other_element_value = other_element.getValue();

        String __this__stopKey_copy_key = other_element_key;

        Datum __this__stopKey_copy_value = new Datum(other_element_value);

        __this__stopKey.put(__this__stopKey_copy_key, __this__stopKey_copy_value);
      }
      this.stopKey = __this__stopKey;
    }
  }
            ...
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                ...
                for (int _i135 = 0; _i135 < _map134.size; ++_i135)
                {
                  ...
                  _val137 = new Datum();
                  _val137.read(iprot);
                  struct.startKey.put(_key136, _val137);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                ...
                for (int _i139 = 0; _i139 < _map138.size; ++_i139)
                {
                  ...
                  _val141 = new Datum();
                  _val141.read(iprot);
                  struct.stopKey.put(_key140, _val141);
                }
                iprot.readMapEnd();
              }
      ...
      if (incoming.get(0)) {
        {
          ...
          for (int _i147 = 0; _i147 < _map146.size; ++_i147)
          {
            ...
            _val149 = new Datum();
            _val149.read(iprot);
            struct.startKey.put(_key148, _val149);
          }
        }
        struct.setStartKeyIsSet(true);
      }
      if (incoming.get(1)) {
        {
          ...
          for (int _i151 = 0; _i151 < _map150.size; ++_i151)
          {
            ...
            _val153 = new Datum();
            _val153.read(iprot);
            struct.stopKey.put(_key152, _val153);
          }
        }
        struct.setStopKeyIsSet(true);
      }
