...
public class TableSplit implements libthrift091.TBase<TableSplit, TableSplit._Fields>, java.io.Serializable, Cloneable, Comparable<TableSplit> {
        ...
        switch (schemeField.id) {
          case 1: // START_KEY
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                libthrift091.protocol.TMap _map170 = iprot.readMapBegin();
                struct.startKey = new HashMap<String,Datum>(2*_map170.size);
                String _key171;
                Datum _val172;
                for (int _i173 = 0; _i173 < _map170.size; ++_i173)
                {
                  ...
                  _val172 = new Datum();
                  _val172.read(iprot);
                  struct.startKey.put(_key171, _val172);
                }
                iprot.readMapEnd();
              }
          ...
          case 2: // STOP_KEY
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                libthrift091.protocol.TMap _map174 = iprot.readMapBegin();
                struct.stopKey = new HashMap<String,Datum>(2*_map174.size);
                String _key175;
                Datum _val176;
                for (int _i177 = 0; _i177 < _map174.size; ++_i177)
                {
                  ...
                  _val176 = new Datum();
                  _val176.read(iprot);
                  struct.stopKey.put(_key175, _val176);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.startKey != null) {
        if (struct.isSetStartKey()) {
          oprot.writeFieldBegin(START_KEY_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Datum> _iter178 : struct.startKey.entrySet())
            {
      ...
      if (struct.stopKey != null) {
        if (struct.isSetStopKey()) {
          oprot.writeFieldBegin(STOP_KEY_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Datum> _iter179 : struct.stopKey.entrySet())
            {
  ...
  private static class TableSplitTupleScheme extends TupleScheme<TableSplit> {
      ...
      if (struct.isSetStartKey()) {
        {
          ...
          for (Map.Entry<String, Datum> _iter180 : struct.startKey.entrySet())
          {
      ...
      if (struct.isSetStopKey()) {
        {
          ...
          for (Map.Entry<String, Datum> _iter181 : struct.stopKey.entrySet())
          {
    ...
    public void read(libthrift091.protocol.TProtocol prot, TableSplit struct) throws libthrift091.TException {
      ...
      if (incoming.get(0)) {
        {
          libthrift091.protocol.TMap _map182 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.STRUCT, iprot.readI32());
          struct.startKey = new HashMap<String,Datum>(2*_map182.size);
          String _key183;
          Datum _val184;
          for (int _i185 = 0; _i185 < _map182.size; ++_i185)
          {
            ...
            _val184 = new Datum();
            _val184.read(iprot);
            struct.startKey.put(_key183, _val184);
          }
        }
        struct.setStartKeyIsSet(true);
      }
      if (incoming.get(1)) {
        {
          libthrift091.protocol.TMap _map186 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.STRUCT, iprot.readI32());
          struct.stopKey = new HashMap<String,Datum>(2*_map186.size);
          String _key187;
          Datum _val188;
          for (int _i189 = 0; _i189 < _map186.size; ++_i189)
          {
            ...
            _val188 = new Datum();
            _val188.read(iprot);
            struct.stopKey.put(_key187, _val188);
          }
        }
        struct.setStopKeyIsSet(true);
      }
