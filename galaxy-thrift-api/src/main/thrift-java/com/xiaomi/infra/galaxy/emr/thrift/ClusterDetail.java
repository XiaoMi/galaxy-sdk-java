...
public class ClusterDetail implements libthrift091.TBase<ClusterDetail, ClusterDetail._Fields>, java.io.Serializable, Cloneable, Comparable<ClusterDetail> {
  ...
  private static final libthrift091.protocol.TField REGION_FIELD_DESC = new libthrift091.protocol.TField("region", libthrift091.protocol.TType.STRING, (short)3);
  private static final libthrift091.protocol.TField PURPOSE_FIELD_DESC = new libthrift091.protocol.TField("purpose", libthrift091.protocol.TType.STRING, (short)4);
  private static final libthrift091.protocol.TField KEY_PAIR_FIELD_DESC = new libthrift091.protocol.TField("keyPair", libthrift091.protocol.TType.STRING, (short)5);
  private static final libthrift091.protocol.TField AUTO_TERMINATE_FIELD_DESC = new libthrift091.protocol.TField("autoTerminate", libthrift091.protocol.TType.BOOL, (short)6);
  private static final libthrift091.protocol.TField TERMINATION_PROTECTED_FIELD_DESC = new libthrift091.protocol.TField("terminationProtected", libthrift091.protocol.TType.BOOL, (short)7);
  private static final libthrift091.protocol.TField INSTANCE_GROUPS_FIELD_DESC = new libthrift091.protocol.TField("instanceGroups", libthrift091.protocol.TType.LIST, (short)8);
  private static final libthrift091.protocol.TField MASTER_PUBLIC_DNS_NAME_FIELD_DESC = new libthrift091.protocol.TField("masterPublicDnsName", libthrift091.protocol.TType.STRING, (short)9);
  private static final libthrift091.protocol.TField CLUSTER_STATUS_FIELD_DESC = new libthrift091.protocol.TField("clusterStatus", libthrift091.protocol.TType.STRUCT, (short)10);
  ...
  public enum _Fields implements libthrift091.TFieldIdEnum {
    ...
    KEY_PAIR((short)5, "keyPair"),
    AUTO_TERMINATE((short)6, "autoTerminate"),
    TERMINATION_PROTECTED((short)7, "terminationProtected"),
    INSTANCE_GROUPS((short)8, "instanceGroups"),
    MASTER_PUBLIC_DNS_NAME((short)9, "masterPublicDnsName"),
    CLUSTER_STATUS((short)10, "clusterStatus");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 5: // KEY_PAIR
          return KEY_PAIR;
        case 6: // AUTO_TERMINATE
          return AUTO_TERMINATE;
        case 7: // TERMINATION_PROTECTED
          return TERMINATION_PROTECTED;
        case 8: // INSTANCE_GROUPS
          return INSTANCE_GROUPS;
        case 9: // MASTER_PUBLIC_DNS_NAME
          return MASTER_PUBLIC_DNS_NAME;
        case 10: // CLUSTER_STATUS
  ...
  private static final _Fields optionals[] = {_Fields.NAME,_Fields.REGION,_Fields.PURPOSE,_Fields.KEY_PAIR,_Fields.AUTO_TERMINATE,_Fields.TERMINATION_PROTECTED,_Fields.INSTANCE_GROUPS,_Fields.MASTER_PUBLIC_DNS_NAME,_Fields.CLUSTER_STATUS};
  ...
  static {
    ...
    tmpMap.put(_Fields.INSTANCE_GROUPS, new libthrift091.meta_data.FieldMetaData("instanceGroups", libthrift091.TFieldRequirementType.OPTIONAL, 
        new libthrift091.meta_data.ListMetaData(libthrift091.protocol.TType.LIST, 
            new libthrift091.meta_data.FieldValueMetaData(libthrift091.protocol.TType.STRUCT            , "InstanceGroupDetail"))));
  ...
  public ClusterDetail(ClusterDetail other) {
    ...
    if (other.isSetInstanceGroups()) {
      ...
      for (InstanceGroupDetail other_element : other.instanceGroups) {
        __this__instanceGroups.add(other_element);
      }
            ...
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                ...
                struct.instanceGroups = new ArrayList<InstanceGroupDetail>(_list58.size);
                InstanceGroupDetail _elem59;
                for (int _i60 = 0; _i60 < _list58.size; ++_i60)
                {
                  _elem59 = new InstanceGroupDetail();
                  _elem59.read(iprot);
                  struct.instanceGroups.add(_elem59);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.instanceGroups != null) {
        if (struct.isSetInstanceGroups()) {
          oprot.writeFieldBegin(INSTANCE_GROUPS_FIELD_DESC);
          {
            ...
            for (InstanceGroupDetail _iter61 : struct.instanceGroups)
            {
              _iter61.write(oprot);
            }
            oprot.writeListEnd();
  ...
  private static class ClusterDetailTupleScheme extends TupleScheme<ClusterDetail> {
      ...
      if (struct.isSetInstanceGroups()) {
        {
          ...
          for (InstanceGroupDetail _iter62 : struct.instanceGroups)
          {
            _iter62.write(oprot);
          }
        }
    ...
    public void read(libthrift091.protocol.TProtocol prot, ClusterDetail struct) throws libthrift091.TException {
      ...
      if (incoming.get(6)) {
        {
          libthrift091.protocol.TList _list63 = new libthrift091.protocol.TList(libthrift091.protocol.TType.STRUCT, iprot.readI32());
          struct.instanceGroups = new ArrayList<InstanceGroupDetail>(_list63.size);
          InstanceGroupDetail _elem64;
          for (int _i65 = 0; _i65 < _list63.size; ++_i65)
          {
            _elem64 = new InstanceGroupDetail();
            _elem64.read(iprot);
            struct.instanceGroups.add(_elem64);
          }
        }
        struct.setInstanceGroupsIsSet(true);
      }
