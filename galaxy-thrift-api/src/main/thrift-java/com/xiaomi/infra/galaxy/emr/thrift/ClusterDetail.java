...
public class ClusterDetail implements libthrift091.TBase<ClusterDetail, ClusterDetail._Fields>, java.io.Serializable, Cloneable, Comparable<ClusterDetail> {
        ...
        switch (schemeField.id) {
          ...
          case 8: // INSTANCE_GROUPS
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                libthrift091.protocol.TList _list86 = iprot.readListBegin();
                struct.instanceGroups = new ArrayList<InstanceGroupDetail>(_list86.size);
                InstanceGroupDetail _elem87;
                for (int _i88 = 0; _i88 < _list86.size; ++_i88)
                {
                  _elem87 = new InstanceGroupDetail();
                  _elem87.read(iprot);
                  struct.instanceGroups.add(_elem87);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.instanceGroups != null) {
        if (struct.isSetInstanceGroups()) {
          oprot.writeFieldBegin(INSTANCE_GROUPS_FIELD_DESC);
          {
            ...
            for (InstanceGroupDetail _iter89 : struct.instanceGroups)
            {
              _iter89.write(oprot);
            }
            oprot.writeListEnd();
  ...
  private static class ClusterDetailTupleScheme extends TupleScheme<ClusterDetail> {
      ...
      if (struct.isSetInstanceGroups()) {
        {
          ...
          for (InstanceGroupDetail _iter90 : struct.instanceGroups)
          {
            _iter90.write(oprot);
          }
        }
    ...
    public void read(libthrift091.protocol.TProtocol prot, ClusterDetail struct) throws libthrift091.TException {
      ...
      if (incoming.get(6)) {
        {
          libthrift091.protocol.TList _list91 = new libthrift091.protocol.TList(libthrift091.protocol.TType.STRUCT, iprot.readI32());
          struct.instanceGroups = new ArrayList<InstanceGroupDetail>(_list91.size);
          InstanceGroupDetail _elem92;
          for (int _i93 = 0; _i93 < _list91.size; ++_i93)
          {
            _elem92 = new InstanceGroupDetail();
            _elem92.read(iprot);
            struct.instanceGroups.add(_elem92);
          }
        }
        struct.setInstanceGroupsIsSet(true);
      }
