...
public class GetResult implements libthrift091.TBase<GetResult, GetResult._Fields>, java.io.Serializable, Cloneable, Comparable<GetResult> {
            ...
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                ...
                struct.item = new HashMap<String,Datum>(2*_map172.size);
                String _key173;
                Datum _val174;
                for (int _i175 = 0; _i175 < _map172.size; ++_i175)
                {
                  ...
                  _val174 = new Datum();
                  _val174.read(iprot);
                  struct.item.put(_key173, _val174);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.item != null) {
        if (struct.isSetItem()) {
          oprot.writeFieldBegin(ITEM_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Datum> _iter176 : struct.item.entrySet())
            {
  ...
  private static class GetResultTupleScheme extends TupleScheme<GetResult> {
      ...
      if (struct.isSetItem()) {
        {
          ...
          for (Map.Entry<String, Datum> _iter177 : struct.item.entrySet())
          {
    ...
    public void read(libthrift091.protocol.TProtocol prot, GetResult struct) throws libthrift091.TException {
      ...
      if (incoming.get(0)) {
        {
          libthrift091.protocol.TMap _map178 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.STRUCT, iprot.readI32());
          struct.item = new HashMap<String,Datum>(2*_map178.size);
          String _key179;
          Datum _val180;
          for (int _i181 = 0; _i181 < _map178.size; ++_i181)
          {
            ...
            _val180 = new Datum();
            _val180.read(iprot);
            struct.item.put(_key179, _val180);
          }
        }
        struct.setItemIsSet(true);
      }
