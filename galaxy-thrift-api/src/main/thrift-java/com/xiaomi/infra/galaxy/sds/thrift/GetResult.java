...
public class GetResult implements libthrift091.TBase<GetResult, GetResult._Fields>, java.io.Serializable, Cloneable, Comparable<GetResult> {
            ...
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                ...
                struct.item = new HashMap<String,Datum>(2*_map190.size);
                String _key191;
                Datum _val192;
                for (int _i193 = 0; _i193 < _map190.size; ++_i193)
                {
                  ...
                  _val192 = new Datum();
                  _val192.read(iprot);
                  struct.item.put(_key191, _val192);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.item != null) {
        if (struct.isSetItem()) {
          oprot.writeFieldBegin(ITEM_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Datum> _iter194 : struct.item.entrySet())
            {
  ...
  private static class GetResultTupleScheme extends TupleScheme<GetResult> {
      ...
      if (struct.isSetItem()) {
        {
          ...
          for (Map.Entry<String, Datum> _iter195 : struct.item.entrySet())
          {
    ...
    public void read(libthrift091.protocol.TProtocol prot, GetResult struct) throws libthrift091.TException {
      ...
      if (incoming.get(0)) {
        {
          libthrift091.protocol.TMap _map196 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.STRUCT, iprot.readI32());
          struct.item = new HashMap<String,Datum>(2*_map196.size);
          String _key197;
          Datum _val198;
          for (int _i199 = 0; _i199 < _map196.size; ++_i199)
          {
            ...
            _val198 = new Datum();
            _val198.read(iprot);
            struct.item.put(_key197, _val198);
          }
        }
        struct.setItemIsSet(true);
      }
