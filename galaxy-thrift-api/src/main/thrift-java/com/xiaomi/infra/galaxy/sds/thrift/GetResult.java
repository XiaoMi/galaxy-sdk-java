...
public class GetResult implements libthrift091.TBase<GetResult, GetResult._Fields>, java.io.Serializable, Cloneable, Comparable<GetResult> {
            ...
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                ...
                struct.item = new HashMap<String,Datum>(2*_map192.size);
                String _key193;
                Datum _val194;
                for (int _i195 = 0; _i195 < _map192.size; ++_i195)
                {
                  ...
                  _val194 = new Datum();
                  _val194.read(iprot);
                  struct.item.put(_key193, _val194);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.item != null) {
        if (struct.isSetItem()) {
          oprot.writeFieldBegin(ITEM_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Datum> _iter196 : struct.item.entrySet())
            {
  ...
  private static class GetResultTupleScheme extends TupleScheme<GetResult> {
      ...
      if (struct.isSetItem()) {
        {
          ...
          for (Map.Entry<String, Datum> _iter197 : struct.item.entrySet())
          {
    ...
    public void read(libthrift091.protocol.TProtocol prot, GetResult struct) throws libthrift091.TException {
      ...
      if (incoming.get(0)) {
        {
          libthrift091.protocol.TMap _map198 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.STRUCT, iprot.readI32());
          struct.item = new HashMap<String,Datum>(2*_map198.size);
          String _key199;
          Datum _val200;
          for (int _i201 = 0; _i201 < _map198.size; ++_i201)
          {
            ...
            _val200 = new Datum();
            _val200.read(iprot);
            struct.item.put(_key199, _val200);
          }
        }
        struct.setItemIsSet(true);
      }
