...
public class GetResult implements libthrift091.TBase<GetResult, GetResult._Fields>, java.io.Serializable, Cloneable, Comparable<GetResult> {
        ...
        switch (schemeField.id) {
          case 1: // ITEM
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                libthrift091.protocol.TMap _map208 = iprot.readMapBegin();
                struct.item = new HashMap<String,Datum>(2*_map208.size);
                String _key209;
                Datum _val210;
                for (int _i211 = 0; _i211 < _map208.size; ++_i211)
                {
                  ...
                  _val210 = new Datum();
                  _val210.read(iprot);
                  struct.item.put(_key209, _val210);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.item != null) {
        if (struct.isSetItem()) {
          oprot.writeFieldBegin(ITEM_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Datum> _iter212 : struct.item.entrySet())
            {
  ...
  private static class GetResultTupleScheme extends TupleScheme<GetResult> {
      ...
      if (struct.isSetItem()) {
        {
          ...
          for (Map.Entry<String, Datum> _iter213 : struct.item.entrySet())
          {
    ...
    public void read(libthrift091.protocol.TProtocol prot, GetResult struct) throws libthrift091.TException {
      ...
      if (incoming.get(0)) {
        {
          libthrift091.protocol.TMap _map214 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.STRUCT, iprot.readI32());
          struct.item = new HashMap<String,Datum>(2*_map214.size);
          String _key215;
          Datum _val216;
          for (int _i217 = 0; _i217 < _map214.size; ++_i217)
          {
            ...
            _val216 = new Datum();
            _val216.read(iprot);
            struct.item.put(_key215, _val216);
          }
        }
        struct.setItemIsSet(true);
      }
