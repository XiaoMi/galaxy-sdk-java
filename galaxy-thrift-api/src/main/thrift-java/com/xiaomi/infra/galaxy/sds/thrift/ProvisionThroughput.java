...
public class ProvisionThroughput implements libthrift091.TBase<ProvisionThroughput, ProvisionThroughput._Fields>, java.io.Serializable, Cloneable, Comparable<ProvisionThroughput> {
  ...
  public long readQps; // required
  public long writeQps; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.READ_QPS, new libthrift091.meta_data.FieldMetaData("readQps", libthrift091.TFieldRequirementType.REQUIRED, 
        new libthrift091.meta_data.FieldValueMetaData(libthrift091.protocol.TType.I64)));
    tmpMap.put(_Fields.WRITE_QPS, new libthrift091.meta_data.FieldMetaData("writeQps", libthrift091.TFieldRequirementType.REQUIRED, 
        new libthrift091.meta_data.FieldValueMetaData(libthrift091.protocol.TType.I64)));
  ...
  public ProvisionThroughput setReadQps(long readQps) {
    this.readQps = readQps;
    setReadQpsIsSet(true);
    return this;
  }
  ...
  public ProvisionThroughput setWriteQps(long writeQps) {
    this.writeQps = writeQps;
    setWriteQpsIsSet(true);
    return this;
  }
  ...
  public boolean equals(ProvisionThroughput that) {
    ...
    boolean this_present_readQps = true;
    boolean that_present_readQps = true;
    ...
    boolean this_present_writeQps = true;
    boolean that_present_writeQps = true;
  ...
  public int hashCode() {
    ...
    boolean present_readQps = true;
    list.add(present_readQps);
    if (present_readQps)
      list.add(readQps);

    boolean present_writeQps = true;
  ...
  public void validate() throws libthrift091.TException {
    ...
    // alas, we cannot check 'readQps' because it's a primitive and you chose the non-beans generator.
    // alas, we cannot check 'writeQps' because it's a primitive and you chose the non-beans generator.
  ...
  private static class ProvisionThroughputStandardScheme extends StandardScheme<ProvisionThroughput> {
    ...
    public void read(libthrift091.protocol.TProtocol iprot, ProvisionThroughput struct) throws libthrift091.TException {
      ...
      if (!struct.isSetReadQps()) {
        throw new libthrift091.protocol.TProtocolException("Required field 'readQps' was not found in serialized data! Struct: " + toString());
      }
      if (!struct.isSetWriteQps()) {
        throw new libthrift091.protocol.TProtocolException("Required field 'writeQps' was not found in serialized data! Struct: " + toString());
      }
      struct.validate();
    }
