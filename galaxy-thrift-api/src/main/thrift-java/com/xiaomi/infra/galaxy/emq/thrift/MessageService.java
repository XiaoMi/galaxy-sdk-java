              ...
              if (schemeField.type == libthrift091.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<ReceiveMessageResponse>(_list72.size);
                  ReceiveMessageResponse _elem73;
                  for (int _i74 = 0; _i74 < _list72.size; ++_i74)
                  {
                    _elem73 = new ReceiveMessageResponse();
                    _elem73.read(iprot);
      ...
      public void write(libthrift091.protocol.TProtocol oprot, receiveMessage_result struct) throws libthrift091.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (ReceiveMessageResponse _iter75 : struct.success)
            {
              _iter75.write(oprot);
            }
            oprot.writeListEnd();
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (ReceiveMessageResponse _iter76 : struct.success)
            {
              _iter76.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<ReceiveMessageResponse>(_list77.size);
            ReceiveMessageResponse _elem78;
            for (int _i79 = 0; _i79 < _list77.size; ++_i79)
            {
              _elem78 = new ReceiveMessageResponse();
              _elem78.read(iprot);
