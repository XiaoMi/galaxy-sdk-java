...
public class MessageService {
  ...
  public interface Iface extends com.xiaomi.infra.galaxy.emq.thrift.EMQBaseService.Iface {
     ...
     * @param requests
     */
    public List<SendMessageResponse> sendMessageBatch(String queueName, List<SendMessageRequest> requests) throws com.xiaomi.infra.galaxy.emq.thrift.GalaxyEmqServiceException, libthrift091.TException;
     ...
     * @param requests
     */
    public void changeMessageVisibilitySecondsBatch(String queueName, List<ChangeMessageVisibilityRequest> requests) throws com.xiaomi.infra.galaxy.emq.thrift.GalaxyEmqServiceException, libthrift091.TException;
     ...
     * @param requests
     */
    public void deleteMessageBatch(String queueName, List<DeleteMessageRequest> requests) throws com.xiaomi.infra.galaxy.emq.thrift.GalaxyEmqServiceException, libthrift091.TException;
  ...
  public interface AsyncIface extends com.xiaomi.infra.galaxy.emq.thrift.EMQBaseService .AsyncIface {
    ...
    public void sendMessageBatch(String queueName, List<SendMessageRequest> requests, libthrift091.async.AsyncMethodCallback resultHandler) throws libthrift091.TException;
  ...
  public static class Client extends com.xiaomi.infra.galaxy.emq.thrift.EMQBaseService.Client implements Iface {
    ...
    public void send_sendMessageBatch(String queueName, List<SendMessageRequest> requests) throws libthrift091.TException
    {
    ...
    public List<SendMessageResponse> recv_sendMessageBatch() throws com.xiaomi.infra.galaxy.emq.thrift.GalaxyEmqServiceException, libthrift091.TException
    {
  ...
  public static class AsyncClient extends com.xiaomi.infra.galaxy.emq.thrift.EMQBaseService.AsyncClient implements AsyncIface {
    ...
    public static class sendMessageBatch_call extends libthrift091.async.TAsyncMethodCall {
      private String queueName;
      private List<SendMessageRequest> requests;
      public sendMessageBatch_call(String queueName, List<SendMessageRequest> requests, libthrift091.async.AsyncMethodCallback resultHandler, libthrift091.async.TAsyncClient client, libthrift091.protocol.TProtocolFactory protocolFactory, libthrift091.transport.TNonblockingTransport transport) throws libthrift091.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.queueName = queueName;
      ...
      public List<SendMessageResponse> getResult() throws com.xiaomi.infra.galaxy.emq.thrift.GalaxyEmqServiceException, libthrift091.TException {
        if (getState() != libthrift091.async.TAsyncMethodCall.State.RESPONSE_READ) {
          throw new IllegalStateException("Method call not finished!");
        }
        libthrift091.transport.TMemoryInputTransport memoryTransport = new libthrift091.transport.TMemoryInputTransport(getFrameBuffer().array());
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends com.xiaomi.infra.galaxy.emq.thrift.EMQBaseService.AsyncProcessor<I> {
    ...
    public static class sendMessageBatch<I extends AsyncIface> extends libthrift091.AsyncProcessFunction<I, sendMessageBatch_args, List<SendMessageResponse>> {
      public sendMessageBatch() {
        super("sendMessageBatch");
      }
      ...
      public AsyncMethodCallback<List<SendMessageResponse>> getResultHandler(final AsyncFrameBuffer fb, final int seqid) {
        final libthrift091.AsyncProcessFunction fcall = this;
        return new AsyncMethodCallback<List<SendMessageResponse>>() { 
          public void onComplete(List<SendMessageResponse> o) {
            sendMessageBatch_result result = new sendMessageBatch_result();
            result.success = o;
            try {
              fcall.sendResponse(fb,result, libthrift091.protocol.TMessageType.REPLY,seqid);
      ...
      public void start(I iface, sendMessageBatch_args args, libthrift091.async.AsyncMethodCallback<List<SendMessageResponse>> resultHandler) throws TException {
    ...
    public static class changeMessageVisibilitySecondsBatch<I extends AsyncIface> extends libthrift091.AsyncProcessFunction<I, changeMessageVisibilitySecondsBatch_args, Void> {
      public changeMessageVisibilitySecondsBatch() {
        super("changeMessageVisibilitySecondsBatch");
      }
      ...
      public void start(I iface, changeMessageVisibilitySecondsBatch_args args, libthrift091.async.AsyncMethodCallback<Void> resultHandler) throws TException {
    ...
    public static class deleteMessageBatch<I extends AsyncIface> extends libthrift091.AsyncProcessFunction<I, deleteMessageBatch_args, Void> {
      public deleteMessageBatch() {
        super("deleteMessageBatch");
      }
      ...
      public void start(I iface, deleteMessageBatch_args args, libthrift091.async.AsyncMethodCallback<Void> resultHandler) throws TException {
  ...
  public static class sendMessageBatch_args implements libthrift091.TBase<sendMessageBatch_args, sendMessageBatch_args._Fields>, java.io.Serializable, Cloneable, Comparable<sendMessageBatch_args>   {
    ...
    public String queueName; // required
    public List<SendMessageRequest> requests; // required
    ...
    public sendMessageBatch_args(sendMessageBatch_args other) {
      ...
      if (other.isSetRequests()) {
        List<SendMessageRequest> __this__requests = new ArrayList<SendMessageRequest>(other.requests.size());
    ...
    public java.util.Iterator<SendMessageRequest> getRequestsIterator() {
      return (this.requests == null) ? null : this.requests.iterator();
    }

    public void addToRequests(SendMessageRequest elem) {
      if (this.requests == null) {
        this.requests = new ArrayList<SendMessageRequest>();
      }
      this.requests.add(elem);
    }

    public List<SendMessageRequest> getRequests() {
      return this.requests;
    }

    public sendMessageBatch_args setRequests(List<SendMessageRequest> requests) {
      this.requests = requests;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case REQUESTS:
        if (value == null) {
          ...
          setRequests((List<SendMessageRequest>)value);
        }
        break;
              ...
              if (schemeField.type == libthrift091.protocol.TType.LIST) {
                {
                  ...
                  struct.requests = new ArrayList<SendMessageRequest>(_list0.size);
        ...
        if (incoming.get(1)) {
          {
            ...
            struct.requests = new ArrayList<SendMessageRequest>(_list5.size);
  ...
  public static class sendMessageBatch_result implements libthrift091.TBase<sendMessageBatch_result, sendMessageBatch_result._Fields>, java.io.Serializable, Cloneable, Comparable<sendMessageBatch_result>   {
    ...
    public List<SendMessageResponse> success; // required
    public com.xiaomi.infra.galaxy.emq.thrift.GalaxyEmqServiceException e; // required
    ...
    public sendMessageBatch_result(
      List<SendMessageResponse> success,
      com.xiaomi.infra.galaxy.emq.thrift.GalaxyEmqServiceException e)
    {
      this();
      this.success = success;
    ...
    public sendMessageBatch_result(sendMessageBatch_result other) {
      if (other.isSetSuccess()) {
        List<SendMessageResponse> __this__success = new ArrayList<SendMessageResponse>(other.success.size());
    ...
    public java.util.Iterator<SendMessageResponse> getSuccessIterator() {
      return (this.success == null) ? null : this.success.iterator();
    }

    public void addToSuccess(SendMessageResponse elem) {
      if (this.success == null) {
        this.success = new ArrayList<SendMessageResponse>();
      }
      this.success.add(elem);
    }

    public List<SendMessageResponse> getSuccess() {
      return this.success;
    }

    public sendMessageBatch_result setSuccess(List<SendMessageResponse> success) {
      this.success = success;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case SUCCESS:
        if (value == null) {
          ...
          setSuccess((List<SendMessageResponse>)value);
        }
        break;
              ...
              if (schemeField.type == libthrift091.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<SendMessageResponse>(_list8.size);
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<SendMessageResponse>(_list13.size);
              ...
              if (schemeField.type == libthrift091.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<ReceiveMessageResponse>(_list16.size);
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<ReceiveMessageResponse>(_list21.size);
              ...
              if (schemeField.type == libthrift091.protocol.TType.LIST) {
                {
                  ...
                  struct.requests = new ArrayList<ChangeMessageVisibilityRequest>(_list24.size);
        ...
        if (incoming.get(1)) {
          {
            ...
            struct.requests = new ArrayList<ChangeMessageVisibilityRequest>(_list29.size);
              ...
              if (schemeField.type == libthrift091.protocol.TType.LIST) {
                {
                  ...
                  struct.requests = new ArrayList<DeleteMessageRequest>(_list32.size);
        ...
        if (incoming.get(1)) {
          {
            ...
            struct.requests = new ArrayList<DeleteMessageRequest>(_list37.size);
