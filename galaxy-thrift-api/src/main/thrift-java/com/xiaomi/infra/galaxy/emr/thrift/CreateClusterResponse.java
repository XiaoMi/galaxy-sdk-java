...
public class CreateClusterResponse implements libthrift091.TBase<CreateClusterResponse, CreateClusterResponse._Fields>, java.io.Serializable, Cloneable, Comparable<CreateClusterResponse> {
  ...
  static {
    ...
    tmpMap.put(_Fields.ADD_INSTANCE_GROUP_RESPONSES, new libthrift091.meta_data.FieldMetaData("addInstanceGroupResponses", libthrift091.TFieldRequirementType.OPTIONAL, 
        new libthrift091.meta_data.ListMetaData(libthrift091.protocol.TType.LIST, 
            new libthrift091.meta_data.FieldValueMetaData(libthrift091.protocol.TType.STRUCT            , "AddInstanceGroupResponse"))));
    tmpMap.put(_Fields.SUBMIT_JOB_RESPONSES, new libthrift091.meta_data.FieldMetaData("submitJobResponses", libthrift091.TFieldRequirementType.OPTIONAL, 
        new libthrift091.meta_data.ListMetaData(libthrift091.protocol.TType.LIST, 
            new libthrift091.meta_data.FieldValueMetaData(libthrift091.protocol.TType.STRUCT            , "SubmitJobResponse"))));
  ...
  public CreateClusterResponse(CreateClusterResponse other) {
    ...
    if (other.isSetAddInstanceGroupResponses()) {
      ...
      for (AddInstanceGroupResponse other_element : other.addInstanceGroupResponses) {
        __this__addInstanceGroupResponses.add(other_element);
      }
    ...
    if (other.isSetSubmitJobResponses()) {
      ...
      for (SubmitJobResponse other_element : other.submitJobResponses) {
        __this__submitJobResponses.add(other_element);
      }
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                ...
                struct.addInstanceGroupResponses = new ArrayList<AddInstanceGroupResponse>(_list24.size);
                AddInstanceGroupResponse _elem25;
                for (int _i26 = 0; _i26 < _list24.size; ++_i26)
                {
                  _elem25 = new AddInstanceGroupResponse();
                  _elem25.read(iprot);
                  struct.addInstanceGroupResponses.add(_elem25);
                }
                iprot.readListEnd();
              }
          ...
          case 4: // SUBMIT_JOB_RESPONSES
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                libthrift091.protocol.TList _list27 = iprot.readListBegin();
                struct.submitJobResponses = new ArrayList<SubmitJobResponse>(_list27.size);
                SubmitJobResponse _elem28;
                for (int _i29 = 0; _i29 < _list27.size; ++_i29)
                {
                  _elem28 = new SubmitJobResponse();
                  _elem28.read(iprot);
                  struct.submitJobResponses.add(_elem28);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.addInstanceGroupResponses != null) {
        if (struct.isSetAddInstanceGroupResponses()) {
          oprot.writeFieldBegin(ADD_INSTANCE_GROUP_RESPONSES_FIELD_DESC);
          {
            ...
            for (AddInstanceGroupResponse _iter30 : struct.addInstanceGroupResponses)
            {
              _iter30.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.submitJobResponses != null) {
        if (struct.isSetSubmitJobResponses()) {
          oprot.writeFieldBegin(SUBMIT_JOB_RESPONSES_FIELD_DESC);
          {
            ...
            for (SubmitJobResponse _iter31 : struct.submitJobResponses)
            {
              _iter31.write(oprot);
            }
            oprot.writeListEnd();
  ...
  private static class CreateClusterResponseTupleScheme extends TupleScheme<CreateClusterResponse> {
      ...
      if (struct.isSetAddInstanceGroupResponses()) {
        {
          ...
          for (AddInstanceGroupResponse _iter32 : struct.addInstanceGroupResponses)
          {
            _iter32.write(oprot);
          }
        }
      ...
      if (struct.isSetSubmitJobResponses()) {
        {
          ...
          for (SubmitJobResponse _iter33 : struct.submitJobResponses)
          {
            _iter33.write(oprot);
          }
        }
    ...
    public void read(libthrift091.protocol.TProtocol prot, CreateClusterResponse struct) throws libthrift091.TException {
      ...
      if (incoming.get(0)) {
        {
          libthrift091.protocol.TList _list34 = new libthrift091.protocol.TList(libthrift091.protocol.TType.STRUCT, iprot.readI32());
          struct.addInstanceGroupResponses = new ArrayList<AddInstanceGroupResponse>(_list34.size);
          AddInstanceGroupResponse _elem35;
          for (int _i36 = 0; _i36 < _list34.size; ++_i36)
          {
            _elem35 = new AddInstanceGroupResponse();
            _elem35.read(iprot);
            struct.addInstanceGroupResponses.add(_elem35);
          }
        }
        struct.setAddInstanceGroupResponsesIsSet(true);
      }
      if (incoming.get(1)) {
        {
          ...
          struct.submitJobResponses = new ArrayList<SubmitJobResponse>(_list37.size);
          SubmitJobResponse _elem38;
          for (int _i39 = 0; _i39 < _list37.size; ++_i39)
          {
            _elem38 = new SubmitJobResponse();
            _elem38.read(iprot);
            struct.submitJobResponses.add(_elem38);
          }
        }
        struct.setSubmitJobResponsesIsSet(true);
      }
