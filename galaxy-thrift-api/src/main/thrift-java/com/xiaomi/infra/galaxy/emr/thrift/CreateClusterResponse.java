...
public class CreateClusterResponse implements libthrift091.TBase<CreateClusterResponse, CreateClusterResponse._Fields>, java.io.Serializable, Cloneable, Comparable<CreateClusterResponse> {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                ...
                struct.addInstanceGroupResponses = new ArrayList<AddInstanceGroupResponse>(_list58.size);
                AddInstanceGroupResponse _elem59;
                for (int _i60 = 0; _i60 < _list58.size; ++_i60)
                {
                  _elem59 = new AddInstanceGroupResponse();
                  _elem59.read(iprot);
                  struct.addInstanceGroupResponses.add(_elem59);
                }
                iprot.readListEnd();
              }
          ...
          case 4: // SUBMIT_JOB_RESPONSES
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                libthrift091.protocol.TList _list61 = iprot.readListBegin();
                struct.submitJobResponses = new ArrayList<SubmitJobResponse>(_list61.size);
                SubmitJobResponse _elem62;
                for (int _i63 = 0; _i63 < _list61.size; ++_i63)
                {
                  _elem62 = new SubmitJobResponse();
                  _elem62.read(iprot);
                  struct.submitJobResponses.add(_elem62);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.addInstanceGroupResponses != null) {
        if (struct.isSetAddInstanceGroupResponses()) {
          oprot.writeFieldBegin(ADD_INSTANCE_GROUP_RESPONSES_FIELD_DESC);
          {
            ...
            for (AddInstanceGroupResponse _iter64 : struct.addInstanceGroupResponses)
            {
              _iter64.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.submitJobResponses != null) {
        if (struct.isSetSubmitJobResponses()) {
          oprot.writeFieldBegin(SUBMIT_JOB_RESPONSES_FIELD_DESC);
          {
            ...
            for (SubmitJobResponse _iter65 : struct.submitJobResponses)
            {
              _iter65.write(oprot);
            }
            oprot.writeListEnd();
  ...
  private static class CreateClusterResponseTupleScheme extends TupleScheme<CreateClusterResponse> {
      ...
      if (struct.isSetAddInstanceGroupResponses()) {
        {
          ...
          for (AddInstanceGroupResponse _iter66 : struct.addInstanceGroupResponses)
          {
            _iter66.write(oprot);
          }
        }
      ...
      if (struct.isSetSubmitJobResponses()) {
        {
          ...
          for (SubmitJobResponse _iter67 : struct.submitJobResponses)
          {
            _iter67.write(oprot);
          }
        }
    ...
    public void read(libthrift091.protocol.TProtocol prot, CreateClusterResponse struct) throws libthrift091.TException {
      ...
      if (incoming.get(0)) {
        {
          libthrift091.protocol.TList _list68 = new libthrift091.protocol.TList(libthrift091.protocol.TType.STRUCT, iprot.readI32());
