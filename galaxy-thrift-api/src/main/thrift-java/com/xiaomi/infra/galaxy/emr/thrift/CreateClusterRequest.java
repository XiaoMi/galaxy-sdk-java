...
public class CreateClusterRequest implements libthrift091.TBase<CreateClusterRequest, CreateClusterRequest._Fields>, java.io.Serializable, Cloneable, Comparable<CreateClusterRequest> {
  ...
  public CreateClusterRequest setTags(Map<String,String> tags) {
    this.tags = tags;
    return this;
  }
            ...
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                ...
                struct.tags = new HashMap<String,String>(2*_map48.size);
                String _key49;
                String _val50;
      ...
      if (struct.tags != null) {
        if (struct.isSetTags()) {
          oprot.writeFieldBegin(TAGS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, String> _iter54 : struct.tags.entrySet())
            {
      ...
      if (struct.isSetTags()) {
        {
          ...
          for (Map.Entry<String, String> _iter57 : struct.tags.entrySet())
          {
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.addInstanceGroupRequests = new ArrayList<AddInstanceGroupRequest>(_list58.size);
      ...
      if (incoming.get(6)) {
        {
          ...
          struct.submitJobRequests = new ArrayList<SubmitJobRequest>(_list61.size);
      ...
      if (incoming.get(8)) {
        {
          ...
          struct.tags = new HashMap<String,String>(2*_map64.size);
          String _key65;
          String _val66;
