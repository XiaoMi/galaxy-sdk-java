...
public class CreateClusterRequest implements libthrift091.TBase<CreateClusterRequest, CreateClusterRequest._Fields>, java.io.Serializable, Cloneable, Comparable<CreateClusterRequest> {
  ...
  private static final _Fields optionals[] = {_Fields.AUTO_TERMINATE,_Fields.TERMINATION_PROTECTED,_Fields.REGION,_Fields.PURPOSE,_Fields.KEY_PAIR,_Fields.ADD_INSTANCE_GROUP_REQUESTS,_Fields.SUBMIT_JOB_REQUESTS};
  ...
  static {
    ...
    tmpMap.put(_Fields.ADD_INSTANCE_GROUP_REQUESTS, new libthrift091.meta_data.FieldMetaData("addInstanceGroupRequests", libthrift091.TFieldRequirementType.OPTIONAL, 
        new libthrift091.meta_data.ListMetaData(libthrift091.protocol.TType.LIST, 
            new libthrift091.meta_data.FieldValueMetaData(libthrift091.protocol.TType.STRUCT            , "AddInstanceGroupRequest"))));
    tmpMap.put(_Fields.SUBMIT_JOB_REQUESTS, new libthrift091.meta_data.FieldMetaData("submitJobRequests", libthrift091.TFieldRequirementType.OPTIONAL, 
        new libthrift091.meta_data.ListMetaData(libthrift091.protocol.TType.LIST, 
            new libthrift091.meta_data.FieldValueMetaData(libthrift091.protocol.TType.STRUCT            , "SubmitJobRequest"))));
  ...
  public CreateClusterRequest(CreateClusterRequest other) {
    ...
    if (other.isSetAddInstanceGroupRequests()) {
      ...
      for (AddInstanceGroupRequest other_element : other.addInstanceGroupRequests) {
        __this__addInstanceGroupRequests.add(other_element);
      }
    ...
    if (other.isSetSubmitJobRequests()) {
      ...
      for (SubmitJobRequest other_element : other.submitJobRequests) {
        __this__submitJobRequests.add(other_element);
      }
            ...
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                ...
                struct.addInstanceGroupRequests = new ArrayList<AddInstanceGroupRequest>(_list8.size);
                AddInstanceGroupRequest _elem9;
                for (int _i10 = 0; _i10 < _list8.size; ++_i10)
                {
                  _elem9 = new AddInstanceGroupRequest();
                  _elem9.read(iprot);
                  struct.addInstanceGroupRequests.add(_elem9);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                ...
                struct.submitJobRequests = new ArrayList<SubmitJobRequest>(_list11.size);
                SubmitJobRequest _elem12;
                for (int _i13 = 0; _i13 < _list11.size; ++_i13)
                {
                  _elem12 = new SubmitJobRequest();
                  _elem12.read(iprot);
                  struct.submitJobRequests.add(_elem12);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.addInstanceGroupRequests != null) {
        if (struct.isSetAddInstanceGroupRequests()) {
          oprot.writeFieldBegin(ADD_INSTANCE_GROUP_REQUESTS_FIELD_DESC);
          {
            ...
            for (AddInstanceGroupRequest _iter14 : struct.addInstanceGroupRequests)
            {
              _iter14.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.submitJobRequests != null) {
        if (struct.isSetSubmitJobRequests()) {
          oprot.writeFieldBegin(SUBMIT_JOB_REQUESTS_FIELD_DESC);
          {
            ...
            for (SubmitJobRequest _iter15 : struct.submitJobRequests)
            {
              _iter15.write(oprot);
            }
            oprot.writeListEnd();
  ...
  private static class CreateClusterRequestTupleScheme extends TupleScheme<CreateClusterRequest> {
      ...
      if (struct.isSetAddInstanceGroupRequests()) {
        {
          ...
          for (AddInstanceGroupRequest _iter16 : struct.addInstanceGroupRequests)
          {
            _iter16.write(oprot);
          }
        }
      ...
      if (struct.isSetSubmitJobRequests()) {
        {
          ...
          for (SubmitJobRequest _iter17 : struct.submitJobRequests)
          {
            _iter17.write(oprot);
          }
        }
    ...
    public void read(libthrift091.protocol.TProtocol prot, CreateClusterRequest struct) throws libthrift091.TException {
      ...
      if (incoming.get(5)) {
        {
          libthrift091.protocol.TList _list18 = new libthrift091.protocol.TList(libthrift091.protocol.TType.STRUCT, iprot.readI32());
          struct.addInstanceGroupRequests = new ArrayList<AddInstanceGroupRequest>(_list18.size);
          AddInstanceGroupRequest _elem19;
          for (int _i20 = 0; _i20 < _list18.size; ++_i20)
          {
            _elem19 = new AddInstanceGroupRequest();
            _elem19.read(iprot);
            struct.addInstanceGroupRequests.add(_elem19);
          }
        }
        struct.setAddInstanceGroupRequestsIsSet(true);
      }
      if (incoming.get(6)) {
        {
          ...
          struct.submitJobRequests = new ArrayList<SubmitJobRequest>(_list21.size);
          SubmitJobRequest _elem22;
          for (int _i23 = 0; _i23 < _list21.size; ++_i23)
          {
            _elem22 = new SubmitJobRequest();
            _elem22.read(iprot);
            struct.submitJobRequests.add(_elem22);
          }
        }
        struct.setSubmitJobRequestsIsSet(true);
      }
