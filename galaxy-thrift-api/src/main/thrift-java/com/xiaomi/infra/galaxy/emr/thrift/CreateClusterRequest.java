...
public class CreateClusterRequest implements libthrift091.TBase<CreateClusterRequest, CreateClusterRequest._Fields>, java.io.Serializable, Cloneable, Comparable<CreateClusterRequest> {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                ...
                struct.addInstanceGroupRequests = new ArrayList<AddInstanceGroupRequest>(_list26.size);
                AddInstanceGroupRequest _elem27;
                for (int _i28 = 0; _i28 < _list26.size; ++_i28)
                {
                  _elem27 = new AddInstanceGroupRequest();
                  _elem27.read(iprot);
                  struct.addInstanceGroupRequests.add(_elem27);
                }
                iprot.readListEnd();
              }
          ...
          case 8: // SUBMIT_JOB_REQUESTS
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                libthrift091.protocol.TList _list29 = iprot.readListBegin();
                struct.submitJobRequests = new ArrayList<SubmitJobRequest>(_list29.size);
                SubmitJobRequest _elem30;
                for (int _i31 = 0; _i31 < _list29.size; ++_i31)
                {
                  _elem30 = new SubmitJobRequest();
                  _elem30.read(iprot);
                  struct.submitJobRequests.add(_elem30);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.addInstanceGroupRequests != null) {
        if (struct.isSetAddInstanceGroupRequests()) {
          oprot.writeFieldBegin(ADD_INSTANCE_GROUP_REQUESTS_FIELD_DESC);
          {
            ...
            for (AddInstanceGroupRequest _iter32 : struct.addInstanceGroupRequests)
            {
              _iter32.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.submitJobRequests != null) {
        if (struct.isSetSubmitJobRequests()) {
          oprot.writeFieldBegin(SUBMIT_JOB_REQUESTS_FIELD_DESC);
          {
            ...
            for (SubmitJobRequest _iter33 : struct.submitJobRequests)
            {
              _iter33.write(oprot);
            }
            oprot.writeListEnd();
  ...
  private static class CreateClusterRequestTupleScheme extends TupleScheme<CreateClusterRequest> {
      ...
      if (struct.isSetAddInstanceGroupRequests()) {
        {
          ...
          for (AddInstanceGroupRequest _iter34 : struct.addInstanceGroupRequests)
          {
            _iter34.write(oprot);
          }
        }
      ...
      if (struct.isSetSubmitJobRequests()) {
        {
          ...
          for (SubmitJobRequest _iter35 : struct.submitJobRequests)
          {
            _iter35.write(oprot);
          }
        }
    ...
    public void read(libthrift091.protocol.TProtocol prot, CreateClusterRequest struct) throws libthrift091.TException {
      ...
      if (incoming.get(5)) {
        {
          libthrift091.protocol.TList _list36 = new libthrift091.protocol.TList(libthrift091.protocol.TType.STRUCT, iprot.readI32());
          struct.addInstanceGroupRequests = new ArrayList<AddInstanceGroupRequest>(_list36.size);
          AddInstanceGroupRequest _elem37;
          for (int _i38 = 0; _i38 < _list36.size; ++_i38)
          {
            _elem37 = new AddInstanceGroupRequest();
            _elem37.read(iprot);
            struct.addInstanceGroupRequests.add(_elem37);
          }
        }
        struct.setAddInstanceGroupRequestsIsSet(true);
      }
      if (incoming.get(6)) {
        {
          ...
          struct.submitJobRequests = new ArrayList<SubmitJobRequest>(_list39.size);
          SubmitJobRequest _elem40;
          for (int _i41 = 0; _i41 < _list39.size; ++_i41)
          {
            _elem40 = new SubmitJobRequest();
            _elem40.read(iprot);
            struct.submitJobRequests.add(_elem40);
          }
        }
        struct.setSubmitJobRequestsIsSet(true);
      }
