...
public class JobDetail implements libthrift091.TBase<JobDetail, JobDetail._Fields>, java.io.Serializable, Cloneable, Comparable<JobDetail> {
        ...
        switch (schemeField.id) {
          ...
          case 5: // JAR_ARGS
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                libthrift091.protocol.TList _list170 = iprot.readListBegin();
                struct.jarArgs = new ArrayList<String>(_list170.size);
                String _elem171;
                for (int _i172 = 0; _i172 < _list170.size; ++_i172)
                {
                  _elem171 = iprot.readString();
                  struct.jarArgs.add(_elem171);
                }
                iprot.readListEnd();
              }
          ...
          case 6: // JAR_PROPERTIES
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                libthrift091.protocol.TMap _map173 = iprot.readMapBegin();
                struct.jarProperties = new HashMap<String,String>(2*_map173.size);
                String _key174;
                String _val175;
                for (int _i176 = 0; _i176 < _map173.size; ++_i176)
                {
                  ...
                  struct.jarProperties.put(_key174, _val175);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.jarArgs != null) {
        if (struct.isSetJarArgs()) {
          oprot.writeFieldBegin(JAR_ARGS_FIELD_DESC);
          {
            ...
            for (String _iter177 : struct.jarArgs)
            {
      ...
      if (struct.jarProperties != null) {
        if (struct.isSetJarProperties()) {
          oprot.writeFieldBegin(JAR_PROPERTIES_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, String> _iter178 : struct.jarProperties.entrySet())
            {
  ...
  private static class JobDetailTupleScheme extends TupleScheme<JobDetail> {
      ...
      if (struct.isSetJarArgs()) {
        {
          ...
          for (String _iter179 : struct.jarArgs)
          {
      ...
      if (struct.isSetJarProperties()) {
        {
          ...
          for (Map.Entry<String, String> _iter180 : struct.jarProperties.entrySet())
          {
    ...
    public void read(libthrift091.protocol.TProtocol prot, JobDetail struct) throws libthrift091.TException {
      ...
      if (incoming.get(3)) {
        {
          libthrift091.protocol.TList _list181 = new libthrift091.protocol.TList(libthrift091.protocol.TType.STRING, iprot.readI32());
          struct.jarArgs = new ArrayList<String>(_list181.size);
          String _elem182;
          for (int _i183 = 0; _i183 < _list181.size; ++_i183)
          {
            _elem182 = iprot.readString();
            struct.jarArgs.add(_elem182);
          }
        }
        struct.setJarArgsIsSet(true);
      }
      if (incoming.get(4)) {
        {
          libthrift091.protocol.TMap _map184 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.STRING, iprot.readI32());
          struct.jarProperties = new HashMap<String,String>(2*_map184.size);
          String _key185;
          String _val186;
          for (int _i187 = 0; _i187 < _map184.size; ++_i187)
          {
            ...
            struct.jarProperties.put(_key185, _val186);
          }
        }
        struct.setJarPropertiesIsSet(true);
      }
