...
public class JobDetail implements libthrift091.TBase<JobDetail, JobDetail._Fields>, java.io.Serializable, Cloneable, Comparable<JobDetail> {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                ...
                struct.jarArgs = new ArrayList<String>(_list140.size);
                String _elem141;
                for (int _i142 = 0; _i142 < _list140.size; ++_i142)
                {
                  _elem141 = iprot.readString();
                  struct.jarArgs.add(_elem141);
                }
                iprot.readListEnd();
              }
          ...
          case 6: // JAR_PROPERTIES
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                libthrift091.protocol.TMap _map143 = iprot.readMapBegin();
                struct.jarProperties = new HashMap<String,String>(2*_map143.size);
                String _key144;
                String _val145;
                for (int _i146 = 0; _i146 < _map143.size; ++_i146)
                {
                  ...
                  struct.jarProperties.put(_key144, _val145);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.jarArgs != null) {
        if (struct.isSetJarArgs()) {
          oprot.writeFieldBegin(JAR_ARGS_FIELD_DESC);
          {
            ...
            for (String _iter147 : struct.jarArgs)
            {
      ...
      if (struct.jarProperties != null) {
        if (struct.isSetJarProperties()) {
          oprot.writeFieldBegin(JAR_PROPERTIES_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, String> _iter148 : struct.jarProperties.entrySet())
            {
  ...
  private static class JobDetailTupleScheme extends TupleScheme<JobDetail> {
      ...
      if (struct.isSetJarArgs()) {
        {
          ...
          for (String _iter149 : struct.jarArgs)
          {
      ...
      if (struct.isSetJarProperties()) {
        {
          ...
          for (Map.Entry<String, String> _iter150 : struct.jarProperties.entrySet())
          {
    ...
    public void read(libthrift091.protocol.TProtocol prot, JobDetail struct) throws libthrift091.TException {
      ...
      if (incoming.get(3)) {
        {
          libthrift091.protocol.TList _list151 = new libthrift091.protocol.TList(libthrift091.protocol.TType.STRING, iprot.readI32());
          struct.jarArgs = new ArrayList<String>(_list151.size);
          String _elem152;
          for (int _i153 = 0; _i153 < _list151.size; ++_i153)
          {
            _elem152 = iprot.readString();
            struct.jarArgs.add(_elem152);
          }
        }
        struct.setJarArgsIsSet(true);
      }
      if (incoming.get(4)) {
        {
          libthrift091.protocol.TMap _map154 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.STRING, iprot.readI32());
          struct.jarProperties = new HashMap<String,String>(2*_map154.size);
          String _key155;
          String _val156;
          for (int _i157 = 0; _i157 < _map154.size; ++_i157)
          {
            ...
            struct.jarProperties.put(_key155, _val156);
          }
        }
        struct.setJarPropertiesIsSet(true);
      }
