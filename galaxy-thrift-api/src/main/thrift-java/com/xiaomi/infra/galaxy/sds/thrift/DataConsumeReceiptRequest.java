...
public class DataConsumeReceiptRequest implements libthrift091.TBase<DataConsumeReceiptRequest, DataConsumeReceiptRequest._Fields>, java.io.Serializable, Cloneable, Comparable<DataConsumeReceiptRequest> {
  private static final libthrift091.protocol.TStruct STRUCT_DESC = new libthrift091.protocol.TStruct("DataConsumeReceiptRequest");
  ...
  private static final libthrift091.protocol.TField LAST_CONSUMED_OFFSET_FIELD_DESC = new libthrift091.protocol.TField("lastConsumedOffset", libthrift091.protocol.TType.MAP, (short)4);

  private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
  static {
    schemes.put(StandardScheme.class, new DataConsumeReceiptRequestStandardSchemeFactory());
    schemes.put(TupleScheme.class, new DataConsumeReceiptRequestTupleSchemeFactory());
  }
   ...
   * 当前消费存量数据的最后偏移
   */
  public Map<String,Datum> lastConsumedOffset; // optional
  ...
  private static final _Fields optionals[] = {_Fields.TABLE_NAME,_Fields.PARTITION_ID,_Fields.SUBSCRIBER_ID,_Fields.LAST_CONSUMED_OFFSET};
  ...
  static {
    ...
    libthrift091.meta_data.FieldMetaData.addStructMetaDataMap(DataConsumeReceiptRequest.class, metaDataMap);
  }

  public DataConsumeReceiptRequest() {
  }

  /**
   * Performs a deep copy on <i>other</i>.
   */
  public DataConsumeReceiptRequest(DataConsumeReceiptRequest other) {
    ...
    if (other.isSetLastConsumedOffset()) {
      this.lastConsumedOffset = other.lastConsumedOffset;
    }
  }

  public DataConsumeReceiptRequest deepCopy() {
    return new DataConsumeReceiptRequest(this);
  }
   ...
   * 表名
   */
  public DataConsumeReceiptRequest setTableName(String tableName) {
   ...
   * 表分片ID
   */
  public DataConsumeReceiptRequest setPartitionId(long partitionId) {
   ...
   * 订阅者ID
   */
  public DataConsumeReceiptRequest setSubscriberId(String subscriberId) {
  ...
  public int getLastConsumedOffsetSize() {
    return (this.lastConsumedOffset == null) ? 0 : this.lastConsumedOffset.size();
  }

  public void putToLastConsumedOffset(String key, Datum val) {
    if (this.lastConsumedOffset == null) {
      this.lastConsumedOffset = new HashMap<String,Datum>();
    }
    this.lastConsumedOffset.put(key, val);
  }

  /**
   * 当前消费存量数据的最后偏移
   */
  public Map<String,Datum> getLastConsumedOffset() {
   ...
   * 当前消费存量数据的最后偏移
   */
  public DataConsumeReceiptRequest setLastConsumedOffset(Map<String,Datum> lastConsumedOffset) {
  ...
  public boolean isSetLastConsumedOffset() {
    return this.lastConsumedOffset != null;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case LAST_CONSUMED_OFFSET:
      if (value == null) {
        ...
        setLastConsumedOffset((Map<String,Datum>)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof DataConsumeReceiptRequest)
      return this.equals((DataConsumeReceiptRequest)that);
    return false;
  }

  public boolean equals(DataConsumeReceiptRequest that) {
    if (that == null)
      return false;
    ...
    if (this_present_lastConsumedOffset || that_present_lastConsumedOffset) {
      if (!(this_present_lastConsumedOffset && that_present_lastConsumedOffset))
        return false;
      if (!this.lastConsumedOffset.equals(that.lastConsumedOffset))
        return false;
    }
  ...
  @Override
  public int compareTo(DataConsumeReceiptRequest other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("DataConsumeReceiptRequest(");
    boolean first = true;
  ...
  private static class DataConsumeReceiptRequestStandardSchemeFactory implements SchemeFactory {
    public DataConsumeReceiptRequestStandardScheme getScheme() {
      return new DataConsumeReceiptRequestStandardScheme();
    }
  }

  private static class DataConsumeReceiptRequestStandardScheme extends StandardScheme<DataConsumeReceiptRequest> {

    public void read(libthrift091.protocol.TProtocol iprot, DataConsumeReceiptRequest struct) throws libthrift091.TException {
        ...
        switch (schemeField.id) {
          ...
          case 4: // LAST_CONSUMED_OFFSET
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                libthrift091.protocol.TMap _map386 = iprot.readMapBegin();
                struct.lastConsumedOffset = new HashMap<String,Datum>(2*_map386.size);
                String _key387;
                Datum _val388;
                for (int _i389 = 0; _i389 < _map386.size; ++_i389)
                {
                  ...
                  _val388 = new Datum();
                  _val388.read(iprot);
                  struct.lastConsumedOffset.put(_key387, _val388);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(libthrift091.protocol.TProtocol oprot, DataConsumeReceiptRequest struct) throws libthrift091.TException {
      struct.validate();
      ...
      if (struct.lastConsumedOffset != null) {
        if (struct.isSetLastConsumedOffset()) {
          oprot.writeFieldBegin(LAST_CONSUMED_OFFSET_FIELD_DESC);
          {
            oprot.writeMapBegin(new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.STRUCT, struct.lastConsumedOffset.size()));
            for (Map.Entry<String, Datum> _iter390 : struct.lastConsumedOffset.entrySet())
            {
  ...
  private static class DataConsumeReceiptRequestTupleSchemeFactory implements SchemeFactory {
    public DataConsumeReceiptRequestTupleScheme getScheme() {
      return new DataConsumeReceiptRequestTupleScheme();
    }
  }

  private static class DataConsumeReceiptRequestTupleScheme extends TupleScheme<DataConsumeReceiptRequest> {

    @Override
    public void write(libthrift091.protocol.TProtocol prot, DataConsumeReceiptRequest struct) throws libthrift091.TException {
      ...
      if (struct.isSetLastConsumedOffset()) {
        {
          oprot.writeI32(struct.lastConsumedOffset.size());
          for (Map.Entry<String, Datum> _iter391 : struct.lastConsumedOffset.entrySet())
          {
    ...
    @Override
    public void read(libthrift091.protocol.TProtocol prot, DataConsumeReceiptRequest struct) throws libthrift091.TException {
      ...
      if (incoming.get(3)) {
        {
          libthrift091.protocol.TMap _map392 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.STRUCT, iprot.readI32());
          struct.lastConsumedOffset = new HashMap<String,Datum>(2*_map392.size);
          String _key393;
          Datum _val394;
          for (int _i395 = 0; _i395 < _map392.size; ++_i395)
          {
            ...
            _val394 = new Datum();
            _val394.read(iprot);
            struct.lastConsumedOffset.put(_key393, _val394);
          }
        }
        struct.setLastConsumedOffsetIsSet(true);
      }
