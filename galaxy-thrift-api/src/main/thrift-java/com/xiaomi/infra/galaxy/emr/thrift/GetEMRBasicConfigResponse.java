...
public class GetEMRBasicConfigResponse implements libthrift091.TBase<GetEMRBasicConfigResponse, GetEMRBasicConfigResponse._Fields>, java.io.Serializable, Cloneable, Comparable<GetEMRBasicConfigResponse> {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                ...
                struct.hardware = new ArrayList<InstanceTypeInfo>(_list108.size);
                InstanceTypeInfo _elem109;
                for (int _i110 = 0; _i110 < _list108.size; ++_i110)
                {
                  _elem109 = new InstanceTypeInfo();
                  _elem109.read(iprot);
                  struct.hardware.add(_elem109);
                }
                iprot.readListEnd();
              }
          ...
          case 2: // SOFTWARE
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                libthrift091.protocol.TList _list111 = iprot.readListBegin();
                struct.software = new ArrayList<ApplicationSuite>(_list111.size);
                ApplicationSuite _elem112;
                for (int _i113 = 0; _i113 < _list111.size; ++_i113)
                {
                  _elem112 = new ApplicationSuite();
                  _elem112.read(iprot);
                  struct.software.add(_elem112);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.hardware != null) {
        if (struct.isSetHardware()) {
          oprot.writeFieldBegin(HARDWARE_FIELD_DESC);
          {
            ...
            for (InstanceTypeInfo _iter114 : struct.hardware)
            {
      ...
      if (struct.software != null) {
        if (struct.isSetSoftware()) {
          oprot.writeFieldBegin(SOFTWARE_FIELD_DESC);
          {
            ...
            for (ApplicationSuite _iter115 : struct.software)
            {
  ...
  private static class GetEMRBasicConfigResponseTupleScheme extends TupleScheme<GetEMRBasicConfigResponse> {
      ...
      if (struct.isSetHardware()) {
        {
          ...
          for (InstanceTypeInfo _iter116 : struct.hardware)
          {
      ...
      if (struct.isSetSoftware()) {
        {
          ...
          for (ApplicationSuite _iter117 : struct.software)
          {
    ...
    public void read(libthrift091.protocol.TProtocol prot, GetEMRBasicConfigResponse struct) throws libthrift091.TException {
      ...
      if (incoming.get(0)) {
        {
          libthrift091.protocol.TList _list118 = new libthrift091.protocol.TList(libthrift091.protocol.TType.STRUCT, iprot.readI32());
