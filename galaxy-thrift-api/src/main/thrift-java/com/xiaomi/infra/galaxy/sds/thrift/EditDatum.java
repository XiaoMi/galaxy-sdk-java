...
public class EditDatum implements libthrift091.TBase<EditDatum, EditDatum._Fields>, java.io.Serializable, Cloneable, Comparable<EditDatum> {
  private static final libthrift091.protocol.TStruct STRUCT_DESC = new libthrift091.protocol.TStruct("EditDatum");
  ...
  static {
    schemes.put(StandardScheme.class, new EditDatumStandardSchemeFactory());
    schemes.put(TupleScheme.class, new EditDatumTupleSchemeFactory());
  }
  ...
  static {
    ...
    libthrift091.meta_data.FieldMetaData.addStructMetaDataMap(EditDatum.class, metaDataMap);
  }
   ...
   */
  public EditDatum(EditDatum other) {
  ...
  public EditDatum deepCopy() {
    return new EditDatum(this);
  }
   ...
   * @see EditType
   */
  public EditDatum setEditType(EditType editType) {
   ...
   * 增量操作单元的数据
   */
  public EditDatum setDatum(Datum datum) {
    this.datum = datum;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof EditDatum)
      return this.equals((EditDatum)that);
    return false;
  }

  public boolean equals(EditDatum that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(EditDatum other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("EditDatum(");
    boolean first = true;
  ...
  private static class EditDatumStandardSchemeFactory implements SchemeFactory {
    public EditDatumStandardScheme getScheme() {
      return new EditDatumStandardScheme();
    }
  }

  private static class EditDatumStandardScheme extends StandardScheme<EditDatum> {

    public void read(libthrift091.protocol.TProtocol iprot, EditDatum struct) throws libthrift091.TException {
    ...
    public void write(libthrift091.protocol.TProtocol oprot, EditDatum struct) throws libthrift091.TException {
      struct.validate();
  ...
  private static class EditDatumTupleSchemeFactory implements SchemeFactory {
    public EditDatumTupleScheme getScheme() {
      return new EditDatumTupleScheme();
    }
  }

  private static class EditDatumTupleScheme extends TupleScheme<EditDatum> {

    @Override
    public void write(libthrift091.protocol.TProtocol prot, EditDatum struct) throws libthrift091.TException {
    ...
    @Override
    public void read(libthrift091.protocol.TProtocol prot, EditDatum struct) throws libthrift091.TException {
