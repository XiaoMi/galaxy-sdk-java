...
public class RemoveRequest implements libthrift091.TBase<RemoveRequest, RemoveRequest._Fields>, java.io.Serializable, Cloneable, Comparable<RemoveRequest> {
        ...
        switch (schemeField.id) {
          ...
          case 2: // KEYS
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                libthrift091.protocol.TMap _map242 = iprot.readMapBegin();
                struct.keys = new HashMap<String,Datum>(2*_map242.size);
                String _key243;
                Datum _val244;
                for (int _i245 = 0; _i245 < _map242.size; ++_i245)
                {
                  ...
                  _val244 = new Datum();
                  _val244.read(iprot);
                  struct.keys.put(_key243, _val244);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                ...
                struct.attributes = new ArrayList<String>(_list246.size);
                String _elem247;
                for (int _i248 = 0; _i248 < _list246.size; ++_i248)
                {
                  _elem247 = iprot.readString();
                  struct.attributes.add(_elem247);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.keys != null) {
        if (struct.isSetKeys()) {
          oprot.writeFieldBegin(KEYS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Datum> _iter249 : struct.keys.entrySet())
            {
      ...
      if (struct.attributes != null) {
        if (struct.isSetAttributes()) {
          oprot.writeFieldBegin(ATTRIBUTES_FIELD_DESC);
          {
            ...
            for (String _iter250 : struct.attributes)
            {
  ...
  private static class RemoveRequestTupleScheme extends TupleScheme<RemoveRequest> {
      ...
      if (struct.isSetKeys()) {
        {
          ...
          for (Map.Entry<String, Datum> _iter251 : struct.keys.entrySet())
          {
      ...
      if (struct.isSetAttributes()) {
        {
          ...
          for (String _iter252 : struct.attributes)
          {
    ...
    public void read(libthrift091.protocol.TProtocol prot, RemoveRequest struct) throws libthrift091.TException {
      ...
      if (incoming.get(1)) {
        {
          libthrift091.protocol.TMap _map253 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.STRUCT, iprot.readI32());
          struct.keys = new HashMap<String,Datum>(2*_map253.size);
          String _key254;
          Datum _val255;
          for (int _i256 = 0; _i256 < _map253.size; ++_i256)
          {
            ...
            _val255 = new Datum();
            _val255.read(iprot);
            struct.keys.put(_key254, _val255);
          }
        }
        struct.setKeysIsSet(true);
      }
      if (incoming.get(2)) {
        {
          libthrift091.protocol.TList _list257 = new libthrift091.protocol.TList(libthrift091.protocol.TType.STRING, iprot.readI32());
          struct.attributes = new ArrayList<String>(_list257.size);
          String _elem258;
          for (int _i259 = 0; _i259 < _list257.size; ++_i259)
          {
            _elem258 = iprot.readString();
            struct.attributes.add(_elem258);
          }
        }
        struct.setAttributesIsSet(true);
      }
