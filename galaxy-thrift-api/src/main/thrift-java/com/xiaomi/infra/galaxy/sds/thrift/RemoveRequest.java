...
public class RemoveRequest implements libthrift091.TBase<RemoveRequest, RemoveRequest._Fields>, java.io.Serializable, Cloneable, Comparable<RemoveRequest> {
        ...
        switch (schemeField.id) {
          ...
          case 2: // KEYS
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                libthrift091.protocol.TMap _map284 = iprot.readMapBegin();
                struct.keys = new HashMap<String,Datum>(2*_map284.size);
                String _key285;
                Datum _val286;
                for (int _i287 = 0; _i287 < _map284.size; ++_i287)
                {
                  ...
                  _val286 = new Datum();
                  _val286.read(iprot);
                  struct.keys.put(_key285, _val286);
                }
                iprot.readMapEnd();
              }
          ...
          case 3: // ATTRIBUTES
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                libthrift091.protocol.TList _list288 = iprot.readListBegin();
                struct.attributes = new ArrayList<String>(_list288.size);
                String _elem289;
                for (int _i290 = 0; _i290 < _list288.size; ++_i290)
                {
                  _elem289 = iprot.readString();
                  struct.attributes.add(_elem289);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.keys != null) {
        if (struct.isSetKeys()) {
          oprot.writeFieldBegin(KEYS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Datum> _iter291 : struct.keys.entrySet())
            {
  ...
  private static class RemoveRequestTupleScheme extends TupleScheme<RemoveRequest> {
      ...
      if (struct.isSetKeys()) {
        {
          ...
          for (Map.Entry<String, Datum> _iter293 : struct.keys.entrySet())
          {
      ...
      if (struct.isSetAttributes()) {
        {
          ...
          for (String _iter294 : struct.attributes)
          {
    ...
    public void read(libthrift091.protocol.TProtocol prot, RemoveRequest struct) throws libthrift091.TException {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.keys = new HashMap<String,Datum>(2*_map295.size);
          String _key296;
          Datum _val297;
          for (int _i298 = 0; _i298 < _map295.size; ++_i298)
          {
            ...
            _val297 = new Datum();
            _val297.read(iprot);
            struct.keys.put(_key296, _val297);
          }
        }
        struct.setKeysIsSet(true);
      }
      if (incoming.get(2)) {
        {
          libthrift091.protocol.TList _list299 = new libthrift091.protocol.TList(libthrift091.protocol.TType.STRING, iprot.readI32());
          struct.attributes = new ArrayList<String>(_list299.size);
          String _elem300;
          for (int _i301 = 0; _i301 < _list299.size; ++_i301)
          {
            _elem300 = iprot.readString();
            struct.attributes.add(_elem300);
          }
        }
        struct.setAttributesIsSet(true);
      }
