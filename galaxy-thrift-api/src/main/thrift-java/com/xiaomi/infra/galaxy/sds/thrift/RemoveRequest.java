...
public class RemoveRequest implements libthrift091.TBase<RemoveRequest, RemoveRequest._Fields>, java.io.Serializable, Cloneable, Comparable<RemoveRequest> {
  ...
  private _Fields optionals[] = {_Fields.ATTRIBUTES,_Fields.CONDITION};
            ...
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                ...
                for (int _i223 = 0; _i223 < _map222.size; ++_i223)
                {
                  ...
                  _val225 = new Datum();
                  _val225.read(iprot);
                  struct.keys.put(_key224, _val225);
                }
                iprot.readMapEnd();
              }
    ...
    public void read(libthrift091.protocol.TProtocol prot, RemoveRequest struct) throws libthrift091.TException {
      ...
      struct.setTableNameIsSet(true);
      {
        ...
        for (int _i234 = 0; _i234 < _map233.size; ++_i234)
        {
          ...
          _val236 = new Datum();
          _val236.read(iprot);
          struct.keys.put(_key235, _val236);
        }
      }
      struct.setKeysIsSet(true);
      ...
      if (incoming.get(0)) {
        {
          ...
          for (int _i238 = 0; _i238 < _list237.size; ++_i238)
          {
            ...
            struct.attributes.add(_elem239);
          }
        }
        struct.setAttributesIsSet(true);
      }
