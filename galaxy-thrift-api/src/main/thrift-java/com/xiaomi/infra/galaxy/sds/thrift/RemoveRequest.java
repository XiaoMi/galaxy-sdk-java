...
public class RemoveRequest implements libthrift091.TBase<RemoveRequest, RemoveRequest._Fields>, java.io.Serializable, Cloneable, Comparable<RemoveRequest> {
            ...
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                ...
                struct.attributes = new ArrayList<String>(_list244.size);
                String _elem245;
                for (int _i246 = 0; _i246 < _list244.size; ++_i246)
                {
                  _elem245 = iprot.readString();
                  struct.attributes.add(_elem245);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.keys != null) {
        if (struct.isSetKeys()) {
          oprot.writeFieldBegin(KEYS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Datum> _iter247 : struct.keys.entrySet())
            {
      ...
      if (struct.attributes != null) {
        if (struct.isSetAttributes()) {
          oprot.writeFieldBegin(ATTRIBUTES_FIELD_DESC);
          {
            ...
            for (String _iter248 : struct.attributes)
            {
  ...
  private static class RemoveRequestTupleScheme extends TupleScheme<RemoveRequest> {
    ...
    public void read(libthrift091.protocol.TProtocol prot, RemoveRequest struct) throws libthrift091.TException {
      ...
      if (incoming.get(1)) {
        {
          libthrift091.protocol.TMap _map251 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.STRUCT, iprot.readI32());
          struct.keys = new HashMap<String,Datum>(2*_map251.size);
          String _key252;
          Datum _val253;
          for (int _i254 = 0; _i254 < _map251.size; ++_i254)
          {
            ...
            _val253 = new Datum();
            _val253.read(iprot);
            struct.keys.put(_key252, _val253);
          }
        }
        struct.setKeysIsSet(true);
      }
      if (incoming.get(2)) {
        {
          libthrift091.protocol.TList _list255 = new libthrift091.protocol.TList(libthrift091.protocol.TType.STRING, iprot.readI32());
          struct.attributes = new ArrayList<String>(_list255.size);
          String _elem256;
          for (int _i257 = 0; _i257 < _list255.size; ++_i257)
          {
            _elem256 = iprot.readString();
            struct.attributes.add(_elem256);
          }
        }
        struct.setAttributesIsSet(true);
      }
