...
public class RemoveRequest implements libthrift091.TBase<RemoveRequest, RemoveRequest._Fields>, java.io.Serializable, Cloneable, Comparable<RemoveRequest> {
            ...
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                ...
                struct.keys = new HashMap<String,Datum>(2*_map258.size);
                String _key259;
                Datum _val260;
                for (int _i261 = 0; _i261 < _map258.size; ++_i261)
                {
                  ...
                  _val260 = new Datum();
                  _val260.read(iprot);
                  struct.keys.put(_key259, _val260);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                ...
                struct.attributes = new ArrayList<String>(_list262.size);
                String _elem263;
                for (int _i264 = 0; _i264 < _list262.size; ++_i264)
                {
                  _elem263 = iprot.readString();
                  struct.attributes.add(_elem263);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.keys != null) {
        if (struct.isSetKeys()) {
          oprot.writeFieldBegin(KEYS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Datum> _iter265 : struct.keys.entrySet())
            {
      ...
      if (struct.attributes != null) {
        if (struct.isSetAttributes()) {
          oprot.writeFieldBegin(ATTRIBUTES_FIELD_DESC);
          {
            ...
            for (String _iter266 : struct.attributes)
            {
  ...
  private static class RemoveRequestTupleScheme extends TupleScheme<RemoveRequest> {
      ...
      if (struct.isSetKeys()) {
        {
          ...
          for (Map.Entry<String, Datum> _iter267 : struct.keys.entrySet())
          {
      ...
      if (struct.isSetAttributes()) {
        {
          ...
          for (String _iter268 : struct.attributes)
          {
    ...
    public void read(libthrift091.protocol.TProtocol prot, RemoveRequest struct) throws libthrift091.TException {
      ...
      if (incoming.get(1)) {
        {
          libthrift091.protocol.TMap _map269 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.STRUCT, iprot.readI32());
          struct.keys = new HashMap<String,Datum>(2*_map269.size);
          String _key270;
          Datum _val271;
          for (int _i272 = 0; _i272 < _map269.size; ++_i272)
          {
            ...
            _val271 = new Datum();
            _val271.read(iprot);
            struct.keys.put(_key270, _val271);
          }
        }
        struct.setKeysIsSet(true);
      }
      if (incoming.get(2)) {
        {
          libthrift091.protocol.TList _list273 = new libthrift091.protocol.TList(libthrift091.protocol.TType.STRING, iprot.readI32());
          struct.attributes = new ArrayList<String>(_list273.size);
          String _elem274;
