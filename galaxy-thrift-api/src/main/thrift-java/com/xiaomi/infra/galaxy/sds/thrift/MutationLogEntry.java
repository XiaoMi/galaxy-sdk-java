...
public class MutationLogEntry implements libthrift091.TBase<MutationLogEntry, MutationLogEntry._Fields>, java.io.Serializable, Cloneable, Comparable<MutationLogEntry> {
  ...
  private static final libthrift091.protocol.TField AMOUNTS_FIELD_DESC = new libthrift091.protocol.TField("amounts", libthrift091.protocol.TType.MAP, (short)5);
  private static final libthrift091.protocol.TField TABLE_NAME_FIELD_DESC = new libthrift091.protocol.TField("tableName", libthrift091.protocol.TType.STRING, (short)6);
  ...
  private static final _Fields optionals[] = {_Fields.RECORD,_Fields.TYPE,_Fields.ROW_DELETED,_Fields.TIMESTAMP,_Fields.AMOUNTS,_Fields.TABLE_NAME};
   ...
   * increment amounts
   */
  public MutationLogEntry setAmounts(Map<String,Datum> amounts) {
   ...
   * sds tableName
   */
  public MutationLogEntry setTableName(String tableName) {
        ...
        switch (schemeField.id) {
          case 1: // RECORD
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                libthrift091.protocol.TMap _map402 = iprot.readMapBegin();
                struct.record = new HashMap<String,Datum>(2*_map402.size);
                String _key403;
                Datum _val404;
                for (int _i405 = 0; _i405 < _map402.size; ++_i405)
                {
                  ...
                  _val404 = new Datum();
                  _val404.read(iprot);
                  struct.record.put(_key403, _val404);
                }
                iprot.readMapEnd();
              }
          ...
          case 5: // AMOUNTS
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                libthrift091.protocol.TMap _map406 = iprot.readMapBegin();
                struct.amounts = new HashMap<String,Datum>(2*_map406.size);
                String _key407;
                Datum _val408;
                for (int _i409 = 0; _i409 < _map406.size; ++_i409)
                {
                  ...
                  _val408 = new Datum();
                  _val408.read(iprot);
                  struct.amounts.put(_key407, _val408);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.record != null) {
        if (struct.isSetRecord()) {
          oprot.writeFieldBegin(RECORD_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Datum> _iter410 : struct.record.entrySet())
            {
      ...
      if (struct.amounts != null) {
        if (struct.isSetAmounts()) {
          oprot.writeFieldBegin(AMOUNTS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Datum> _iter411 : struct.amounts.entrySet())
            {
  ...
  private static class MutationLogEntryTupleScheme extends TupleScheme<MutationLogEntry> {
      ...
      if (struct.isSetRecord()) {
        {
          ...
          for (Map.Entry<String, Datum> _iter412 : struct.record.entrySet())
          {
      ...
      if (struct.isSetAmounts()) {
        {
          ...
          for (Map.Entry<String, Datum> _iter413 : struct.amounts.entrySet())
          {
    ...
    public void read(libthrift091.protocol.TProtocol prot, MutationLogEntry struct) throws libthrift091.TException {
      ...
      if (incoming.get(0)) {
        {
          libthrift091.protocol.TMap _map414 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.STRUCT, iprot.readI32());
          struct.record = new HashMap<String,Datum>(2*_map414.size);
          String _key415;
          Datum _val416;
          for (int _i417 = 0; _i417 < _map414.size; ++_i417)
          {
            ...
            _val416 = new Datum();
            _val416.read(iprot);
            struct.record.put(_key415, _val416);
          }
        }
        struct.setRecordIsSet(true);
      }
      ...
      if (incoming.get(4)) {
        {
          libthrift091.protocol.TMap _map418 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.STRUCT, iprot.readI32());
          struct.amounts = new HashMap<String,Datum>(2*_map418.size);
          String _key419;
          Datum _val420;
          for (int _i421 = 0; _i421 < _map418.size; ++_i421)
          {
            ...
            _val420 = new Datum();
            _val420.read(iprot);
            struct.amounts.put(_key419, _val420);
          }
        }
        struct.setAmountsIsSet(true);
      }
