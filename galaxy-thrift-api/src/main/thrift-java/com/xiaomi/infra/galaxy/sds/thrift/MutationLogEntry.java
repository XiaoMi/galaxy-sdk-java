...
public class MutationLogEntry implements libthrift091.TBase<MutationLogEntry, MutationLogEntry._Fields>, java.io.Serializable, Cloneable, Comparable<MutationLogEntry> {
        ...
        switch (schemeField.id) {
          case 1: // RECORD
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                libthrift091.protocol.TMap _map410 = iprot.readMapBegin();
                struct.record = new HashMap<String,Datum>(2*_map410.size);
                String _key411;
                Datum _val412;
                for (int _i413 = 0; _i413 < _map410.size; ++_i413)
                {
                  ...
                  _val412 = new Datum();
                  _val412.read(iprot);
                  struct.record.put(_key411, _val412);
                }
                iprot.readMapEnd();
              }
          ...
          case 5: // AMOUNTS
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                libthrift091.protocol.TMap _map414 = iprot.readMapBegin();
                struct.amounts = new HashMap<String,Datum>(2*_map414.size);
                String _key415;
                Datum _val416;
                for (int _i417 = 0; _i417 < _map414.size; ++_i417)
                {
                  ...
                  _val416 = new Datum();
                  _val416.read(iprot);
                  struct.amounts.put(_key415, _val416);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.record != null) {
        if (struct.isSetRecord()) {
          oprot.writeFieldBegin(RECORD_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Datum> _iter418 : struct.record.entrySet())
            {
      ...
      if (struct.amounts != null) {
        if (struct.isSetAmounts()) {
          oprot.writeFieldBegin(AMOUNTS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Datum> _iter419 : struct.amounts.entrySet())
            {
  ...
  private static class MutationLogEntryTupleScheme extends TupleScheme<MutationLogEntry> {
      ...
      if (struct.isSetRecord()) {
        {
          ...
          for (Map.Entry<String, Datum> _iter420 : struct.record.entrySet())
          {
      ...
      if (struct.isSetAmounts()) {
        {
          ...
          for (Map.Entry<String, Datum> _iter421 : struct.amounts.entrySet())
          {
    ...
    public void read(libthrift091.protocol.TProtocol prot, MutationLogEntry struct) throws libthrift091.TException {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.record = new HashMap<String,Datum>(2*_map422.size);
          String _key423;
          Datum _val424;
          for (int _i425 = 0; _i425 < _map422.size; ++_i425)
          {
            ...
            _val424 = new Datum();
            _val424.read(iprot);
            struct.record.put(_key423, _val424);
          }
        }
        struct.setRecordIsSet(true);
      }
      ...
      if (incoming.get(4)) {
        {
          libthrift091.protocol.TMap _map426 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.STRUCT, iprot.readI32());
          struct.amounts = new HashMap<String,Datum>(2*_map426.size);
          String _key427;
          Datum _val428;
          for (int _i429 = 0; _i429 < _map426.size; ++_i429)
          {
            ...
            _val428 = new Datum();
            _val428.read(iprot);
            struct.amounts.put(_key427, _val428);
          }
        }
        struct.setAmountsIsSet(true);
      }
