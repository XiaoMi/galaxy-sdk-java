...
public class MutationLogEntry implements libthrift091.TBase<MutationLogEntry, MutationLogEntry._Fields>, java.io.Serializable, Cloneable, Comparable<MutationLogEntry> {
  ...
  private static final _Fields optionals[] = {_Fields.RECORD,_Fields.TYPE,_Fields.ROW_DELETED,_Fields.TIMESTAMP,_Fields.AMOUNTS};
        ...
        switch (schemeField.id) {
          case 1: // RECORD
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                libthrift091.protocol.TMap _map394 = iprot.readMapBegin();
                struct.record = new HashMap<String,Datum>(2*_map394.size);
                String _key395;
                Datum _val396;
                for (int _i397 = 0; _i397 < _map394.size; ++_i397)
                {
                  ...
                  _val396 = new Datum();
                  _val396.read(iprot);
                  struct.record.put(_key395, _val396);
                }
                iprot.readMapEnd();
              }
          ...
          case 5: // AMOUNTS
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                libthrift091.protocol.TMap _map398 = iprot.readMapBegin();
                struct.amounts = new HashMap<String,Datum>(2*_map398.size);
                String _key399;
                Datum _val400;
                for (int _i401 = 0; _i401 < _map398.size; ++_i401)
                {
                  ...
                  _val400 = new Datum();
                  _val400.read(iprot);
                  struct.amounts.put(_key399, _val400);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.record != null) {
        if (struct.isSetRecord()) {
          oprot.writeFieldBegin(RECORD_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Datum> _iter402 : struct.record.entrySet())
            {
      ...
      if (struct.amounts != null) {
        if (struct.isSetAmounts()) {
          oprot.writeFieldBegin(AMOUNTS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Datum> _iter403 : struct.amounts.entrySet())
            {
  ...
  private static class MutationLogEntryTupleScheme extends TupleScheme<MutationLogEntry> {
      ...
      if (struct.isSetRecord()) {
        {
          ...
          for (Map.Entry<String, Datum> _iter404 : struct.record.entrySet())
          {
      ...
      if (struct.isSetAmounts()) {
        {
          ...
          for (Map.Entry<String, Datum> _iter405 : struct.amounts.entrySet())
          {
    ...
    public void read(libthrift091.protocol.TProtocol prot, MutationLogEntry struct) throws libthrift091.TException {
      ...
      if (incoming.get(0)) {
        {
          libthrift091.protocol.TMap _map406 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.STRUCT, iprot.readI32());
          struct.record = new HashMap<String,Datum>(2*_map406.size);
          String _key407;
          Datum _val408;
          for (int _i409 = 0; _i409 < _map406.size; ++_i409)
          {
            ...
            _val408 = new Datum();
            _val408.read(iprot);
            struct.record.put(_key407, _val408);
          }
        }
        struct.setRecordIsSet(true);
      }
      ...
      if (incoming.get(4)) {
        {
          libthrift091.protocol.TMap _map410 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.STRUCT, iprot.readI32());
          struct.amounts = new HashMap<String,Datum>(2*_map410.size);
          String _key411;
          Datum _val412;
          for (int _i413 = 0; _i413 < _map410.size; ++_i413)
          {
            ...
            _val412 = new Datum();
            _val412.read(iprot);
            struct.amounts.put(_key411, _val412);
          }
        }
        struct.setAmountsIsSet(true);
      }
