        ...
        switch (schemeField.id) {
          case 1: // RECORD
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                libthrift091.protocol.TMap _map384 = iprot.readMapBegin();
                struct.record = new HashMap<String,Datum>(2*_map384.size);
                String _key385;
                Datum _val386;
                for (int _i387 = 0; _i387 < _map384.size; ++_i387)
                {
                  ...
                  _val386 = new Datum();
                  _val386.read(iprot);
                  struct.record.put(_key385, _val386);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.record != null) {
        if (struct.isSetRecord()) {
          oprot.writeFieldBegin(RECORD_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Datum> _iter388 : struct.record.entrySet())
            {
      ...
      if (struct.isSetRecord()) {
        {
          ...
          for (Map.Entry<String, Datum> _iter389 : struct.record.entrySet())
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.record = new HashMap<String,Datum>(2*_map390.size);
          String _key391;
          Datum _val392;
          for (int _i393 = 0; _i393 < _map390.size; ++_i393)
          {
            ...
            _val392 = new Datum();
            _val392.read(iprot);
            struct.record.put(_key391, _val392);
          }
        }
        struct.setRecordIsSet(true);
      }
