...
public class TableMetadata implements libthrift091.TBase<TableMetadata, TableMetadata._Fields>, java.io.Serializable, Cloneable, Comparable<TableMetadata> {
  ...
  private _Fields optionals[] = {_Fields.TABLE_ID,_Fields.DEVELOPER_ID,_Fields.APP_ACL,_Fields.QUOTA,_Fields.THROUGHPUT,_Fields.DESCRIPTION};
            ...
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                ...
                {
                  String _key118;
                  List<CannedAcl> _val119;
                  _key118 = iprot.readString();
                  {
                    libthrift091.protocol.TList _list120 = iprot.readListBegin();
                    _val119 = new ArrayList<CannedAcl>(_list120.size);
                    for (int _i121 = 0; _i121 < _list120.size; ++_i121)
                    {
                      CannedAcl _elem122;
                      _elem122 = CannedAcl.findByValue(iprot.readI32());
                      _val119.add(_elem122);
                    }
                    iprot.readListEnd();
                  }
                  struct.appAcl.put(_key118, _val119);
                }
                iprot.readMapEnd();
              }
      ...
      if (incoming.get(2)) {
        {
          ...
          for (int _i128 = 0; _i128 < _map127.size; ++_i128)
          {
            ...
            _key129 = iprot.readString();
            {
              ...
              _val130 = new ArrayList<CannedAcl>(_list131.size);
              for (int _i132 = 0; _i132 < _list131.size; ++_i132)
              {
                CannedAcl _elem133;
                _elem133 = CannedAcl.findByValue(iprot.readI32());
                _val130.add(_elem133);
              }
            }
            struct.appAcl.put(_key129, _val130);
          }
        }
        struct.setAppAclIsSet(true);
      }
