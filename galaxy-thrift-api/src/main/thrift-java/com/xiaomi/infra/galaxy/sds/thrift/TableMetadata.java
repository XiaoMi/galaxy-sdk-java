...
public class TableMetadata implements libthrift091.TBase<TableMetadata, TableMetadata._Fields>, java.io.Serializable, Cloneable, Comparable<TableMetadata> {
  ...
  private static final libthrift091.protocol.TField ENABLE_SCAN_IN_GLOBAL_ORDER_FIELD_DESC = new libthrift091.protocol.TField("enableScanInGlobalOrder", libthrift091.protocol.TType.BOOL, (short)7);
  private static final libthrift091.protocol.TField REPLICATION_FIELD_DESC = new libthrift091.protocol.TField("replication", libthrift091.protocol.TType.STRUCT, (short)8);
  private static final libthrift091.protocol.TField ENABLE_SYS_SNAPSHOT_FIELD_DESC = new libthrift091.protocol.TField("enableSysSnapshot", libthrift091.protocol.TType.BOOL, (short)9);
   ...
   * 远程复制定义
   */
  public ReplicationSpec replication; // optional
  /**
  ...
  public enum _Fields implements libthrift091.TFieldIdEnum {
     ...
     * 是否支持全局有序扫描
     */
    ENABLE_SCAN_IN_GLOBAL_ORDER((short)7, "enableScanInGlobalOrder"),
    /**
     * 远程复制定义
     */
    REPLICATION((short)8, "replication"),
    /**
     * 是否支持系统定期做snapshot， 默认为true
     */
    ENABLE_SYS_SNAPSHOT((short)9, "enableSysSnapshot");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 6: // DESCRIPTION
          return DESCRIPTION;
        case 7: // ENABLE_SCAN_IN_GLOBAL_ORDER
          return ENABLE_SCAN_IN_GLOBAL_ORDER;
        case 8: // REPLICATION
          return REPLICATION;
        case 9: // ENABLE_SYS_SNAPSHOT
  ...
  private static final int __ENABLESCANINGLOBALORDER_ISSET_ID = 0;
  private static final int __ENABLESYSSNAPSHOT_ISSET_ID = 1;
  private byte __isset_bitfield = 0;
  private static final _Fields optionals[] = {_Fields.TABLE_ID,_Fields.DEVELOPER_ID,_Fields.APP_ACL,_Fields.QUOTA,_Fields.THROUGHPUT,_Fields.DESCRIPTION,_Fields.ENABLE_SCAN_IN_GLOBAL_ORDER,_Fields.REPLICATION,_Fields.ENABLE_SYS_SNAPSHOT};
  ...
  static {
    ...
    tmpMap.put(_Fields.REPLICATION, new libthrift091.meta_data.FieldMetaData("replication", libthrift091.TFieldRequirementType.OPTIONAL, 
        new libthrift091.meta_data.StructMetaData(libthrift091.protocol.TType.STRUCT, ReplicationSpec.class)));
  ...
  public TableMetadata(TableMetadata other) {
    ...
    if (other.isSetReplication()) {
      this.replication = new ReplicationSpec(other.replication);
    }
  ...
  public void clear() {
    ...
    setEnableScanInGlobalOrderIsSet(false);
   ...
   * 远程复制定义
   */
  public TableMetadata setReplication(ReplicationSpec replication) {
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case REPLICATION:
      if (value == null) {
        ...
        setReplication((ReplicationSpec)value);
      }
      break;
  ...
  public int compareTo(TableMetadata other) {
    ...
    if (isSetReplication()) {
      lastComparison = libthrift091.TBaseHelper.compareTo(this.replication, other.replication);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    public void read(libthrift091.protocol.TProtocol iprot, TableMetadata struct) throws libthrift091.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 8: // REPLICATION
            if (schemeField.type == libthrift091.protocol.TType.STRUCT) {
              struct.replication = new ReplicationSpec();
              struct.replication.read(iprot);
