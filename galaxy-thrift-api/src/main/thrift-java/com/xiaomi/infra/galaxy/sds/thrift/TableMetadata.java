...
public class TableMetadata implements libthrift091.TBase<TableMetadata, TableMetadata._Fields>, java.io.Serializable, Cloneable, Comparable<TableMetadata> {
  ...
  private static final libthrift091.protocol.TField SCAN_IN_GLOBAL_ORDER_ENABLED_FIELD_DESC = new libthrift091.protocol.TField("scanInGlobalOrderEnabled", libthrift091.protocol.TType.BOOL, (short)8);
   ...
   * 是否支持全局有序扫描
   */
  public boolean scanInGlobalOrderEnabled; // optional
  ...
  public enum _Fields implements libthrift091.TFieldIdEnum {
     ...
     * 是否支持全局有序扫描
     */
    SCAN_IN_GLOBAL_ORDER_ENABLED((short)8, "scanInGlobalOrderEnabled");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 8: // SCAN_IN_GLOBAL_ORDER_ENABLED
          return SCAN_IN_GLOBAL_ORDER_ENABLED;
        default:
          return null;
      }
    }
  ...
  private static final int __SCANINGLOBALORDERENABLED_ISSET_ID = 1;
  private byte __isset_bitfield = 0;
  private static final _Fields optionals[] = {_Fields.TABLE_ID,_Fields.DEVELOPER_ID,_Fields.APP_ACL,_Fields.QUOTA,_Fields.THROUGHPUT,_Fields.DESCRIPTION,_Fields.ENABLE_REPLICATION,_Fields.SCAN_IN_GLOBAL_ORDER_ENABLED};
  ...
  static {
    ...
    tmpMap.put(_Fields.SCAN_IN_GLOBAL_ORDER_ENABLED, new libthrift091.meta_data.FieldMetaData("scanInGlobalOrderEnabled", libthrift091.TFieldRequirementType.OPTIONAL, 
        new libthrift091.meta_data.FieldValueMetaData(libthrift091.protocol.TType.BOOL)));
  ...
  public TableMetadata(TableMetadata other) {
    ...
    this.scanInGlobalOrderEnabled = other.scanInGlobalOrderEnabled;
  }
  ...
  public void clear() {
    ...
    setScanInGlobalOrderEnabledIsSet(false);
    this.scanInGlobalOrderEnabled = false;
  }
   ...
   * 是否支持全局有序扫描
   */
  public boolean isScanInGlobalOrderEnabled() {
    return this.scanInGlobalOrderEnabled;
  }

  /**
   * 是否支持全局有序扫描
   */
  public TableMetadata setScanInGlobalOrderEnabled(boolean scanInGlobalOrderEnabled) {
    this.scanInGlobalOrderEnabled = scanInGlobalOrderEnabled;
    setScanInGlobalOrderEnabledIsSet(true);
    return this;
  }

  public void unsetScanInGlobalOrderEnabled() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __SCANINGLOBALORDERENABLED_ISSET_ID);
  }

  /** Returns true if field scanInGlobalOrderEnabled is set (has been assigned a value) and false otherwise */
  public boolean isSetScanInGlobalOrderEnabled() {
    return EncodingUtils.testBit(__isset_bitfield, __SCANINGLOBALORDERENABLED_ISSET_ID);
  }

  public void setScanInGlobalOrderEnabledIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __SCANINGLOBALORDERENABLED_ISSET_ID, value);
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case SCAN_IN_GLOBAL_ORDER_ENABLED:
      if (value == null) {
        unsetScanInGlobalOrderEnabled();
      } else {
        setScanInGlobalOrderEnabled((Boolean)value);
      }
      break;
  ...
  public Object getFieldValue(_Fields field) {
    ...
    case SCAN_IN_GLOBAL_ORDER_ENABLED:
      return Boolean.valueOf(isScanInGlobalOrderEnabled());
  ...
  public boolean isSet(_Fields field) {
    ...
    case SCAN_IN_GLOBAL_ORDER_ENABLED:
      return isSetScanInGlobalOrderEnabled();
    }
    throw new IllegalStateException();
  }
  ...
  public boolean equals(TableMetadata that) {
    ...
    boolean this_present_scanInGlobalOrderEnabled = true && this.isSetScanInGlobalOrderEnabled();
    boolean that_present_scanInGlobalOrderEnabled = true && that.isSetScanInGlobalOrderEnabled();
    if (this_present_scanInGlobalOrderEnabled || that_present_scanInGlobalOrderEnabled) {
      if (!(this_present_scanInGlobalOrderEnabled && that_present_scanInGlobalOrderEnabled))
        return false;
      if (this.scanInGlobalOrderEnabled != that.scanInGlobalOrderEnabled)
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_scanInGlobalOrderEnabled = true && (isSetScanInGlobalOrderEnabled());
    list.add(present_scanInGlobalOrderEnabled);
    if (present_scanInGlobalOrderEnabled)
      list.add(scanInGlobalOrderEnabled);
  ...
  public int compareTo(TableMetadata other) {
    ...
    lastComparison = Boolean.valueOf(isSetScanInGlobalOrderEnabled()).compareTo(other.isSetScanInGlobalOrderEnabled());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetScanInGlobalOrderEnabled()) {
      lastComparison = libthrift091.TBaseHelper.compareTo(this.scanInGlobalOrderEnabled, other.scanInGlobalOrderEnabled);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    ...
    if (isSetScanInGlobalOrderEnabled()) {
      if (!first) sb.append(", ");
      sb.append("scanInGlobalOrderEnabled:");
      sb.append(this.scanInGlobalOrderEnabled);
      first = false;
    }
    sb.append(")");
    return sb.toString();
  ...
  private static class TableMetadataStandardScheme extends StandardScheme<TableMetadata> {
    ...
    public void read(libthrift091.protocol.TProtocol iprot, TableMetadata struct) throws libthrift091.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 8: // SCAN_IN_GLOBAL_ORDER_ENABLED
            if (schemeField.type == libthrift091.protocol.TType.BOOL) {
              struct.scanInGlobalOrderEnabled = iprot.readBool();
              struct.setScanInGlobalOrderEnabledIsSet(true);
            } else { 
              libthrift091.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(libthrift091.protocol.TProtocol oprot, TableMetadata struct) throws libthrift091.TException {
      ...
      if (struct.isSetScanInGlobalOrderEnabled()) {
        oprot.writeFieldBegin(SCAN_IN_GLOBAL_ORDER_ENABLED_FIELD_DESC);
        oprot.writeBool(struct.scanInGlobalOrderEnabled);
        oprot.writeFieldEnd();
      }
