...
public class TableMetadata implements libthrift091.TBase<TableMetadata, TableMetadata._Fields>, java.io.Serializable, Cloneable, Comparable<TableMetadata> {
  ...
  private static final _Fields optionals[] = {_Fields.TABLE_ID,_Fields.DEVELOPER_ID,_Fields.APP_ACL,_Fields.QUOTA,_Fields.THROUGHPUT,_Fields.DESCRIPTION,_Fields.STREAM,_Fields.ENABLE_SYS_SNAPSHOT,_Fields.EXCEEDED_THROUGHPUT,_Fields.SLAVE_THROUGHPUT,_Fields.EXCEEDED_SLAVE_THROUGHPUT};
      ...
      if (struct.appAcl != null) {
        if (struct.isSetAppAcl()) {
          oprot.writeFieldBegin(APP_ACL_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, List<CannedAcl>> _iter141 : struct.appAcl.entrySet())
            {
              oprot.writeString(_iter141.getKey());
              {
                oprot.writeListBegin(new libthrift091.protocol.TList(libthrift091.protocol.TType.I32, _iter141.getValue().size()));
                for (CannedAcl _iter142 : _iter141.getValue())
                {
  ...
  private static class TableMetadataTupleScheme extends TupleScheme<TableMetadata> {
      ...
      if (struct.isSetAppAcl()) {
        {
          ...
          for (Map.Entry<String, List<CannedAcl>> _iter143 : struct.appAcl.entrySet())
          {
            oprot.writeString(_iter143.getKey());
            {
              oprot.writeI32(_iter143.getValue().size());
              for (CannedAcl _iter144 : _iter143.getValue())
              {
    ...
    public void read(libthrift091.protocol.TProtocol prot, TableMetadata struct) throws libthrift091.TException {
      ...
      if (incoming.get(2)) {
        {
          libthrift091.protocol.TMap _map145 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.LIST, iprot.readI32());
          struct.appAcl = new HashMap<String,List<CannedAcl>>(2*_map145.size);
          String _key146;
          List<CannedAcl> _val147;
          for (int _i148 = 0; _i148 < _map145.size; ++_i148)
          {
            _key146 = iprot.readString();
            {
              libthrift091.protocol.TList _list149 = new libthrift091.protocol.TList(libthrift091.protocol.TType.I32, iprot.readI32());
              _val147 = new ArrayList<CannedAcl>(_list149.size);
              CannedAcl _elem150;
              for (int _i151 = 0; _i151 < _list149.size; ++_i151)
              {
                _elem150 = com.xiaomi.infra.galaxy.sds.thrift.CannedAcl.findByValue(iprot.readI32());
                _val147.add(_elem150);
              }
            }
            struct.appAcl.put(_key146, _val147);
          }
        }
        struct.setAppAclIsSet(true);
      }
