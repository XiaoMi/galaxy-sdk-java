...
public class TableMetadata implements libthrift091.TBase<TableMetadata, TableMetadata._Fields>, java.io.Serializable, Cloneable, Comparable<TableMetadata> {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                ...
                struct.appAcl = new HashMap<String,List<CannedAcl>>(2*_map134.size);
                String _key135;
                List<CannedAcl> _val136;
                for (int _i137 = 0; _i137 < _map134.size; ++_i137)
                {
                  _key135 = iprot.readString();
                  {
                    libthrift091.protocol.TList _list138 = iprot.readListBegin();
                    _val136 = new ArrayList<CannedAcl>(_list138.size);
                    CannedAcl _elem139;
                    for (int _i140 = 0; _i140 < _list138.size; ++_i140)
                    {
                      _elem139 = com.xiaomi.infra.galaxy.sds.thrift.CannedAcl.findByValue(iprot.readI32());
                      _val136.add(_elem139);
                    }
                    iprot.readListEnd();
                  }
                  struct.appAcl.put(_key135, _val136);
                }
                iprot.readMapEnd();
              }
          ...
          case 12: // ACL
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                libthrift091.protocol.TMap _map141 = iprot.readMapBegin();
                struct.acl = new HashMap<String,List<Permission>>(2*_map141.size);
                String _key142;
                List<Permission> _val143;
                for (int _i144 = 0; _i144 < _map141.size; ++_i144)
                {
                  _key142 = iprot.readString();
                  {
                    libthrift091.protocol.TList _list145 = iprot.readListBegin();
                    _val143 = new ArrayList<Permission>(_list145.size);
                    Permission _elem146;
                    for (int _i147 = 0; _i147 < _list145.size; ++_i147)
                    {
                      _elem146 = com.xiaomi.infra.galaxy.sds.thrift.Permission.findByValue(iprot.readI32());
                      _val143.add(_elem146);
                    }
                    iprot.readListEnd();
                  }
                  struct.acl.put(_key142, _val143);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.appAcl != null) {
        if (struct.isSetAppAcl()) {
          oprot.writeFieldBegin(APP_ACL_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, List<CannedAcl>> _iter148 : struct.appAcl.entrySet())
            {
              oprot.writeString(_iter148.getKey());
              {
                oprot.writeListBegin(new libthrift091.protocol.TList(libthrift091.protocol.TType.I32, _iter148.getValue().size()));
                for (CannedAcl _iter149 : _iter148.getValue())
                {
      ...
      if (struct.acl != null) {
        if (struct.isSetAcl()) {
          oprot.writeFieldBegin(ACL_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, List<Permission>> _iter150 : struct.acl.entrySet())
            {
              oprot.writeString(_iter150.getKey());
              {
                oprot.writeListBegin(new libthrift091.protocol.TList(libthrift091.protocol.TType.I32, _iter150.getValue().size()));
                for (Permission _iter151 : _iter150.getValue())
                {
  ...
  private static class TableMetadataTupleScheme extends TupleScheme<TableMetadata> {
      ...
      if (struct.isSetAppAcl()) {
        {
          ...
          for (Map.Entry<String, List<CannedAcl>> _iter152 : struct.appAcl.entrySet())
          {
            oprot.writeString(_iter152.getKey());
            {
              oprot.writeI32(_iter152.getValue().size());
              for (CannedAcl _iter153 : _iter152.getValue())
              {
      ...
      if (struct.isSetAcl()) {
        {
          ...
          for (Map.Entry<String, List<Permission>> _iter154 : struct.acl.entrySet())
          {
            oprot.writeString(_iter154.getKey());
            {
              oprot.writeI32(_iter154.getValue().size());
              for (Permission _iter155 : _iter154.getValue())
              {
    ...
    public void read(libthrift091.protocol.TProtocol prot, TableMetadata struct) throws libthrift091.TException {
      ...
      if (incoming.get(2)) {
        {
          libthrift091.protocol.TMap _map156 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.LIST, iprot.readI32());
          struct.appAcl = new HashMap<String,List<CannedAcl>>(2*_map156.size);
          String _key157;
          List<CannedAcl> _val158;
          for (int _i159 = 0; _i159 < _map156.size; ++_i159)
          {
            _key157 = iprot.readString();
            {
              libthrift091.protocol.TList _list160 = new libthrift091.protocol.TList(libthrift091.protocol.TType.I32, iprot.readI32());
              _val158 = new ArrayList<CannedAcl>(_list160.size);
              CannedAcl _elem161;
              for (int _i162 = 0; _i162 < _list160.size; ++_i162)
              {
                _elem161 = com.xiaomi.infra.galaxy.sds.thrift.CannedAcl.findByValue(iprot.readI32());
                _val158.add(_elem161);
              }
            }
            struct.appAcl.put(_key157, _val158);
          }
        }
        struct.setAppAclIsSet(true);
      }
      ...
      if (incoming.get(11)) {
        {
          libthrift091.protocol.TMap _map163 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.LIST, iprot.readI32());
          struct.acl = new HashMap<String,List<Permission>>(2*_map163.size);
          String _key164;
          List<Permission> _val165;
          for (int _i166 = 0; _i166 < _map163.size; ++_i166)
          {
            _key164 = iprot.readString();
            {
              libthrift091.protocol.TList _list167 = new libthrift091.protocol.TList(libthrift091.protocol.TType.I32, iprot.readI32());
              _val165 = new ArrayList<Permission>(_list167.size);
              Permission _elem168;
              for (int _i169 = 0; _i169 < _list167.size; ++_i169)
              {
                _elem168 = com.xiaomi.infra.galaxy.sds.thrift.Permission.findByValue(iprot.readI32());
                _val165.add(_elem168);
              }
            }
            struct.acl.put(_key164, _val165);
          }
        }
        struct.setAclIsSet(true);
      }
