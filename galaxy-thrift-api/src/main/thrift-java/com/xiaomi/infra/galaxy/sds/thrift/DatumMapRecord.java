...
public class DatumMapRecord implements libthrift091.TBase<DatumMapRecord, DatumMapRecord._Fields>, java.io.Serializable, Cloneable, Comparable<DatumMapRecord> {
  ...
  private _Fields optionals[] = {_Fields.DATA,_Fields.KEY_ID_MAP};
            ...
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                ...
                {
                  short _key38;
                  com.xiaomi.infra.galaxy.sds.thrift.Datum _val39;
                  _key38 = iprot.readI16();
                  _val39 = new com.xiaomi.infra.galaxy.sds.thrift.Datum();
                  _val39.read(iprot);
            ...
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                ...
                for (int _i41 = 0; _i41 < _map40.size; ++_i41)
                {
                  short _key42;
                  String _val43;
                  _key42 = iprot.readI16();
                  _val43 = iprot.readString();
                  struct.keyIdMap.put(_key42, _val43);
                }
                iprot.readMapEnd();
              }
      ...
      if (incoming.get(0)) {
        {
          ...
          {
            short _key50;
            com.xiaomi.infra.galaxy.sds.thrift.Datum _val51;
            _key50 = iprot.readI16();
            _val51 = new com.xiaomi.infra.galaxy.sds.thrift.Datum();
            _val51.read(iprot);
            struct.data.put(_key50, _val51);
          }
        }
        struct.setDataIsSet(true);
      }
      if (incoming.get(1)) {
        {
          ...
          for (int _i53 = 0; _i53 < _map52.size; ++_i53)
          {
            ...
            struct.keyIdMap.put(_key54, _val55);
          }
        }
        struct.setKeyIdMapIsSet(true);
      }
