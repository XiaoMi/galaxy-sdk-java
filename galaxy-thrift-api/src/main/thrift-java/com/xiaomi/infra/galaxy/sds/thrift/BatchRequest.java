...
public class BatchRequest implements libthrift091.TBase<BatchRequest, BatchRequest._Fields>, java.io.Serializable, Cloneable, Comparable<BatchRequest> {
        ...
        switch (schemeField.id) {
          case 1: // ITEMS
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                libthrift091.protocol.TList _list326 = iprot.readListBegin();
                struct.items = new ArrayList<BatchRequestItem>(_list326.size);
                BatchRequestItem _elem327;
                for (int _i328 = 0; _i328 < _list326.size; ++_i328)
                {
                  _elem327 = new BatchRequestItem();
                  _elem327.read(iprot);
                  struct.items.add(_elem327);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.items != null) {
        if (struct.isSetItems()) {
          oprot.writeFieldBegin(ITEMS_FIELD_DESC);
          {
            ...
            for (BatchRequestItem _iter329 : struct.items)
            {
  ...
  private static class BatchRequestTupleScheme extends TupleScheme<BatchRequest> {
      ...
      if (struct.isSetItems()) {
        {
          ...
          for (BatchRequestItem _iter330 : struct.items)
          {
    ...
    public void read(libthrift091.protocol.TProtocol prot, BatchRequest struct) throws libthrift091.TException {
      ...
      if (incoming.get(0)) {
        {
          libthrift091.protocol.TList _list331 = new libthrift091.protocol.TList(libthrift091.protocol.TType.STRUCT, iprot.readI32());
          struct.items = new ArrayList<BatchRequestItem>(_list331.size);
          BatchRequestItem _elem332;
          for (int _i333 = 0; _i333 < _list331.size; ++_i333)
          {
            _elem332 = new BatchRequestItem();
            _elem332.read(iprot);
            struct.items.add(_elem332);
          }
        }
        struct.setItemsIsSet(true);
      }
