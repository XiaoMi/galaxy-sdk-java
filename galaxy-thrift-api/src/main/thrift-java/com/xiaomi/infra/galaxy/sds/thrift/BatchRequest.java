...
public class BatchRequest implements libthrift091.TBase<BatchRequest, BatchRequest._Fields>, java.io.Serializable, Cloneable, Comparable<BatchRequest> {
        ...
        switch (schemeField.id) {
          case 1: // ITEMS
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                libthrift091.protocol.TList _list358 = iprot.readListBegin();
                struct.items = new ArrayList<BatchRequestItem>(_list358.size);
                BatchRequestItem _elem359;
                for (int _i360 = 0; _i360 < _list358.size; ++_i360)
                {
                  _elem359 = new BatchRequestItem();
                  _elem359.read(iprot);
                  struct.items.add(_elem359);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.items != null) {
        if (struct.isSetItems()) {
          oprot.writeFieldBegin(ITEMS_FIELD_DESC);
          {
            ...
            for (BatchRequestItem _iter361 : struct.items)
            {
  ...
  private static class BatchRequestTupleScheme extends TupleScheme<BatchRequest> {
      ...
      if (struct.isSetItems()) {
        {
          ...
          for (BatchRequestItem _iter362 : struct.items)
          {
    ...
    public void read(libthrift091.protocol.TProtocol prot, BatchRequest struct) throws libthrift091.TException {
      ...
      if (incoming.get(0)) {
        {
          libthrift091.protocol.TList _list363 = new libthrift091.protocol.TList(libthrift091.protocol.TType.STRUCT, iprot.readI32());
          struct.items = new ArrayList<BatchRequestItem>(_list363.size);
          BatchRequestItem _elem364;
          for (int _i365 = 0; _i365 < _list363.size; ++_i365)
          {
            _elem364 = new BatchRequestItem();
            _elem364.read(iprot);
            struct.items.add(_elem364);
          }
        }
        struct.setItemsIsSet(true);
      }
