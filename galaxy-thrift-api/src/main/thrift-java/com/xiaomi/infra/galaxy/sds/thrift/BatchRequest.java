...
public class BatchRequest implements libthrift091.TBase<BatchRequest, BatchRequest._Fields>, java.io.Serializable, Cloneable, Comparable<BatchRequest> {
        ...
        switch (schemeField.id) {
          case 1: // ITEMS
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                libthrift091.protocol.TList _list332 = iprot.readListBegin();
                struct.items = new ArrayList<BatchRequestItem>(_list332.size);
                BatchRequestItem _elem333;
                for (int _i334 = 0; _i334 < _list332.size; ++_i334)
                {
                  _elem333 = new BatchRequestItem();
                  _elem333.read(iprot);
                  struct.items.add(_elem333);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.items != null) {
        if (struct.isSetItems()) {
          oprot.writeFieldBegin(ITEMS_FIELD_DESC);
          {
            ...
            for (BatchRequestItem _iter335 : struct.items)
            {
  ...
  private static class BatchRequestTupleScheme extends TupleScheme<BatchRequest> {
      ...
      if (struct.isSetItems()) {
        {
          ...
          for (BatchRequestItem _iter336 : struct.items)
          {
    ...
    public void read(libthrift091.protocol.TProtocol prot, BatchRequest struct) throws libthrift091.TException {
      ...
      if (incoming.get(0)) {
        {
          libthrift091.protocol.TList _list337 = new libthrift091.protocol.TList(libthrift091.protocol.TType.STRUCT, iprot.readI32());
          struct.items = new ArrayList<BatchRequestItem>(_list337.size);
          BatchRequestItem _elem338;
          for (int _i339 = 0; _i339 < _list337.size; ++_i339)
          {
            _elem338 = new BatchRequestItem();
            _elem338.read(iprot);
            struct.items.add(_elem338);
          }
        }
        struct.setItemsIsSet(true);
      }
