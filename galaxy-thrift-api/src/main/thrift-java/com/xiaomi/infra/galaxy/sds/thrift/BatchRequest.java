...
public class BatchRequest implements libthrift091.TBase<BatchRequest, BatchRequest._Fields>, java.io.Serializable, Cloneable, Comparable<BatchRequest> {
        ...
        switch (schemeField.id) {
          case 1: // ITEMS
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                libthrift091.protocol.TList _list306 = iprot.readListBegin();
                struct.items = new ArrayList<BatchRequestItem>(_list306.size);
                BatchRequestItem _elem307;
                for (int _i308 = 0; _i308 < _list306.size; ++_i308)
                {
                  _elem307 = new BatchRequestItem();
                  _elem307.read(iprot);
                  struct.items.add(_elem307);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.items != null) {
        if (struct.isSetItems()) {
          oprot.writeFieldBegin(ITEMS_FIELD_DESC);
          {
            ...
            for (BatchRequestItem _iter309 : struct.items)
            {
  ...
  private static class BatchRequestTupleScheme extends TupleScheme<BatchRequest> {
      ...
      if (struct.isSetItems()) {
        {
          ...
          for (BatchRequestItem _iter310 : struct.items)
          {
    ...
    public void read(libthrift091.protocol.TProtocol prot, BatchRequest struct) throws libthrift091.TException {
      ...
      if (incoming.get(0)) {
        {
          libthrift091.protocol.TList _list311 = new libthrift091.protocol.TList(libthrift091.protocol.TType.STRUCT, iprot.readI32());
          struct.items = new ArrayList<BatchRequestItem>(_list311.size);
          BatchRequestItem _elem312;
          for (int _i313 = 0; _i313 < _list311.size; ++_i313)
          {
            _elem312 = new BatchRequestItem();
            _elem312.read(iprot);
            struct.items.add(_elem312);
          }
        }
        struct.setItemsIsSet(true);
      }
