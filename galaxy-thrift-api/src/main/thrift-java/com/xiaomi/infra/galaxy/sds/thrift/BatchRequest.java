...
public class BatchRequest implements libthrift091.TBase<BatchRequest, BatchRequest._Fields>, java.io.Serializable, Cloneable, Comparable<BatchRequest> {
  ...
  public List<BatchRequestItem> items; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.ITEMS, new libthrift091.meta_data.FieldMetaData("items", libthrift091.TFieldRequirementType.REQUIRED, 
  ...
  public void validate() throws libthrift091.TException {
    ...
    if (items == null) {
      throw new libthrift091.protocol.TProtocolException("Required field 'items' was not present! Struct: " + toString());
    }
            ...
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                ...
                {
                  BatchRequestItem _elem298;
                  _elem298 = new BatchRequestItem();
                  _elem298.read(iprot);
                  struct.items.add(_elem298);
                }
                iprot.readListEnd();
              }
  ...
  private static class BatchRequestTupleScheme extends TupleScheme<BatchRequest> {
    ...
    public void read(libthrift091.protocol.TProtocol prot, BatchRequest struct) throws libthrift091.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      {
        ...
        {
          BatchRequestItem _elem303;
          _elem303 = new BatchRequestItem();
          _elem303.read(iprot);
          struct.items.add(_elem303);
        }
      }
      struct.setItemsIsSet(true);
    }
