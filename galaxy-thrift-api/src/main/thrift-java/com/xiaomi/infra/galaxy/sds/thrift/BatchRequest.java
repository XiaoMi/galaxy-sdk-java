...
public class BatchRequest implements libthrift091.TBase<BatchRequest, BatchRequest._Fields>, java.io.Serializable, Cloneable, Comparable<BatchRequest> {
        ...
        switch (schemeField.id) {
          case 1: // ITEMS
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                libthrift091.protocol.TList _list314 = iprot.readListBegin();
                struct.items = new ArrayList<BatchRequestItem>(_list314.size);
                BatchRequestItem _elem315;
                for (int _i316 = 0; _i316 < _list314.size; ++_i316)
                {
                  _elem315 = new BatchRequestItem();
                  _elem315.read(iprot);
                  struct.items.add(_elem315);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.items != null) {
        if (struct.isSetItems()) {
          oprot.writeFieldBegin(ITEMS_FIELD_DESC);
          {
            ...
            for (BatchRequestItem _iter317 : struct.items)
            {
  ...
  private static class BatchRequestTupleScheme extends TupleScheme<BatchRequest> {
      ...
      if (struct.isSetItems()) {
        {
          ...
          for (BatchRequestItem _iter318 : struct.items)
          {
    ...
    public void read(libthrift091.protocol.TProtocol prot, BatchRequest struct) throws libthrift091.TException {
      ...
      if (incoming.get(0)) {
        {
          libthrift091.protocol.TList _list319 = new libthrift091.protocol.TList(libthrift091.protocol.TType.STRUCT, iprot.readI32());
          struct.items = new ArrayList<BatchRequestItem>(_list319.size);
          BatchRequestItem _elem320;
          for (int _i321 = 0; _i321 < _list319.size; ++_i321)
          {
            _elem320 = new BatchRequestItem();
            _elem320.read(iprot);
            struct.items.add(_elem320);
          }
        }
        struct.setItemsIsSet(true);
      }
