...
public class DeployState implements libthrift091.TBase<DeployState, DeployState._Fields>, java.io.Serializable, Cloneable, Comparable<DeployState> {
  private static final libthrift091.protocol.TStruct STRUCT_DESC = new libthrift091.protocol.TStruct("DeployState");
  ...
  static {
    schemes.put(StandardScheme.class, new DeployStateStandardSchemeFactory());
    schemes.put(TupleScheme.class, new DeployStateTupleSchemeFactory());
  }
  ...
  static {
    ...
    libthrift091.meta_data.FieldMetaData.addStructMetaDataMap(DeployState.class, metaDataMap);
  }
   ...
   */
  public DeployState(DeployState other) {
  ...
  public DeployState deepCopy() {
    return new DeployState(this);
  }
  ...
  public DeployState setReady(boolean ready) {
    this.ready = ready;
    setReadyIsSet(true);
    return this;
  }
  ...
  public DeployState setTimeline(Timeline timeline) {
  ...
  public DeployState setHostReady(boolean hostReady) {
  ...
  public DeployState setServiceReady(boolean serviceReady) {
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof DeployState)
      return this.equals((DeployState)that);
    return false;
  }

  public boolean equals(DeployState that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(DeployState other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("DeployState(");
    boolean first = true;
  ...
  private static class DeployStateStandardSchemeFactory implements SchemeFactory {
    public DeployStateStandardScheme getScheme() {
      return new DeployStateStandardScheme();
    }
  }

  private static class DeployStateStandardScheme extends StandardScheme<DeployState> {

    public void read(libthrift091.protocol.TProtocol iprot, DeployState struct) throws libthrift091.TException {
    ...
    public void write(libthrift091.protocol.TProtocol oprot, DeployState struct) throws libthrift091.TException {
      struct.validate();
  ...
  private static class DeployStateTupleSchemeFactory implements SchemeFactory {
    public DeployStateTupleScheme getScheme() {
      return new DeployStateTupleScheme();
    }
  }

  private static class DeployStateTupleScheme extends TupleScheme<DeployState> {

    @Override
    public void write(libthrift091.protocol.TProtocol prot, DeployState struct) throws libthrift091.TException {
    ...
    @Override
    public void read(libthrift091.protocol.TProtocol prot, DeployState struct) throws libthrift091.TException {
