...
public class MetricQueryRequest implements libthrift091.TBase<MetricQueryRequest, MetricQueryRequest._Fields>, java.io.Serializable, Cloneable, Comparable<MetricQueryRequest> {
  ...
  private _Fields optionals[] = {_Fields.TABLE_NAME,_Fields.START_TIME,_Fields.STOP_TIME,_Fields.METRIC_KEY,_Fields.METRIC_TYPE,_Fields.DOWNSAMPLE_INTERVAL,_Fields.DOWNSAMPLE_TIME_UNIT};
        ...
        switch (schemeField.id) {
          ...
          case 4: // METRIC_KEY
            if (schemeField.type == libthrift091.protocol.TType.I32) {
              struct.metricKey = MetricKey.findByValue(iprot.readI32());
          ...
          case 5: // METRIC_TYPE
            if (schemeField.type == libthrift091.protocol.TType.I32) {
              struct.metricType = MetricType.findByValue(iprot.readI32());
          ...
          case 7: // DOWNSAMPLE_TIME_UNIT
            if (schemeField.type == libthrift091.protocol.TType.I32) {
              struct.downsampleTimeUnit = TimeSpanUnit.findByValue(iprot.readI32());
