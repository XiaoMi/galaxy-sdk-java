...
public class AppInfo implements libthrift091.TBase<AppInfo, AppInfo._Fields>, java.io.Serializable, Cloneable, Comparable<AppInfo> {
  ...
  private _Fields optionals[] = {_Fields.APP_ID,_Fields.DEVELOPER_ID,_Fields.TABLE_MAPPINGS,_Fields.OAUTH_APP_MAPPING};
            ...
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                ...
                for (int _i1 = 0; _i1 < _map0.size; ++_i1)
                {
                  ...
                  struct.tableMappings.put(_key2, _val3);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                ...
                for (int _i5 = 0; _i5 < _map4.size; ++_i5)
                {
                  ...
                  struct.oauthAppMapping.put(_key6, _val7);
                }
                iprot.readMapEnd();
              }
      ...
      if (incoming.get(2)) {
        {
          ...
          for (int _i13 = 0; _i13 < _map12.size; ++_i13)
          {
            ...
            struct.tableMappings.put(_key14, _val15);
          }
        }
        struct.setTableMappingsIsSet(true);
      }
      if (incoming.get(3)) {
        {
          ...
          for (int _i17 = 0; _i17 < _map16.size; ++_i17)
          {
            ...
            struct.oauthAppMapping.put(_key18, _val19);
          }
        }
        struct.setOauthAppMappingIsSet(true);
      }
