...
public class ScanResult implements libthrift091.TBase<ScanResult, ScanResult._Fields>, java.io.Serializable, Cloneable, Comparable<ScanResult> {
        ...
        switch (schemeField.id) {
          case 1: // NEXT_START_KEY
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                libthrift091.protocol.TMap _map278 = iprot.readMapBegin();
                struct.nextStartKey = new HashMap<String,Datum>(2*_map278.size);
                String _key279;
                Datum _val280;
                for (int _i281 = 0; _i281 < _map278.size; ++_i281)
                {
                  ...
                  _val280 = new Datum();
                  _val280.read(iprot);
                  struct.nextStartKey.put(_key279, _val280);
                }
                iprot.readMapEnd();
              }
          ...
          case 2: // RECORDS
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                libthrift091.protocol.TList _list282 = iprot.readListBegin();
                struct.records = new ArrayList<Map<String,Datum>>(_list282.size);
                Map<String,Datum> _elem283;
                for (int _i284 = 0; _i284 < _list282.size; ++_i284)
                {
                  {
                    libthrift091.protocol.TMap _map285 = iprot.readMapBegin();
                    _elem283 = new HashMap<String,Datum>(2*_map285.size);
                    String _key286;
                    Datum _val287;
                    for (int _i288 = 0; _i288 < _map285.size; ++_i288)
                    {
                      ...
                      _val287 = new Datum();
                      _val287.read(iprot);
                      _elem283.put(_key286, _val287);
                    }
                    iprot.readMapEnd();
                  }
                  struct.records.add(_elem283);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.nextStartKey != null) {
        if (struct.isSetNextStartKey()) {
          oprot.writeFieldBegin(NEXT_START_KEY_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Datum> _iter289 : struct.nextStartKey.entrySet())
            {
      ...
      if (struct.records != null) {
        if (struct.isSetRecords()) {
          oprot.writeFieldBegin(RECORDS_FIELD_DESC);
          {
            ...
            for (Map<String,Datum> _iter290 : struct.records)
            {
              {
                oprot.writeMapBegin(new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.STRUCT, _iter290.size()));
                for (Map.Entry<String, Datum> _iter291 : _iter290.entrySet())
                {
  ...
  private static class ScanResultTupleScheme extends TupleScheme<ScanResult> {
      ...
      if (struct.isSetNextStartKey()) {
        {
          ...
          for (Map.Entry<String, Datum> _iter292 : struct.nextStartKey.entrySet())
          {
      ...
      if (struct.isSetRecords()) {
        {
          ...
          for (Map<String,Datum> _iter293 : struct.records)
          {
            {
              oprot.writeI32(_iter293.size());
              for (Map.Entry<String, Datum> _iter294 : _iter293.entrySet())
              {
    ...
    public void read(libthrift091.protocol.TProtocol prot, ScanResult struct) throws libthrift091.TException {
      ...
      if (incoming.get(0)) {
        {
          libthrift091.protocol.TMap _map295 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.STRUCT, iprot.readI32());
          struct.nextStartKey = new HashMap<String,Datum>(2*_map295.size);
          String _key296;
          Datum _val297;
          for (int _i298 = 0; _i298 < _map295.size; ++_i298)
          {
            ...
            _val297 = new Datum();
            _val297.read(iprot);
            struct.nextStartKey.put(_key296, _val297);
          }
        }
        struct.setNextStartKeyIsSet(true);
      }
      if (incoming.get(1)) {
        {
          libthrift091.protocol.TList _list299 = new libthrift091.protocol.TList(libthrift091.protocol.TType.MAP, iprot.readI32());
          struct.records = new ArrayList<Map<String,Datum>>(_list299.size);
          Map<String,Datum> _elem300;
          for (int _i301 = 0; _i301 < _list299.size; ++_i301)
          {
            {
              libthrift091.protocol.TMap _map302 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.STRUCT, iprot.readI32());
              _elem300 = new HashMap<String,Datum>(2*_map302.size);
              String _key303;
              Datum _val304;
              for (int _i305 = 0; _i305 < _map302.size; ++_i305)
              {
                ...
                _val304 = new Datum();
                _val304.read(iprot);
                _elem300.put(_key303, _val304);
              }
            }
            struct.records.add(_elem300);
          }
        }
        struct.setRecordsIsSet(true);
      }
