...
public class ScanResult implements libthrift091.TBase<ScanResult, ScanResult._Fields>, java.io.Serializable, Cloneable, Comparable<ScanResult> {
  ...
  private static final libthrift091.protocol.TField THROTTLE_FIELD_DESC = new libthrift091.protocol.TField("throttle", libthrift091.protocol.TType.BOOL, (short)3);
  private static final libthrift091.protocol.TField SUCCESS_FIELD_DESC = new libthrift091.protocol.TField("success", libthrift091.protocol.TType.BOOL, (short)4);
  private static final libthrift091.protocol.TField SCANNED_RECORDS_FIELD_DESC = new libthrift091.protocol.TField("scannedRecords", libthrift091.protocol.TType.I32, (short)5);
   ...
   * 是否超过表的qps quota
   */
  public boolean throttle; // optional
  /**
   * 是否成功扫描到所有数据
   */
   ...
   * 已经扫描的记录条数
   */
  public int scannedRecords; // optional
  ...
  public enum _Fields implements libthrift091.TFieldIdEnum {
     ...
     * 已经扫描的记录条数
     */
    SCANNED_RECORDS((short)5, "scannedRecords");
  ...
  private static final int __THROTTLE_ISSET_ID = 0;
  private static final int __SUCCESS_ISSET_ID = 1;
  private static final int __SCANNEDRECORDS_ISSET_ID = 2;
  private byte __isset_bitfield = 0;
  private static final _Fields optionals[] = {_Fields.NEXT_START_KEY,_Fields.RECORDS,_Fields.THROTTLE,_Fields.SUCCESS,_Fields.SCANNED_RECORDS};
  ...
  static {
    ...
    tmpMap.put(_Fields.RECORDS, new libthrift091.meta_data.FieldMetaData("records", libthrift091.TFieldRequirementType.OPTIONAL, 
        new libthrift091.meta_data.ListMetaData(libthrift091.protocol.TType.LIST, 
            new libthrift091.meta_data.FieldValueMetaData(libthrift091.protocol.TType.MAP            , "Dictionary"))));
    tmpMap.put(_Fields.THROTTLE, new libthrift091.meta_data.FieldMetaData("throttle", libthrift091.TFieldRequirementType.OPTIONAL, 
    ...
    tmpMap.put(_Fields.SUCCESS, new libthrift091.meta_data.FieldMetaData("success", libthrift091.TFieldRequirementType.OPTIONAL, 
        new libthrift091.meta_data.FieldValueMetaData(libthrift091.protocol.TType.BOOL)));
    tmpMap.put(_Fields.SCANNED_RECORDS, new libthrift091.meta_data.FieldMetaData("scannedRecords", libthrift091.TFieldRequirementType.OPTIONAL, 
  ...
  public ScanResult(ScanResult other) {
    ...
    this.scannedRecords = other.scannedRecords;
  }
  ...
  public void clear() {
    ...
    this.records = null;
    setThrottleIsSet(false);
    this.throttle = false;
    setSuccessIsSet(false);
    this.success = false;
    setScannedRecordsIsSet(false);
   ...
   * 是否超过表的qps quota
   */
  public ScanResult setThrottle(boolean throttle) {
    this.throttle = throttle;
    setThrottleIsSet(true);
    return this;
  }

  public void unsetThrottle() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __THROTTLE_ISSET_ID);
  }

  /** Returns true if field throttle is set (has been assigned a value) and false otherwise */
  public boolean isSetThrottle() {
    return EncodingUtils.testBit(__isset_bitfield, __THROTTLE_ISSET_ID);
  }

  public void setThrottleIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __THROTTLE_ISSET_ID, value);
  }
   ...
   * 已经扫描的记录条数
   */
  public ScanResult setScannedRecords(int scannedRecords) {
    this.scannedRecords = scannedRecords;
    setScannedRecordsIsSet(true);
    return this;
  }

  public void unsetScannedRecords() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __SCANNEDRECORDS_ISSET_ID);
  }

  /** Returns true if field scannedRecords is set (has been assigned a value) and false otherwise */
  public boolean isSetScannedRecords() {
    return EncodingUtils.testBit(__isset_bitfield, __SCANNEDRECORDS_ISSET_ID);
  }

  public void setScannedRecordsIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __SCANNEDRECORDS_ISSET_ID, value);
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case SCANNED_RECORDS:
      if (value == null) {
        unsetScannedRecords();
      } else {
        setScannedRecords((Integer)value);
      }
      break;
  ...
  public Object getFieldValue(_Fields field) {
    ...
    case THROTTLE:
      return Boolean.valueOf(isThrottle());

    case SUCCESS:
      return Boolean.valueOf(isSuccess());

    case SCANNED_RECORDS:
      return Integer.valueOf(getScannedRecords());
  ...
  public boolean equals(ScanResult that) {
    ...
    boolean this_present_throttle = true && this.isSetThrottle();
    boolean that_present_throttle = true && that.isSetThrottle();
    if (this_present_throttle || that_present_throttle) {
      if (!(this_present_throttle && that_present_throttle))
        return false;
      if (this.throttle != that.throttle)
        return false;
    }
    ...
    boolean this_present_scannedRecords = true && this.isSetScannedRecords();
    boolean that_present_scannedRecords = true && that.isSetScannedRecords();
    if (this_present_scannedRecords || that_present_scannedRecords) {
      if (!(this_present_scannedRecords && that_present_scannedRecords))
        return false;
      if (this.scannedRecords != that.scannedRecords)
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_throttle = true && (isSetThrottle());
    list.add(present_throttle);
    if (present_throttle)
      list.add(throttle);
    ...
    boolean present_scannedRecords = true && (isSetScannedRecords());
    list.add(present_scannedRecords);
    if (present_scannedRecords)
      list.add(scannedRecords);
  ...
  public int compareTo(ScanResult other) {
    ...
    lastComparison = Boolean.valueOf(isSetThrottle()).compareTo(other.isSetThrottle());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetThrottle()) {
      lastComparison = libthrift091.TBaseHelper.compareTo(this.throttle, other.throttle);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    lastComparison = Boolean.valueOf(isSetScannedRecords()).compareTo(other.isSetScannedRecords());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetScannedRecords()) {
      lastComparison = libthrift091.TBaseHelper.compareTo(this.scannedRecords, other.scannedRecords);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    ...
    if (isSetScannedRecords()) {
      if (!first) sb.append(", ");
      sb.append("scannedRecords:");
      sb.append(this.scannedRecords);
      first = false;
    }
    sb.append(")");
    return sb.toString();
  ...
  private static class ScanResultStandardScheme extends StandardScheme<ScanResult> {
        ...
        switch (schemeField.id) {
          ...
          case 3: // THROTTLE
            if (schemeField.type == libthrift091.protocol.TType.BOOL) {
              struct.throttle = iprot.readBool();
              struct.setThrottleIsSet(true);
            } else { 
              libthrift091.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
          ...
          case 5: // SCANNED_RECORDS
            if (schemeField.type == libthrift091.protocol.TType.I32) {
              struct.scannedRecords = iprot.readI32();
              struct.setScannedRecordsIsSet(true);
            } else { 
              libthrift091.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(libthrift091.protocol.TProtocol oprot, ScanResult struct) throws libthrift091.TException {
      ...
      if (struct.isSetThrottle()) {
        oprot.writeFieldBegin(THROTTLE_FIELD_DESC);
        oprot.writeBool(struct.throttle);
        oprot.writeFieldEnd();
      }
      ...
      if (struct.isSetScannedRecords()) {
        oprot.writeFieldBegin(SCANNED_RECORDS_FIELD_DESC);
        oprot.writeI32(struct.scannedRecords);
        oprot.writeFieldEnd();
      }
