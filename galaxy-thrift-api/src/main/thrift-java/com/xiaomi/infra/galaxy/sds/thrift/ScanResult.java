...
public class ScanResult implements libthrift091.TBase<ScanResult, ScanResult._Fields>, java.io.Serializable, Cloneable, Comparable<ScanResult> {
        ...
        switch (schemeField.id) {
          case 1: // NEXT_START_KEY
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                libthrift091.protocol.TMap _map286 = iprot.readMapBegin();
                struct.nextStartKey = new HashMap<String,Datum>(2*_map286.size);
                String _key287;
                Datum _val288;
          ...
          case 2: // RECORDS
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                libthrift091.protocol.TList _list290 = iprot.readListBegin();
                struct.records = new ArrayList<Map<String,Datum>>(_list290.size);
                Map<String,Datum> _elem291;
                for (int _i292 = 0; _i292 < _list290.size; ++_i292)
                {
                  {
                    libthrift091.protocol.TMap _map293 = iprot.readMapBegin();
                    _elem291 = new HashMap<String,Datum>(2*_map293.size);
                    String _key294;
                    Datum _val295;
      ...
      if (struct.nextStartKey != null) {
        if (struct.isSetNextStartKey()) {
          oprot.writeFieldBegin(NEXT_START_KEY_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Datum> _iter297 : struct.nextStartKey.entrySet())
            {
      ...
      if (struct.records != null) {
        if (struct.isSetRecords()) {
          oprot.writeFieldBegin(RECORDS_FIELD_DESC);
          {
            ...
            for (Map<String,Datum> _iter298 : struct.records)
            {
              {
                oprot.writeMapBegin(new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.STRUCT, _iter298.size()));
                for (Map.Entry<String, Datum> _iter299 : _iter298.entrySet())
                {
  ...
  private static class ScanResultTupleScheme extends TupleScheme<ScanResult> {
      ...
      if (struct.isSetNextStartKey()) {
        {
          ...
          for (Map.Entry<String, Datum> _iter300 : struct.nextStartKey.entrySet())
          {
      ...
      if (struct.isSetRecords()) {
        {
          ...
          for (Map<String,Datum> _iter301 : struct.records)
          {
            {
              oprot.writeI32(_iter301.size());
              for (Map.Entry<String, Datum> _iter302 : _iter301.entrySet())
              {
    ...
    public void read(libthrift091.protocol.TProtocol prot, ScanResult struct) throws libthrift091.TException {
      ...
      if (incoming.get(0)) {
        {
          libthrift091.protocol.TMap _map303 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.STRUCT, iprot.readI32());
          struct.nextStartKey = new HashMap<String,Datum>(2*_map303.size);
          String _key304;
          Datum _val305;
          for (int _i306 = 0; _i306 < _map303.size; ++_i306)
          {
            ...
            _val305 = new Datum();
            _val305.read(iprot);
            struct.nextStartKey.put(_key304, _val305);
          }
        }
        struct.setNextStartKeyIsSet(true);
      }
      if (incoming.get(1)) {
        {
          libthrift091.protocol.TList _list307 = new libthrift091.protocol.TList(libthrift091.protocol.TType.MAP, iprot.readI32());
          struct.records = new ArrayList<Map<String,Datum>>(_list307.size);
          Map<String,Datum> _elem308;
          for (int _i309 = 0; _i309 < _list307.size; ++_i309)
          {
            {
              libthrift091.protocol.TMap _map310 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.STRUCT, iprot.readI32());
              _elem308 = new HashMap<String,Datum>(2*_map310.size);
              String _key311;
              Datum _val312;
              for (int _i313 = 0; _i313 < _map310.size; ++_i313)
              {
                ...
                _val312 = new Datum();
                _val312.read(iprot);
                _elem308.put(_key311, _val312);
              }
            }
            struct.records.add(_elem308);
          }
        }
        struct.setRecordsIsSet(true);
      }
