...
public class ScanResult implements libthrift091.TBase<ScanResult, ScanResult._Fields>, java.io.Serializable, Cloneable, Comparable<ScanResult> {
        ...
        switch (schemeField.id) {
          case 1: // NEXT_START_KEY
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                libthrift091.protocol.TMap _map288 = iprot.readMapBegin();
                struct.nextStartKey = new HashMap<String,Datum>(2*_map288.size);
                String _key289;
                Datum _val290;
                for (int _i291 = 0; _i291 < _map288.size; ++_i291)
                {
                  ...
                  _val290 = new Datum();
                  _val290.read(iprot);
                  struct.nextStartKey.put(_key289, _val290);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                ...
                struct.records = new ArrayList<Map<String,Datum>>(_list292.size);
                Map<String,Datum> _elem293;
                for (int _i294 = 0; _i294 < _list292.size; ++_i294)
                {
                  {
                    libthrift091.protocol.TMap _map295 = iprot.readMapBegin();
                    _elem293 = new HashMap<String,Datum>(2*_map295.size);
                    String _key296;
                    Datum _val297;
                    for (int _i298 = 0; _i298 < _map295.size; ++_i298)
                    {
                      ...
                      _val297 = new Datum();
                      _val297.read(iprot);
                      _elem293.put(_key296, _val297);
                    }
                    iprot.readMapEnd();
                  }
                  struct.records.add(_elem293);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.nextStartKey != null) {
        if (struct.isSetNextStartKey()) {
          oprot.writeFieldBegin(NEXT_START_KEY_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Datum> _iter299 : struct.nextStartKey.entrySet())
            {
      ...
      if (struct.records != null) {
        if (struct.isSetRecords()) {
          oprot.writeFieldBegin(RECORDS_FIELD_DESC);
          {
            ...
            for (Map<String,Datum> _iter300 : struct.records)
            {
              {
                oprot.writeMapBegin(new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.STRUCT, _iter300.size()));
                for (Map.Entry<String, Datum> _iter301 : _iter300.entrySet())
                {
  ...
  private static class ScanResultTupleScheme extends TupleScheme<ScanResult> {
      ...
      if (struct.isSetNextStartKey()) {
        {
          ...
          for (Map.Entry<String, Datum> _iter302 : struct.nextStartKey.entrySet())
          {
      ...
      if (struct.isSetRecords()) {
        {
          ...
          for (Map<String,Datum> _iter303 : struct.records)
          {
            {
              oprot.writeI32(_iter303.size());
              for (Map.Entry<String, Datum> _iter304 : _iter303.entrySet())
              {
    ...
    public void read(libthrift091.protocol.TProtocol prot, ScanResult struct) throws libthrift091.TException {
      ...
      if (incoming.get(0)) {
        {
          libthrift091.protocol.TMap _map305 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.STRUCT, iprot.readI32());
          struct.nextStartKey = new HashMap<String,Datum>(2*_map305.size);
          String _key306;
          Datum _val307;
          for (int _i308 = 0; _i308 < _map305.size; ++_i308)
          {
            ...
            _val307 = new Datum();
            _val307.read(iprot);
            struct.nextStartKey.put(_key306, _val307);
          }
        }
        struct.setNextStartKeyIsSet(true);
      }
      if (incoming.get(1)) {
        {
          libthrift091.protocol.TList _list309 = new libthrift091.protocol.TList(libthrift091.protocol.TType.MAP, iprot.readI32());
          struct.records = new ArrayList<Map<String,Datum>>(_list309.size);
          Map<String,Datum> _elem310;
          for (int _i311 = 0; _i311 < _list309.size; ++_i311)
          {
            {
              libthrift091.protocol.TMap _map312 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.STRUCT, iprot.readI32());
              _elem310 = new HashMap<String,Datum>(2*_map312.size);
              String _key313;
              Datum _val314;
