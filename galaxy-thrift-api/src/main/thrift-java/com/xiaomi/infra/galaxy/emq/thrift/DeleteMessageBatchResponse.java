...
public class DeleteMessageBatchResponse implements libthrift091.TBase<DeleteMessageBatchResponse, DeleteMessageBatchResponse._Fields>, java.io.Serializable, Cloneable, Comparable<DeleteMessageBatchResponse> {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                ...
                struct.successful = new ArrayList<String>(_list56.size);
                String _elem57;
                for (int _i58 = 0; _i58 < _list56.size; ++_i58)
                {
                  _elem57 = iprot.readString();
                  struct.successful.add(_elem57);
                }
                iprot.readListEnd();
              }
          ...
          case 2: // FAILED
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                libthrift091.protocol.TList _list59 = iprot.readListBegin();
                struct.failed = new ArrayList<MessageBatchErrorEntry>(_list59.size);
                MessageBatchErrorEntry _elem60;
                for (int _i61 = 0; _i61 < _list59.size; ++_i61)
                {
                  _elem60 = new MessageBatchErrorEntry();
                  _elem60.read(iprot);
                  struct.failed.add(_elem60);
                }
                iprot.readListEnd();
              }
    ...
    public void write(libthrift091.protocol.TProtocol oprot, DeleteMessageBatchResponse struct) throws libthrift091.TException {
      ...
      if (struct.successful != null) {
        oprot.writeFieldBegin(SUCCESSFUL_FIELD_DESC);
        {
          ...
          for (String _iter62 : struct.successful)
          {
      ...
      if (struct.failed != null) {
        oprot.writeFieldBegin(FAILED_FIELD_DESC);
        {
          ...
          for (MessageBatchErrorEntry _iter63 : struct.failed)
          {
            _iter63.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class DeleteMessageBatchResponseTupleScheme extends TupleScheme<DeleteMessageBatchResponse> {
      ...
      if (struct.isSetSuccessful()) {
        {
          ...
          for (String _iter64 : struct.successful)
          {
      ...
      if (struct.isSetFailed()) {
        {
          ...
          for (MessageBatchErrorEntry _iter65 : struct.failed)
          {
            _iter65.write(oprot);
          }
        }
    ...
    public void read(libthrift091.protocol.TProtocol prot, DeleteMessageBatchResponse struct) throws libthrift091.TException {
      ...
      if (incoming.get(0)) {
        {
          libthrift091.protocol.TList _list66 = new libthrift091.protocol.TList(libthrift091.protocol.TType.STRING, iprot.readI32());
          struct.successful = new ArrayList<String>(_list66.size);
          String _elem67;
          for (int _i68 = 0; _i68 < _list66.size; ++_i68)
          {
            _elem67 = iprot.readString();
            struct.successful.add(_elem67);
          }
        }
        struct.setSuccessfulIsSet(true);
      }
      if (incoming.get(1)) {
        {
          ...
          struct.failed = new ArrayList<MessageBatchErrorEntry>(_list69.size);
          MessageBatchErrorEntry _elem70;
          for (int _i71 = 0; _i71 < _list69.size; ++_i71)
          {
            _elem70 = new MessageBatchErrorEntry();
            _elem70.read(iprot);
            struct.failed.add(_elem70);
          }
        }
        struct.setFailedIsSet(true);
      }
