...
public class DeleteMessageBatchResponse implements libthrift091.TBase<DeleteMessageBatchResponse, DeleteMessageBatchResponse._Fields>, java.io.Serializable, Cloneable, Comparable<DeleteMessageBatchResponse> {
            ...
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                ...
                struct.successful = new ArrayList<String>(_list32.size);
                String _elem33;
                for (int _i34 = 0; _i34 < _list32.size; ++_i34)
                {
                  _elem33 = iprot.readString();
                  struct.successful.add(_elem33);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                ...
                struct.failed = new ArrayList<MessageBatchErrorEntry>(_list35.size);
                MessageBatchErrorEntry _elem36;
                for (int _i37 = 0; _i37 < _list35.size; ++_i37)
                {
                  _elem36 = new MessageBatchErrorEntry();
                  _elem36.read(iprot);
                  struct.failed.add(_elem36);
                }
                iprot.readListEnd();
              }
    ...
    public void write(libthrift091.protocol.TProtocol oprot, DeleteMessageBatchResponse struct) throws libthrift091.TException {
      ...
      if (struct.successful != null) {
        oprot.writeFieldBegin(SUCCESSFUL_FIELD_DESC);
        {
          ...
          for (String _iter38 : struct.successful)
          {
      ...
      if (struct.failed != null) {
        oprot.writeFieldBegin(FAILED_FIELD_DESC);
        {
          ...
          for (MessageBatchErrorEntry _iter39 : struct.failed)
          {
            _iter39.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class DeleteMessageBatchResponseTupleScheme extends TupleScheme<DeleteMessageBatchResponse> {
      ...
      if (struct.isSetSuccessful()) {
        {
          ...
          for (String _iter40 : struct.successful)
          {
      ...
      if (struct.isSetFailed()) {
        {
          ...
          for (MessageBatchErrorEntry _iter41 : struct.failed)
          {
            _iter41.write(oprot);
          }
        }
    ...
    public void read(libthrift091.protocol.TProtocol prot, DeleteMessageBatchResponse struct) throws libthrift091.TException {
      ...
      if (incoming.get(0)) {
        {
          libthrift091.protocol.TList _list42 = new libthrift091.protocol.TList(libthrift091.protocol.TType.STRING, iprot.readI32());
          struct.successful = new ArrayList<String>(_list42.size);
          String _elem43;
          for (int _i44 = 0; _i44 < _list42.size; ++_i44)
          {
            _elem43 = iprot.readString();
            struct.successful.add(_elem43);
          }
        }
        struct.setSuccessfulIsSet(true);
      }
      if (incoming.get(1)) {
        {
          ...
          struct.failed = new ArrayList<MessageBatchErrorEntry>(_list45.size);
          MessageBatchErrorEntry _elem46;
          for (int _i47 = 0; _i47 < _list45.size; ++_i47)
          {
            _elem46 = new MessageBatchErrorEntry();
            _elem46.read(iprot);
            struct.failed.add(_elem46);
          }
        }
        struct.setFailedIsSet(true);
      }
