...
public class AuthService {
  ...
  public interface Iface extends com.xiaomi.infra.galaxy.sds.thrift.BaseService.Iface {
     ...
     * @param authToken
     */
    public Credential createCredential(String xiaomiAppId, AppUserAuthProvider appUserAuthProvider, String authToken) throws com.xiaomi.infra.galaxy.sds.thrift.ServiceException, libthrift091.TException;
          ...
          switch (schemeField.id) {
            ...
            case 2: // APP_USER_AUTH_PROVIDER
              if (schemeField.type == libthrift091.protocol.TType.I32) {
                struct.appUserAuthProvider = AppUserAuthProvider.findByValue(iprot.readI32());
