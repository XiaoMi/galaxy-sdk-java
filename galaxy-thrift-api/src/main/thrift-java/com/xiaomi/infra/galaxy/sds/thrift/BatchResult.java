...
public class BatchResult implements libthrift091.TBase<BatchResult, BatchResult._Fields>, java.io.Serializable, Cloneable, Comparable<BatchResult> {
  ...
  private _Fields optionals[] = {_Fields.ITEMS};
            ...
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                ...
                {
                  BatchResultItem _elem306;
                  _elem306 = new BatchResultItem();
                  _elem306.read(iprot);
                  struct.items.add(_elem306);
                }
                iprot.readListEnd();
              }
      ...
      if (incoming.get(0)) {
        {
          ...
          {
            BatchResultItem _elem311;
            _elem311 = new BatchResultItem();
            _elem311.read(iprot);
            struct.items.add(_elem311);
          }
        }
        struct.setItemsIsSet(true);
      }
