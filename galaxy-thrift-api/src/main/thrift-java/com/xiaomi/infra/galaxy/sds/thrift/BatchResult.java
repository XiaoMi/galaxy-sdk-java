...
public class BatchResult implements libthrift091.TBase<BatchResult, BatchResult._Fields>, java.io.Serializable, Cloneable, Comparable<BatchResult> {
        ...
        switch (schemeField.id) {
          case 1: // ITEMS
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                libthrift091.protocol.TList _list322 = iprot.readListBegin();
                struct.items = new ArrayList<BatchResultItem>(_list322.size);
                BatchResultItem _elem323;
                for (int _i324 = 0; _i324 < _list322.size; ++_i324)
                {
                  _elem323 = new BatchResultItem();
                  _elem323.read(iprot);
      ...
      if (struct.items != null) {
        if (struct.isSetItems()) {
          oprot.writeFieldBegin(ITEMS_FIELD_DESC);
          {
            ...
            for (BatchResultItem _iter325 : struct.items)
            {
  ...
  private static class BatchResultTupleScheme extends TupleScheme<BatchResult> {
      ...
      if (struct.isSetItems()) {
        {
          ...
          for (BatchResultItem _iter326 : struct.items)
          {
    ...
    public void read(libthrift091.protocol.TProtocol prot, BatchResult struct) throws libthrift091.TException {
      ...
      if (incoming.get(0)) {
        {
          libthrift091.protocol.TList _list327 = new libthrift091.protocol.TList(libthrift091.protocol.TType.STRUCT, iprot.readI32());
          struct.items = new ArrayList<BatchResultItem>(_list327.size);
          BatchResultItem _elem328;
          for (int _i329 = 0; _i329 < _list327.size; ++_i329)
          {
            _elem328 = new BatchResultItem();
            _elem328.read(iprot);
            struct.items.add(_elem328);
          }
        }
        struct.setItemsIsSet(true);
      }
