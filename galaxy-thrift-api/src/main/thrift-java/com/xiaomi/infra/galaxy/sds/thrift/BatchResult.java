...
public class BatchResult implements libthrift091.TBase<BatchResult, BatchResult._Fields>, java.io.Serializable, Cloneable, Comparable<BatchResult> {
        ...
        switch (schemeField.id) {
          case 1: // ITEMS
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                libthrift091.protocol.TList _list340 = iprot.readListBegin();
                struct.items = new ArrayList<BatchResultItem>(_list340.size);
                BatchResultItem _elem341;
                for (int _i342 = 0; _i342 < _list340.size; ++_i342)
                {
                  _elem341 = new BatchResultItem();
                  _elem341.read(iprot);
                  struct.items.add(_elem341);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.items != null) {
        if (struct.isSetItems()) {
          oprot.writeFieldBegin(ITEMS_FIELD_DESC);
          {
            ...
            for (BatchResultItem _iter343 : struct.items)
            {
  ...
  private static class BatchResultTupleScheme extends TupleScheme<BatchResult> {
      ...
      if (struct.isSetItems()) {
        {
          ...
          for (BatchResultItem _iter344 : struct.items)
          {
    ...
    public void read(libthrift091.protocol.TProtocol prot, BatchResult struct) throws libthrift091.TException {
      ...
      if (incoming.get(0)) {
        {
          libthrift091.protocol.TList _list345 = new libthrift091.protocol.TList(libthrift091.protocol.TType.STRUCT, iprot.readI32());
          struct.items = new ArrayList<BatchResultItem>(_list345.size);
          BatchResultItem _elem346;
          for (int _i347 = 0; _i347 < _list345.size; ++_i347)
          {
            _elem346 = new BatchResultItem();
            _elem346.read(iprot);
            struct.items.add(_elem346);
          }
        }
        struct.setItemsIsSet(true);
      }
