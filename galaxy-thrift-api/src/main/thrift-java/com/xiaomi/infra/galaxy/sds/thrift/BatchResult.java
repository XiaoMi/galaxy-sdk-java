...
public class BatchResult implements libthrift091.TBase<BatchResult, BatchResult._Fields>, java.io.Serializable, Cloneable, Comparable<BatchResult> {
            ...
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                ...
                struct.items = new ArrayList<BatchResultItem>(_list334.size);
                BatchResultItem _elem335;
                for (int _i336 = 0; _i336 < _list334.size; ++_i336)
                {
                  _elem335 = new BatchResultItem();
                  _elem335.read(iprot);
                  struct.items.add(_elem335);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.items != null) {
        if (struct.isSetItems()) {
          oprot.writeFieldBegin(ITEMS_FIELD_DESC);
          {
            ...
            for (BatchResultItem _iter337 : struct.items)
            {
  ...
  private static class BatchResultTupleScheme extends TupleScheme<BatchResult> {
      ...
      if (struct.isSetItems()) {
        {
          ...
          for (BatchResultItem _iter338 : struct.items)
          {
    ...
    public void read(libthrift091.protocol.TProtocol prot, BatchResult struct) throws libthrift091.TException {
      ...
      if (incoming.get(0)) {
        {
          libthrift091.protocol.TList _list339 = new libthrift091.protocol.TList(libthrift091.protocol.TType.STRUCT, iprot.readI32());
          struct.items = new ArrayList<BatchResultItem>(_list339.size);
          BatchResultItem _elem340;
          for (int _i341 = 0; _i341 < _list339.size; ++_i341)
          {
            _elem340 = new BatchResultItem();
            _elem340.read(iprot);
            struct.items.add(_elem340);
          }
        }
        struct.setItemsIsSet(true);
      }
