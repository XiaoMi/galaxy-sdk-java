...
public class BatchResult implements libthrift091.TBase<BatchResult, BatchResult._Fields>, java.io.Serializable, Cloneable, Comparable<BatchResult> {
        ...
        switch (schemeField.id) {
          case 1: // ITEMS
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                libthrift091.protocol.TList _list324 = iprot.readListBegin();
                struct.items = new ArrayList<BatchResultItem>(_list324.size);
                BatchResultItem _elem325;
                for (int _i326 = 0; _i326 < _list324.size; ++_i326)
                {
                  _elem325 = new BatchResultItem();
                  _elem325.read(iprot);
                  struct.items.add(_elem325);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.items != null) {
        if (struct.isSetItems()) {
          oprot.writeFieldBegin(ITEMS_FIELD_DESC);
          {
            ...
            for (BatchResultItem _iter327 : struct.items)
            {
  ...
  private static class BatchResultTupleScheme extends TupleScheme<BatchResult> {
      ...
      if (struct.isSetItems()) {
        {
          ...
          for (BatchResultItem _iter328 : struct.items)
          {
    ...
    public void read(libthrift091.protocol.TProtocol prot, BatchResult struct) throws libthrift091.TException {
      ...
      if (incoming.get(0)) {
        {
          libthrift091.protocol.TList _list329 = new libthrift091.protocol.TList(libthrift091.protocol.TType.STRUCT, iprot.readI32());
          struct.items = new ArrayList<BatchResultItem>(_list329.size);
          BatchResultItem _elem330;
          for (int _i331 = 0; _i331 < _list329.size; ++_i331)
          {
            _elem330 = new BatchResultItem();
            _elem330.read(iprot);
            struct.items.add(_elem330);
          }
        }
        struct.setItemsIsSet(true);
      }
