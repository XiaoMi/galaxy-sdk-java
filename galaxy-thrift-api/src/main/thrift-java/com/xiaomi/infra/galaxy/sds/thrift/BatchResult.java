            ...
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                ...
                struct.items = new ArrayList<BatchResultItem>(_list314.size);
                BatchResultItem _elem315;
                for (int _i316 = 0; _i316 < _list314.size; ++_i316)
                {
                  _elem315 = new BatchResultItem();
                  _elem315.read(iprot);
      ...
      if (struct.items != null) {
        if (struct.isSetItems()) {
          oprot.writeFieldBegin(ITEMS_FIELD_DESC);
          {
            ...
            for (BatchResultItem _iter317 : struct.items)
            {
      ...
      if (struct.isSetItems()) {
        {
          ...
          for (BatchResultItem _iter318 : struct.items)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.items = new ArrayList<BatchResultItem>(_list319.size);
          BatchResultItem _elem320;
          for (int _i321 = 0; _i321 < _list319.size; ++_i321)
          {
            _elem320 = new BatchResultItem();
            _elem320.read(iprot);
