...
public class IncrementResult implements libthrift091.TBase<IncrementResult, IncrementResult._Fields>, java.io.Serializable, Cloneable, Comparable<IncrementResult> {
        ...
        switch (schemeField.id) {
          case 1: // AMOUNTS
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                libthrift091.protocol.TMap _map230 = iprot.readMapBegin();
                struct.amounts = new HashMap<String,Datum>(2*_map230.size);
                String _key231;
                Datum _val232;
                for (int _i233 = 0; _i233 < _map230.size; ++_i233)
                {
                  ...
                  _val232 = new Datum();
                  _val232.read(iprot);
                  struct.amounts.put(_key231, _val232);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.amounts != null) {
        if (struct.isSetAmounts()) {
          oprot.writeFieldBegin(AMOUNTS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Datum> _iter234 : struct.amounts.entrySet())
            {
  ...
  private static class IncrementResultTupleScheme extends TupleScheme<IncrementResult> {
      ...
      if (struct.isSetAmounts()) {
        {
          ...
          for (Map.Entry<String, Datum> _iter235 : struct.amounts.entrySet())
          {
    ...
    public void read(libthrift091.protocol.TProtocol prot, IncrementResult struct) throws libthrift091.TException {
      ...
      if (incoming.get(0)) {
        {
          libthrift091.protocol.TMap _map236 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.STRUCT, iprot.readI32());
          struct.amounts = new HashMap<String,Datum>(2*_map236.size);
          String _key237;
          Datum _val238;
          for (int _i239 = 0; _i239 < _map236.size; ++_i239)
          {
            ...
            _val238 = new Datum();
            _val238.read(iprot);
            struct.amounts.put(_key237, _val238);
          }
        }
        struct.setAmountsIsSet(true);
      }
