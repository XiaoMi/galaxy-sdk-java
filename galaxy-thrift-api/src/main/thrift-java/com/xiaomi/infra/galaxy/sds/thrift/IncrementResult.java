...
public class IncrementResult implements libthrift091.TBase<IncrementResult, IncrementResult._Fields>, java.io.Serializable, Cloneable, Comparable<IncrementResult> {
        ...
        switch (schemeField.id) {
          case 1: // AMOUNTS
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                libthrift091.protocol.TMap _map248 = iprot.readMapBegin();
                struct.amounts = new HashMap<String,Datum>(2*_map248.size);
                String _key249;
                Datum _val250;
                for (int _i251 = 0; _i251 < _map248.size; ++_i251)
                {
                  ...
                  _val250 = new Datum();
                  _val250.read(iprot);
                  struct.amounts.put(_key249, _val250);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.amounts != null) {
        if (struct.isSetAmounts()) {
          oprot.writeFieldBegin(AMOUNTS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Datum> _iter252 : struct.amounts.entrySet())
            {
  ...
  private static class IncrementResultTupleScheme extends TupleScheme<IncrementResult> {
      ...
      if (struct.isSetAmounts()) {
        {
          ...
          for (Map.Entry<String, Datum> _iter253 : struct.amounts.entrySet())
          {
    ...
    public void read(libthrift091.protocol.TProtocol prot, IncrementResult struct) throws libthrift091.TException {
      ...
      if (incoming.get(0)) {
        {
          libthrift091.protocol.TMap _map254 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.STRUCT, iprot.readI32());
          struct.amounts = new HashMap<String,Datum>(2*_map254.size);
          String _key255;
          Datum _val256;
          for (int _i257 = 0; _i257 < _map254.size; ++_i257)
          {
            ...
            _val256 = new Datum();
            _val256.read(iprot);
            struct.amounts.put(_key255, _val256);
          }
        }
        struct.setAmountsIsSet(true);
      }
