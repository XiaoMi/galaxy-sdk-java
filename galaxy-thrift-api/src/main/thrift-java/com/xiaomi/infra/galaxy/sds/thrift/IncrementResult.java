...
public class IncrementResult implements libthrift091.TBase<IncrementResult, IncrementResult._Fields>, java.io.Serializable, Cloneable, Comparable<IncrementResult> {
        ...
        switch (schemeField.id) {
          case 1: // AMOUNTS
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                libthrift091.protocol.TMap _map274 = iprot.readMapBegin();
                struct.amounts = new HashMap<String,Datum>(2*_map274.size);
                String _key275;
                Datum _val276;
                for (int _i277 = 0; _i277 < _map274.size; ++_i277)
                {
                  ...
                  _val276 = new Datum();
                  _val276.read(iprot);
                  struct.amounts.put(_key275, _val276);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.amounts != null) {
        if (struct.isSetAmounts()) {
          oprot.writeFieldBegin(AMOUNTS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Datum> _iter278 : struct.amounts.entrySet())
            {
  ...
  private static class IncrementResultTupleScheme extends TupleScheme<IncrementResult> {
      ...
      if (struct.isSetAmounts()) {
        {
          ...
          for (Map.Entry<String, Datum> _iter279 : struct.amounts.entrySet())
          {
    ...
    public void read(libthrift091.protocol.TProtocol prot, IncrementResult struct) throws libthrift091.TException {
      ...
      if (incoming.get(0)) {
        {
          libthrift091.protocol.TMap _map280 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.STRUCT, iprot.readI32());
          struct.amounts = new HashMap<String,Datum>(2*_map280.size);
          String _key281;
          Datum _val282;
          for (int _i283 = 0; _i283 < _map280.size; ++_i283)
          {
            ...
            _val282 = new Datum();
            _val282.read(iprot);
            struct.amounts.put(_key281, _val282);
          }
        }
        struct.setAmountsIsSet(true);
      }
