...
public class SubmitJobRequest implements libthrift091.TBase<SubmitJobRequest, SubmitJobRequest._Fields>, java.io.Serializable, Cloneable, Comparable<SubmitJobRequest> {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                ...
                struct.jarArgs = new ArrayList<String>(_list8.size);
                String _elem9;
                for (int _i10 = 0; _i10 < _list8.size; ++_i10)
                {
                  _elem9 = iprot.readString();
                  struct.jarArgs.add(_elem9);
                }
                iprot.readListEnd();
              }
          ...
          case 6: // JAR_PROPERTIES
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                libthrift091.protocol.TMap _map11 = iprot.readMapBegin();
                struct.jarProperties = new HashMap<String,String>(2*_map11.size);
                String _key12;
                String _val13;
                for (int _i14 = 0; _i14 < _map11.size; ++_i14)
                {
                  ...
                  struct.jarProperties.put(_key12, _val13);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.jarArgs != null) {
        if (struct.isSetJarArgs()) {
          oprot.writeFieldBegin(JAR_ARGS_FIELD_DESC);
          {
            ...
            for (String _iter15 : struct.jarArgs)
            {
      ...
      if (struct.jarProperties != null) {
        if (struct.isSetJarProperties()) {
          oprot.writeFieldBegin(JAR_PROPERTIES_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, String> _iter16 : struct.jarProperties.entrySet())
            {
  ...
  private static class SubmitJobRequestTupleScheme extends TupleScheme<SubmitJobRequest> {
      ...
      if (struct.isSetJarArgs()) {
        {
          ...
          for (String _iter17 : struct.jarArgs)
          {
      ...
      if (struct.isSetJarProperties()) {
        {
          ...
          for (Map.Entry<String, String> _iter18 : struct.jarProperties.entrySet())
          {
    ...
    public void read(libthrift091.protocol.TProtocol prot, SubmitJobRequest struct) throws libthrift091.TException {
      ...
      if (incoming.get(3)) {
        {
          libthrift091.protocol.TList _list19 = new libthrift091.protocol.TList(libthrift091.protocol.TType.STRING, iprot.readI32());
          struct.jarArgs = new ArrayList<String>(_list19.size);
          String _elem20;
          for (int _i21 = 0; _i21 < _list19.size; ++_i21)
          {
            _elem20 = iprot.readString();
            struct.jarArgs.add(_elem20);
          }
        }
        struct.setJarArgsIsSet(true);
      }
      if (incoming.get(4)) {
        {
          libthrift091.protocol.TMap _map22 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.STRING, iprot.readI32());
          struct.jarProperties = new HashMap<String,String>(2*_map22.size);
          String _key23;
          String _val24;
          for (int _i25 = 0; _i25 < _map22.size; ++_i25)
          {
            ...
            struct.jarProperties.put(_key23, _val24);
          }
        }
        struct.setJarPropertiesIsSet(true);
      }
