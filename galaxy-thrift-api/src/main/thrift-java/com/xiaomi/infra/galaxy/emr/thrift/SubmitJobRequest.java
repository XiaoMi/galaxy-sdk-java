...
public class SubmitJobRequest implements libthrift091.TBase<SubmitJobRequest, SubmitJobRequest._Fields>, java.io.Serializable, Cloneable, Comparable<SubmitJobRequest> {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                ...
                struct.jarArgs = new ArrayList<String>(_list40.size);
                String _elem41;
                for (int _i42 = 0; _i42 < _list40.size; ++_i42)
                {
                  _elem41 = iprot.readString();
                  struct.jarArgs.add(_elem41);
                }
                iprot.readListEnd();
              }
          ...
          case 6: // JAR_PROPERTIES
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                libthrift091.protocol.TMap _map43 = iprot.readMapBegin();
                struct.jarProperties = new HashMap<String,String>(2*_map43.size);
                String _key44;
                String _val45;
                for (int _i46 = 0; _i46 < _map43.size; ++_i46)
                {
                  ...
                  struct.jarProperties.put(_key44, _val45);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.jarArgs != null) {
        if (struct.isSetJarArgs()) {
          oprot.writeFieldBegin(JAR_ARGS_FIELD_DESC);
          {
            ...
            for (String _iter47 : struct.jarArgs)
            {
      ...
      if (struct.jarProperties != null) {
        if (struct.isSetJarProperties()) {
          oprot.writeFieldBegin(JAR_PROPERTIES_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, String> _iter48 : struct.jarProperties.entrySet())
            {
  ...
  private static class SubmitJobRequestTupleScheme extends TupleScheme<SubmitJobRequest> {
      ...
      if (struct.isSetJarArgs()) {
        {
          ...
          for (String _iter49 : struct.jarArgs)
          {
      ...
      if (struct.isSetJarProperties()) {
        {
          ...
          for (Map.Entry<String, String> _iter50 : struct.jarProperties.entrySet())
          {
    ...
    public void read(libthrift091.protocol.TProtocol prot, SubmitJobRequest struct) throws libthrift091.TException {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.jarArgs = new ArrayList<String>(_list51.size);
          String _elem52;
          for (int _i53 = 0; _i53 < _list51.size; ++_i53)
          {
            _elem52 = iprot.readString();
            struct.jarArgs.add(_elem52);
          }
        }
        struct.setJarArgsIsSet(true);
      }
      if (incoming.get(4)) {
        {
          libthrift091.protocol.TMap _map54 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.STRING, iprot.readI32());
          struct.jarProperties = new HashMap<String,String>(2*_map54.size);
          String _key55;
          String _val56;
          for (int _i57 = 0; _i57 < _map54.size; ++_i57)
          {
            ...
            struct.jarProperties.put(_key55, _val56);
          }
        }
        struct.setJarPropertiesIsSet(true);
      }
