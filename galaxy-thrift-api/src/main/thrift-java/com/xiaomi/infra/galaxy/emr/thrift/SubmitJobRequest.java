...
public class SubmitJobRequest implements libthrift091.TBase<SubmitJobRequest, SubmitJobRequest._Fields>, java.io.Serializable, Cloneable, Comparable<SubmitJobRequest> {
  ...
  public SubmitJobRequest setJarArgs(List<String> jarArgs) {
  ...
  public SubmitJobRequest setJarProperties(Map<String,String> jarProperties) {
  ...
  public int hashCode() {
    ...
    boolean present_actionOnFailure = true && (isSetActionOnFailure());
    list.add(present_actionOnFailure);
    if (present_actionOnFailure)
      list.add(actionOnFailure.getValue());

    return list.hashCode();
  }

  @Override
  public int compareTo(SubmitJobRequest other) {
    ...
    lastComparison = Boolean.valueOf(isSetActionOnFailure()).compareTo(other.isSetActionOnFailure());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetActionOnFailure()) {
      lastComparison = libthrift091.TBaseHelper.compareTo(this.actionOnFailure, other.actionOnFailure);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class SubmitJobRequestStandardScheme extends StandardScheme<SubmitJobRequest> {

    public void read(libthrift091.protocol.TProtocol iprot, SubmitJobRequest struct) throws libthrift091.TException {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                ...
                struct.jarArgs = new ArrayList<String>(_list24.size);
                String _elem25;
                for (int _i26 = 0; _i26 < _list24.size; ++_i26)
                {
                  _elem25 = iprot.readString();
                  struct.jarArgs.add(_elem25);
                }
                iprot.readListEnd();
              }
          ...
          case 6: // JAR_PROPERTIES
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                libthrift091.protocol.TMap _map27 = iprot.readMapBegin();
                struct.jarProperties = new HashMap<String,String>(2*_map27.size);
                String _key28;
                String _val29;
                for (int _i30 = 0; _i30 < _map27.size; ++_i30)
                {
                  ...
                  struct.jarProperties.put(_key28, _val29);
                }
                iprot.readMapEnd();
              }
          ...
          case 7: // ACTION_ON_FAILURE
            if (schemeField.type == libthrift091.protocol.TType.I32) {
              struct.actionOnFailure = com.xiaomi.infra.galaxy.emr.thrift.JobActionOnFailure.findByValue(iprot.readI32());
              struct.setActionOnFailureIsSet(true);
            } else { 
              libthrift091.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(libthrift091.protocol.TProtocol oprot, SubmitJobRequest struct) throws libthrift091.TException {
      struct.validate();
      ...
      if (struct.jarArgs != null) {
        if (struct.isSetJarArgs()) {
          oprot.writeFieldBegin(JAR_ARGS_FIELD_DESC);
          {
            ...
            for (String _iter31 : struct.jarArgs)
            {
      ...
      if (struct.jarProperties != null) {
        if (struct.isSetJarProperties()) {
          oprot.writeFieldBegin(JAR_PROPERTIES_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, String> _iter32 : struct.jarProperties.entrySet())
            {
      ...
      if (struct.actionOnFailure != null) {
        if (struct.isSetActionOnFailure()) {
          oprot.writeFieldBegin(ACTION_ON_FAILURE_FIELD_DESC);
          oprot.writeI32(struct.actionOnFailure.getValue());
          oprot.writeFieldEnd();
        }
      }
  ...
  private static class SubmitJobRequestTupleScheme extends TupleScheme<SubmitJobRequest> {

    @Override
    public void write(libthrift091.protocol.TProtocol prot, SubmitJobRequest struct) throws libthrift091.TException {
      ...
      if (struct.isSetJarArgs()) {
        {
          ...
          for (String _iter33 : struct.jarArgs)
          {
      ...
      if (struct.isSetJarProperties()) {
        {
          ...
          for (Map.Entry<String, String> _iter34 : struct.jarProperties.entrySet())
          {
    ...
    @Override
    public void read(libthrift091.protocol.TProtocol prot, SubmitJobRequest struct) throws libthrift091.TException {
      ...
      if (incoming.get(3)) {
        {
          libthrift091.protocol.TList _list35 = new libthrift091.protocol.TList(libthrift091.protocol.TType.STRING, iprot.readI32());
          struct.jarArgs = new ArrayList<String>(_list35.size);
          String _elem36;
          for (int _i37 = 0; _i37 < _list35.size; ++_i37)
          {
            _elem36 = iprot.readString();
            struct.jarArgs.add(_elem36);
          }
        }
        struct.setJarArgsIsSet(true);
      }
      if (incoming.get(4)) {
        {
          libthrift091.protocol.TMap _map38 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.STRING, iprot.readI32());
          struct.jarProperties = new HashMap<String,String>(2*_map38.size);
          String _key39;
          String _val40;
          for (int _i41 = 0; _i41 < _map38.size; ++_i41)
          {
            ...
            struct.jarProperties.put(_key39, _val40);
          }
        }
        struct.setJarPropertiesIsSet(true);
      }
