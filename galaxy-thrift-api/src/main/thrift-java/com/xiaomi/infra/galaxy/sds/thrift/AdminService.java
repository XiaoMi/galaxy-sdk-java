...
public class AdminService {
  ...
  public interface Iface extends com.xiaomi.infra.galaxy.sds.thrift.BaseService.Iface {
     ...
     * 获取AppId列表
     */
    public List<String> findAllAppIds() throws com.xiaomi.infra.galaxy.sds.thrift.ServiceException, libthrift091.TException;
  ...
  public interface AsyncIface extends com.xiaomi.infra.galaxy.sds.thrift.BaseService .AsyncIface {
    ...
    public void findAllAppIds(libthrift091.async.AsyncMethodCallback resultHandler) throws libthrift091.TException;
  ...
  public static class Client extends com.xiaomi.infra.galaxy.sds.thrift.BaseService.Client implements Iface {
    ...
    {
      send_findAllAppIds();
      return recv_findAllAppIds();
    }

    public void send_findAllAppIds() throws libthrift091.TException
    {
      findAllAppIds_args args = new findAllAppIds_args();
      sendBase("findAllAppIds", args);
    }

    public List<String> recv_findAllAppIds() throws com.xiaomi.infra.galaxy.sds.thrift.ServiceException, libthrift091.TException
    {
      findAllAppIds_result result = new findAllAppIds_result();
      receiveBase(result, "findAllAppIds");
      if (result.isSetSuccess()) {
        return result.success;
      }
      if (result.se != null) {
      ...
      throw new libthrift091.TApplicationException(libthrift091.TApplicationException.MISSING_RESULT, "findAllAppIds failed: unknown result");
    }
  ...
  public static class AsyncClient extends com.xiaomi.infra.galaxy.sds.thrift.BaseService.AsyncClient implements AsyncIface {
    ...
    public void findAllAppIds(libthrift091.async.AsyncMethodCallback resultHandler) throws libthrift091.TException {
      checkReady();
      findAllAppIds_call method_call = new findAllAppIds_call(resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }

    public static class findAllAppIds_call extends libthrift091.async.TAsyncMethodCall {
      public findAllAppIds_call(libthrift091.async.AsyncMethodCallback resultHandler, libthrift091.async.TAsyncClient client, libthrift091.protocol.TProtocolFactory protocolFactory, libthrift091.transport.TNonblockingTransport transport) throws libthrift091.TException {
        super(client, protocolFactory, transport, resultHandler, false);
      }

      public void write_args(libthrift091.protocol.TProtocol prot) throws libthrift091.TException {
        prot.writeMessageBegin(new libthrift091.protocol.TMessage("findAllAppIds", libthrift091.protocol.TMessageType.CALL, 0));
        findAllAppIds_args args = new findAllAppIds_args();
        args.write(prot);
        prot.writeMessageEnd();
      }
      ...
      public List<String> getResult() throws com.xiaomi.infra.galaxy.sds.thrift.ServiceException, libthrift091.TException {
        ...
        libthrift091.transport.TMemoryInputTransport memoryTransport = new libthrift091.transport.TMemoryInputTransport(getFrameBuffer().array());
        libthrift091.protocol.TProtocol prot = client.getProtocolFactory().getProtocol(memoryTransport);
        return (new Client(prot)).recv_findAllAppIds();
      }
    }
  ...
  public static class Processor<I extends Iface> extends com.xiaomi.infra.galaxy.sds.thrift.BaseService.Processor<I> implements libthrift091.TProcessor {
    ...
    private static <I extends Iface> Map<String,  libthrift091.ProcessFunction<I, ? extends  libthrift091.TBase>> getProcessMap(Map<String,  libthrift091.ProcessFunction<I, ? extends  libthrift091.TBase>> processMap) {
      ...
      processMap.put("findAllAppIds", new findAllAppIds());
      return processMap;
    }
    ...
    public static class findAllAppIds<I extends Iface> extends libthrift091.ProcessFunction<I, findAllAppIds_args> {
      public findAllAppIds() {
        super("findAllAppIds");
      }

      public findAllAppIds_args getEmptyArgsInstance() {
        return new findAllAppIds_args();
      }
      ...
      public findAllAppIds_result getResult(I iface, findAllAppIds_args args) throws libthrift091.TException {
        findAllAppIds_result result = new findAllAppIds_result();
        try {
          result.success = iface.findAllAppIds();
        } catch (com.xiaomi.infra.galaxy.sds.thrift.ServiceException se) {
          result.se = se;
        }
        return result;
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends com.xiaomi.infra.galaxy.sds.thrift.BaseService.AsyncProcessor<I> {
    ...
    public static class findAllAppIds<I extends AsyncIface> extends libthrift091.AsyncProcessFunction<I, findAllAppIds_args, List<String>> {
      public findAllAppIds() {
        super("findAllAppIds");
      }
      ...
      public void start(I iface, findAllAppIds_args args, libthrift091.async.AsyncMethodCallback<List<String>> resultHandler) throws TException {
        iface.findAllAppIds(resultHandler);
      }
    }
...
;
  ...
  public static class findAllAppIds_args implements libthrift091.TBase<findAllAppIds_args, findAllAppIds_args._Fields>, java.io.Serializable, Cloneable, Comparable<findAllAppIds_args>   {
    private static final libthrift091.protocol.TStruct STRUCT_DESC = new libthrift091.protocol.TStruct("findAllAppIds_args");


    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new findAllAppIds_argsStandardSchemeFactory());
      schemes.put(TupleScheme.class, new findAllAppIds_argsTupleSchemeFactory());
    }
...
;
    ...
    static {
      Map<_Fields, libthrift091.meta_data.FieldMetaData> tmpMap = new EnumMap<_Fields, libthrift091.meta_data.FieldMetaData>(_Fields.class);
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      libthrift091.meta_data.FieldMetaData.addStructMetaDataMap(findAllAppIds_args.class, metaDataMap);
    }

    public findAllAppIds_args() {
    }

    /**
     * Performs a deep copy on <i>other</i>.
     */
    public findAllAppIds_args(findAllAppIds_args other) {
    }

    public findAllAppIds_args deepCopy() {
      return new findAllAppIds_args(this);
    }
    ...
    public boolean equals(Object that) {
      if (that == null)
        return false;
      if (that instanceof findAllAppIds_args)
        return this.equals((findAllAppIds_args)that);
      return false;
    }

    public boolean equals(findAllAppIds_args that) {
      if (that == null)
        return false;
    ...
    @Override
    public int compareTo(findAllAppIds_args other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("findAllAppIds_args(");
      boolean first = true;
    ...
    private static class findAllAppIds_argsStandardSchemeFactory implements SchemeFactory {
      public findAllAppIds_argsStandardScheme getScheme() {
        return new findAllAppIds_argsStandardScheme();
      }
    }

    private static class findAllAppIds_argsStandardScheme extends StandardScheme<findAllAppIds_args> {

      public void read(libthrift091.protocol.TProtocol iprot, findAllAppIds_args struct) throws libthrift091.TException {
        libthrift091.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(libthrift091.protocol.TProtocol oprot, findAllAppIds_args struct) throws libthrift091.TException {
        struct.validate();
    ...
    private static class findAllAppIds_argsTupleSchemeFactory implements SchemeFactory {
      public findAllAppIds_argsTupleScheme getScheme() {
        return new findAllAppIds_argsTupleScheme();
      }
    }

    private static class findAllAppIds_argsTupleScheme extends TupleScheme<findAllAppIds_args> {

      @Override
      public void write(libthrift091.protocol.TProtocol prot, findAllAppIds_args struct) throws libthrift091.TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
      }

      @Override
      public void read(libthrift091.protocol.TProtocol prot, findAllAppIds_args struct) throws libthrift091.TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
      }
    }
  ...
  public static class findAllAppIds_result implements libthrift091.TBase<findAllAppIds_result, findAllAppIds_result._Fields>, java.io.Serializable, Cloneable, Comparable<findAllAppIds_result>   {
    private static final libthrift091.protocol.TStruct STRUCT_DESC = new libthrift091.protocol.TStruct("findAllAppIds_result");
    ...
    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new findAllAppIds_resultStandardSchemeFactory());
      schemes.put(TupleScheme.class, new findAllAppIds_resultTupleSchemeFactory());
    }
    ...
    static {
      ...
      tmpMap.put(_Fields.SE, new libthrift091.meta_data.FieldMetaData("se", libthrift091.TFieldRequirementType.DEFAULT, 
          new libthrift091.meta_data.FieldValueMetaData(libthrift091.protocol.TType.STRUCT)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      libthrift091.meta_data.FieldMetaData.addStructMetaDataMap(findAllAppIds_result.class, metaDataMap);
    }

    public findAllAppIds_result() {
    }
     ...
     * Performs a deep copy on <i>other</i>.
     */
    public findAllAppIds_result(findAllAppIds_result other) {
      if (other.isSetSuccess()) {
    ...
    public findAllAppIds_result deepCopy() {
      return new findAllAppIds_result(this);
    }
    ...
    public findAllAppIds_result setSuccess(List<String> success) {
      this.success = success;
      return this;
    }
    ...
    public findAllAppIds_result setSe(com.xiaomi.infra.galaxy.sds.thrift.ServiceException se) {
      this.se = se;
      return this;
    }
    ...
    public boolean equals(Object that) {
      if (that == null)
        return false;
      if (that instanceof findAllAppIds_result)
        return this.equals((findAllAppIds_result)that);
      return false;
    }

    public boolean equals(findAllAppIds_result that) {
      if (that == null)
        return false;
    ...
    @Override
    public int compareTo(findAllAppIds_result other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("findAllAppIds_result(");
      boolean first = true;
    ...
    private static class findAllAppIds_resultStandardSchemeFactory implements SchemeFactory {
      public findAllAppIds_resultStandardScheme getScheme() {
        return new findAllAppIds_resultStandardScheme();
      }
    }

    private static class findAllAppIds_resultStandardScheme extends StandardScheme<findAllAppIds_result> {

      public void read(libthrift091.protocol.TProtocol iprot, findAllAppIds_result struct) throws libthrift091.TException {
        libthrift091.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(libthrift091.protocol.TProtocol oprot, findAllAppIds_result struct) throws libthrift091.TException {
        struct.validate();
    ...
    private static class findAllAppIds_resultTupleSchemeFactory implements SchemeFactory {
      public findAllAppIds_resultTupleScheme getScheme() {
        return new findAllAppIds_resultTupleScheme();
      }
    }

    private static class findAllAppIds_resultTupleScheme extends TupleScheme<findAllAppIds_result> {

      @Override
      public void write(libthrift091.protocol.TProtocol prot, findAllAppIds_result struct) throws libthrift091.TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetSuccess()) {
          optionals.set(0);
      ...
      @Override
      public void read(libthrift091.protocol.TProtocol prot, findAllAppIds_result struct) throws libthrift091.TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(2);
        if (incoming.get(0)) {
          {
            libthrift091.protocol.TList _list95 = new libthrift091.protocol.TList(libthrift091.protocol.TType.STRING, iprot.readI32());
