...
public class AdminService {
  ...
  public interface Iface extends com.xiaomi.infra.galaxy.sds.thrift.BaseService.Iface {
     ...
     * 清除所有延迟删除的表
     */
    public List<String> cleanAllLazyDroppedTables() throws com.xiaomi.infra.galaxy.sds.thrift.ServiceException, libthrift091.TException;
  ...
  public static class Client extends com.xiaomi.infra.galaxy.sds.thrift.BaseService.Client implements Iface {
    ...
    public List<String> recv_cleanAllLazyDroppedTables() throws com.xiaomi.infra.galaxy.sds.thrift.ServiceException, libthrift091.TException
    {
  ...
  public static class Processor<I extends Iface> extends com.xiaomi.infra.galaxy.sds.thrift.BaseService.Processor<I> implements libthrift091.TProcessor {
    ...
    public static class cleanAllLazyDroppedTables<I extends Iface> extends libthrift091.ProcessFunction<I, cleanAllLazyDroppedTables_args> {
    ...
    public static class restoreTable<I extends Iface> extends libthrift091.ProcessFunction<I, restoreTable_args> {
      public restoreTable() {
        super("restoreTable");
      }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends com.xiaomi.infra.galaxy.sds.thrift.BaseService.AsyncProcessor<I> {
    ...
    public static class cleanAllLazyDroppedTables<I extends AsyncIface> extends libthrift091.AsyncProcessFunction<I, cleanAllLazyDroppedTables_args, List<String>> {
      public cleanAllLazyDroppedTables() {
        super("cleanAllLazyDroppedTables");
      }
      ...
      public void start(I iface, cleanAllLazyDroppedTables_args args, libthrift091.async.AsyncMethodCallback<List<String>> resultHandler) throws TException {
    ...
    public static class restoreTable<I extends AsyncIface> extends libthrift091.AsyncProcessFunction<I, restoreTable_args, Void> {
      public restoreTable() {
        super("restoreTable");
      }
      ...
      public void start(I iface, restoreTable_args args, libthrift091.async.AsyncMethodCallback<Void> resultHandler) throws TException {
...
;
  ...
  public static class cleanAllLazyDroppedTables_args implements libthrift091.TBase<cleanAllLazyDroppedTables_args, cleanAllLazyDroppedTables_args._Fields>, java.io.Serializable, Cloneable, Comparable<cleanAllLazyDroppedTables_args>   {
...
;
    ...
    private static class cleanAllLazyDroppedTables_argsStandardScheme extends StandardScheme<cleanAllLazyDroppedTables_args> {
    ...
    private static class cleanAllLazyDroppedTables_argsTupleScheme extends TupleScheme<cleanAllLazyDroppedTables_args> {
  ...
  public static class cleanAllLazyDroppedTables_result implements libthrift091.TBase<cleanAllLazyDroppedTables_result, cleanAllLazyDroppedTables_result._Fields>, java.io.Serializable, Cloneable, Comparable<cleanAllLazyDroppedTables_result>   {
    ...
    public cleanAllLazyDroppedTables_result setSuccess(List<String> success) {
      this.success = success;
      return this;
    }
    ...
    private static class cleanAllLazyDroppedTables_resultStandardScheme extends StandardScheme<cleanAllLazyDroppedTables_result> {
    ...
    private static class cleanAllLazyDroppedTables_resultTupleScheme extends TupleScheme<cleanAllLazyDroppedTables_result> {
      ...
      public void read(libthrift091.protocol.TProtocol prot, cleanAllLazyDroppedTables_result struct) throws libthrift091.TException {
        ...
        if (incoming.get(0)) {
          {
            libthrift091.protocol.TList _list59 = new libthrift091.protocol.TList(libthrift091.protocol.TType.STRING, iprot.readI32());
  ...
  public static class restoreTable_args implements libthrift091.TBase<restoreTable_args, restoreTable_args._Fields>, java.io.Serializable, Cloneable, Comparable<restoreTable_args>   {
    ...
    private static class restoreTable_argsStandardScheme extends StandardScheme<restoreTable_args> {
    ...
    private static class restoreTable_argsTupleScheme extends TupleScheme<restoreTable_args> {
  ...
  public static class restoreTable_result implements libthrift091.TBase<restoreTable_result, restoreTable_result._Fields>, java.io.Serializable, Cloneable, Comparable<restoreTable_result>   {
    ...
    private static class restoreTable_resultStandardScheme extends StandardScheme<restoreTable_result> {
    ...
    private static class restoreTable_resultTupleScheme extends TupleScheme<restoreTable_result> {
  ...
  public static class getTableSplits_args implements libthrift091.TBase<getTableSplits_args, getTableSplits_args._Fields>, java.io.Serializable, Cloneable, Comparable<getTableSplits_args>   {
          ...
          switch (schemeField.id) {
            ...
            case 2: // START_KEY
              if (schemeField.type == libthrift091.protocol.TType.MAP) {
                {
                  libthrift091.protocol.TMap _map62 = iprot.readMapBegin();
                  struct.startKey = new HashMap<String,com.xiaomi.infra.galaxy.sds.thrift.Datum>(2*_map62.size);
                  String _key63;
                  ...
                  for (int _i65 = 0; _i65 < _map62.size; ++_i65)
                  {
                    ...
                    _val64.read(iprot);
                    struct.startKey.put(_key63, _val64);
                  }
                  iprot.readMapEnd();
                }
            ...
            case 3: // STOP_KEY
              if (schemeField.type == libthrift091.protocol.TType.MAP) {
                {
                  libthrift091.protocol.TMap _map66 = iprot.readMapBegin();
                  struct.stopKey = new HashMap<String,com.xiaomi.infra.galaxy.sds.thrift.Datum>(2*_map66.size);
                  String _key67;
                  ...
                  for (int _i69 = 0; _i69 < _map66.size; ++_i69)
                  {
                    ...
                    _val68.read(iprot);
                    struct.stopKey.put(_key67, _val68);
                  }
                  iprot.readMapEnd();
                }
      ...
      public void write(libthrift091.protocol.TProtocol oprot, getTableSplits_args struct) throws libthrift091.TException {
        ...
        if (struct.startKey != null) {
          oprot.writeFieldBegin(START_KEY_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, com.xiaomi.infra.galaxy.sds.thrift.Datum> _iter70 : struct.startKey.entrySet())
            {
        ...
        if (struct.stopKey != null) {
          oprot.writeFieldBegin(STOP_KEY_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, com.xiaomi.infra.galaxy.sds.thrift.Datum> _iter71 : struct.stopKey.entrySet())
            {
    ...
    private static class getTableSplits_argsTupleScheme extends TupleScheme<getTableSplits_args> {
        ...
        if (struct.isSetStartKey()) {
          {
            ...
            for (Map.Entry<String, com.xiaomi.infra.galaxy.sds.thrift.Datum> _iter72 : struct.startKey.entrySet())
            {
        ...
        if (struct.isSetStopKey()) {
          {
            ...
            for (Map.Entry<String, com.xiaomi.infra.galaxy.sds.thrift.Datum> _iter73 : struct.stopKey.entrySet())
            {
      ...
      public void read(libthrift091.protocol.TProtocol prot, getTableSplits_args struct) throws libthrift091.TException {
        ...
        if (incoming.get(1)) {
          {
            libthrift091.protocol.TMap _map74 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.STRUCT, iprot.readI32());
            struct.startKey = new HashMap<String,com.xiaomi.infra.galaxy.sds.thrift.Datum>(2*_map74.size);
            String _key75;
            ...
            for (int _i77 = 0; _i77 < _map74.size; ++_i77)
            {
              ...
              _val76.read(iprot);
              struct.startKey.put(_key75, _val76);
            }
          }
          struct.setStartKeyIsSet(true);
        }
        if (incoming.get(2)) {
          {
            libthrift091.protocol.TMap _map78 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.STRUCT, iprot.readI32());
            struct.stopKey = new HashMap<String,com.xiaomi.infra.galaxy.sds.thrift.Datum>(2*_map78.size);
            String _key79;
            com.xiaomi.infra.galaxy.sds.thrift.Datum _val80;
            for (int _i81 = 0; _i81 < _map78.size; ++_i81)
            {
              _key79 = iprot.readString();
              _val80 = new com.xiaomi.infra.galaxy.sds.thrift.Datum();
              _val80.read(iprot);
              struct.stopKey.put(_key79, _val80);
            }
          }
          struct.setStopKeyIsSet(true);
        }
    ...
    private static class getTableSplits_resultStandardScheme extends StandardScheme<getTableSplits_result> {
              ...
              if (schemeField.type == libthrift091.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<com.xiaomi.infra.galaxy.sds.thrift.TableSplit>(_list82.size);
                  com.xiaomi.infra.galaxy.sds.thrift.TableSplit _elem83;
                  for (int _i84 = 0; _i84 < _list82.size; ++_i84)
                  {
                    _elem83 = new com.xiaomi.infra.galaxy.sds.thrift.TableSplit();
                    _elem83.read(iprot);
      ...
      public void write(libthrift091.protocol.TProtocol oprot, getTableSplits_result struct) throws libthrift091.TException {
        ...
        if (struct.success != null) {
          ...
          {
            oprot.writeListBegin(new libthrift091.protocol.TList(libthrift091.protocol.TType.STRUCT, struct.success.size()));
            for (com.xiaomi.infra.galaxy.sds.thrift.TableSplit _iter85 : struct.success)
            {
              _iter85.write(oprot);
            }
            oprot.writeListEnd();
    ...
    private static class getTableSplits_resultTupleScheme extends TupleScheme<getTableSplits_result> {
      ...
      public void write(libthrift091.protocol.TProtocol prot, getTableSplits_result struct) throws libthrift091.TException {
        ...
        if (struct.isSetSuccess()) {
          {
            oprot.writeI32(struct.success.size());
            for (com.xiaomi.infra.galaxy.sds.thrift.TableSplit _iter86 : struct.success)
            {
              _iter86.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<com.xiaomi.infra.galaxy.sds.thrift.TableSplit>(_list87.size);
            com.xiaomi.infra.galaxy.sds.thrift.TableSplit _elem88;
            for (int _i89 = 0; _i89 < _list87.size; ++_i89)
            {
              _elem88 = new com.xiaomi.infra.galaxy.sds.thrift.TableSplit();
              _elem88.read(iprot);
              ...
              if (schemeField.type == libthrift091.protocol.TType.LIST) {
                {
                  ...
                  struct.queries = new ArrayList<MetricQueryRequest>(_list90.size);
                  MetricQueryRequest _elem91;
                  for (int _i92 = 0; _i92 < _list90.size; ++_i92)
                  {
                    _elem91 = new MetricQueryRequest();
                    _elem91.read(iprot);
                    struct.queries.add(_elem91);
                  }
                  iprot.readListEnd();
                }
      ...
      public void write(libthrift091.protocol.TProtocol oprot, queryMetrics_args struct) throws libthrift091.TException {
        ...
        if (struct.queries != null) {
          oprot.writeFieldBegin(QUERIES_FIELD_DESC);
          {
            ...
            for (MetricQueryRequest _iter93 : struct.queries)
            {
              _iter93.write(oprot);
            }
            oprot.writeListEnd();
        ...
        if (struct.isSetQueries()) {
          {
            ...
            for (MetricQueryRequest _iter94 : struct.queries)
            {
              _iter94.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.queries = new ArrayList<MetricQueryRequest>(_list95.size);
            MetricQueryRequest _elem96;
            for (int _i97 = 0; _i97 < _list95.size; ++_i97)
            {
              _elem96 = new MetricQueryRequest();
              _elem96.read(iprot);
              struct.queries.add(_elem96);
            }
          }
          struct.setQueriesIsSet(true);
        }
    ...
    private static class queryMetrics_resultStandardScheme extends StandardScheme<queryMetrics_result> {
              ...
              if (schemeField.type == libthrift091.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<TimeSeriesData>(_list98.size);
                  TimeSeriesData _elem99;
                  for (int _i100 = 0; _i100 < _list98.size; ++_i100)
                  {
                    _elem99 = new TimeSeriesData();
                    _elem99.read(iprot);
      ...
      public void write(libthrift091.protocol.TProtocol oprot, queryMetrics_result struct) throws libthrift091.TException {
        ...
        if (struct.success != null) {
          ...
          {
            oprot.writeListBegin(new libthrift091.protocol.TList(libthrift091.protocol.TType.STRUCT, struct.success.size()));
            for (TimeSeriesData _iter101 : struct.success)
            {
    ...
    private static class queryMetrics_resultTupleScheme extends TupleScheme<queryMetrics_result> {
      ...
      public void write(libthrift091.protocol.TProtocol prot, queryMetrics_result struct) throws libthrift091.TException {
        ...
        if (struct.isSetSuccess()) {
          {
            oprot.writeI32(struct.success.size());
            for (TimeSeriesData _iter102 : struct.success)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<TimeSeriesData>(_list103.size);
            TimeSeriesData _elem104;
            for (int _i105 = 0; _i105 < _list103.size; ++_i105)
            {
              _elem104 = new TimeSeriesData();
              _elem104.read(iprot);
    ...
    private static class findAllAppInfo_resultStandardScheme extends StandardScheme<findAllAppInfo_result> {
              ...
              if (schemeField.type == libthrift091.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<AppInfo>(_list106.size);
                  AppInfo _elem107;
                  for (int _i108 = 0; _i108 < _list106.size; ++_i108)
                  {
                    _elem107 = new AppInfo();
                    _elem107.read(iprot);
      ...
      public void write(libthrift091.protocol.TProtocol oprot, findAllAppInfo_result struct) throws libthrift091.TException {
        ...
        if (struct.success != null) {
          ...
          {
            oprot.writeListBegin(new libthrift091.protocol.TList(libthrift091.protocol.TType.STRUCT, struct.success.size()));
            for (AppInfo _iter109 : struct.success)
            {
    ...
    private static class findAllAppInfo_resultTupleScheme extends TupleScheme<findAllAppInfo_result> {
      ...
      public void write(libthrift091.protocol.TProtocol prot, findAllAppInfo_result struct) throws libthrift091.TException {
        ...
        if (struct.isSetSuccess()) {
          {
            oprot.writeI32(struct.success.size());
            for (AppInfo _iter110 : struct.success)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<AppInfo>(_list111.size);
            AppInfo _elem112;
            for (int _i113 = 0; _i113 < _list111.size; ++_i113)
            {
              _elem112 = new AppInfo();
              _elem112.read(iprot);
