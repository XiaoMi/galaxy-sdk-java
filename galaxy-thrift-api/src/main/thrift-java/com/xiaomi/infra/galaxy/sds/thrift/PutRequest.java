        ...
        switch (schemeField.id) {
          ...
          case 2: // RECORD
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                libthrift091.protocol.TMap _map218 = iprot.readMapBegin();
                struct.record = new HashMap<String,Datum>(2*_map218.size);
                String _key219;
                Datum _val220;
                for (int _i221 = 0; _i221 < _map218.size; ++_i221)
                {
                  ...
                  _val220 = new Datum();
                  _val220.read(iprot);
                  struct.record.put(_key219, _val220);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.record != null) {
        if (struct.isSetRecord()) {
          oprot.writeFieldBegin(RECORD_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Datum> _iter222 : struct.record.entrySet())
            {
      ...
      if (struct.isSetRecord()) {
        {
          ...
          for (Map.Entry<String, Datum> _iter223 : struct.record.entrySet())
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.record = new HashMap<String,Datum>(2*_map224.size);
          String _key225;
          Datum _val226;
          for (int _i227 = 0; _i227 < _map224.size; ++_i227)
          {
            ...
            _val226 = new Datum();
            _val226.read(iprot);
            struct.record.put(_key225, _val226);
          }
        }
        struct.setRecordIsSet(true);
      }
