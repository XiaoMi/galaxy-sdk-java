...
public class PutRequest implements libthrift091.TBase<PutRequest, PutRequest._Fields>, java.io.Serializable, Cloneable, Comparable<PutRequest> {
   ...
   * 待写入的记录
   */
  public Map<String,Datum> record; // required
  /**
   * 仅当满足指定条件时执行写入操作
   */
  ...
  private _Fields optionals[] = {_Fields.CONDITION};
  ...
  static {
    ...
    tmpMap.put(_Fields.RECORD, new libthrift091.meta_data.FieldMetaData("record", libthrift091.TFieldRequirementType.REQUIRED, 
  ...
  public void validate() throws libthrift091.TException {
    ...
    if (record == null) {
      throw new libthrift091.protocol.TProtocolException("Required field 'record' was not present! Struct: " + toString());
    }
            ...
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                ...
                for (int _i183 = 0; _i183 < _map182.size; ++_i183)
                {
                  ...
                  _val185 = new Datum();
                  _val185.read(iprot);
                  struct.record.put(_key184, _val185);
                }
                iprot.readMapEnd();
              }
    ...
    public void read(libthrift091.protocol.TProtocol prot, PutRequest struct) throws libthrift091.TException {
      ...
      struct.setTableNameIsSet(true);
      {
        ...
        for (int _i189 = 0; _i189 < _map188.size; ++_i189)
        {
          ...
          _val191 = new Datum();
          _val191.read(iprot);
          struct.record.put(_key190, _val191);
        }
      }
      struct.setRecordIsSet(true);
