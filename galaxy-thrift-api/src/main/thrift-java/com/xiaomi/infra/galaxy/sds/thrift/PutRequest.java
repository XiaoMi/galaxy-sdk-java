...
public class PutRequest implements libthrift091.TBase<PutRequest, PutRequest._Fields>, java.io.Serializable, Cloneable, Comparable<PutRequest> {
            ...
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                ...
                struct.record = new HashMap<String,Datum>(2*_map244.size);
                String _key245;
                Datum _val246;
                for (int _i247 = 0; _i247 < _map244.size; ++_i247)
                {
                  ...
                  _val246 = new Datum();
                  _val246.read(iprot);
                  struct.record.put(_key245, _val246);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.record != null) {
        if (struct.isSetRecord()) {
          oprot.writeFieldBegin(RECORD_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Datum> _iter248 : struct.record.entrySet())
            {
  ...
  private static class PutRequestTupleScheme extends TupleScheme<PutRequest> {
      ...
      if (struct.isSetRecord()) {
        {
          ...
          for (Map.Entry<String, Datum> _iter249 : struct.record.entrySet())
          {
    ...
    public void read(libthrift091.protocol.TProtocol prot, PutRequest struct) throws libthrift091.TException {
      ...
      if (incoming.get(1)) {
        {
          libthrift091.protocol.TMap _map250 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.STRUCT, iprot.readI32());
          struct.record = new HashMap<String,Datum>(2*_map250.size);
          String _key251;
          Datum _val252;
          for (int _i253 = 0; _i253 < _map250.size; ++_i253)
          {
            ...
            _val252 = new Datum();
            _val252.read(iprot);
            struct.record.put(_key251, _val252);
          }
        }
        struct.setRecordIsSet(true);
      }
