...
public class PutRequest implements libthrift091.TBase<PutRequest, PutRequest._Fields>, java.io.Serializable, Cloneable, Comparable<PutRequest> {
            ...
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                ...
                struct.record = new HashMap<String,Datum>(2*_map200.size);
                String _key201;
                Datum _val202;
                for (int _i203 = 0; _i203 < _map200.size; ++_i203)
                {
                  ...
                  _val202 = new Datum();
                  _val202.read(iprot);
                  struct.record.put(_key201, _val202);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.record != null) {
        if (struct.isSetRecord()) {
          oprot.writeFieldBegin(RECORD_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Datum> _iter204 : struct.record.entrySet())
            {
  ...
  private static class PutRequestTupleScheme extends TupleScheme<PutRequest> {
      ...
      if (struct.isSetRecord()) {
        {
          ...
          for (Map.Entry<String, Datum> _iter205 : struct.record.entrySet())
          {
    ...
    public void read(libthrift091.protocol.TProtocol prot, PutRequest struct) throws libthrift091.TException {
      ...
      if (incoming.get(1)) {
        {
          libthrift091.protocol.TMap _map206 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.STRUCT, iprot.readI32());
          struct.record = new HashMap<String,Datum>(2*_map206.size);
          String _key207;
          Datum _val208;
          for (int _i209 = 0; _i209 < _map206.size; ++_i209)
          {
            ...
            _val208 = new Datum();
            _val208.read(iprot);
            struct.record.put(_key207, _val208);
          }
        }
        struct.setRecordIsSet(true);
      }
