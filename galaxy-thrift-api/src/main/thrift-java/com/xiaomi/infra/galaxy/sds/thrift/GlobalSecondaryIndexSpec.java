...
public class GlobalSecondaryIndexSpec implements libthrift091.TBase<GlobalSecondaryIndexSpec, GlobalSecondaryIndexSpec._Fields>, java.io.Serializable, Cloneable, Comparable<GlobalSecondaryIndexSpec> {
  ...
  private static final libthrift091.protocol.TField AUTO_SCALING_FIELD_DESC = new libthrift091.protocol.TField("autoScaling", libthrift091.protocol.TType.STRUCT, (short)11);
  ...
  public enum _Fields implements libthrift091.TFieldIdEnum {
     ...
     * 自动调整quota策略
     */
    AUTO_SCALING((short)11, "autoScaling");
  ...
  private static final _Fields optionals[] = {_Fields.INDEX_ENTITY_GROUP,_Fields.INDEX_PRIMARY_KEY,_Fields.PROJECTIONS,_Fields.CONSISTENCY_LEVEL,_Fields.UNIQUE,_Fields.THROUGHPUT,_Fields.SLAVE_THROUGHPUT,_Fields.EXCEEDED_THROUGHPUT,_Fields.EXCEEDED_SLAVE_THROUGHPUT,_Fields.PRE_SPLITS,_Fields.AUTO_SCALING};
   ...
   * 自动调整quota策略
   */
  public GlobalSecondaryIndexSpec setAutoScaling(AutoScaling autoScaling) {
