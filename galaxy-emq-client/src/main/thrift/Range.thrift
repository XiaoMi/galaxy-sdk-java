 ...
 * default 1G (0 ~ 100G)
 */
const i64 GALAXY_EMQ_QUEUE_MAX_SPACE_QUOTA_DEFAULT = 1000000000;
const i64 GALAXY_EMQ_QUEUE_MAX_SPACE_QUOTA_MINIMAL = 0;
const i64 GALAXY_EMQ_QUEUE_MAX_SPACE_QUOTA_MAXIMAL = 100000000000;

/**
 * queue read qps, default 1000 (0 ~ 100000)
 */
const i64 GALAXY_EMQ_QUEUE_READ_QPS_DEFAULT = 1000;
 ...
 */
const i64 GALAXY_EMQ_QUEUE_WRITE_QPS_DEFAULT = 1000;
