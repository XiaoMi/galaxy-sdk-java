...
public class QueueAttribute implements libthrift091.TBase<QueueAttribute, QueueAttribute._Fields>, java.io.Serializable, Cloneable, Comparable<QueueAttribute> {
  ...
  private static final libthrift091.protocol.TField OWNER_FIELD_DESC = new libthrift091.protocol.TField("owner", libthrift091.protocol.TType.STRING, (short)9);
  ...
  private static final _Fields optionals[] = {_Fields.DELAY_SECONDS,_Fields.INVISIBILITY_SECONDS,_Fields.RECEIVE_MESSAGE_WAIT_SECONDS,_Fields.RECEIVE_MESSAGE_MAXIMUM_NUMBER,_Fields.MESSAGE_RETENTION_SECONDS,_Fields.MESSAGE_MAXIMUM_BYTES,_Fields.PARTITION_NUMBER,_Fields.USER_ATTRIBUTES,_Fields.OWNER};
  ...
  static {
    ...
    tmpMap.put(_Fields.USER_ATTRIBUTES, new libthrift091.meta_data.FieldMetaData("userAttributes", libthrift091.TFieldRequirementType.OPTIONAL, 
        new libthrift091.meta_data.MapMetaData(libthrift091.protocol.TType.MAP, 
            ...
            new libthrift091.meta_data.FieldValueMetaData(libthrift091.protocol.TType.STRING))));
    tmpMap.put(_Fields.OWNER, new libthrift091.meta_data.FieldMetaData("owner", libthrift091.TFieldRequirementType.OPTIONAL, 
        new libthrift091.meta_data.FieldValueMetaData(libthrift091.protocol.TType.STRING)));
  ...
  public QueueAttribute setOwner(String owner) {
    this.owner = owner;
    return this;
  }
  ...
  public int compareTo(QueueAttribute other) {
    ...
    if (isSetOwner()) {
      lastComparison = libthrift091.TBaseHelper.compareTo(this.owner, other.owner);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
