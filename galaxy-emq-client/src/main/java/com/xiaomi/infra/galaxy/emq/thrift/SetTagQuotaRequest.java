...
public class SetTagQuotaRequest implements libthrift091.TBase<SetTagQuotaRequest, SetTagQuotaRequest._Fields>, java.io.Serializable, Cloneable, Comparable<SetTagQuotaRequest> {
  private static final libthrift091.protocol.TStruct STRUCT_DESC = new libthrift091.protocol.TStruct("SetTagQuotaRequest");
  ...
  static {
    schemes.put(StandardScheme.class, new SetTagQuotaRequestStandardSchemeFactory());
    schemes.put(TupleScheme.class, new SetTagQuotaRequestTupleSchemeFactory());
  }
  ...
  static {
    ...
    libthrift091.meta_data.FieldMetaData.addStructMetaDataMap(SetTagQuotaRequest.class, metaDataMap);
  }

  public SetTagQuotaRequest() {
  }
   ...
   */
  public SetTagQuotaRequest(SetTagQuotaRequest other) {
  ...
  public SetTagQuotaRequest deepCopy() {
    return new SetTagQuotaRequest(this);
  }
  ...
  public SetTagQuotaRequest setQueueName(String queueName) {
    this.queueName = queueName;
    return this;
  }
  ...
  public SetTagQuotaRequest setTagName(String tagName) {
    this.tagName = tagName;
    return this;
  }
  ...
  public SetTagQuotaRequest setReadQPSQuota(long readQPSQuota) {
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof SetTagQuotaRequest)
      return this.equals((SetTagQuotaRequest)that);
    return false;
  }

  public boolean equals(SetTagQuotaRequest that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(SetTagQuotaRequest other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("SetTagQuotaRequest(");
    boolean first = true;
  ...
  private static class SetTagQuotaRequestStandardSchemeFactory implements SchemeFactory {
    public SetTagQuotaRequestStandardScheme getScheme() {
      return new SetTagQuotaRequestStandardScheme();
    }
  }

  private static class SetTagQuotaRequestStandardScheme extends StandardScheme<SetTagQuotaRequest> {

    public void read(libthrift091.protocol.TProtocol iprot, SetTagQuotaRequest struct) throws libthrift091.TException {
    ...
    public void write(libthrift091.protocol.TProtocol oprot, SetTagQuotaRequest struct) throws libthrift091.TException {
      struct.validate();
  ...
  private static class SetTagQuotaRequestTupleSchemeFactory implements SchemeFactory {
    public SetTagQuotaRequestTupleScheme getScheme() {
      return new SetTagQuotaRequestTupleScheme();
    }
  }

  private static class SetTagQuotaRequestTupleScheme extends TupleScheme<SetTagQuotaRequest> {

    @Override
    public void write(libthrift091.protocol.TProtocol prot, SetTagQuotaRequest struct) throws libthrift091.TException {
    ...
    @Override
    public void read(libthrift091.protocol.TProtocol prot, SetTagQuotaRequest struct) throws libthrift091.TException {
