...
public class SetQueueQuotaResponse implements libthrift091.TBase<SetQueueQuotaResponse, SetQueueQuotaResponse._Fields>, java.io.Serializable, Cloneable, Comparable<SetQueueQuotaResponse> {
  private static final libthrift091.protocol.TStruct STRUCT_DESC = new libthrift091.protocol.TStruct("SetQueueQuotaResponse");
  ...
  static {
    schemes.put(StandardScheme.class, new SetQueueQuotaResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new SetQueueQuotaResponseTupleSchemeFactory());
  }
  ...
  static {
    ...
    libthrift091.meta_data.FieldMetaData.addStructMetaDataMap(SetQueueQuotaResponse.class, metaDataMap);
  }

  public SetQueueQuotaResponse() {
  }
   ...
   */
  public SetQueueQuotaResponse(SetQueueQuotaResponse other) {
  ...
  public SetQueueQuotaResponse deepCopy() {
    return new SetQueueQuotaResponse(this);
  }
   ...
   * 
   */
  public SetQueueQuotaResponse setQueueName(String queueName) {
    this.queueName = queueName;
    return this;
  }
   ...
   * 
   */
  public SetQueueQuotaResponse setQueueQuota(QueueQuota queueQuota) {
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof SetQueueQuotaResponse)
      return this.equals((SetQueueQuotaResponse)that);
    return false;
  }

  public boolean equals(SetQueueQuotaResponse that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(SetQueueQuotaResponse other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("SetQueueQuotaResponse(");
    boolean first = true;
  ...
  private static class SetQueueQuotaResponseStandardSchemeFactory implements SchemeFactory {
    public SetQueueQuotaResponseStandardScheme getScheme() {
      return new SetQueueQuotaResponseStandardScheme();
    }
  }

  private static class SetQueueQuotaResponseStandardScheme extends StandardScheme<SetQueueQuotaResponse> {

    public void read(libthrift091.protocol.TProtocol iprot, SetQueueQuotaResponse struct) throws libthrift091.TException {
    ...
    public void write(libthrift091.protocol.TProtocol oprot, SetQueueQuotaResponse struct) throws libthrift091.TException {
      struct.validate();
  ...
  private static class SetQueueQuotaResponseTupleSchemeFactory implements SchemeFactory {
    public SetQueueQuotaResponseTupleScheme getScheme() {
      return new SetQueueQuotaResponseTupleScheme();
    }
  }

  private static class SetQueueQuotaResponseTupleScheme extends TupleScheme<SetQueueQuotaResponse> {

    @Override
    public void write(libthrift091.protocol.TProtocol prot, SetQueueQuotaResponse struct) throws libthrift091.TException {
    ...
    @Override
    public void read(libthrift091.protocol.TProtocol prot, SetQueueQuotaResponse struct) throws libthrift091.TException {
