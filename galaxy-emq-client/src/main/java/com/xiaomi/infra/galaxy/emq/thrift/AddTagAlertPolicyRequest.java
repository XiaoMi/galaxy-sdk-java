...
public class AddTagAlertPolicyRequest implements libthrift091.TBase<AddTagAlertPolicyRequest, AddTagAlertPolicyRequest._Fields>, java.io.Serializable, Cloneable, Comparable<AddTagAlertPolicyRequest> {
  private static final libthrift091.protocol.TStruct STRUCT_DESC = new libthrift091.protocol.TStruct("AddTagAlertPolicyRequest");
  ...
  static {
    schemes.put(StandardScheme.class, new AddTagAlertPolicyRequestStandardSchemeFactory());
    schemes.put(TupleScheme.class, new AddTagAlertPolicyRequestTupleSchemeFactory());
  }
  ...
  static {
    ...
    libthrift091.meta_data.FieldMetaData.addStructMetaDataMap(AddTagAlertPolicyRequest.class, metaDataMap);
  }

  public AddTagAlertPolicyRequest() {
  }
   ...
   */
  public AddTagAlertPolicyRequest(AddTagAlertPolicyRequest other) {
  ...
  public AddTagAlertPolicyRequest deepCopy() {
    return new AddTagAlertPolicyRequest(this);
  }
   ...
   *  
   */
  public AddTagAlertPolicyRequest setQueueName(String queueName) {
    this.queueName = queueName;
    return this;
  }
   ...
   *  
   */
  public AddTagAlertPolicyRequest setTagName(String tagName) {
   ...
   *  
   */
  public AddTagAlertPolicyRequest setAlertPolicy(AlertPolicy alertPolicy) {
    this.alertPolicy = alertPolicy;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof AddTagAlertPolicyRequest)
      return this.equals((AddTagAlertPolicyRequest)that);
    return false;
  }

  public boolean equals(AddTagAlertPolicyRequest that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(AddTagAlertPolicyRequest other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("AddTagAlertPolicyRequest(");
    boolean first = true;
  ...
  private static class AddTagAlertPolicyRequestStandardSchemeFactory implements SchemeFactory {
    public AddTagAlertPolicyRequestStandardScheme getScheme() {
      return new AddTagAlertPolicyRequestStandardScheme();
    }
  }

  private static class AddTagAlertPolicyRequestStandardScheme extends StandardScheme<AddTagAlertPolicyRequest> {

    public void read(libthrift091.protocol.TProtocol iprot, AddTagAlertPolicyRequest struct) throws libthrift091.TException {
    ...
    public void write(libthrift091.protocol.TProtocol oprot, AddTagAlertPolicyRequest struct) throws libthrift091.TException {
      struct.validate();
  ...
  private static class AddTagAlertPolicyRequestTupleSchemeFactory implements SchemeFactory {
    public AddTagAlertPolicyRequestTupleScheme getScheme() {
      return new AddTagAlertPolicyRequestTupleScheme();
    }
  }

  private static class AddTagAlertPolicyRequestTupleScheme extends TupleScheme<AddTagAlertPolicyRequest> {

    @Override
    public void write(libthrift091.protocol.TProtocol prot, AddTagAlertPolicyRequest struct) throws libthrift091.TException {
    ...
    @Override
    public void read(libthrift091.protocol.TProtocol prot, AddTagAlertPolicyRequest struct) throws libthrift091.TException {
