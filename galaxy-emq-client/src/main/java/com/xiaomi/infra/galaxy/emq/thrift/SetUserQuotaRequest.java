...
public class SetUserQuotaRequest implements libthrift091.TBase<SetUserQuotaRequest, SetUserQuotaRequest._Fields>, java.io.Serializable, Cloneable, Comparable<SetUserQuotaRequest> {
  private static final libthrift091.protocol.TStruct STRUCT_DESC = new libthrift091.protocol.TStruct("SetUserQuotaRequest");
  ...
  static {
    schemes.put(StandardScheme.class, new SetUserQuotaRequestStandardSchemeFactory());
    schemes.put(TupleScheme.class, new SetUserQuotaRequestTupleSchemeFactory());
  }
  ...
  static {
    ...
    libthrift091.meta_data.FieldMetaData.addStructMetaDataMap(SetUserQuotaRequest.class, metaDataMap);
  }
   ...
   */
  public SetUserQuotaRequest(SetUserQuotaRequest other) {
  ...
  public SetUserQuotaRequest deepCopy() {
   ...
   *  
   */
  public SetUserQuotaRequest setDeveloperId(String developerId) {
    this.developerId = developerId;
    return this;
  }
   ...
   * 
   */
  public SetUserQuotaRequest setUserQuota(UserQuota userQuota) {
    this.userQuota = userQuota;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof SetUserQuotaRequest)
      return this.equals((SetUserQuotaRequest)that);
    return false;
  }

  public boolean equals(SetUserQuotaRequest that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(SetUserQuotaRequest other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("SetUserQuotaRequest(");
    boolean first = true;
  ...
  private static class SetUserQuotaRequestStandardSchemeFactory implements SchemeFactory {
    public SetUserQuotaRequestStandardScheme getScheme() {
      return new SetUserQuotaRequestStandardScheme();
    }
  }

  private static class SetUserQuotaRequestStandardScheme extends StandardScheme<SetUserQuotaRequest> {

    public void read(libthrift091.protocol.TProtocol iprot, SetUserQuotaRequest struct) throws libthrift091.TException {
    ...
    public void write(libthrift091.protocol.TProtocol oprot, SetUserQuotaRequest struct) throws libthrift091.TException {
      struct.validate();
  ...
  private static class SetUserQuotaRequestTupleSchemeFactory implements SchemeFactory {
    public SetUserQuotaRequestTupleScheme getScheme() {
      return new SetUserQuotaRequestTupleScheme();
    }
  }

  private static class SetUserQuotaRequestTupleScheme extends TupleScheme<SetUserQuotaRequest> {

    @Override
    public void write(libthrift091.protocol.TProtocol prot, SetUserQuotaRequest struct) throws libthrift091.TException {
    ...
    @Override
    public void read(libthrift091.protocol.TProtocol prot, SetUserQuotaRequest struct) throws libthrift091.TException {
