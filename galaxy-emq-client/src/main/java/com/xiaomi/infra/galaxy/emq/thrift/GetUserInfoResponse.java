...
public class GetUserInfoResponse implements libthrift091.TBase<GetUserInfoResponse, GetUserInfoResponse._Fields>, java.io.Serializable, Cloneable, Comparable<GetUserInfoResponse> {
  private static final libthrift091.protocol.TStruct STRUCT_DESC = new libthrift091.protocol.TStruct("GetUserInfoResponse");
  ...
  static {
    schemes.put(StandardScheme.class, new GetUserInfoResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new GetUserInfoResponseTupleSchemeFactory());
  }
  ...
  private static final _Fields optionals[] = {_Fields.USER_NAME,_Fields.EMAIL,_Fields.SMS};
  ...
  static {
    ...
    libthrift091.meta_data.FieldMetaData.addStructMetaDataMap(GetUserInfoResponse.class, metaDataMap);
  }
   ...
   */
  public GetUserInfoResponse(GetUserInfoResponse other) {
  ...
  public GetUserInfoResponse deepCopy() {
   ...
   *  
   */
  public GetUserInfoResponse setDeveloperId(String developerId) {
    this.developerId = developerId;
    return this;
  }
   ...
   *  
   */
  public GetUserInfoResponse setUserName(String userName) {
   ...
   *  
   */
  public GetUserInfoResponse setEmail(String email) {
    this.email = email;
    return this;
  }
   ...
   *  
   */
  public GetUserInfoResponse setSms(String sms) {
    this.sms = sms;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof GetUserInfoResponse)
      return this.equals((GetUserInfoResponse)that);
    return false;
  }

  public boolean equals(GetUserInfoResponse that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(GetUserInfoResponse other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("GetUserInfoResponse(");
    boolean first = true;
  ...
  private static class GetUserInfoResponseStandardSchemeFactory implements SchemeFactory {
    public GetUserInfoResponseStandardScheme getScheme() {
      return new GetUserInfoResponseStandardScheme();
    }
  }

  private static class GetUserInfoResponseStandardScheme extends StandardScheme<GetUserInfoResponse> {

    public void read(libthrift091.protocol.TProtocol iprot, GetUserInfoResponse struct) throws libthrift091.TException {
    ...
    public void write(libthrift091.protocol.TProtocol oprot, GetUserInfoResponse struct) throws libthrift091.TException {
      struct.validate();
  ...
  private static class GetUserInfoResponseTupleSchemeFactory implements SchemeFactory {
    public GetUserInfoResponseTupleScheme getScheme() {
      return new GetUserInfoResponseTupleScheme();
    }
  }

  private static class GetUserInfoResponseTupleScheme extends TupleScheme<GetUserInfoResponse> {

    @Override
    public void write(libthrift091.protocol.TProtocol prot, GetUserInfoResponse struct) throws libthrift091.TException {
    ...
    @Override
    public void read(libthrift091.protocol.TProtocol prot, GetUserInfoResponse struct) throws libthrift091.TException {
