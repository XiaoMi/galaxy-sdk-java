...
public class QueueTag implements libthrift091.TBase<QueueTag, QueueTag._Fields>, java.io.Serializable, Cloneable, Comparable<QueueTag> {
        ...
        switch (schemeField.id) {
          ...
          case 8: // USER_ATTRIBUTES
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                libthrift091.protocol.TMap _map112 = iprot.readMapBegin();
                struct.userAttributes = new HashMap<String,String>(2*_map112.size);
                String _key113;
                String _val114;
                for (int _i115 = 0; _i115 < _map112.size; ++_i115)
                {
                  ...
                  struct.userAttributes.put(_key113, _val114);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.userAttributes != null) {
        if (struct.isSetUserAttributes()) {
          oprot.writeFieldBegin(USER_ATTRIBUTES_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, String> _iter116 : struct.userAttributes.entrySet())
            {
  ...
  private static class QueueTagTupleScheme extends TupleScheme<QueueTag> {
      ...
      if (struct.isSetUserAttributes()) {
        {
          ...
          for (Map.Entry<String, String> _iter117 : struct.userAttributes.entrySet())
          {
    ...
    public void read(libthrift091.protocol.TProtocol prot, QueueTag struct) throws libthrift091.TException {
      ...
      if (incoming.get(4)) {
        {
          libthrift091.protocol.TMap _map118 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.STRING, iprot.readI32());
          struct.userAttributes = new HashMap<String,String>(2*_map118.size);
          String _key119;
          String _val120;
          for (int _i121 = 0; _i121 < _map118.size; ++_i121)
          {
            ...
            struct.userAttributes.put(_key119, _val120);
          }
        }
        struct.setUserAttributesIsSet(true);
      }
