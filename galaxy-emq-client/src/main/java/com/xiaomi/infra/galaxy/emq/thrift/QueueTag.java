...
public class QueueTag implements libthrift091.TBase<QueueTag, QueueTag._Fields>, java.io.Serializable, Cloneable, Comparable<QueueTag> {
        ...
        switch (schemeField.id) {
          ...
          case 8: // USER_ATTRIBUTES
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                libthrift091.protocol.TMap _map130 = iprot.readMapBegin();
                struct.userAttributes = new HashMap<String,String>(2*_map130.size);
                String _key131;
                String _val132;
                for (int _i133 = 0; _i133 < _map130.size; ++_i133)
                {
                  ...
                  struct.userAttributes.put(_key131, _val132);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.userAttributes != null) {
        if (struct.isSetUserAttributes()) {
          oprot.writeFieldBegin(USER_ATTRIBUTES_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, String> _iter134 : struct.userAttributes.entrySet())
            {
  ...
  private static class QueueTagTupleScheme extends TupleScheme<QueueTag> {
      ...
      if (struct.isSetUserAttributes()) {
        {
          ...
          for (Map.Entry<String, String> _iter135 : struct.userAttributes.entrySet())
          {
    ...
    public void read(libthrift091.protocol.TProtocol prot, QueueTag struct) throws libthrift091.TException {
      ...
      if (incoming.get(4)) {
        {
          libthrift091.protocol.TMap _map136 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.STRING, iprot.readI32());
          struct.userAttributes = new HashMap<String,String>(2*_map136.size);
          String _key137;
          String _val138;
          for (int _i139 = 0; _i139 < _map136.size; ++_i139)
          {
            ...
            struct.userAttributes.put(_key137, _val138);
          }
        }
        struct.setUserAttributesIsSet(true);
      }
