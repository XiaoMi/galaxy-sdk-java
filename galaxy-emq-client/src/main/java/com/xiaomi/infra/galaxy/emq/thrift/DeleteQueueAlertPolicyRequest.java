...
public class DeleteQueueAlertPolicyRequest implements libthrift091.TBase<DeleteQueueAlertPolicyRequest, DeleteQueueAlertPolicyRequest._Fields>, java.io.Serializable, Cloneable, Comparable<DeleteQueueAlertPolicyRequest> {
  private static final libthrift091.protocol.TStruct STRUCT_DESC = new libthrift091.protocol.TStruct("DeleteQueueAlertPolicyRequest");
  ...
  static {
    schemes.put(StandardScheme.class, new DeleteQueueAlertPolicyRequestStandardSchemeFactory());
    schemes.put(TupleScheme.class, new DeleteQueueAlertPolicyRequestTupleSchemeFactory());
  }
  ...
  static {
    ...
    libthrift091.meta_data.FieldMetaData.addStructMetaDataMap(DeleteQueueAlertPolicyRequest.class, metaDataMap);
  }

  public DeleteQueueAlertPolicyRequest() {
  }
   ...
   */
  public DeleteQueueAlertPolicyRequest(DeleteQueueAlertPolicyRequest other) {
  ...
  public DeleteQueueAlertPolicyRequest deepCopy() {
    return new DeleteQueueAlertPolicyRequest(this);
  }
   ...
   *  
   */
  public DeleteQueueAlertPolicyRequest setQueueName(String queueName) {
    this.queueName = queueName;
    return this;
  }
   ...
   *  
   */
  public DeleteQueueAlertPolicyRequest setAlertPolicy(AlertPolicy alertPolicy) {
    this.alertPolicy = alertPolicy;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof DeleteQueueAlertPolicyRequest)
      return this.equals((DeleteQueueAlertPolicyRequest)that);
    return false;
  }

  public boolean equals(DeleteQueueAlertPolicyRequest that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(DeleteQueueAlertPolicyRequest other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("DeleteQueueAlertPolicyRequest(");
    boolean first = true;
  ...
  private static class DeleteQueueAlertPolicyRequestStandardSchemeFactory implements SchemeFactory {
    public DeleteQueueAlertPolicyRequestStandardScheme getScheme() {
      return new DeleteQueueAlertPolicyRequestStandardScheme();
    }
  }

  private static class DeleteQueueAlertPolicyRequestStandardScheme extends StandardScheme<DeleteQueueAlertPolicyRequest> {

    public void read(libthrift091.protocol.TProtocol iprot, DeleteQueueAlertPolicyRequest struct) throws libthrift091.TException {
    ...
    public void write(libthrift091.protocol.TProtocol oprot, DeleteQueueAlertPolicyRequest struct) throws libthrift091.TException {
      struct.validate();
  ...
  private static class DeleteQueueAlertPolicyRequestTupleSchemeFactory implements SchemeFactory {
    public DeleteQueueAlertPolicyRequestTupleScheme getScheme() {
      return new DeleteQueueAlertPolicyRequestTupleScheme();
    }
  }

  private static class DeleteQueueAlertPolicyRequestTupleScheme extends TupleScheme<DeleteQueueAlertPolicyRequest> {

    @Override
    public void write(libthrift091.protocol.TProtocol prot, DeleteQueueAlertPolicyRequest struct) throws libthrift091.TException {
    ...
    @Override
    public void read(libthrift091.protocol.TProtocol prot, DeleteQueueAlertPolicyRequest struct) throws libthrift091.TException {
