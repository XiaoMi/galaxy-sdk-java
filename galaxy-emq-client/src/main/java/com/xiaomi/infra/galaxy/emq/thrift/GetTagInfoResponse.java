...
public class GetTagInfoResponse implements libthrift091.TBase<GetTagInfoResponse, GetTagInfoResponse._Fields>, java.io.Serializable, Cloneable, Comparable<GetTagInfoResponse> {
  ...
  private static final _Fields optionals[] = {_Fields.TAG_NAME,_Fields.READ_QPSQUOTA,_Fields.ATTRIBUTE_NAME,_Fields.ATTRIBUTE_VALUE,_Fields.USER_ATTRIBUTES};
            ...
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                ...
                struct.userAttributes = new HashMap<String,String>(2*_map46.size);
                String _key47;
                String _val48;
                for (int _i49 = 0; _i49 < _map46.size; ++_i49)
                {
                  ...
                  struct.userAttributes.put(_key47, _val48);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.userAttributes != null) {
        if (struct.isSetUserAttributes()) {
          oprot.writeFieldBegin(USER_ATTRIBUTES_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, String> _iter50 : struct.userAttributes.entrySet())
            {
  ...
  private static class GetTagInfoResponseTupleScheme extends TupleScheme<GetTagInfoResponse> {
      ...
      if (struct.isSetUserAttributes()) {
        {
          ...
          for (Map.Entry<String, String> _iter51 : struct.userAttributes.entrySet())
          {
    ...
    public void read(libthrift091.protocol.TProtocol prot, GetTagInfoResponse struct) throws libthrift091.TException {
      ...
      if (incoming.get(4)) {
        {
          libthrift091.protocol.TMap _map52 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.STRING, iprot.readI32());
          struct.userAttributes = new HashMap<String,String>(2*_map52.size);
          String _key53;
          String _val54;
          for (int _i55 = 0; _i55 < _map52.size; ++_i55)
          {
            ...
            struct.userAttributes.put(_key53, _val54);
          }
        }
        struct.setUserAttributesIsSet(true);
      }
