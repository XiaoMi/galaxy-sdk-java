...
public class DeletePeekMessageRequest implements libthrift091.TBase<DeletePeekMessageRequest, DeletePeekMessageRequest._Fields>, java.io.Serializable, Cloneable, Comparable<DeletePeekMessageRequest> {
  private static final libthrift091.protocol.TStruct STRUCT_DESC = new libthrift091.protocol.TStruct("DeletePeekMessageRequest");
  ...
  static {
    schemes.put(StandardScheme.class, new DeletePeekMessageRequestStandardSchemeFactory());
    schemes.put(TupleScheme.class, new DeletePeekMessageRequestTupleSchemeFactory());
  }
  ...
  static {
    ...
    libthrift091.meta_data.FieldMetaData.addStructMetaDataMap(DeletePeekMessageRequest.class, metaDataMap);
  }

  public DeletePeekMessageRequest() {
  }
   ...
   */
  public DeletePeekMessageRequest(DeletePeekMessageRequest other) {
  ...
  public DeletePeekMessageRequest deepCopy() {
    return new DeletePeekMessageRequest(this);
  }
   ...
   * 
   */
  public DeletePeekMessageRequest setQueueName(String queueName) {
    this.queueName = queueName;
    return this;
  }
   ...
   * 
   */
  public DeletePeekMessageRequest setReceiptHandle(String receiptHandle) {
    this.receiptHandle = receiptHandle;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof DeletePeekMessageRequest)
      return this.equals((DeletePeekMessageRequest)that);
    return false;
  }

  public boolean equals(DeletePeekMessageRequest that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(DeletePeekMessageRequest other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("DeletePeekMessageRequest(");
    boolean first = true;
  ...
  private static class DeletePeekMessageRequestStandardSchemeFactory implements SchemeFactory {
    public DeletePeekMessageRequestStandardScheme getScheme() {
      return new DeletePeekMessageRequestStandardScheme();
    }
  }

  private static class DeletePeekMessageRequestStandardScheme extends StandardScheme<DeletePeekMessageRequest> {

    public void read(libthrift091.protocol.TProtocol iprot, DeletePeekMessageRequest struct) throws libthrift091.TException {
    ...
    public void write(libthrift091.protocol.TProtocol oprot, DeletePeekMessageRequest struct) throws libthrift091.TException {
      struct.validate();
  ...
  private static class DeletePeekMessageRequestTupleSchemeFactory implements SchemeFactory {
    public DeletePeekMessageRequestTupleScheme getScheme() {
      return new DeletePeekMessageRequestTupleScheme();
    }
  }

  private static class DeletePeekMessageRequestTupleScheme extends TupleScheme<DeletePeekMessageRequest> {

    @Override
    public void write(libthrift091.protocol.TProtocol prot, DeletePeekMessageRequest struct) throws libthrift091.TException {
    ...
    @Override
    public void read(libthrift091.protocol.TProtocol prot, DeletePeekMessageRequest struct) throws libthrift091.TException {
