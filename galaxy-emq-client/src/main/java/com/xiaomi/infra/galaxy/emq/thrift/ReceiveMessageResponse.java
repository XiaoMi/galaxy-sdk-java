...
public class ReceiveMessageResponse implements libthrift091.TBase<ReceiveMessageResponse, ReceiveMessageResponse._Fields>, java.io.Serializable, Cloneable, Comparable<ReceiveMessageResponse> {
  ...
  private static final libthrift091.protocol.TField MESSAGE_ATTRIBUTES_FIELD_DESC = new libthrift091.protocol.TField("messageAttributes", libthrift091.protocol.TType.LIST, (short)4);
   ...
   * 
   */
  public List<MessageAttribute> messageAttributes; // optional
  ...
  private static final _Fields optionals[] = {_Fields.MESSAGE_ATTRIBUTES};
  ...
  public ReceiveMessageResponse(ReceiveMessageResponse other) {
    ...
    if (other.isSetMessageAttributes()) {
      List<MessageAttribute> __this__messageAttributes = new ArrayList<MessageAttribute>(other.messageAttributes.size());
      for (MessageAttribute other_element : other.messageAttributes) {
        __this__messageAttributes.add(new MessageAttribute(other_element));
      }
  ...
  public java.util.Iterator<MessageAttribute> getMessageAttributesIterator() {
    return (this.messageAttributes == null) ? null : this.messageAttributes.iterator();
  }

  public void addToMessageAttributes(MessageAttribute elem) {
    if (this.messageAttributes == null) {
      this.messageAttributes = new ArrayList<MessageAttribute>();
    }
    this.messageAttributes.add(elem);
  }
   ...
   * 
   */
  public ReceiveMessageResponse setMessageAttributes(List<MessageAttribute> messageAttributes) {
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case MESSAGE_ATTRIBUTES:
      if (value == null) {
        ...
        setMessageAttributes((List<MessageAttribute>)value);
      }
      break;
            ...
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                ...
                struct.messageAttributes = new ArrayList<MessageAttribute>(_list40.size);
                MessageAttribute _elem41;
                for (int _i42 = 0; _i42 < _list40.size; ++_i42)
                {
                  _elem41 = new MessageAttribute();
                  _elem41.read(iprot);
                  struct.messageAttributes.add(_elem41);
                }
                iprot.readListEnd();
              }
    ...
    public void write(libthrift091.protocol.TProtocol oprot, ReceiveMessageResponse struct) throws libthrift091.TException {
      ...
      if (struct.messageAttributes != null) {
        if (struct.isSetMessageAttributes()) {
          ...
          {
            oprot.writeListBegin(new libthrift091.protocol.TList(libthrift091.protocol.TType.STRUCT, struct.messageAttributes.size()));
            for (MessageAttribute _iter43 : struct.messageAttributes)
            {
              _iter43.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.isSetMessageAttributes()) {
        {
          ...
          for (MessageAttribute _iter44 : struct.messageAttributes)
          {
            _iter44.write(oprot);
          }
        }
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.messageAttributes = new ArrayList<MessageAttribute>(_list45.size);
          MessageAttribute _elem46;
          for (int _i47 = 0; _i47 < _list45.size; ++_i47)
          {
            _elem46 = new MessageAttribute();
            _elem46.read(iprot);
            struct.messageAttributes.add(_elem46);
          }
        }
        struct.setMessageAttributesIsSet(true);
      }
