...
public class StatisticsService {
  ...
  public interface Iface extends com.xiaomi.infra.galaxy.emq.thrift.EMQBaseService.Iface {
     ...
     * @param request
     */
    public void addQueueAlertPolicy(AddAlertPolicyRequest request) throws com.xiaomi.infra.galaxy.emq.thrift.GalaxyEmqServiceException, libthrift091.TException;
     ...
     * @param request
     */
    public void deleteQueueAlertPolicy(DeleteAlertPolicyRequest request) throws com.xiaomi.infra.galaxy.emq.thrift.GalaxyEmqServiceException, libthrift091.TException;
  ...
  public interface AsyncIface extends com.xiaomi.infra.galaxy.emq.thrift.EMQBaseService .AsyncIface {
    ...
    public void addQueueAlertPolicy(AddAlertPolicyRequest request, libthrift091.async.AsyncMethodCallback resultHandler) throws libthrift091.TException;

    public void deleteQueueAlertPolicy(DeleteAlertPolicyRequest request, libthrift091.async.AsyncMethodCallback resultHandler) throws libthrift091.TException;
  ...
  public static class Client extends com.xiaomi.infra.galaxy.emq.thrift.EMQBaseService.Client implements Iface {
    ...
    public void send_addQueueAlertPolicy(AddAlertPolicyRequest request) throws libthrift091.TException
    {
    ...
    public void send_deleteQueueAlertPolicy(DeleteAlertPolicyRequest request) throws libthrift091.TException
    {
  ...
  public static class AsyncClient extends com.xiaomi.infra.galaxy.emq.thrift.EMQBaseService.AsyncClient implements AsyncIface {
    ...
    public static class addQueueAlertPolicy_call extends libthrift091.async.TAsyncMethodCall {
      private AddAlertPolicyRequest request;
      public addQueueAlertPolicy_call(AddAlertPolicyRequest request, libthrift091.async.AsyncMethodCallback resultHandler, libthrift091.async.TAsyncClient client, libthrift091.protocol.TProtocolFactory protocolFactory, libthrift091.transport.TNonblockingTransport transport) throws libthrift091.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.request = request;
      }
    ...
    public static class deleteQueueAlertPolicy_call extends libthrift091.async.TAsyncMethodCall {
      private DeleteAlertPolicyRequest request;
      public deleteQueueAlertPolicy_call(DeleteAlertPolicyRequest request, libthrift091.async.AsyncMethodCallback resultHandler, libthrift091.async.TAsyncClient client, libthrift091.protocol.TProtocolFactory protocolFactory, libthrift091.transport.TNonblockingTransport transport) throws libthrift091.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.request = request;
      }
  ...
  public static class addQueueAlertPolicy_args implements libthrift091.TBase<addQueueAlertPolicy_args, addQueueAlertPolicy_args._Fields>, java.io.Serializable, Cloneable, Comparable<addQueueAlertPolicy_args>   {
    ...
    public AddAlertPolicyRequest request; // required
    ...
    static {
      Map<_Fields, libthrift091.meta_data.FieldMetaData> tmpMap = new EnumMap<_Fields, libthrift091.meta_data.FieldMetaData>(_Fields.class);
      tmpMap.put(_Fields.REQUEST, new libthrift091.meta_data.FieldMetaData("request", libthrift091.TFieldRequirementType.DEFAULT, 
          new libthrift091.meta_data.StructMetaData(libthrift091.protocol.TType.STRUCT, AddAlertPolicyRequest.class)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
    ...
    public addQueueAlertPolicy_args(addQueueAlertPolicy_args other) {
      if (other.isSetRequest()) {
        this.request = new AddAlertPolicyRequest(other.request);
      }
    }
    ...
    public AddAlertPolicyRequest getRequest() {
      return this.request;
    }

    public addQueueAlertPolicy_args setRequest(AddAlertPolicyRequest request) {
      this.request = request;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case REQUEST:
        if (value == null) {
          ...
          setRequest((AddAlertPolicyRequest)value);
        }
        break;
      ...
      public void read(libthrift091.protocol.TProtocol iprot, addQueueAlertPolicy_args struct) throws libthrift091.TException {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
            case 1: // REQUEST
              if (schemeField.type == libthrift091.protocol.TType.STRUCT) {
                struct.request = new AddAlertPolicyRequest();
                struct.request.read(iprot);
                struct.setRequestIsSet(true);
              } else { 
                libthrift091.protocol.TProtocolUtil.skip(iprot, schemeField.type);
  ...
  public static class deleteQueueAlertPolicy_args implements libthrift091.TBase<deleteQueueAlertPolicy_args, deleteQueueAlertPolicy_args._Fields>, java.io.Serializable, Cloneable, Comparable<deleteQueueAlertPolicy_args>   {
    ...
    public DeleteAlertPolicyRequest request; // required
    ...
    static {
      Map<_Fields, libthrift091.meta_data.FieldMetaData> tmpMap = new EnumMap<_Fields, libthrift091.meta_data.FieldMetaData>(_Fields.class);
      tmpMap.put(_Fields.REQUEST, new libthrift091.meta_data.FieldMetaData("request", libthrift091.TFieldRequirementType.DEFAULT, 
          new libthrift091.meta_data.StructMetaData(libthrift091.protocol.TType.STRUCT, DeleteAlertPolicyRequest.class)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
    ...
    public deleteQueueAlertPolicy_args(deleteQueueAlertPolicy_args other) {
      if (other.isSetRequest()) {
        this.request = new DeleteAlertPolicyRequest(other.request);
      }
    }
    ...
    public DeleteAlertPolicyRequest getRequest() {
      return this.request;
    }

    public deleteQueueAlertPolicy_args setRequest(DeleteAlertPolicyRequest request) {
      this.request = request;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case REQUEST:
        if (value == null) {
          ...
          setRequest((DeleteAlertPolicyRequest)value);
        }
        break;
      ...
      public void read(libthrift091.protocol.TProtocol iprot, deleteQueueAlertPolicy_args struct) throws libthrift091.TException {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
            case 1: // REQUEST
              if (schemeField.type == libthrift091.protocol.TType.STRUCT) {
                struct.request = new DeleteAlertPolicyRequest();
                struct.request.read(iprot);
                struct.setRequestIsSet(true);
              } else { 
                libthrift091.protocol.TProtocolUtil.skip(iprot, schemeField.type);
