...
public class QueueMeta implements libthrift091.TBase<QueueMeta, QueueMeta._Fields>, java.io.Serializable, Cloneable, Comparable<QueueMeta> {
            ...
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                ...
                struct.permissionList = new HashMap<String,Permission>(2*_map112.size);
                String _key113;
                Permission _val114;
                for (int _i115 = 0; _i115 < _map112.size; ++_i115)
                {
                  _key113 = iprot.readString();
                  _val114 = com.xiaomi.infra.galaxy.emq.thrift.Permission.findByValue(iprot.readI32());
                  struct.permissionList.put(_key113, _val114);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                ...
                struct.sourceQueues = new ArrayList<String>(_list116.size);
                String _elem117;
                for (int _i118 = 0; _i118 < _list116.size; ++_i118)
                {
                  _elem117 = iprot.readString();
                  struct.sourceQueues.add(_elem117);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                ...
                struct.queueTagMap = new HashMap<String,QueueTag>(2*_map119.size);
                String _key120;
                QueueTag _val121;
                for (int _i122 = 0; _i122 < _map119.size; ++_i122)
                {
                  _key120 = iprot.readString();
                  _val121 = new QueueTag();
                  _val121.read(iprot);
                  struct.queueTagMap.put(_key120, _val121);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.permissionList != null) {
        if (struct.isSetPermissionList()) {
          oprot.writeFieldBegin(PERMISSION_LIST_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Permission> _iter123 : struct.permissionList.entrySet())
            {
              oprot.writeString(_iter123.getKey());
              oprot.writeI32(_iter123.getValue().getValue());
            }
            oprot.writeMapEnd();
          }
          oprot.writeFieldEnd();
      ...
      if (struct.sourceQueues != null) {
        if (struct.isSetSourceQueues()) {
          oprot.writeFieldBegin(SOURCE_QUEUES_FIELD_DESC);
          {
            ...
            for (String _iter124 : struct.sourceQueues)
            {
      ...
      if (struct.queueTagMap != null) {
        if (struct.isSetQueueTagMap()) {
          oprot.writeFieldBegin(QUEUE_TAG_MAP_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, QueueTag> _iter125 : struct.queueTagMap.entrySet())
            {
  ...
  private static class QueueMetaTupleScheme extends TupleScheme<QueueMeta> {
      ...
      if (struct.isSetPermissionList()) {
        {
          ...
          for (Map.Entry<String, Permission> _iter126 : struct.permissionList.entrySet())
          {
      ...
      if (struct.isSetSourceQueues()) {
        {
          ...
          for (String _iter127 : struct.sourceQueues)
          {
      ...
      if (struct.isSetQueueTagMap()) {
        {
          ...
          for (Map.Entry<String, QueueTag> _iter128 : struct.queueTagMap.entrySet())
          {
    ...
    public void read(libthrift091.protocol.TProtocol prot, QueueMeta struct) throws libthrift091.TException {
      ...
      if (incoming.get(5)) {
        {
          libthrift091.protocol.TMap _map129 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.I32, iprot.readI32());
          struct.permissionList = new HashMap<String,Permission>(2*_map129.size);
          String _key130;
          Permission _val131;
          for (int _i132 = 0; _i132 < _map129.size; ++_i132)
          {
            _key130 = iprot.readString();
            _val131 = com.xiaomi.infra.galaxy.emq.thrift.Permission.findByValue(iprot.readI32());
            struct.permissionList.put(_key130, _val131);
          }
        }
        struct.setPermissionListIsSet(true);
      }
      ...
      if (incoming.get(7)) {
        {
          libthrift091.protocol.TList _list133 = new libthrift091.protocol.TList(libthrift091.protocol.TType.STRING, iprot.readI32());
          struct.sourceQueues = new ArrayList<String>(_list133.size);
          String _elem134;
          for (int _i135 = 0; _i135 < _list133.size; ++_i135)
          {
            _elem134 = iprot.readString();
            struct.sourceQueues.add(_elem134);
          }
        }
        struct.setSourceQueuesIsSet(true);
      }
      ...
      if (incoming.get(10)) {
        {
          libthrift091.protocol.TMap _map136 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.STRUCT, iprot.readI32());
          struct.queueTagMap = new HashMap<String,QueueTag>(2*_map136.size);
          String _key137;
          QueueTag _val138;
          for (int _i139 = 0; _i139 < _map136.size; ++_i139)
          {
            _key137 = iprot.readString();
            _val138 = new QueueTag();
            _val138.read(iprot);
            struct.queueTagMap.put(_key137, _val138);
          }
        }
        struct.setQueueTagMapIsSet(true);
      }
