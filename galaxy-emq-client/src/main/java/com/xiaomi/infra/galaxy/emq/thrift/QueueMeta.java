...
public class QueueMeta implements libthrift091.TBase<QueueMeta, QueueMeta._Fields>, java.io.Serializable, Cloneable, Comparable<QueueMeta> {
  ...
  static {
    ...
    tmpMap.put(_Fields.QUEUE_TAG_MAP, new libthrift091.meta_data.FieldMetaData("queueTagMap", libthrift091.TFieldRequirementType.OPTIONAL, 
        new libthrift091.meta_data.MapMetaData(libthrift091.protocol.TType.MAP, 
            new libthrift091.meta_data.FieldValueMetaData(libthrift091.protocol.TType.STRING), 
            new libthrift091.meta_data.FieldValueMetaData(libthrift091.protocol.TType.STRUCT            , "QueueTag"))));
  ...
  public QueueMeta(QueueMeta other) {
    ...
    if (other.isSetQueueTagMap()) {
      ...
      for (Map.Entry<String, QueueTag> other_element : other.queueTagMap.entrySet()) {
        ...
        QueueTag __this__queueTagMap_copy_value = other_element_value;
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                ...
                struct.permissionList = new HashMap<String,Permission>(2*_map102.size);
                String _key103;
                Permission _val104;
                for (int _i105 = 0; _i105 < _map102.size; ++_i105)
                {
                  _key103 = iprot.readString();
                  _val104 = com.xiaomi.infra.galaxy.emq.thrift.Permission.findByValue(iprot.readI32());
                  struct.permissionList.put(_key103, _val104);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                ...
                struct.sourceQueues = new ArrayList<String>(_list106.size);
                String _elem107;
                for (int _i108 = 0; _i108 < _list106.size; ++_i108)
                {
                  _elem107 = iprot.readString();
                  struct.sourceQueues.add(_elem107);
                }
                iprot.readListEnd();
              }
          ...
          case 13: // QUEUE_TAG_MAP
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                libthrift091.protocol.TMap _map109 = iprot.readMapBegin();
                struct.queueTagMap = new HashMap<String,QueueTag>(2*_map109.size);
                String _key110;
                QueueTag _val111;
                for (int _i112 = 0; _i112 < _map109.size; ++_i112)
                {
                  _key110 = iprot.readString();
                  _val111 = new QueueTag();
                  _val111.read(iprot);
                  struct.queueTagMap.put(_key110, _val111);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.permissionList != null) {
        if (struct.isSetPermissionList()) {
          oprot.writeFieldBegin(PERMISSION_LIST_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Permission> _iter113 : struct.permissionList.entrySet())
            {
      ...
      if (struct.sourceQueues != null) {
        if (struct.isSetSourceQueues()) {
          oprot.writeFieldBegin(SOURCE_QUEUES_FIELD_DESC);
          {
            ...
            for (String _iter114 : struct.sourceQueues)
            {
      ...
      if (struct.queueTagMap != null) {
        if (struct.isSetQueueTagMap()) {
          oprot.writeFieldBegin(QUEUE_TAG_MAP_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, QueueTag> _iter115 : struct.queueTagMap.entrySet())
            {
  ...
  private static class QueueMetaTupleScheme extends TupleScheme<QueueMeta> {
      ...
      if (struct.isSetPermissionList()) {
        {
          ...
          for (Map.Entry<String, Permission> _iter116 : struct.permissionList.entrySet())
          {
            oprot.writeString(_iter116.getKey());
            oprot.writeI32(_iter116.getValue().getValue());
          }
        }
      }
      if (struct.isSetRedrivePolicy()) {
      ...
      if (struct.isSetSourceQueues()) {
        {
          ...
          for (String _iter117 : struct.sourceQueues)
          {
      ...
      if (struct.isSetQueueTagMap()) {
        {
          ...
          for (Map.Entry<String, QueueTag> _iter118 : struct.queueTagMap.entrySet())
          {
    ...
    public void read(libthrift091.protocol.TProtocol prot, QueueMeta struct) throws libthrift091.TException {
      ...
      if (incoming.get(5)) {
        {
          libthrift091.protocol.TMap _map119 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.I32, iprot.readI32());
          struct.permissionList = new HashMap<String,Permission>(2*_map119.size);
          String _key120;
          Permission _val121;
          for (int _i122 = 0; _i122 < _map119.size; ++_i122)
          {
            _key120 = iprot.readString();
            _val121 = com.xiaomi.infra.galaxy.emq.thrift.Permission.findByValue(iprot.readI32());
            struct.permissionList.put(_key120, _val121);
          }
        }
        struct.setPermissionListIsSet(true);
      }
      ...
      if (incoming.get(7)) {
        {
          libthrift091.protocol.TList _list123 = new libthrift091.protocol.TList(libthrift091.protocol.TType.STRING, iprot.readI32());
          struct.sourceQueues = new ArrayList<String>(_list123.size);
          String _elem124;
          for (int _i125 = 0; _i125 < _list123.size; ++_i125)
          {
            _elem124 = iprot.readString();
            struct.sourceQueues.add(_elem124);
          }
        }
        struct.setSourceQueuesIsSet(true);
      }
      ...
      if (incoming.get(10)) {
        {
          libthrift091.protocol.TMap _map126 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.STRUCT, iprot.readI32());
          struct.queueTagMap = new HashMap<String,QueueTag>(2*_map126.size);
          String _key127;
          QueueTag _val128;
          for (int _i129 = 0; _i129 < _map126.size; ++_i129)
          {
            _key127 = iprot.readString();
            _val128 = new QueueTag();
            _val128.read(iprot);
            struct.queueTagMap.put(_key127, _val128);
          }
        }
        struct.setQueueTagMapIsSet(true);
      }
