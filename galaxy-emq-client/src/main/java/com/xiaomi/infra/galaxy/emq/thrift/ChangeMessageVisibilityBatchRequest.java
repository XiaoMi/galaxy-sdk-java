            ...
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                ...
                struct.changeMessageVisibilityRequestEntryList = new ArrayList<ChangeMessageVisibilityBatchRequestEntry>(_list48.size);
                ChangeMessageVisibilityBatchRequestEntry _elem49;
                for (int _i50 = 0; _i50 < _list48.size; ++_i50)
                {
                  _elem49 = new ChangeMessageVisibilityBatchRequestEntry();
                  _elem49.read(iprot);
                  struct.changeMessageVisibilityRequestEntryList.add(_elem49);
                }
                iprot.readListEnd();
              }
    ...
    public void write(libthrift091.protocol.TProtocol oprot, ChangeMessageVisibilityBatchRequest struct) throws libthrift091.TException {
      ...
      if (struct.changeMessageVisibilityRequestEntryList != null) {
        oprot.writeFieldBegin(CHANGE_MESSAGE_VISIBILITY_REQUEST_ENTRY_LIST_FIELD_DESC);
        {
          ...
          for (ChangeMessageVisibilityBatchRequestEntry _iter51 : struct.changeMessageVisibilityRequestEntryList)
          {
            _iter51.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class ChangeMessageVisibilityBatchRequestTupleScheme extends TupleScheme<ChangeMessageVisibilityBatchRequest> {
    ...
    public void write(libthrift091.protocol.TProtocol prot, ChangeMessageVisibilityBatchRequest struct) throws libthrift091.TException {
      ...
      oprot.writeString(struct.queueName);
      {
        ...
        for (ChangeMessageVisibilityBatchRequestEntry _iter52 : struct.changeMessageVisibilityRequestEntryList)
        {
          _iter52.write(oprot);
        }
      }
    ...
    public void read(libthrift091.protocol.TProtocol prot, ChangeMessageVisibilityBatchRequest struct) throws libthrift091.TException {
      ...
      struct.setQueueNameIsSet(true);
      {
        ...
        struct.changeMessageVisibilityRequestEntryList = new ArrayList<ChangeMessageVisibilityBatchRequestEntry>(_list53.size);
        ChangeMessageVisibilityBatchRequestEntry _elem54;
        for (int _i55 = 0; _i55 < _list53.size; ++_i55)
        {
          _elem54 = new ChangeMessageVisibilityBatchRequestEntry();
          _elem54.read(iprot);
          struct.changeMessageVisibilityRequestEntryList.add(_elem54);
        }
      }
      struct.setChangeMessageVisibilityRequestEntryListIsSet(true);
    }
