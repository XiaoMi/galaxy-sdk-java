            ...
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                ...
                struct.changeMessageVisibilityRequestEntryList = new ArrayList<ChangeMessageVisibilityBatchRequestEntry>(_list24.size);
                ChangeMessageVisibilityBatchRequestEntry _elem25;
                for (int _i26 = 0; _i26 < _list24.size; ++_i26)
                {
                  _elem25 = new ChangeMessageVisibilityBatchRequestEntry();
                  _elem25.read(iprot);
                  struct.changeMessageVisibilityRequestEntryList.add(_elem25);
                }
                iprot.readListEnd();
              }
    ...
    public void write(libthrift091.protocol.TProtocol oprot, ChangeMessageVisibilityBatchRequest struct) throws libthrift091.TException {
      ...
      if (struct.changeMessageVisibilityRequestEntryList != null) {
        oprot.writeFieldBegin(CHANGE_MESSAGE_VISIBILITY_REQUEST_ENTRY_LIST_FIELD_DESC);
        {
          ...
          for (ChangeMessageVisibilityBatchRequestEntry _iter27 : struct.changeMessageVisibilityRequestEntryList)
          {
            _iter27.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class ChangeMessageVisibilityBatchRequestTupleScheme extends TupleScheme<ChangeMessageVisibilityBatchRequest> {
    ...
    public void write(libthrift091.protocol.TProtocol prot, ChangeMessageVisibilityBatchRequest struct) throws libthrift091.TException {
      ...
      oprot.writeString(struct.queueName);
      {
        ...
        for (ChangeMessageVisibilityBatchRequestEntry _iter28 : struct.changeMessageVisibilityRequestEntryList)
        {
          _iter28.write(oprot);
        }
      }
    ...
    public void read(libthrift091.protocol.TProtocol prot, ChangeMessageVisibilityBatchRequest struct) throws libthrift091.TException {
      ...
      struct.setQueueNameIsSet(true);
      {
        ...
        struct.changeMessageVisibilityRequestEntryList = new ArrayList<ChangeMessageVisibilityBatchRequestEntry>(_list29.size);
        ChangeMessageVisibilityBatchRequestEntry _elem30;
        for (int _i31 = 0; _i31 < _list29.size; ++_i31)
        {
          _elem30 = new ChangeMessageVisibilityBatchRequestEntry();
          _elem30.read(iprot);
          struct.changeMessageVisibilityRequestEntryList.add(_elem30);
        }
      }
      struct.setChangeMessageVisibilityRequestEntryListIsSet(true);
    }
