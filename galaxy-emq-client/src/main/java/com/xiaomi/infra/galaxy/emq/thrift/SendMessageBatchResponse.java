            ...
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                ...
                struct.successful = new ArrayList<SendMessageBatchResponseEntry>(_list24.size);
                SendMessageBatchResponseEntry _elem25;
                for (int _i26 = 0; _i26 < _list24.size; ++_i26)
                {
                  _elem25 = new SendMessageBatchResponseEntry();
                  _elem25.read(iprot);
                  struct.successful.add(_elem25);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                ...
                struct.failed = new ArrayList<MessageBatchErrorEntry>(_list27.size);
                MessageBatchErrorEntry _elem28;
                for (int _i29 = 0; _i29 < _list27.size; ++_i29)
                {
                  _elem28 = new MessageBatchErrorEntry();
                  _elem28.read(iprot);
                  struct.failed.add(_elem28);
                }
                iprot.readListEnd();
              }
    ...
    public void write(libthrift091.protocol.TProtocol oprot, SendMessageBatchResponse struct) throws libthrift091.TException {
      ...
      if (struct.successful != null) {
        oprot.writeFieldBegin(SUCCESSFUL_FIELD_DESC);
        {
          ...
          for (SendMessageBatchResponseEntry _iter30 : struct.successful)
          {
            _iter30.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.failed != null) {
        oprot.writeFieldBegin(FAILED_FIELD_DESC);
        {
          ...
          for (MessageBatchErrorEntry _iter31 : struct.failed)
          {
            _iter31.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetSuccessful()) {
        {
          ...
          for (SendMessageBatchResponseEntry _iter32 : struct.successful)
          {
            _iter32.write(oprot);
          }
        }
      ...
      if (struct.isSetFailed()) {
        {
          ...
          for (MessageBatchErrorEntry _iter33 : struct.failed)
          {
            _iter33.write(oprot);
          }
        }
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.successful = new ArrayList<SendMessageBatchResponseEntry>(_list34.size);
          SendMessageBatchResponseEntry _elem35;
          for (int _i36 = 0; _i36 < _list34.size; ++_i36)
          {
            _elem35 = new SendMessageBatchResponseEntry();
            _elem35.read(iprot);
            struct.successful.add(_elem35);
          }
        }
        struct.setSuccessfulIsSet(true);
      }
      if (incoming.get(1)) {
        {
          ...
          struct.failed = new ArrayList<MessageBatchErrorEntry>(_list37.size);
          MessageBatchErrorEntry _elem38;
          for (int _i39 = 0; _i39 < _list37.size; ++_i39)
          {
            _elem38 = new MessageBatchErrorEntry();
            _elem38.read(iprot);
            struct.failed.add(_elem38);
          }
        }
        struct.setFailedIsSet(true);
      }
