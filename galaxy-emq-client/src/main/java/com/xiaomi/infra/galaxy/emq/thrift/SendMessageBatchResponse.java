            ...
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                ...
                struct.successful = new ArrayList<SendMessageBatchResponseEntry>(_list8.size);
                SendMessageBatchResponseEntry _elem9;
                for (int _i10 = 0; _i10 < _list8.size; ++_i10)
                {
                  _elem9 = new SendMessageBatchResponseEntry();
                  _elem9.read(iprot);
                  struct.successful.add(_elem9);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                ...
                struct.failed = new ArrayList<MessageBatchErrorEntry>(_list11.size);
                MessageBatchErrorEntry _elem12;
                for (int _i13 = 0; _i13 < _list11.size; ++_i13)
                {
                  _elem12 = new MessageBatchErrorEntry();
                  _elem12.read(iprot);
                  struct.failed.add(_elem12);
                }
                iprot.readListEnd();
              }
    ...
    public void write(libthrift091.protocol.TProtocol oprot, SendMessageBatchResponse struct) throws libthrift091.TException {
      ...
      if (struct.successful != null) {
        oprot.writeFieldBegin(SUCCESSFUL_FIELD_DESC);
        {
          ...
          for (SendMessageBatchResponseEntry _iter14 : struct.successful)
          {
            _iter14.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.failed != null) {
        oprot.writeFieldBegin(FAILED_FIELD_DESC);
        {
          ...
          for (MessageBatchErrorEntry _iter15 : struct.failed)
          {
            _iter15.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetSuccessful()) {
        {
          ...
          for (SendMessageBatchResponseEntry _iter16 : struct.successful)
          {
            _iter16.write(oprot);
          }
        }
      ...
      if (struct.isSetFailed()) {
        {
          ...
          for (MessageBatchErrorEntry _iter17 : struct.failed)
          {
            _iter17.write(oprot);
          }
        }
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.successful = new ArrayList<SendMessageBatchResponseEntry>(_list18.size);
          SendMessageBatchResponseEntry _elem19;
          for (int _i20 = 0; _i20 < _list18.size; ++_i20)
          {
            _elem19 = new SendMessageBatchResponseEntry();
            _elem19.read(iprot);
            struct.successful.add(_elem19);
          }
        }
        struct.setSuccessfulIsSet(true);
      }
      if (incoming.get(1)) {
        {
          ...
          struct.failed = new ArrayList<MessageBatchErrorEntry>(_list21.size);
          MessageBatchErrorEntry _elem22;
          for (int _i23 = 0; _i23 < _list21.size; ++_i23)
          {
            _elem22 = new MessageBatchErrorEntry();
            _elem22.read(iprot);
            struct.failed.add(_elem22);
          }
        }
        struct.setFailedIsSet(true);
      }
