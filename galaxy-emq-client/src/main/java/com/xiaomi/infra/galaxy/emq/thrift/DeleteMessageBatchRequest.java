            ...
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                ...
                struct.deleteMessageBatchRequestEntryList = new ArrayList<DeleteMessageBatchRequestEntry>(_list48.size);
                DeleteMessageBatchRequestEntry _elem49;
                for (int _i50 = 0; _i50 < _list48.size; ++_i50)
                {
                  _elem49 = new DeleteMessageBatchRequestEntry();
                  _elem49.read(iprot);
                  struct.deleteMessageBatchRequestEntryList.add(_elem49);
                }
                iprot.readListEnd();
              }
    ...
    public void write(libthrift091.protocol.TProtocol oprot, DeleteMessageBatchRequest struct) throws libthrift091.TException {
      ...
      if (struct.deleteMessageBatchRequestEntryList != null) {
        oprot.writeFieldBegin(DELETE_MESSAGE_BATCH_REQUEST_ENTRY_LIST_FIELD_DESC);
        {
          ...
          for (DeleteMessageBatchRequestEntry _iter51 : struct.deleteMessageBatchRequestEntryList)
          {
            _iter51.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class DeleteMessageBatchRequestTupleScheme extends TupleScheme<DeleteMessageBatchRequest> {
    ...
    public void write(libthrift091.protocol.TProtocol prot, DeleteMessageBatchRequest struct) throws libthrift091.TException {
      ...
      oprot.writeString(struct.queueName);
      {
        ...
        for (DeleteMessageBatchRequestEntry _iter52 : struct.deleteMessageBatchRequestEntryList)
        {
          _iter52.write(oprot);
        }
      }
    ...
    public void read(libthrift091.protocol.TProtocol prot, DeleteMessageBatchRequest struct) throws libthrift091.TException {
      ...
      struct.setQueueNameIsSet(true);
      {
        ...
        struct.deleteMessageBatchRequestEntryList = new ArrayList<DeleteMessageBatchRequestEntry>(_list53.size);
        DeleteMessageBatchRequestEntry _elem54;
        for (int _i55 = 0; _i55 < _list53.size; ++_i55)
        {
          _elem54 = new DeleteMessageBatchRequestEntry();
          _elem54.read(iprot);
          struct.deleteMessageBatchRequestEntryList.add(_elem54);
        }
      }
      struct.setDeleteMessageBatchRequestEntryListIsSet(true);
    }
