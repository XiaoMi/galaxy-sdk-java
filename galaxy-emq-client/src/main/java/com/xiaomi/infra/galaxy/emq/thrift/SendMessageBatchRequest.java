            ...
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                ...
                struct.sendMessageBatchRequestEntryList = new ArrayList<SendMessageBatchRequestEntry>(_list0.size);
                SendMessageBatchRequestEntry _elem1;
                for (int _i2 = 0; _i2 < _list0.size; ++_i2)
                {
                  _elem1 = new SendMessageBatchRequestEntry();
                  _elem1.read(iprot);
                  struct.sendMessageBatchRequestEntryList.add(_elem1);
                }
                iprot.readListEnd();
              }
    ...
    public void write(libthrift091.protocol.TProtocol oprot, SendMessageBatchRequest struct) throws libthrift091.TException {
      ...
      if (struct.sendMessageBatchRequestEntryList != null) {
        oprot.writeFieldBegin(SEND_MESSAGE_BATCH_REQUEST_ENTRY_LIST_FIELD_DESC);
        {
          ...
          for (SendMessageBatchRequestEntry _iter3 : struct.sendMessageBatchRequestEntryList)
          {
            _iter3.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class SendMessageBatchRequestTupleScheme extends TupleScheme<SendMessageBatchRequest> {
    ...
    public void write(libthrift091.protocol.TProtocol prot, SendMessageBatchRequest struct) throws libthrift091.TException {
      ...
      oprot.writeString(struct.queueName);
      {
        ...
        for (SendMessageBatchRequestEntry _iter4 : struct.sendMessageBatchRequestEntryList)
        {
          _iter4.write(oprot);
        }
      }
    ...
    public void read(libthrift091.protocol.TProtocol prot, SendMessageBatchRequest struct) throws libthrift091.TException {
      ...
      struct.setQueueNameIsSet(true);
      {
        ...
        struct.sendMessageBatchRequestEntryList = new ArrayList<SendMessageBatchRequestEntry>(_list5.size);
        SendMessageBatchRequestEntry _elem6;
        for (int _i7 = 0; _i7 < _list5.size; ++_i7)
        {
          _elem6 = new SendMessageBatchRequestEntry();
          _elem6.read(iprot);
          struct.sendMessageBatchRequestEntryList.add(_elem6);
        }
      }
      struct.setSendMessageBatchRequestEntryListIsSet(true);
    }
