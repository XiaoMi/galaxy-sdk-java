...
public class SendMessageBatchRequest implements libthrift091.TBase<SendMessageBatchRequest, SendMessageBatchRequest._Fields>, java.io.Serializable, Cloneable, Comparable<SendMessageBatchRequest> {
  ...
  private static final libthrift091.protocol.TField TOPIC_FIELD_DESC = new libthrift091.protocol.TField("topic", libthrift091.protocol.TType.STRING, (short)3);
  ...
  private static final _Fields optionals[] = {_Fields.TOPIC};
   ...
   * 
   */
  public SendMessageBatchRequest setTopic(String topic) {
    this.topic = topic;
    return this;
  }
