            ...
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                ...
                struct.sendMessageBatchRequestEntryList = new ArrayList<SendMessageBatchRequestEntry>(_list16.size);
                SendMessageBatchRequestEntry _elem17;
                for (int _i18 = 0; _i18 < _list16.size; ++_i18)
                {
                  _elem17 = new SendMessageBatchRequestEntry();
                  _elem17.read(iprot);
                  struct.sendMessageBatchRequestEntryList.add(_elem17);
                }
                iprot.readListEnd();
              }
    ...
    public void write(libthrift091.protocol.TProtocol oprot, SendMessageBatchRequest struct) throws libthrift091.TException {
      ...
      if (struct.sendMessageBatchRequestEntryList != null) {
        oprot.writeFieldBegin(SEND_MESSAGE_BATCH_REQUEST_ENTRY_LIST_FIELD_DESC);
        {
          ...
          for (SendMessageBatchRequestEntry _iter19 : struct.sendMessageBatchRequestEntryList)
          {
            _iter19.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class SendMessageBatchRequestTupleScheme extends TupleScheme<SendMessageBatchRequest> {
    ...
    public void write(libthrift091.protocol.TProtocol prot, SendMessageBatchRequest struct) throws libthrift091.TException {
      ...
      oprot.writeString(struct.queueName);
      {
        ...
        for (SendMessageBatchRequestEntry _iter20 : struct.sendMessageBatchRequestEntryList)
        {
          _iter20.write(oprot);
        }
      }
    ...
    public void read(libthrift091.protocol.TProtocol prot, SendMessageBatchRequest struct) throws libthrift091.TException {
      ...
      struct.setQueueNameIsSet(true);
      {
        ...
        struct.sendMessageBatchRequestEntryList = new ArrayList<SendMessageBatchRequestEntry>(_list21.size);
        SendMessageBatchRequestEntry _elem22;
        for (int _i23 = 0; _i23 < _list21.size; ++_i23)
        {
          _elem22 = new SendMessageBatchRequestEntry();
          _elem22.read(iprot);
          struct.sendMessageBatchRequestEntryList.add(_elem22);
        }
      }
      struct.setSendMessageBatchRequestEntryListIsSet(true);
    }
