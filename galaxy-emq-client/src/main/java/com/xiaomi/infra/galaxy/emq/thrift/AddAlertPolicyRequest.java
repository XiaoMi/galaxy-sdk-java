...
public class AddAlertPolicyRequest implements libthrift091.TBase<AddAlertPolicyRequest, AddAlertPolicyRequest._Fields>, java.io.Serializable, Cloneable, Comparable<AddAlertPolicyRequest> {
  private static final libthrift091.protocol.TStruct STRUCT_DESC = new libthrift091.protocol.TStruct("AddAlertPolicyRequest");
  ...
  static {
    schemes.put(StandardScheme.class, new AddAlertPolicyRequestStandardSchemeFactory());
    schemes.put(TupleScheme.class, new AddAlertPolicyRequestTupleSchemeFactory());
  }
  ...
  static {
    ...
    libthrift091.meta_data.FieldMetaData.addStructMetaDataMap(AddAlertPolicyRequest.class, metaDataMap);
  }

  public AddAlertPolicyRequest() {
  }
   ...
   */
  public AddAlertPolicyRequest(AddAlertPolicyRequest other) {
  ...
  public AddAlertPolicyRequest deepCopy() {
    return new AddAlertPolicyRequest(this);
  }
   ...
   *  
   */
  public AddAlertPolicyRequest setQueueName(String queueName) {
    this.queueName = queueName;
    return this;
  }
   ...
   *  
   */
  public AddAlertPolicyRequest setAlertPolicy(AlertPolicy alertPolicy) {
    this.alertPolicy = alertPolicy;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof AddAlertPolicyRequest)
      return this.equals((AddAlertPolicyRequest)that);
    return false;
  }

  public boolean equals(AddAlertPolicyRequest that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(AddAlertPolicyRequest other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("AddAlertPolicyRequest(");
    boolean first = true;
  ...
  private static class AddAlertPolicyRequestStandardSchemeFactory implements SchemeFactory {
    public AddAlertPolicyRequestStandardScheme getScheme() {
      return new AddAlertPolicyRequestStandardScheme();
    }
  }

  private static class AddAlertPolicyRequestStandardScheme extends StandardScheme<AddAlertPolicyRequest> {

    public void read(libthrift091.protocol.TProtocol iprot, AddAlertPolicyRequest struct) throws libthrift091.TException {
    ...
    public void write(libthrift091.protocol.TProtocol oprot, AddAlertPolicyRequest struct) throws libthrift091.TException {
      struct.validate();
  ...
  private static class AddAlertPolicyRequestTupleSchemeFactory implements SchemeFactory {
    public AddAlertPolicyRequestTupleScheme getScheme() {
      return new AddAlertPolicyRequestTupleScheme();
    }
  }

  private static class AddAlertPolicyRequestTupleScheme extends TupleScheme<AddAlertPolicyRequest> {

    @Override
    public void write(libthrift091.protocol.TProtocol prot, AddAlertPolicyRequest struct) throws libthrift091.TException {
    ...
    @Override
    public void read(libthrift091.protocol.TProtocol prot, AddAlertPolicyRequest struct) throws libthrift091.TException {
