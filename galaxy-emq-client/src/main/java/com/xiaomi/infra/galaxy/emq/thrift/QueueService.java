...
public class QueueService {
  ...
  public static class Processor<I extends Iface> extends com.xiaomi.infra.galaxy.emq.thrift.EMQBaseService.Processor<I> implements libthrift091.TProcessor {
    ...
    public static class listDeadLetterSourceQueues<I extends Iface> extends libthrift091.ProcessFunction<I, listDeadLetterSourceQueues_args> {
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends com.xiaomi.infra.galaxy.emq.thrift.EMQBaseService.AsyncProcessor<I> {
    ...
    public static class listDeadLetterSourceQueues<I extends AsyncIface> extends libthrift091.AsyncProcessFunction<I, listDeadLetterSourceQueues_args, ListDeadLetterSourceQueuesResponse> {
      public listDeadLetterSourceQueues() {
        super("listDeadLetterSourceQueues");
      }
      ...
      public AsyncMethodCallback<ListDeadLetterSourceQueuesResponse> getResultHandler(final AsyncFrameBuffer fb, final int seqid) {
        final libthrift091.AsyncProcessFunction fcall = this;
        return new AsyncMethodCallback<ListDeadLetterSourceQueuesResponse>() { 
      ...
      public void start(I iface, listDeadLetterSourceQueues_args args, libthrift091.async.AsyncMethodCallback<ListDeadLetterSourceQueuesResponse> resultHandler) throws TException {
  ...
  public static class listDeadLetterSourceQueues_args implements libthrift091.TBase<listDeadLetterSourceQueues_args, listDeadLetterSourceQueues_args._Fields>, java.io.Serializable, Cloneable, Comparable<listDeadLetterSourceQueues_args>   {
    private static final libthrift091.protocol.TStruct STRUCT_DESC = new libthrift091.protocol.TStruct("listDeadLetterSourceQueues_args");

    private static final libthrift091.protocol.TField REQUEST_FIELD_DESC = new libthrift091.protocol.TField("request", libthrift091.protocol.TType.STRUCT, (short)1);

    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new listDeadLetterSourceQueues_argsStandardSchemeFactory());
      schemes.put(TupleScheme.class, new listDeadLetterSourceQueues_argsTupleSchemeFactory());
    }

    public ListDeadLetterSourceQueuesRequest request; // required
    ...
    static {
      Map<_Fields, libthrift091.meta_data.FieldMetaData> tmpMap = new EnumMap<_Fields, libthrift091.meta_data.FieldMetaData>(_Fields.class);
      tmpMap.put(_Fields.REQUEST, new libthrift091.meta_data.FieldMetaData("request", libthrift091.TFieldRequirementType.DEFAULT, 
          new libthrift091.meta_data.StructMetaData(libthrift091.protocol.TType.STRUCT, ListDeadLetterSourceQueuesRequest.class)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      libthrift091.meta_data.FieldMetaData.addStructMetaDataMap(listDeadLetterSourceQueues_args.class, metaDataMap);
    }

    public listDeadLetterSourceQueues_args() {
    }
     ...
     * Performs a deep copy on <i>other</i>.
     */
    public listDeadLetterSourceQueues_args(listDeadLetterSourceQueues_args other) {
      if (other.isSetRequest()) {
        this.request = new ListDeadLetterSourceQueuesRequest(other.request);
      }
    }

    public listDeadLetterSourceQueues_args deepCopy() {
      return new listDeadLetterSourceQueues_args(this);
    }
    ...
    public ListDeadLetterSourceQueuesRequest getRequest() {
      return this.request;
    }

    public listDeadLetterSourceQueues_args setRequest(ListDeadLetterSourceQueuesRequest request) {
      this.request = request;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case REQUEST:
        if (value == null) {
          ...
          setRequest((ListDeadLetterSourceQueuesRequest)value);
        }
        break;
    ...
    public boolean equals(Object that) {
      if (that == null)
        return false;
      if (that instanceof listDeadLetterSourceQueues_args)
        return this.equals((listDeadLetterSourceQueues_args)that);
      return false;
    }

    public boolean equals(listDeadLetterSourceQueues_args that) {
      if (that == null)
        return false;
    ...
    @Override
    public int compareTo(listDeadLetterSourceQueues_args other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("listDeadLetterSourceQueues_args(");
      boolean first = true;
    ...
    private static class listDeadLetterSourceQueues_argsStandardSchemeFactory implements SchemeFactory {
      public listDeadLetterSourceQueues_argsStandardScheme getScheme() {
        return new listDeadLetterSourceQueues_argsStandardScheme();
      }
    }

    private static class listDeadLetterSourceQueues_argsStandardScheme extends StandardScheme<listDeadLetterSourceQueues_args> {

      public void read(libthrift091.protocol.TProtocol iprot, listDeadLetterSourceQueues_args struct) throws libthrift091.TException {
        libthrift091.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
          ...
          switch (schemeField.id) {
            case 1: // REQUEST
              if (schemeField.type == libthrift091.protocol.TType.STRUCT) {
                struct.request = new ListDeadLetterSourceQueuesRequest();
                struct.request.read(iprot);
                struct.setRequestIsSet(true);
              } else { 
                libthrift091.protocol.TProtocolUtil.skip(iprot, schemeField.type);
      ...
      public void write(libthrift091.protocol.TProtocol oprot, listDeadLetterSourceQueues_args struct) throws libthrift091.TException {
        struct.validate();
    ...
    private static class listDeadLetterSourceQueues_argsTupleSchemeFactory implements SchemeFactory {
      public listDeadLetterSourceQueues_argsTupleScheme getScheme() {
        return new listDeadLetterSourceQueues_argsTupleScheme();
      }
    }

    private static class listDeadLetterSourceQueues_argsTupleScheme extends TupleScheme<listDeadLetterSourceQueues_args> {

      @Override
      public void write(libthrift091.protocol.TProtocol prot, listDeadLetterSourceQueues_args struct) throws libthrift091.TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetRequest()) {
          optionals.set(0);
      ...
      @Override
      public void read(libthrift091.protocol.TProtocol prot, listDeadLetterSourceQueues_args struct) throws libthrift091.TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(1);
        if (incoming.get(0)) {
          struct.request = new ListDeadLetterSourceQueuesRequest();
  ...
  public static class listDeadLetterSourceQueues_result implements libthrift091.TBase<listDeadLetterSourceQueues_result, listDeadLetterSourceQueues_result._Fields>, java.io.Serializable, Cloneable, Comparable<listDeadLetterSourceQueues_result>   {
    private static final libthrift091.protocol.TStruct STRUCT_DESC = new libthrift091.protocol.TStruct("listDeadLetterSourceQueues_result");
    ...
    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new listDeadLetterSourceQueues_resultStandardSchemeFactory());
      schemes.put(TupleScheme.class, new listDeadLetterSourceQueues_resultTupleSchemeFactory());
    }

    public ListDeadLetterSourceQueuesResponse success; // required
    public com.xiaomi.infra.galaxy.emq.thrift.GalaxyEmqServiceException e; // required
    ...
    static {
      Map<_Fields, libthrift091.meta_data.FieldMetaData> tmpMap = new EnumMap<_Fields, libthrift091.meta_data.FieldMetaData>(_Fields.class);
      tmpMap.put(_Fields.SUCCESS, new libthrift091.meta_data.FieldMetaData("success", libthrift091.TFieldRequirementType.DEFAULT, 
          new libthrift091.meta_data.StructMetaData(libthrift091.protocol.TType.STRUCT, ListDeadLetterSourceQueuesResponse.class)));
      tmpMap.put(_Fields.E, new libthrift091.meta_data.FieldMetaData("e", libthrift091.TFieldRequirementType.DEFAULT, 
          new libthrift091.meta_data.FieldValueMetaData(libthrift091.protocol.TType.STRUCT)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      libthrift091.meta_data.FieldMetaData.addStructMetaDataMap(listDeadLetterSourceQueues_result.class, metaDataMap);
    }

    public listDeadLetterSourceQueues_result() {
    }

    public listDeadLetterSourceQueues_result(
      ListDeadLetterSourceQueuesResponse success,
      com.xiaomi.infra.galaxy.emq.thrift.GalaxyEmqServiceException e)
    {
      this();
      this.success = success;
     ...
     * Performs a deep copy on <i>other</i>.
     */
    public listDeadLetterSourceQueues_result(listDeadLetterSourceQueues_result other) {
      if (other.isSetSuccess()) {
        this.success = new ListDeadLetterSourceQueuesResponse(other.success);
      }
      if (other.isSetE()) {
        this.e = new com.xiaomi.infra.galaxy.emq.thrift.GalaxyEmqServiceException(other.e);
      }
    ...
    public listDeadLetterSourceQueues_result deepCopy() {
      return new listDeadLetterSourceQueues_result(this);
    }
    ...
    public ListDeadLetterSourceQueuesResponse getSuccess() {
      return this.success;
    }

    public listDeadLetterSourceQueues_result setSuccess(ListDeadLetterSourceQueuesResponse success) {
      this.success = success;
      return this;
    }
    ...
    public listDeadLetterSourceQueues_result setE(com.xiaomi.infra.galaxy.emq.thrift.GalaxyEmqServiceException e) {
      this.e = e;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case SUCCESS:
        if (value == null) {
          ...
          setSuccess((ListDeadLetterSourceQueuesResponse)value);
        }
        break;
    ...
    public boolean equals(Object that) {
      if (that == null)
        return false;
      if (that instanceof listDeadLetterSourceQueues_result)
        return this.equals((listDeadLetterSourceQueues_result)that);
      return false;
    }

    public boolean equals(listDeadLetterSourceQueues_result that) {
      if (that == null)
        return false;
    ...
    @Override
    public int compareTo(listDeadLetterSourceQueues_result other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("listDeadLetterSourceQueues_result(");
      boolean first = true;
    ...
    private static class listDeadLetterSourceQueues_resultStandardSchemeFactory implements SchemeFactory {
      public listDeadLetterSourceQueues_resultStandardScheme getScheme() {
        return new listDeadLetterSourceQueues_resultStandardScheme();
      }
    }

    private static class listDeadLetterSourceQueues_resultStandardScheme extends StandardScheme<listDeadLetterSourceQueues_result> {

      public void read(libthrift091.protocol.TProtocol iprot, listDeadLetterSourceQueues_result struct) throws libthrift091.TException {
        libthrift091.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
          ...
          switch (schemeField.id) {
            case 0: // SUCCESS
              if (schemeField.type == libthrift091.protocol.TType.STRUCT) {
                struct.success = new ListDeadLetterSourceQueuesResponse();
                struct.success.read(iprot);
                struct.setSuccessIsSet(true);
              } else { 
                libthrift091.protocol.TProtocolUtil.skip(iprot, schemeField.type);
      ...
      public void write(libthrift091.protocol.TProtocol oprot, listDeadLetterSourceQueues_result struct) throws libthrift091.TException {
        struct.validate();
    ...
    private static class listDeadLetterSourceQueues_resultTupleSchemeFactory implements SchemeFactory {
      public listDeadLetterSourceQueues_resultTupleScheme getScheme() {
        return new listDeadLetterSourceQueues_resultTupleScheme();
      }
    }

    private static class listDeadLetterSourceQueues_resultTupleScheme extends TupleScheme<listDeadLetterSourceQueues_result> {

      @Override
      public void write(libthrift091.protocol.TProtocol prot, listDeadLetterSourceQueues_result struct) throws libthrift091.TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetSuccess()) {
          optionals.set(0);
      ...
      @Override
      public void read(libthrift091.protocol.TProtocol prot, listDeadLetterSourceQueues_result struct) throws libthrift091.TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(2);
        if (incoming.get(0)) {
          struct.success = new ListDeadLetterSourceQueuesResponse();
