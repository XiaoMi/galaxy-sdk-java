...
public class SendMessageBatchRequestEntry implements libthrift091.TBase<SendMessageBatchRequestEntry, SendMessageBatchRequestEntry._Fields>, java.io.Serializable, Cloneable, Comparable<SendMessageBatchRequestEntry> {
  ...
  private static final libthrift091.protocol.TField MESSAGE_ATTRIBUTES_FIELD_DESC = new libthrift091.protocol.TField("messageAttributes", libthrift091.protocol.TType.LIST, (short)5);
  ...
  private static final _Fields optionals[] = {_Fields.DELAY_SECONDS,_Fields.INVISIBILITY_SECONDS,_Fields.MESSAGE_ATTRIBUTES};
   ...
   * 
   */
  public SendMessageBatchRequestEntry setMessageAttributes(List<MessageAttribute> messageAttributes) {
            ...
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                ...
                struct.messageAttributes = new ArrayList<MessageAttribute>(_list8.size);
                MessageAttribute _elem9;
                for (int _i10 = 0; _i10 < _list8.size; ++_i10)
                {
                  _elem9 = new MessageAttribute();
                  _elem9.read(iprot);
                  struct.messageAttributes.add(_elem9);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.messageAttributes != null) {
        if (struct.isSetMessageAttributes()) {
          oprot.writeFieldBegin(MESSAGE_ATTRIBUTES_FIELD_DESC);
          {
            ...
            for (MessageAttribute _iter11 : struct.messageAttributes)
            {
              _iter11.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.isSetMessageAttributes()) {
        {
          ...
          for (MessageAttribute _iter12 : struct.messageAttributes)
          {
            _iter12.write(oprot);
          }
        }
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.messageAttributes = new ArrayList<MessageAttribute>(_list13.size);
          MessageAttribute _elem14;
          for (int _i15 = 0; _i15 < _list13.size; ++_i15)
          {
            _elem14 = new MessageAttribute();
            _elem14.read(iprot);
            struct.messageAttributes.add(_elem14);
          }
        }
        struct.setMessageAttributesIsSet(true);
      }
