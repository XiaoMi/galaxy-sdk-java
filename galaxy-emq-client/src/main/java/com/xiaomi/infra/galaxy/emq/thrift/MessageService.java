              ...
              if (schemeField.type == libthrift091.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<ReceiveMessageResponse>(_list96.size);
                  ReceiveMessageResponse _elem97;
                  for (int _i98 = 0; _i98 < _list96.size; ++_i98)
                  {
                    _elem97 = new ReceiveMessageResponse();
                    _elem97.read(iprot);
      ...
      public void write(libthrift091.protocol.TProtocol oprot, receiveMessage_result struct) throws libthrift091.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (ReceiveMessageResponse _iter99 : struct.success)
            {
              _iter99.write(oprot);
            }
            oprot.writeListEnd();
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (ReceiveMessageResponse _iter100 : struct.success)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<ReceiveMessageResponse>(_list101.size);
            ReceiveMessageResponse _elem102;
            for (int _i103 = 0; _i103 < _list101.size; ++_i103)
            {
              _elem102 = new ReceiveMessageResponse();
              _elem102.read(iprot);
