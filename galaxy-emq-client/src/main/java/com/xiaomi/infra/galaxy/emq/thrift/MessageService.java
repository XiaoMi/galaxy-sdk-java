              ...
              if (schemeField.type == libthrift091.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<ReceiveMessageResponse>(_list112.size);
                  ReceiveMessageResponse _elem113;
                  for (int _i114 = 0; _i114 < _list112.size; ++_i114)
                  {
                    _elem113 = new ReceiveMessageResponse();
                    _elem113.read(iprot);
      ...
      public void write(libthrift091.protocol.TProtocol oprot, receiveMessage_result struct) throws libthrift091.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (ReceiveMessageResponse _iter115 : struct.success)
            {
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (ReceiveMessageResponse _iter116 : struct.success)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<ReceiveMessageResponse>(_list117.size);
            ReceiveMessageResponse _elem118;
            for (int _i119 = 0; _i119 < _list117.size; ++_i119)
            {
              _elem118 = new ReceiveMessageResponse();
              _elem118.read(iprot);
