...
public class SendMessageResponse implements libthrift091.TBase<SendMessageResponse, SendMessageResponse._Fields>, java.io.Serializable, Cloneable, Comparable<SendMessageResponse> {
  ...
  private static final libthrift091.protocol.TField BODY_LENGTH_FIELD_DESC = new libthrift091.protocol.TField("bodyLength", libthrift091.protocol.TType.I32, (short)2);
  private static final libthrift091.protocol.TField BODY_MD5_FIELD_DESC = new libthrift091.protocol.TField("bodyMd5", libthrift091.protocol.TType.STRING, (short)3);
  private static final libthrift091.protocol.TField SEND_TIMESTAMP_FIELD_DESC = new libthrift091.protocol.TField("sendTimestamp", libthrift091.protocol.TType.I64, (short)4);
  ...
  public enum _Fields implements libthrift091.TFieldIdEnum {
     ...
     * 
     */
    BODY_LENGTH((short)2, "bodyLength"),
    /**
     * MD5 string of the message body
     * 
     */
    BODY_MD5((short)3, "bodyMd5"),
    /**
     * timestamp when the message arrived servers
     * 
     */
    SEND_TIMESTAMP((short)4, "sendTimestamp");
   ...
   * 
   */
  public SendMessageResponse setBodyLength(int bodyLength) {
   ...
   * 
   */
  public SendMessageResponse setBodyMd5(String bodyMd5) {
   ...
   * 
   */
  public SendMessageResponse setSendTimestamp(long sendTimestamp) {
