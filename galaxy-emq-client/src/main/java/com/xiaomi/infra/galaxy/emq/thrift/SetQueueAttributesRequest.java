...
public class SetQueueAttributesRequest implements libthrift091.TBase<SetQueueAttributesRequest, SetQueueAttributesRequest._Fields>, java.io.Serializable, Cloneable, Comparable<SetQueueAttributesRequest> {
  private static final libthrift091.protocol.TStruct STRUCT_DESC = new libthrift091.protocol.TStruct("SetQueueAttributesRequest");
  ...
  static {
    schemes.put(StandardScheme.class, new SetQueueAttributesRequestStandardSchemeFactory());
    schemes.put(TupleScheme.class, new SetQueueAttributesRequestTupleSchemeFactory());
  }
  ...
  private static final _Fields optionals[] = {_Fields.QUEUE_ATTRIBUTE};
  ...
  static {
    ...
    libthrift091.meta_data.FieldMetaData.addStructMetaDataMap(SetQueueAttributesRequest.class, metaDataMap);
  }
   ...
   */
  public SetQueueAttributesRequest(SetQueueAttributesRequest other) {
  ...
  public SetQueueAttributesRequest deepCopy() {
   ...
   * 
   */
  public SetQueueAttributesRequest setQueueAttribute(QueueAttribute queueAttribute) {
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof SetQueueAttributesRequest)
      return this.equals((SetQueueAttributesRequest)that);
    return false;
  }

  public boolean equals(SetQueueAttributesRequest that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(SetQueueAttributesRequest other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("SetQueueAttributesRequest(");
    boolean first = true;
  ...
  private static class SetQueueAttributesRequestStandardSchemeFactory implements SchemeFactory {
    public SetQueueAttributesRequestStandardScheme getScheme() {
      return new SetQueueAttributesRequestStandardScheme();
    }
  }

  private static class SetQueueAttributesRequestStandardScheme extends StandardScheme<SetQueueAttributesRequest> {

    public void read(libthrift091.protocol.TProtocol iprot, SetQueueAttributesRequest struct) throws libthrift091.TException {
    ...
    public void write(libthrift091.protocol.TProtocol oprot, SetQueueAttributesRequest struct) throws libthrift091.TException {
      struct.validate();
  ...
  private static class SetQueueAttributesRequestTupleSchemeFactory implements SchemeFactory {
    public SetQueueAttributesRequestTupleScheme getScheme() {
      return new SetQueueAttributesRequestTupleScheme();
    }
  }

  private static class SetQueueAttributesRequestTupleScheme extends TupleScheme<SetQueueAttributesRequest> {

    @Override
    public void write(libthrift091.protocol.TProtocol prot, SetQueueAttributesRequest struct) throws libthrift091.TException {
    ...
    @Override
    public void read(libthrift091.protocol.TProtocol prot, SetQueueAttributesRequest struct) throws libthrift091.TException {
