...
public class AlertPolicy implements libthrift091.TBase<AlertPolicy, AlertPolicy._Fields>, java.io.Serializable, Cloneable, Comparable<AlertPolicy> {
  ...
  private static final libthrift091.protocol.TField OPERATION_FIELD_DESC = new libthrift091.protocol.TField("operation", libthrift091.protocol.TType.I32, (short)1);
  ...
  static {
    ...
    tmpMap.put(_Fields.OPERATION, new libthrift091.meta_data.FieldMetaData("operation", libthrift091.TFieldRequirementType.REQUIRED, 
        new libthrift091.meta_data.EnumMetaData(libthrift091.protocol.TType.ENUM, OPERATION.class)));
   ...
   * @see OPERATION
   */
  public AlertPolicy setOperation(OPERATION operation) {
    this.operation = operation;
    return this;
  }
  ...
  public int compareTo(AlertPolicy other) {
    ...
    if (isSetOperation()) {
      lastComparison = libthrift091.TBaseHelper.compareTo(this.operation, other.operation);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public void validate() throws libthrift091.TException {
    ...
    if (operation == null) {
      throw new libthrift091.protocol.TProtocolException("Required field 'operation' was not present! Struct: " + toString());
    }
    if (measurement == null) {
        ...
        switch (schemeField.id) {
          case 1: // OPERATION
            if (schemeField.type == libthrift091.protocol.TType.I32) {
              struct.operation = com.xiaomi.infra.galaxy.emq.thrift.OPERATION.findByValue(iprot.readI32());
