...
public class SendMessageRequest implements libthrift091.TBase<SendMessageRequest, SendMessageRequest._Fields>, java.io.Serializable, Cloneable, Comparable<SendMessageRequest> {
   ...
   * 
   */
  public SendMessageRequest setMessageAttributes(Map<String,com.xiaomi.infra.galaxy.emq.thrift.MessageAttribute> messageAttributes) {
            ...
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                ...
                struct.messageAttributes = new HashMap<String,com.xiaomi.infra.galaxy.emq.thrift.MessageAttribute>(2*_map0.size);
                String _key1;
                com.xiaomi.infra.galaxy.emq.thrift.MessageAttribute _val2;
                for (int _i3 = 0; _i3 < _map0.size; ++_i3)
                {
                  _key1 = iprot.readString();
                  _val2 = new com.xiaomi.infra.galaxy.emq.thrift.MessageAttribute();
                  _val2.read(iprot);
      ...
      if (struct.messageAttributes != null) {
        if (struct.isSetMessageAttributes()) {
          oprot.writeFieldBegin(MESSAGE_ATTRIBUTES_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, com.xiaomi.infra.galaxy.emq.thrift.MessageAttribute> _iter4 : struct.messageAttributes.entrySet())
            {
      ...
      if (struct.isSetMessageAttributes()) {
        {
          ...
          for (Map.Entry<String, com.xiaomi.infra.galaxy.emq.thrift.MessageAttribute> _iter5 : struct.messageAttributes.entrySet())
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.messageAttributes = new HashMap<String,com.xiaomi.infra.galaxy.emq.thrift.MessageAttribute>(2*_map6.size);
          String _key7;
          com.xiaomi.infra.galaxy.emq.thrift.MessageAttribute _val8;
          for (int _i9 = 0; _i9 < _map6.size; ++_i9)
          {
            _key7 = iprot.readString();
            _val8 = new com.xiaomi.infra.galaxy.emq.thrift.MessageAttribute();
            _val8.read(iprot);
