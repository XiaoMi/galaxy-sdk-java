...
public class SendMessageRequest implements libthrift091.TBase<SendMessageRequest, SendMessageRequest._Fields>, java.io.Serializable, Cloneable, Comparable<SendMessageRequest> {
   ...
   * 
   */
  public SendMessageRequest setMessageAttributes(List<MessageAttribute> messageAttributes) {
            ...
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                ...
                struct.messageAttributes = new ArrayList<MessageAttribute>(_list0.size);
                MessageAttribute _elem1;
                for (int _i2 = 0; _i2 < _list0.size; ++_i2)
                {
                  _elem1 = new MessageAttribute();
                  _elem1.read(iprot);
                  struct.messageAttributes.add(_elem1);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.messageAttributes != null) {
        if (struct.isSetMessageAttributes()) {
          oprot.writeFieldBegin(MESSAGE_ATTRIBUTES_FIELD_DESC);
          {
            ...
            for (MessageAttribute _iter3 : struct.messageAttributes)
            {
              _iter3.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.isSetMessageAttributes()) {
        {
          ...
          for (MessageAttribute _iter4 : struct.messageAttributes)
          {
            _iter4.write(oprot);
          }
        }
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.messageAttributes = new ArrayList<MessageAttribute>(_list5.size);
          MessageAttribute _elem6;
          for (int _i7 = 0; _i7 < _list5.size; ++_i7)
          {
            _elem6 = new MessageAttribute();
            _elem6.read(iprot);
            struct.messageAttributes.add(_elem6);
          }
        }
        struct.setMessageAttributesIsSet(true);
      }
