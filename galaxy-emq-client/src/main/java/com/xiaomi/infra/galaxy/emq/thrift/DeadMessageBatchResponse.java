...
public class DeadMessageBatchResponse implements libthrift091.TBase<DeadMessageBatchResponse, DeadMessageBatchResponse._Fields>, java.io.Serializable, Cloneable, Comparable<DeadMessageBatchResponse> {
  private static final libthrift091.protocol.TStruct STRUCT_DESC = new libthrift091.protocol.TStruct("DeadMessageBatchResponse");
  ...
  static {
    schemes.put(StandardScheme.class, new DeadMessageBatchResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new DeadMessageBatchResponseTupleSchemeFactory());
  }
  ...
  static {
    ...
    libthrift091.meta_data.FieldMetaData.addStructMetaDataMap(DeadMessageBatchResponse.class, metaDataMap);
  }

  public DeadMessageBatchResponse() {
  }
   ...
   */
  public DeadMessageBatchResponse(DeadMessageBatchResponse other) {
  ...
  public DeadMessageBatchResponse deepCopy() {
    return new DeadMessageBatchResponse(this);
  }
   ...
   * 
   */
  public DeadMessageBatchResponse setSuccessful(List<String> successful) {
    this.successful = successful;
    return this;
  }
   ...
   * 
   */
  public DeadMessageBatchResponse setFailed(List<MessageBatchErrorEntry> failed) {
    this.failed = failed;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof DeadMessageBatchResponse)
      return this.equals((DeadMessageBatchResponse)that);
    return false;
  }

  public boolean equals(DeadMessageBatchResponse that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(DeadMessageBatchResponse other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("DeadMessageBatchResponse(");
    boolean first = true;
  ...
  private static class DeadMessageBatchResponseStandardSchemeFactory implements SchemeFactory {
    public DeadMessageBatchResponseStandardScheme getScheme() {
      return new DeadMessageBatchResponseStandardScheme();
    }
  }

  private static class DeadMessageBatchResponseStandardScheme extends StandardScheme<DeadMessageBatchResponse> {

    public void read(libthrift091.protocol.TProtocol iprot, DeadMessageBatchResponse struct) throws libthrift091.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                ...
                struct.successful = new ArrayList<String>(_list120.size);
                String _elem121;
                for (int _i122 = 0; _i122 < _list120.size; ++_i122)
                {
                  _elem121 = iprot.readString();
                  struct.successful.add(_elem121);
                }
                iprot.readListEnd();
              }
          ...
          case 2: // FAILED
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                libthrift091.protocol.TList _list123 = iprot.readListBegin();
                struct.failed = new ArrayList<MessageBatchErrorEntry>(_list123.size);
                MessageBatchErrorEntry _elem124;
                for (int _i125 = 0; _i125 < _list123.size; ++_i125)
                {
                  _elem124 = new MessageBatchErrorEntry();
                  _elem124.read(iprot);
                  struct.failed.add(_elem124);
                }
                iprot.readListEnd();
              }
    ...
    public void write(libthrift091.protocol.TProtocol oprot, DeadMessageBatchResponse struct) throws libthrift091.TException {
      struct.validate();
      ...
      if (struct.successful != null) {
        oprot.writeFieldBegin(SUCCESSFUL_FIELD_DESC);
        {
          ...
          for (String _iter126 : struct.successful)
          {
      ...
      if (struct.failed != null) {
        oprot.writeFieldBegin(FAILED_FIELD_DESC);
        {
          ...
          for (MessageBatchErrorEntry _iter127 : struct.failed)
          {
  ...
  private static class DeadMessageBatchResponseTupleSchemeFactory implements SchemeFactory {
    public DeadMessageBatchResponseTupleScheme getScheme() {
      return new DeadMessageBatchResponseTupleScheme();
    }
  }

  private static class DeadMessageBatchResponseTupleScheme extends TupleScheme<DeadMessageBatchResponse> {

    @Override
    public void write(libthrift091.protocol.TProtocol prot, DeadMessageBatchResponse struct) throws libthrift091.TException {
      ...
      if (struct.isSetSuccessful()) {
        {
          ...
          for (String _iter128 : struct.successful)
          {
      ...
      if (struct.isSetFailed()) {
        {
          ...
          for (MessageBatchErrorEntry _iter129 : struct.failed)
          {
    ...
    @Override
    public void read(libthrift091.protocol.TProtocol prot, DeadMessageBatchResponse struct) throws libthrift091.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      BitSet incoming = iprot.readBitSet(2);
      if (incoming.get(0)) {
        {
          libthrift091.protocol.TList _list130 = new libthrift091.protocol.TList(libthrift091.protocol.TType.STRING, iprot.readI32());
          struct.successful = new ArrayList<String>(_list130.size);
          String _elem131;
          for (int _i132 = 0; _i132 < _list130.size; ++_i132)
          {
            _elem131 = iprot.readString();
            struct.successful.add(_elem131);
          }
        }
        struct.setSuccessfulIsSet(true);
      }
      if (incoming.get(1)) {
        {
          libthrift091.protocol.TList _list133 = new libthrift091.protocol.TList(libthrift091.protocol.TType.STRUCT, iprot.readI32());
          struct.failed = new ArrayList<MessageBatchErrorEntry>(_list133.size);
          MessageBatchErrorEntry _elem134;
          for (int _i135 = 0; _i135 < _list133.size; ++_i135)
          {
            _elem134 = new MessageBatchErrorEntry();
            _elem134.read(iprot);
            struct.failed.add(_elem134);
          }
        }
        struct.setFailedIsSet(true);
      }
