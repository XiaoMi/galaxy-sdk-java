...
public class TimeIntervalAndMaxNum implements libthrift091.TBase<TimeIntervalAndMaxNum, TimeIntervalAndMaxNum._Fields>, java.io.Serializable, Cloneable, Comparable<TimeIntervalAndMaxNum> {
  private static final libthrift091.protocol.TStruct STRUCT_DESC = new libthrift091.protocol.TStruct("TimeIntervalAndMaxNum");
  ...
  static {
    schemes.put(StandardScheme.class, new TimeIntervalAndMaxNumStandardSchemeFactory());
    schemes.put(TupleScheme.class, new TimeIntervalAndMaxNumTupleSchemeFactory());
  }
  ...
  static {
    ...
    libthrift091.meta_data.FieldMetaData.addStructMetaDataMap(TimeIntervalAndMaxNum.class, metaDataMap);
  }

  public TimeIntervalAndMaxNum() {
  }

  /**
   * Performs a deep copy on <i>other</i>.
   */
  public TimeIntervalAndMaxNum(TimeIntervalAndMaxNum other) {
  ...
  public TimeIntervalAndMaxNum deepCopy() {
    return new TimeIntervalAndMaxNum(this);
  }
   ...
   * 
   */
  public TimeIntervalAndMaxNum setStartTimestamp(long startTimestamp) {
   ...
   * 
   */
  public TimeIntervalAndMaxNum setEndTimestamp(long endTimestamp) {
   ...
   * 
   */
  public TimeIntervalAndMaxNum setMaxNum(int maxNum) {
    this.maxNum = maxNum;
    setMaxNumIsSet(true);
    return this;
  }
   ...
   * 
   */
  public TimeIntervalAndMaxNum setPartitionId(int partitionId) {
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof TimeIntervalAndMaxNum)
      return this.equals((TimeIntervalAndMaxNum)that);
    return false;
  }

  public boolean equals(TimeIntervalAndMaxNum that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(TimeIntervalAndMaxNum other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TimeIntervalAndMaxNum(");
    boolean first = true;
  ...
  private static class TimeIntervalAndMaxNumStandardSchemeFactory implements SchemeFactory {
    public TimeIntervalAndMaxNumStandardScheme getScheme() {
      return new TimeIntervalAndMaxNumStandardScheme();
    }
  }

  private static class TimeIntervalAndMaxNumStandardScheme extends StandardScheme<TimeIntervalAndMaxNum> {

    public void read(libthrift091.protocol.TProtocol iprot, TimeIntervalAndMaxNum struct) throws libthrift091.TException {
    ...
    public void write(libthrift091.protocol.TProtocol oprot, TimeIntervalAndMaxNum struct) throws libthrift091.TException {
      struct.validate();
  ...
  private static class TimeIntervalAndMaxNumTupleSchemeFactory implements SchemeFactory {
    public TimeIntervalAndMaxNumTupleScheme getScheme() {
      return new TimeIntervalAndMaxNumTupleScheme();
    }
  }

  private static class TimeIntervalAndMaxNumTupleScheme extends TupleScheme<TimeIntervalAndMaxNum> {

    @Override
    public void write(libthrift091.protocol.TProtocol prot, TimeIntervalAndMaxNum struct) throws libthrift091.TException {
    ...
    @Override
    public void read(libthrift091.protocol.TProtocol prot, TimeIntervalAndMaxNum struct) throws libthrift091.TException {
