...
public class ListPermissionsResponse implements libthrift091.TBase<ListPermissionsResponse, ListPermissionsResponse._Fields>, java.io.Serializable, Cloneable, Comparable<ListPermissionsResponse> {
            ...
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                ...
                struct.permissionList = new HashMap<String,Permission>(2*_map8.size);
                String _key9;
                Permission _val10;
                for (int _i11 = 0; _i11 < _map8.size; ++_i11)
                {
                  _key9 = iprot.readString();
                  _val10 = com.xiaomi.infra.galaxy.emq.thrift.Permission.findByValue(iprot.readI32());
                  struct.permissionList.put(_key9, _val10);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(libthrift091.protocol.TProtocol oprot, ListPermissionsResponse struct) throws libthrift091.TException {
      ...
      if (struct.permissionList != null) {
        oprot.writeFieldBegin(PERMISSION_LIST_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, Permission> _iter12 : struct.permissionList.entrySet())
          {
  ...
  private static class ListPermissionsResponseTupleScheme extends TupleScheme<ListPermissionsResponse> {
      ...
      if (struct.isSetPermissionList()) {
        {
          ...
          for (Map.Entry<String, Permission> _iter13 : struct.permissionList.entrySet())
          {
    ...
    public void read(libthrift091.protocol.TProtocol prot, ListPermissionsResponse struct) throws libthrift091.TException {
      ...
      if (incoming.get(0)) {
        {
          libthrift091.protocol.TMap _map14 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.I32, iprot.readI32());
          struct.permissionList = new HashMap<String,Permission>(2*_map14.size);
          String _key15;
          Permission _val16;
          for (int _i17 = 0; _i17 < _map14.size; ++_i17)
          {
            _key15 = iprot.readString();
            _val16 = com.xiaomi.infra.galaxy.emq.thrift.Permission.findByValue(iprot.readI32());
            struct.permissionList.put(_key15, _val16);
          }
        }
        struct.setPermissionListIsSet(true);
      }
