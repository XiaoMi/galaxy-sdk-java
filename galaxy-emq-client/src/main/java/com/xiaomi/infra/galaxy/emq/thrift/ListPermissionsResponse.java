            ...
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                ...
                struct.permissionList = new HashMap<String,Permission>(2*_map18.size);
                String _key19;
                Permission _val20;
                for (int _i21 = 0; _i21 < _map18.size; ++_i21)
                {
                  _key19 = iprot.readString();
                  _val20 = com.xiaomi.infra.galaxy.emq.thrift.Permission.findByValue(iprot.readI32());
                  struct.permissionList.put(_key19, _val20);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(libthrift091.protocol.TProtocol oprot, ListPermissionsResponse struct) throws libthrift091.TException {
      ...
      if (struct.permissionList != null) {
        oprot.writeFieldBegin(PERMISSION_LIST_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, Permission> _iter22 : struct.permissionList.entrySet())
          {
      ...
      if (struct.isSetPermissionList()) {
        {
          ...
          for (Map.Entry<String, Permission> _iter23 : struct.permissionList.entrySet())
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.permissionList = new HashMap<String,Permission>(2*_map24.size);
          String _key25;
          Permission _val26;
          for (int _i27 = 0; _i27 < _map24.size; ++_i27)
          {
            _key25 = iprot.readString();
            _val26 = com.xiaomi.infra.galaxy.emq.thrift.Permission.findByValue(iprot.readI32());
            struct.permissionList.put(_key25, _val26);
          }
        }
        struct.setPermissionListIsSet(true);
      }
