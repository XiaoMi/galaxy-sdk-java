...
public class DeleteMessageBatchResponse implements libthrift091.TBase<DeleteMessageBatchResponse, DeleteMessageBatchResponse._Fields>, java.io.Serializable, Cloneable, Comparable<DeleteMessageBatchResponse> {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                ...
                struct.successful = new ArrayList<String>(_list80.size);
                String _elem81;
                for (int _i82 = 0; _i82 < _list80.size; ++_i82)
                {
                  _elem81 = iprot.readString();
                  struct.successful.add(_elem81);
                }
                iprot.readListEnd();
              }
          ...
          case 2: // FAILED
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                libthrift091.protocol.TList _list83 = iprot.readListBegin();
                struct.failed = new ArrayList<MessageBatchErrorEntry>(_list83.size);
                MessageBatchErrorEntry _elem84;
                for (int _i85 = 0; _i85 < _list83.size; ++_i85)
                {
                  _elem84 = new MessageBatchErrorEntry();
                  _elem84.read(iprot);
                  struct.failed.add(_elem84);
                }
                iprot.readListEnd();
              }
    ...
    public void write(libthrift091.protocol.TProtocol oprot, DeleteMessageBatchResponse struct) throws libthrift091.TException {
      ...
      if (struct.successful != null) {
        oprot.writeFieldBegin(SUCCESSFUL_FIELD_DESC);
        {
          ...
          for (String _iter86 : struct.successful)
          {
      ...
      if (struct.failed != null) {
        oprot.writeFieldBegin(FAILED_FIELD_DESC);
        {
          ...
          for (MessageBatchErrorEntry _iter87 : struct.failed)
          {
            _iter87.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class DeleteMessageBatchResponseTupleScheme extends TupleScheme<DeleteMessageBatchResponse> {
      ...
      if (struct.isSetSuccessful()) {
        {
          ...
          for (String _iter88 : struct.successful)
          {
      ...
      if (struct.isSetFailed()) {
        {
          ...
          for (MessageBatchErrorEntry _iter89 : struct.failed)
          {
            _iter89.write(oprot);
          }
        }
    ...
    public void read(libthrift091.protocol.TProtocol prot, DeleteMessageBatchResponse struct) throws libthrift091.TException {
      ...
      if (incoming.get(0)) {
        {
          libthrift091.protocol.TList _list90 = new libthrift091.protocol.TList(libthrift091.protocol.TType.STRING, iprot.readI32());
          struct.successful = new ArrayList<String>(_list90.size);
          String _elem91;
          for (int _i92 = 0; _i92 < _list90.size; ++_i92)
          {
            _elem91 = iprot.readString();
            struct.successful.add(_elem91);
          }
        }
        struct.setSuccessfulIsSet(true);
      }
      if (incoming.get(1)) {
        {
          ...
          struct.failed = new ArrayList<MessageBatchErrorEntry>(_list93.size);
          MessageBatchErrorEntry _elem94;
          for (int _i95 = 0; _i95 < _list93.size; ++_i95)
          {
            _elem94 = new MessageBatchErrorEntry();
            _elem94.read(iprot);
            struct.failed.add(_elem94);
          }
        }
        struct.setFailedIsSet(true);
      }
