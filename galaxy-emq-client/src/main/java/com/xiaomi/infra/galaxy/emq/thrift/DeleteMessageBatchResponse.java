...
public class DeleteMessageBatchResponse implements libthrift091.TBase<DeleteMessageBatchResponse, DeleteMessageBatchResponse._Fields>, java.io.Serializable, Cloneable, Comparable<DeleteMessageBatchResponse> {
  private static final libthrift091.protocol.TStruct STRUCT_DESC = new libthrift091.protocol.TStruct("DeleteMessageBatchResponse");
  ...
  static {
    schemes.put(StandardScheme.class, new DeleteMessageBatchResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new DeleteMessageBatchResponseTupleSchemeFactory());
  }
  ...
  static {
    ...
    libthrift091.meta_data.FieldMetaData.addStructMetaDataMap(DeleteMessageBatchResponse.class, metaDataMap);
  }
   ...
   */
  public DeleteMessageBatchResponse(DeleteMessageBatchResponse other) {
  ...
  public DeleteMessageBatchResponse deepCopy() {
   ...
   * 
   */
  public DeleteMessageBatchResponse setSuccessful(List<String> successful) {
    this.successful = successful;
    return this;
  }
   ...
   * 
   */
  public DeleteMessageBatchResponse setFailed(List<MessageBatchErrorEntry> failed) {
    this.failed = failed;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof DeleteMessageBatchResponse)
      return this.equals((DeleteMessageBatchResponse)that);
    return false;
  }

  public boolean equals(DeleteMessageBatchResponse that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(DeleteMessageBatchResponse other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("DeleteMessageBatchResponse(");
    boolean first = true;
  ...
  private static class DeleteMessageBatchResponseStandardSchemeFactory implements SchemeFactory {
    public DeleteMessageBatchResponseStandardScheme getScheme() {
      return new DeleteMessageBatchResponseStandardScheme();
    }
  }

  private static class DeleteMessageBatchResponseStandardScheme extends StandardScheme<DeleteMessageBatchResponse> {

    public void read(libthrift091.protocol.TProtocol iprot, DeleteMessageBatchResponse struct) throws libthrift091.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                ...
                struct.successful = new ArrayList<String>(_list96.size);
                String _elem97;
                for (int _i98 = 0; _i98 < _list96.size; ++_i98)
                {
                  _elem97 = iprot.readString();
                  struct.successful.add(_elem97);
                }
                iprot.readListEnd();
              }
          ...
          case 2: // FAILED
            if (schemeField.type == libthrift091.protocol.TType.LIST) {
              {
                libthrift091.protocol.TList _list99 = iprot.readListBegin();
                struct.failed = new ArrayList<MessageBatchErrorEntry>(_list99.size);
                MessageBatchErrorEntry _elem100;
                for (int _i101 = 0; _i101 < _list99.size; ++_i101)
                {
                  _elem100 = new MessageBatchErrorEntry();
                  _elem100.read(iprot);
                  struct.failed.add(_elem100);
                }
                iprot.readListEnd();
              }
    ...
    public void write(libthrift091.protocol.TProtocol oprot, DeleteMessageBatchResponse struct) throws libthrift091.TException {
      struct.validate();
      ...
      if (struct.successful != null) {
        oprot.writeFieldBegin(SUCCESSFUL_FIELD_DESC);
        {
          ...
          for (String _iter102 : struct.successful)
          {
      ...
      if (struct.failed != null) {
        oprot.writeFieldBegin(FAILED_FIELD_DESC);
        {
          ...
          for (MessageBatchErrorEntry _iter103 : struct.failed)
          {
  ...
  private static class DeleteMessageBatchResponseTupleSchemeFactory implements SchemeFactory {
    public DeleteMessageBatchResponseTupleScheme getScheme() {
      return new DeleteMessageBatchResponseTupleScheme();
    }
  }

  private static class DeleteMessageBatchResponseTupleScheme extends TupleScheme<DeleteMessageBatchResponse> {

    @Override
    public void write(libthrift091.protocol.TProtocol prot, DeleteMessageBatchResponse struct) throws libthrift091.TException {
      ...
      if (struct.isSetSuccessful()) {
        {
          ...
          for (String _iter104 : struct.successful)
          {
      ...
      if (struct.isSetFailed()) {
        {
          ...
          for (MessageBatchErrorEntry _iter105 : struct.failed)
          {
    ...
    @Override
    public void read(libthrift091.protocol.TProtocol prot, DeleteMessageBatchResponse struct) throws libthrift091.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      BitSet incoming = iprot.readBitSet(2);
      if (incoming.get(0)) {
        {
          libthrift091.protocol.TList _list106 = new libthrift091.protocol.TList(libthrift091.protocol.TType.STRING, iprot.readI32());
          struct.successful = new ArrayList<String>(_list106.size);
          String _elem107;
          for (int _i108 = 0; _i108 < _list106.size; ++_i108)
          {
            _elem107 = iprot.readString();
            struct.successful.add(_elem107);
          }
        }
        struct.setSuccessfulIsSet(true);
      }
      if (incoming.get(1)) {
        {
          libthrift091.protocol.TList _list109 = new libthrift091.protocol.TList(libthrift091.protocol.TType.STRUCT, iprot.readI32());
          struct.failed = new ArrayList<MessageBatchErrorEntry>(_list109.size);
          MessageBatchErrorEntry _elem110;
          for (int _i111 = 0; _i111 < _list109.size; ++_i111)
          {
            _elem110 = new MessageBatchErrorEntry();
            _elem110.read(iprot);
            struct.failed.add(_elem110);
          }
        }
        struct.setFailedIsSet(true);
      }
