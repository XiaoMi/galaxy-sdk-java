      ...
      if (struct.tags != null) {
        if (struct.isSetTags()) {
          oprot.writeFieldBegin(TAGS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, String> _iter68 : struct.tags.entrySet())
            {
      ...
      if (struct.isSetTags()) {
        {
          ...
          for (Map.Entry<String, String> _iter69 : struct.tags.entrySet())
          {
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.tags = new HashMap<String,String>(2*_map70.size);
          String _key71;
          String _val72;
