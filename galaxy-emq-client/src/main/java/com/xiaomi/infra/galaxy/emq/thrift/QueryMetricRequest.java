...
public class QueryMetricRequest implements libthrift091.TBase<QueryMetricRequest, QueryMetricRequest._Fields>, java.io.Serializable, Cloneable, Comparable<QueryMetricRequest> {
      ...
      if (struct.tags != null) {
        if (struct.isSetTags()) {
          oprot.writeFieldBegin(TAGS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, String> _iter60 : struct.tags.entrySet())
            {
  ...
  private static class QueryMetricRequestTupleScheme extends TupleScheme<QueryMetricRequest> {
      ...
      if (struct.isSetTags()) {
        {
          ...
          for (Map.Entry<String, String> _iter61 : struct.tags.entrySet())
          {
    ...
    public void read(libthrift091.protocol.TProtocol prot, QueryMetricRequest struct) throws libthrift091.TException {
      ...
      if (incoming.get(4)) {
        {
          libthrift091.protocol.TMap _map62 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.STRING, iprot.readI32());
          struct.tags = new HashMap<String,String>(2*_map62.size);
          String _key63;
          String _val64;
