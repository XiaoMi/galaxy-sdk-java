      ...
      if (struct.tags != null) {
        if (struct.isSetTags()) {
          oprot.writeFieldBegin(TAGS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, String> _iter32 : struct.tags.entrySet())
            {
      ...
      if (struct.isSetTags()) {
        {
          ...
          for (Map.Entry<String, String> _iter33 : struct.tags.entrySet())
          {
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.tags = new HashMap<String,String>(2*_map34.size);
          String _key35;
          String _val36;
