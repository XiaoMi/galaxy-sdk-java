...
public class ChangeMessageVisibilityRequest implements libthrift091.TBase<ChangeMessageVisibilityRequest, ChangeMessageVisibilityRequest._Fields>, java.io.Serializable, Cloneable, Comparable<ChangeMessageVisibilityRequest> {
  private static final libthrift091.protocol.TStruct STRUCT_DESC = new libthrift091.protocol.TStruct("ChangeMessageVisibilityRequest");
  ...
  static {
    schemes.put(StandardScheme.class, new ChangeMessageVisibilityRequestStandardSchemeFactory());
    schemes.put(TupleScheme.class, new ChangeMessageVisibilityRequestTupleSchemeFactory());
  }
  ...
  static {
    ...
    libthrift091.meta_data.FieldMetaData.addStructMetaDataMap(ChangeMessageVisibilityRequest.class, metaDataMap);
  }
   ...
   */
  public ChangeMessageVisibilityRequest(ChangeMessageVisibilityRequest other) {
  ...
  public ChangeMessageVisibilityRequest deepCopy() {
   ...
   * 
   */
  public ChangeMessageVisibilityRequest setQueueName(String queueName) {
    this.queueName = queueName;
    return this;
  }
   ...
   * 
   */
  public ChangeMessageVisibilityRequest setInvisibilitySeconds(int invisibilitySeconds) {
    this.invisibilitySeconds = invisibilitySeconds;
    setInvisibilitySecondsIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof ChangeMessageVisibilityRequest)
      return this.equals((ChangeMessageVisibilityRequest)that);
    return false;
  }

  public boolean equals(ChangeMessageVisibilityRequest that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(ChangeMessageVisibilityRequest other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("ChangeMessageVisibilityRequest(");
    boolean first = true;
  ...
  private static class ChangeMessageVisibilityRequestStandardSchemeFactory implements SchemeFactory {
    public ChangeMessageVisibilityRequestStandardScheme getScheme() {
      return new ChangeMessageVisibilityRequestStandardScheme();
    }
  }

  private static class ChangeMessageVisibilityRequestStandardScheme extends StandardScheme<ChangeMessageVisibilityRequest> {

    public void read(libthrift091.protocol.TProtocol iprot, ChangeMessageVisibilityRequest struct) throws libthrift091.TException {
    ...
    public void write(libthrift091.protocol.TProtocol oprot, ChangeMessageVisibilityRequest struct) throws libthrift091.TException {
      struct.validate();
  ...
  private static class ChangeMessageVisibilityRequestTupleSchemeFactory implements SchemeFactory {
    public ChangeMessageVisibilityRequestTupleScheme getScheme() {
      return new ChangeMessageVisibilityRequestTupleScheme();
    }
  }

  private static class ChangeMessageVisibilityRequestTupleScheme extends TupleScheme<ChangeMessageVisibilityRequest> {

    @Override
    public void write(libthrift091.protocol.TProtocol prot, ChangeMessageVisibilityRequest struct) throws libthrift091.TException {
    ...
    @Override
    public void read(libthrift091.protocol.TProtocol prot, ChangeMessageVisibilityRequest struct) throws libthrift091.TException {
