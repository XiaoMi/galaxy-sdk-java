...
public class MessageAttribute implements libthrift091.TBase<MessageAttribute, MessageAttribute._Fields>, java.io.Serializable, Cloneable, Comparable<MessageAttribute> {
  ...
  private static final libthrift091.protocol.TField TYPE_FIELD_DESC = new libthrift091.protocol.TField("type", libthrift091.protocol.TType.STRING, (short)2);
  private static final libthrift091.protocol.TField STRING_VALUE_FIELD_DESC = new libthrift091.protocol.TField("stringValue", libthrift091.protocol.TType.STRING, (short)3);
  private static final libthrift091.protocol.TField BINARY_VALUE_FIELD_DESC = new libthrift091.protocol.TField("binaryValue", libthrift091.protocol.TType.STRING, (short)4);
  ...
  public enum _Fields implements libthrift091.TFieldIdEnum {
     ...
     * 
     */
    BINARY_VALUE((short)4, "binaryValue");
   ...
   * must be unique in one message
   */
  public MessageAttribute setName(String name) {
    this.name = name;
    return this;
  }
