...
public class CreateTagRequest implements libthrift091.TBase<CreateTagRequest, CreateTagRequest._Fields>, java.io.Serializable, Cloneable, Comparable<CreateTagRequest> {
            ...
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                ...
                struct.userAttributes = new HashMap<String,String>(2*_map28.size);
                String _key29;
                String _val30;
                for (int _i31 = 0; _i31 < _map28.size; ++_i31)
                {
                  ...
                  struct.userAttributes.put(_key29, _val30);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.userAttributes != null) {
        if (struct.isSetUserAttributes()) {
          oprot.writeFieldBegin(USER_ATTRIBUTES_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, String> _iter32 : struct.userAttributes.entrySet())
            {
  ...
  private static class CreateTagRequestTupleScheme extends TupleScheme<CreateTagRequest> {
      ...
      if (struct.isSetUserAttributes()) {
        {
          ...
          for (Map.Entry<String, String> _iter33 : struct.userAttributes.entrySet())
          {
    ...
    public void read(libthrift091.protocol.TProtocol prot, CreateTagRequest struct) throws libthrift091.TException {
      ...
      if (incoming.get(4)) {
        {
          libthrift091.protocol.TMap _map34 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.STRING, iprot.readI32());
          struct.userAttributes = new HashMap<String,String>(2*_map34.size);
          String _key35;
          String _val36;
          for (int _i37 = 0; _i37 < _map34.size; ++_i37)
          {
            ...
            struct.userAttributes.put(_key35, _val36);
          }
        }
        struct.setUserAttributesIsSet(true);
      }
