...
public class CreateTagRequest implements libthrift091.TBase<CreateTagRequest, CreateTagRequest._Fields>, java.io.Serializable, Cloneable, Comparable<CreateTagRequest> {
  ...
  private static final libthrift091.protocol.TField ATTRIBUTES_FILTER_FIELD_DESC = new libthrift091.protocol.TField("attributesFilter", libthrift091.protocol.TType.STRUCT, (short)8);
  ...
  public enum _Fields implements libthrift091.TFieldIdEnum {
    ...
    ATTRIBUTES_FILTER((short)8, "attributesFilter");
  ...
  private static final _Fields optionals[] = {_Fields.START_TIMESTAMP,_Fields.READ_QPSQUOTA,_Fields.ATTRIBUTE_NAME,_Fields.ATTRIBUTE_VALUE,_Fields.USER_ATTRIBUTES,_Fields.ATTRIBUTES_FILTER};
  ...
  public CreateTagRequest setAttributesFilter(AttributesFilter attributesFilter) {
            ...
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                ...
                struct.userAttributes = new HashMap<String,String>(2*_map54.size);
                String _key55;
                String _val56;
                for (int _i57 = 0; _i57 < _map54.size; ++_i57)
                {
                  ...
                  struct.userAttributes.put(_key55, _val56);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.userAttributes != null) {
        if (struct.isSetUserAttributes()) {
          oprot.writeFieldBegin(USER_ATTRIBUTES_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, String> _iter58 : struct.userAttributes.entrySet())
            {
  ...
  private static class CreateTagRequestTupleScheme extends TupleScheme<CreateTagRequest> {
      ...
      if (struct.isSetUserAttributes()) {
        {
          ...
          for (Map.Entry<String, String> _iter59 : struct.userAttributes.entrySet())
          {
    ...
    public void read(libthrift091.protocol.TProtocol prot, CreateTagRequest struct) throws libthrift091.TException {
      ...
      if (incoming.get(4)) {
        {
          libthrift091.protocol.TMap _map60 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.STRING, iprot.readI32());
          struct.userAttributes = new HashMap<String,String>(2*_map60.size);
          String _key61;
          String _val62;
          for (int _i63 = 0; _i63 < _map60.size; ++_i63)
          {
            ...
            struct.userAttributes.put(_key61, _val62);
          }
        }
        struct.setUserAttributesIsSet(true);
      }
