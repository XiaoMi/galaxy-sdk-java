...
public class CreateTagRequest implements libthrift091.TBase<CreateTagRequest, CreateTagRequest._Fields>, java.io.Serializable, Cloneable, Comparable<CreateTagRequest> {
            ...
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                ...
                struct.userAttributes = new HashMap<String,String>(2*_map36.size);
                String _key37;
                String _val38;
                for (int _i39 = 0; _i39 < _map36.size; ++_i39)
                {
                  ...
                  struct.userAttributes.put(_key37, _val38);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.userAttributes != null) {
        if (struct.isSetUserAttributes()) {
          oprot.writeFieldBegin(USER_ATTRIBUTES_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, String> _iter40 : struct.userAttributes.entrySet())
            {
  ...
  private static class CreateTagRequestTupleScheme extends TupleScheme<CreateTagRequest> {
      ...
      if (struct.isSetUserAttributes()) {
        {
          ...
          for (Map.Entry<String, String> _iter41 : struct.userAttributes.entrySet())
          {
    ...
    public void read(libthrift091.protocol.TProtocol prot, CreateTagRequest struct) throws libthrift091.TException {
      ...
      if (incoming.get(4)) {
        {
          libthrift091.protocol.TMap _map42 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.STRING, iprot.readI32());
          struct.userAttributes = new HashMap<String,String>(2*_map42.size);
          String _key43;
          String _val44;
          for (int _i45 = 0; _i45 < _map42.size; ++_i45)
          {
            ...
            struct.userAttributes.put(_key43, _val44);
          }
        }
        struct.setUserAttributesIsSet(true);
      }
