...
public class TimeSeriesData implements libthrift091.TBase<TimeSeriesData, TimeSeriesData._Fields>, java.io.Serializable, Cloneable, Comparable<TimeSeriesData> {
            ...
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                ...
                struct.tags = new HashMap<String,String>(2*_map66.size);
                String _key67;
                String _val68;
            ...
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                ...
                struct.data = new HashMap<Long,Double>(2*_map70.size);
                long _key71;
                double _val72;
      ...
      if (struct.tags != null) {
        if (struct.isSetTags()) {
          oprot.writeFieldBegin(TAGS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, String> _iter74 : struct.tags.entrySet())
            {
      ...
      if (struct.data != null) {
        if (struct.isSetData()) {
          oprot.writeFieldBegin(DATA_FIELD_DESC);
          {
            ...
            for (Map.Entry<Long, Double> _iter75 : struct.data.entrySet())
            {
  ...
  private static class TimeSeriesDataTupleScheme extends TupleScheme<TimeSeriesData> {
      ...
      if (struct.isSetData()) {
        {
          ...
          for (Map.Entry<Long, Double> _iter77 : struct.data.entrySet())
          {
    ...
    public void read(libthrift091.protocol.TProtocol prot, TimeSeriesData struct) throws libthrift091.TException {
      ...
      if (incoming.get(2)) {
        {
          libthrift091.protocol.TMap _map82 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.I64, libthrift091.protocol.TType.DOUBLE, iprot.readI32());
          struct.data = new HashMap<Long,Double>(2*_map82.size);
          long _key83;
          double _val84;
