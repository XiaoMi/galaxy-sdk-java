            ...
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                ...
                struct.tags = new HashMap<String,String>(2*_map92.size);
                String _key93;
                String _val94;
            ...
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                ...
                struct.data = new HashMap<Long,Double>(2*_map96.size);
                long _key97;
                double _val98;
      ...
      if (struct.tags != null) {
        if (struct.isSetTags()) {
          oprot.writeFieldBegin(TAGS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, String> _iter100 : struct.tags.entrySet())
            {
      ...
      if (struct.data != null) {
        if (struct.isSetData()) {
          oprot.writeFieldBegin(DATA_FIELD_DESC);
          {
            ...
            for (Map.Entry<Long, Double> _iter101 : struct.data.entrySet())
            {
      ...
      if (struct.isSetTags()) {
        {
          ...
          for (Map.Entry<String, String> _iter102 : struct.tags.entrySet())
          {
      ...
      if (struct.isSetData()) {
        {
          ...
          for (Map.Entry<Long, Double> _iter103 : struct.data.entrySet())
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.data = new HashMap<Long,Double>(2*_map108.size);
          long _key109;
          double _val110;
