...
public class TimeSeriesData implements libthrift091.TBase<TimeSeriesData, TimeSeriesData._Fields>, java.io.Serializable, Cloneable, Comparable<TimeSeriesData> {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 3: // DATA
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                libthrift091.protocol.TMap _map78 = iprot.readMapBegin();
                struct.data = new HashMap<Long,Double>(2*_map78.size);
                long _key79;
                double _val80;
      ...
      if (struct.tags != null) {
        if (struct.isSetTags()) {
          oprot.writeFieldBegin(TAGS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, String> _iter82 : struct.tags.entrySet())
            {
      ...
      if (struct.data != null) {
        if (struct.isSetData()) {
          oprot.writeFieldBegin(DATA_FIELD_DESC);
          {
            ...
            for (Map.Entry<Long, Double> _iter83 : struct.data.entrySet())
            {
              oprot.writeI64(_iter83.getKey());
              oprot.writeDouble(_iter83.getValue());
            }
            oprot.writeMapEnd();
          }
          oprot.writeFieldEnd();
  ...
  private static class TimeSeriesDataTupleScheme extends TupleScheme<TimeSeriesData> {
      ...
      if (struct.isSetTags()) {
        {
          ...
          for (Map.Entry<String, String> _iter84 : struct.tags.entrySet())
          {
      ...
      if (struct.isSetData()) {
        {
          ...
          for (Map.Entry<Long, Double> _iter85 : struct.data.entrySet())
          {
            oprot.writeI64(_iter85.getKey());
            oprot.writeDouble(_iter85.getValue());
          }
        }
      }
    }
    ...
    public void read(libthrift091.protocol.TProtocol prot, TimeSeriesData struct) throws libthrift091.TException {
      ...
      if (incoming.get(1)) {
        {
          libthrift091.protocol.TMap _map86 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.STRING, libthrift091.protocol.TType.STRING, iprot.readI32());
      ...
      if (incoming.get(2)) {
        {
          libthrift091.protocol.TMap _map90 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.I64, libthrift091.protocol.TType.DOUBLE, iprot.readI32());
          struct.data = new HashMap<Long,Double>(2*_map90.size);
          long _key91;
          double _val92;
