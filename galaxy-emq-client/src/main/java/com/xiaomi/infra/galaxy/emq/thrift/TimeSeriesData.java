...
public class TimeSeriesData implements libthrift091.TBase<TimeSeriesData, TimeSeriesData._Fields>, java.io.Serializable, Cloneable, Comparable<TimeSeriesData> {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                ...
                struct.tags = new HashMap<String,String>(2*_map38.size);
                String _key39;
                String _val40;
          ...
          case 3: // DATA
            if (schemeField.type == libthrift091.protocol.TType.MAP) {
              {
                libthrift091.protocol.TMap _map42 = iprot.readMapBegin();
                struct.data = new HashMap<Long,Double>(2*_map42.size);
                long _key43;
                double _val44;
      ...
      if (struct.tags != null) {
        if (struct.isSetTags()) {
          oprot.writeFieldBegin(TAGS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, String> _iter46 : struct.tags.entrySet())
            {
      ...
      if (struct.data != null) {
        if (struct.isSetData()) {
          oprot.writeFieldBegin(DATA_FIELD_DESC);
          {
            ...
            for (Map.Entry<Long, Double> _iter47 : struct.data.entrySet())
            {
  ...
  private static class TimeSeriesDataTupleScheme extends TupleScheme<TimeSeriesData> {
      ...
      if (struct.isSetTags()) {
        {
          ...
          for (Map.Entry<String, String> _iter48 : struct.tags.entrySet())
          {
      ...
      if (struct.isSetData()) {
        {
          ...
          for (Map.Entry<Long, Double> _iter49 : struct.data.entrySet())
          {
    ...
    public void read(libthrift091.protocol.TProtocol prot, TimeSeriesData struct) throws libthrift091.TException {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.tags = new HashMap<String,String>(2*_map50.size);
          String _key51;
          String _val52;
      ...
      if (incoming.get(2)) {
        {
          libthrift091.protocol.TMap _map54 = new libthrift091.protocol.TMap(libthrift091.protocol.TType.I64, libthrift091.protocol.TType.DOUBLE, iprot.readI32());
          struct.data = new HashMap<Long,Double>(2*_map54.size);
          long _key55;
          double _val56;
