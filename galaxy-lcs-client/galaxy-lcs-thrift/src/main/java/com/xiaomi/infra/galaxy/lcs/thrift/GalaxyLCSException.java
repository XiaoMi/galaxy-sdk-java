...
public class GalaxyLCSException extends TException implements libthrift091.TBase<GalaxyLCSException, GalaxyLCSException._Fields>, java.io.Serializable, Cloneable, Comparable<GalaxyLCSException> {
  private static final libthrift091.protocol.TStruct STRUCT_DESC = new libthrift091.protocol.TStruct("GalaxyLCSException");
  ...
  static {
    schemes.put(StandardScheme.class, new GalaxyLCSExceptionStandardSchemeFactory());
    schemes.put(TupleScheme.class, new GalaxyLCSExceptionTupleSchemeFactory());
  }
  ...
  private static final _Fields optionals[] = {_Fields.ERR_MSG,_Fields.DETAILS};
  public static final Map<_Fields, libthrift091.meta_data.FieldMetaData> metaDataMap;
  static {
    Map<_Fields, libthrift091.meta_data.FieldMetaData> tmpMap = new EnumMap<_Fields, libthrift091.meta_data.FieldMetaData>(_Fields.class);
    tmpMap.put(_Fields.ERROR_CODE, new libthrift091.meta_data.FieldMetaData("errorCode", libthrift091.TFieldRequirementType.REQUIRED, 
    ...
    libthrift091.meta_data.FieldMetaData.addStructMetaDataMap(GalaxyLCSException.class, metaDataMap);
  }

  public GalaxyLCSException() {
  }
   ...
   */
  public GalaxyLCSException(GalaxyLCSException other) {
  ...
  public GalaxyLCSException deepCopy() {
    return new GalaxyLCSException(this);
  }
   ...
   * @see ErrorCode
   */
  public GalaxyLCSException setErrorCode(ErrorCode errorCode) {
    this.errorCode = errorCode;
    return this;
  }
  ...
  public GalaxyLCSException setErrMsg(String errMsg) {
    this.errMsg = errMsg;
    return this;
  }
  ...
  public GalaxyLCSException setDetails(String details) {
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof GalaxyLCSException)
      return this.equals((GalaxyLCSException)that);
    return false;
  }

  public boolean equals(GalaxyLCSException that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(GalaxyLCSException other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("GalaxyLCSException(");
    boolean first = true;
  ...
  public void validate() throws libthrift091.TException {
    ...
    if (errorCode == null) {
      throw new libthrift091.protocol.TProtocolException("Required field 'errorCode' was not present! Struct: " + toString());
    }
  ...
  private static class GalaxyLCSExceptionStandardSchemeFactory implements SchemeFactory {
    public GalaxyLCSExceptionStandardScheme getScheme() {
      return new GalaxyLCSExceptionStandardScheme();
    }
  }

  private static class GalaxyLCSExceptionStandardScheme extends StandardScheme<GalaxyLCSException> {

    public void read(libthrift091.protocol.TProtocol iprot, GalaxyLCSException struct) throws libthrift091.TException {
        ...
        switch (schemeField.id) {
          case 1: // ERROR_CODE
            if (schemeField.type == libthrift091.protocol.TType.I32) {
              struct.errorCode = com.xiaomi.infra.galaxy.lcs.thrift.ErrorCode.findByValue(iprot.readI32());
    ...
    public void write(libthrift091.protocol.TProtocol oprot, GalaxyLCSException struct) throws libthrift091.TException {
      struct.validate();
  ...
  private static class GalaxyLCSExceptionTupleSchemeFactory implements SchemeFactory {
    public GalaxyLCSExceptionTupleScheme getScheme() {
      return new GalaxyLCSExceptionTupleScheme();
    }
  }

  private static class GalaxyLCSExceptionTupleScheme extends TupleScheme<GalaxyLCSException> {

    @Override
    public void write(libthrift091.protocol.TProtocol prot, GalaxyLCSException struct) throws libthrift091.TException {
    ...
    @Override
    public void read(libthrift091.protocol.TProtocol prot, GalaxyLCSException struct) throws libthrift091.TException {
